...
type PortForwardConfig_Protocol int32

const (
	PortForwardConfig_TCP PortForwardConfig_Protocol = 0
	PortForwardConfig_UDP PortForwardConfig_Protocol = 1
)

// Enum value maps for PortForwardConfig_Protocol.
var (
	PortForwardConfig_Protocol_name = map[int32]string{
		0: "TCP",
		1: "UDP",
	}
	PortForwardConfig_Protocol_value = map[string]int32{
		"TCP": 0,
		"UDP": 1,
	}
)

func (x PortForwardConfig_Protocol) Enum() *PortForwardConfig_Protocol {
	p := new(PortForwardConfig_Protocol)
	*p = x
	return p
}

func (x PortForwardConfig_Protocol) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PortForwardConfig_Protocol) Descriptor() protoreflect.EnumDescriptor {
	return file_vpn_vpn_proto_enumTypes[4].Descriptor()
}

func (PortForwardConfig_Protocol) Type() protoreflect.EnumType {
	return &file_vpn_vpn_proto_enumTypes[4]
}

func (x PortForwardConfig_Protocol) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PortForwardConfig_Protocol.Descriptor instead.
func (PortForwardConfig_Protocol) EnumDescriptor() ([]byte, []int) {
	return file_vpn_vpn_proto_rawDescGZIP(), []int{21, 0}
}

type PortForwardResponseConfig_Status int32

const (
	PortForwardResponseConfig_ACTIVE  PortForwardResponseConfig_Status = 0
	PortForwardResponseConfig_ERRORED PortForwardResponseConfig_Status = 1
)

// Enum value maps for PortForwardResponseConfig_Status.
var (
	PortForwardResponseConfig_Status_name = map[int32]string{
		0: "ACTIVE",
		1: "ERRORED",
	}
	PortForwardResponseConfig_Status_value = map[string]int32{
		"ACTIVE":  0,
		"ERRORED": 1,
	}
)

func (x PortForwardResponseConfig_Status) Enum() *PortForwardResponseConfig_Status {
	p := new(PortForwardResponseConfig_Status)
	*p = x
	return p
}

func (x PortForwardResponseConfig_Status) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PortForwardResponseConfig_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_vpn_vpn_proto_enumTypes[5].Descriptor()
}

func (PortForwardResponseConfig_Status) Type() protoreflect.EnumType {
	return &file_vpn_vpn_proto_enumTypes[5]
}

func (x PortForwardResponseConfig_Status) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PortForwardResponseConfig_Status.Descriptor instead.
func (PortForwardResponseConfig_Status) EnumDescriptor() ([]byte, []int) {
	return file_vpn_vpn_proto_rawDescGZIP(), []int{23, 0}
}
...
func (x *ManagerMessage) GetPortForward() *PortForwardRequest {
	if x, ok := x.GetMsg().(*ManagerMessage_PortForward); ok {
...
type ManagerMessage_PortForward struct {
	PortForward *PortForwardRequest `protobuf:"bytes,6,opt,name=port_forward,json=portForward,proto3,oneof"`
}
...
func (*ManagerMessage_PortForward) isManagerMessage_Msg() {}
...
func (x *TunnelMessage) GetPortForward() *PortForwardResponse {
	if x, ok := x.GetMsg().(*TunnelMessage_PortForward); ok {
		return x.PortForward
	}
	return nil
}
...
type TunnelMessage_PortForward struct {
	PortForward *PortForwardResponse `protobuf:"bytes,7,opt,name=port_forward,json=portForward,proto3,oneof"`
}
...
func (*TunnelMessage_PortForward) isTunnelMessage_Msg() {}
...
type PortForwardConfig struct {
	...
	AgentId    []byte                     `protobuf:"bytes,2,opt,name=agent_id,json=agentId,proto3" json:"agent_id,omitempty"` // UUID
	RemotePort uint32                     `protobuf:"varint,3,opt,name=remote_port,json=remotePort,proto3" json:"remote_port,omitempty"`
	Protocol   PortForwardConfig_Protocol `protobuf:"varint,4,opt,name=protocol,proto3,enum=vpn.PortForwardConfig_Protocol" json:"protocol,omitempty"`
}
...
func (*PortForwardConfig) Descriptor() ([]byte, []int) {
	return file_vpn_vpn_proto_rawDescGZIP(), []int{21}
}

func (x *PortForwardConfig) GetLocalPort() uint32 {
	if x != nil {
		return x.LocalPort
	}
	return 0
...
func (x *PortForwardConfig) GetAgentId() []byte {
	if x != nil {
		return x.AgentId
	}
	return nil
...
func (x *PortForwardConfig) GetRemotePort() uint32 {
	if x != nil {
		return x.RemotePort
	}
	return 0
...
func (x *PortForwardConfig) GetProtocol() PortForwardConfig_Protocol {
	if x != nil {
		return x.Protocol
	}
	return PortForwardConfig_TCP
}
...
type PortForwardRequest struct {
	...
	Configs []*PortForwardConfig `protobuf:"bytes,1,rep,name=configs,proto3" json:"configs,omitempty"`
}
...
func (*PortForwardRequest) Descriptor() ([]byte, []int) {
	return file_vpn_vpn_proto_rawDescGZIP(), []int{22}
}

func (x *PortForwardRequest) GetConfigs() []*PortForwardConfig {
	if x != nil {
		return x.Configs
	}
	return nil
...
type PortForwardResponseConfig struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Config       *PortForwardConfig               `protobuf:"bytes,1,opt,name=config,proto3" json:"config,omitempty"`
	Status       PortForwardResponseConfig_Status `protobuf:"varint,2,opt,name=status,proto3,enum=vpn.PortForwardResponseConfig_Status" json:"status,omitempty"`
	ErrorMessage string                           `protobuf:"bytes,3,opt,name=error_message,json=errorMessage,proto3" json:"error_message,omitempty"`
}

func (x *PortForwardResponseConfig) Reset() {
	*x = PortForwardResponseConfig{}
	if protoimpl.UnsafeEnabled {
...
func (x *PortForwardResponseConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PortForwardResponseConfig) ProtoMessage() {}

func (x *PortForwardResponseConfig) ProtoReflect() protoreflect.Message {
	mi := &file_vpn_vpn_proto_msgTypes[23]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PortForwardResponseConfig.ProtoReflect.Descriptor instead.
func (*PortForwardResponseConfig) Descriptor() ([]byte, []int) {
	return file_vpn_vpn_proto_rawDescGZIP(), []int{23}
}

func (x *PortForwardResponseConfig) GetConfig() *PortForwardConfig {
	if x != nil {
		return x.Config
	}
	return nil
...
func (x *PortForwardResponseConfig) GetStatus() PortForwardResponseConfig_Status {
	if x != nil {
		return x.Status
	}
	return PortForwardResponseConfig_ACTIVE
}

func (x *PortForwardResponseConfig) GetErrorMessage() string {
	if x != nil {
		return x.ErrorMessage
	}
	return ""
...
type PortForwardResponse struct {
	...
	Configs []*PortForwardResponseConfig `protobuf:"bytes,1,rep,name=configs,proto3" json:"configs,omitempty"`
}
...
func (*PortForwardResponse) Descriptor() ([]byte, []int) {
	return file_vpn_vpn_proto_rawDescGZIP(), []int{24}
}

func (x *PortForwardResponse) GetConfigs() []*PortForwardResponseConfig {
	if x != nil {
		return x.Configs
	}
	return nil
...
func (x *NetworkSettingsRequest_IPv6Settings) Reset() {
	*x = NetworkSettingsRequest_IPv6Settings{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vpn_vpn_proto_msgTypes[28]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *NetworkSettingsRequest_IPv4Settings_IPv4Route) Reset() {
	*x = NetworkSettingsRequest_IPv4Settings_IPv4Route{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vpn_vpn_proto_msgTypes[29]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *NetworkSettingsRequest_IPv6Settings_IPv6Route) Reset() {
	*x = NetworkSettingsRequest_IPv6Settings_IPv6Route{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vpn_vpn_proto_msgTypes[30]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *StartRequest_Header) Reset() {
	*x = StartRequest_Header{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vpn_vpn_proto_msgTypes[31]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_vpn_vpn_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x54, 0x6f, 0x22, 0xcd, 0x02, 0x0a, 0x0e, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72,
	...
	,
	...
	,
	...
	,
	...
	0x61, 0x74, 0x75, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x15, 0x2e, 0x76, 0x70, 0x6e,
	0x2e, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x9c, 0x01, 0x0a, 0x06, 0x53, 0x74,
	...
	0x0a, 0x08, 0x53, 0x54, 0x41, 0x52, 0x54, 0x49, 0x4e, 0x47, 0x10, 0x02, 0x12, 0x0b, 0x0a, 0x07,
	...
	0x12, 0x0d, 0x0a, 0x09, 0x43, 0x41, 0x4e, 0x43, 0x45, 0x4c, 0x49, 0x4e, 0x47, 0x10, 0x07, 0x12,
	0x0c, 0x0a, 0x08, 0x43, 0x41, 0x4e, 0x43, 0x45, 0x4c, 0x45, 0x44, 0x10, 0x08, 0x12, 0x0c, 0x0a,
	0x08, 0x44, 0x45, 0x4c, 0x45, 0x54, 0x49, 0x4e, 0x47, 0x10, 0x09, 0x12, 0x0b, 0x0a, 0x07, 0x44,
	0x45, 0x4c, 0x45, 0x54, 0x45, 0x44, 0x10, 0x0a, 0x22, 0xff, 0x01, 0x0a, 0x05, 0x41, 0x67, 0x65,
	...
	,
	...
	0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x73, 0x12, 0x1f, 0x0a,
	...
	,
	...
	0x67, 0x73, 0x2e, 0x49, 0x50, 0x76, 0x36, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x52, 0x0e, 0x69, 0x6e,
	...
	0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x32, 0x2e, 0x76, 0x70, 0x6e, 0x2e, 0x4e, 0x65, 0x74, 0x77,
	0x6f, 0x72, 0x6b, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x2e, 0x49, 0x50, 0x76, 0x36, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x2e,
	0x49, 0x50, 0x76, 0x36, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x52, 0x0e, 0x65, 0x78, 0x63, 0x6c, 0x75,
	0x64, 0x65, 0x64, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x73, 0x1a, 0x6a, 0x0a, 0x09, 0x49, 0x50, 0x76,
	0x36, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x64, 0x65, 0x73, 0x74, 0x69, 0x6e,
	...
	0x6f, 0x74, 0x6f, 0x33,
	0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x23, 0x0a, 0x0d, 0x70, 0x72, 0x65, 0x66,
	0x69, 0x78, 0x5f, 0x6c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x0c, 0x70, 0x72, 0x65, 0x66, 0x69, 0x78, 0x4c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x12, 0x16, 0x0a,
	0x06, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x72,
	0x6f, 0x75, 0x74, 0x65, 0x72, 0x22, 0x58, 0x0a, 0x17, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b,
	...
	,
	...
	,
	...
	,
	...
	0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x30, 0x0a, 0x0b, 0x70, 0x65, 0x65, 0x72, 0x5f, 0x75, 0x70,
	0x64, 0x61, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x76, 0x70, 0x6e,
	0x2e, 0x50, 0x65, 0x65, 0x72, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x0a, 0x70, 0x65, 0x65,
	0x72, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x22, 0x4e, 0x0a, 0x09, 0x4c, 0x69, 0x66, 0x65, 0x63,
	0x79, 0x63, 0x6c, 0x65, 0x12, 0x0b, 0x0a, 0x07, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10,
	...
	,
	...
	,
...
var file_vpn_vpn_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
var file_vpn_vpn_proto_msgTypes = make([]protoimpl.MessageInfo, 32)
var file_vpn_vpn_proto_goTypes = []interface{}{
	...
	(PortForwardConfig_Protocol)(0),                       // 4: vpn.PortForwardConfig.Protocol
	(PortForwardResponseConfig_Status)(0),                 // 5: vpn.PortForwardResponseConfig.Status
	(*RPC)(nil),                                           // 6: vpn.RPC
	(*ManagerMessage)(nil),                                // 7: vpn.ManagerMessage
	(*TunnelMessage)(nil),                                 // 8: vpn.TunnelMessage
	(*ClientMessage)(nil),                                 // 9: vpn.ClientMessage
	(*ServiceMessage)(nil),                                // 10: vpn.ServiceMessage
	(*Log)(nil),                                           // 11: vpn.Log
	(*GetPeerUpdate)(nil),                                 // 12: vpn.GetPeerUpdate
	(*PeerUpdate)(nil),                                    // 13: vpn.PeerUpdate
	(*Workspace)(nil),                                     // 14: vpn.Workspace
	(*Agent)(nil),                                         // 15: vpn.Agent
	(*LastPing)(nil),                                      // 16: vpn.LastPing
	(*NetworkSettingsRequest)(nil),                        // 17: vpn.NetworkSettingsRequest
	(*NetworkSettingsResponse)(nil),                       // 18: vpn.NetworkSettingsResponse
	(*StartRequest)(nil),                                  // 19: vpn.StartRequest
	(*StartResponse)(nil),                                 // 20: vpn.StartResponse
	(*StartProgressDownloadProgress)(nil),                 // 21: vpn.StartProgressDownloadProgress
	(*StartProgress)(nil),                                 // 22: vpn.StartProgress
	(*StopRequest)(nil),                                   // 23: vpn.StopRequest
	(*StopResponse)(nil),                                  // 24: vpn.StopResponse
	(*StatusRequest)(nil),                                 // 25: vpn.StatusRequest
	(*Status)(nil),                                        // 26: vpn.Status
	(*PortForwardConfig)(nil),                             // 27: vpn.PortForwardConfig
	(*PortForwardRequest)(nil),                            // 28: vpn.PortForwardRequest
	(*PortForwardResponseConfig)(nil),                     // 29: vpn.PortForwardResponseConfig
	(*PortForwardResponse)(nil),                           // 30: vpn.PortForwardResponse
	(*Log_Field)(nil),                                     // 31: vpn.Log.Field
	(*NetworkSettingsRequest_DNSSettings)(nil),            // 32: vpn.NetworkSettingsRequest.DNSSettings
	(*NetworkSettingsRequest_IPv4Settings)(nil),           // 33: vpn.NetworkSettingsRequest.IPv4Settings
	(*NetworkSettingsRequest_IPv6Settings)(nil),           // 34: vpn.NetworkSettingsRequest.IPv6Settings
	(*NetworkSettingsRequest_IPv4Settings_IPv4Route)(nil), // 35: vpn.NetworkSettingsRequest.IPv4Settings.IPv4Route
	(*NetworkSettingsRequest_IPv6Settings_IPv6Route)(nil), // 36: vpn.NetworkSettingsRequest.IPv6Settings.IPv6Route
	(*StartRequest_Header)(nil),                           // 37: vpn.StartRequest.Header
	(*timestamppb.Timestamp)(nil),                         // 38: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),                           // 39: google.protobuf.Duration
}
var file_vpn_vpn_proto_depIdxs = []int32{
	6,  // 0: vpn.ManagerMessage.rpc:type_name -> vpn.RPC
	12, // 1: vpn.ManagerMessage.get_peer_update:type_name -> vpn.GetPeerUpdate
	18, // 2: vpn.ManagerMessage.network_settings:type_name -> vpn.NetworkSettingsResponse
	19, // 3: vpn.ManagerMessage.start:type_name -> vpn.StartRequest
	23, // 4: vpn.ManagerMessage.stop:type_name -> vpn.StopRequest
	28, // 5: vpn.ManagerMessage.port_forward:type_name -> vpn.PortForwardRequest
	6,  // 6: vpn.TunnelMessage.rpc:type_name -> vpn.RPC
	11, // 7: vpn.TunnelMessage.log:type_name -> vpn.Log
	13, // 8: vpn.TunnelMessage.peer_update:type_name -> vpn.PeerUpdate
	17, // 9: vpn.TunnelMessage.network_settings:type_name -> vpn.NetworkSettingsRequest
	20, // 10: vpn.TunnelMessage.start:type_name -> vpn.StartResponse
	24, // 11: vpn.TunnelMessage.stop:type_name -> vpn.StopResponse
	30, // 12: vpn.TunnelMessage.port_forward:type_name -> vpn.PortForwardResponse
	6,  // 13: vpn.ClientMessage.rpc:type_name -> vpn.RPC
	19, // 14: vpn.ClientMessage.start:type_name -> vpn.StartRequest
	23, // 15: vpn.ClientMessage.stop:type_name -> vpn.StopRequest
	25, // 16: vpn.ClientMessage.status:type_name -> vpn.StatusRequest
	6,  // 17: vpn.ServiceMessage.rpc:type_name -> vpn.RPC
	20, // 18: vpn.ServiceMessage.start:type_name -> vpn.StartResponse
	24, // 19: vpn.ServiceMessage.stop:type_name -> vpn.StopResponse
	26, // 20: vpn.ServiceMessage.status:type_name -> vpn.Status
	22, // 21: vpn.ServiceMessage.start_progress:type_name -> vpn.StartProgress
	1,  // 22: vpn.Log.level:type_name -> vpn.Log.Level
	31, // 23: vpn.Log.fields:type_name -> vpn.Log.Field
	14, // 24: vpn.PeerUpdate.upserted_workspaces:type_name -> vpn.Workspace
	15, // 25: vpn.PeerUpdate.upserted_agents:type_name -> vpn.Agent
	14, // 26: vpn.PeerUpdate.deleted_workspaces:type_name -> vpn.Workspace
	15, // 27: vpn.PeerUpdate.deleted_agents:type_name -> vpn.Agent
	2,  // 28: vpn.Workspace.status:type_name -> vpn.Workspace.Status
	38, // 29: vpn.Agent.last_handshake:type_name -> google.protobuf.Timestamp
	16, // 30: vpn.Agent.last_ping:type_name -> vpn.LastPing
	39, // 31: vpn.LastPing.latency:type_name -> google.protobuf.Duration
	39, // 32: vpn.LastPing.preferred_derp_latency:type_name -> google.protobuf.Duration
	32, // 33: vpn.NetworkSettingsRequest.dns_settings:type_name -> vpn.NetworkSettingsRequest.DNSSettings
	33, // 34: vpn.NetworkSettingsRequest.ipv4_settings:type_name -> vpn.NetworkSettingsRequest.IPv4Settings
	34, // 35: vpn.NetworkSettingsRequest.ipv6_settings:type_name -> vpn.NetworkSettingsRequest.IPv6Settings
	37, // 36: vpn.StartRequest.headers:type_name -> vpn.StartRequest.Header
	0,  // 37: vpn.StartProgress.stage:type_name -> vpn.StartProgressStage
	21, // 38: vpn.StartProgress.download_progress:type_name -> vpn.StartProgressDownloadProgress
	3,  // 39: vpn.Status.lifecycle:type_name -> vpn.Status.Lifecycle
	13, // 40: vpn.Status.peer_update:type_name -> vpn.PeerUpdate
	4,  // 41: vpn.PortForwardConfig.protocol:type_name -> vpn.PortForwardConfig.Protocol
	27, // 42: vpn.PortForwardRequest.configs:type_name -> vpn.PortForwardConfig
	27, // 43: vpn.PortForwardResponseConfig.config:type_name -> vpn.PortForwardConfig
	5,  // 44: vpn.PortForwardResponseConfig.status:type_name -> vpn.PortForwardResponseConfig.Status
	29, // 45: vpn.PortForwardResponse.configs:type_name -> vpn.PortForwardResponseConfig
	35, // 46: vpn.NetworkSettingsRequest.IPv4Settings.included_routes:type_name -> vpn.NetworkSettingsRequest.IPv4Settings.IPv4Route
	35, // 47: vpn.NetworkSettingsRequest.IPv4Settings.excluded_routes:type_name -> vpn.NetworkSettingsRequest.IPv4Settings.IPv4Route
	36, // 48: vpn.NetworkSettingsRequest.IPv6Settings.included_routes:type_name -> vpn.NetworkSettingsRequest.IPv6Settings.IPv6Route
	36, // 49: vpn.NetworkSettingsRequest.IPv6Settings.excluded_routes:type_name -> vpn.NetworkSettingsRequest.IPv6Settings.IPv6Route
...
func file_vpn_vpn_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_vpn_vpn_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PortForwardConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_vpn_vpn_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PortForwardResponseConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_vpn_vpn_proto_msgTypes[28].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vpn_vpn_proto_msgTypes[29].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vpn_vpn_proto_msgTypes[30].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vpn_vpn_proto_msgTypes[31].Exporter = func(v interface{}, i int) interface{} {
	...
	file_vpn_vpn_proto_msgTypes[1].OneofWrappers = []interface{}{
		...
		(*ManagerMessage_PortForward)(nil),
	}
