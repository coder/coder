...
type Status struct {
	...
	ErrorMessage string           `protobuf:"bytes,2,opt,name=error_message,json=errorMessage,proto3" json:"error_message,omitempty"`
	// In response to a StatusRequest, this will be a FULL update with all
	// workspaces and agents and clients should replace their current peer
	// state. During a status broadcast, this will only contain deltas.
...
var file_vpn_vpn_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x22, 0xe6, 0x01, 0x0a, 0x0c, 0x53, 0x74, 0x61, 0x72, 0x74, 0x52, 0x65, 0x71,
