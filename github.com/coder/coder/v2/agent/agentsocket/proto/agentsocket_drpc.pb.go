...
type DRPCAgentSocketClient interface {
	...
	AgentInfo(ctx context.Context, in *AgentInfoRequest) (*AgentInfoResponse, error)
...
func (c *drpcAgentSocketClient) Health(ctx context.Context, in *HealthRequest) (*HealthResponse, error) {
	out := new(HealthResponse)
	err := c.cc.Invoke(ctx, "/coder.agentsocket.v1.AgentSocket/Health", drpcEncoding_File_agent_agentsocket_proto_agentsocket_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *drpcAgentSocketClient) AgentInfo(ctx context.Context, in *AgentInfoRequest) (*AgentInfoResponse, error) {
	out := new(AgentInfoResponse)
	err := c.cc.Invoke(ctx, "/coder.agentsocket.v1.AgentSocket/AgentInfo", drpcEncoding_File_agent_agentsocket_proto_agentsocket_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *drpcAgentSocketClient) ListMethods(ctx context.Context, in *ListMethodsRequest) (*ListMethodsResponse, error) {
	out := new(ListMethodsResponse)
	err := c.cc.Invoke(ctx, "/coder.agentsocket.v1.AgentSocket/ListMethods", drpcEncoding_File_agent_agentsocket_proto_agentsocket_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (s *DRPCAgentSocketUnimplementedServer) Health(context.Context, *HealthRequest) (*HealthResponse, error) {
	return nil, drpcerr.WithCode(errors.New("Unimplemented"), drpcerr.Unimplemented)
}

func (s *DRPCAgentSocketUnimplementedServer) AgentInfo(context.Context, *AgentInfoRequest) (*AgentInfoResponse, error) {
	return nil, drpcerr.WithCode(errors.New("Unimplemented"), drpcerr.Unimplemented)
}

func (s *DRPCAgentSocketUnimplementedServer) ListMethods(context.Context, *ListMethodsRequest) (*ListMethodsResponse, error) {
	return nil, drpcerr.WithCode(errors.New("Unimplemented"), drpcerr.Unimplemented)
}
...
func (DRPCAgentSocketDescription) NumMethods() int { return 9 }
...
func (DRPCAgentSocketDescription) Method(n int) (string, drpc.Encoding, drpc.Receiver, interface{}, bool) {
	...
	case 1:
		return "/coder.agentsocket.v1.AgentSocket/Health", drpcEncoding_File_agent_agentsocket_proto_agentsocket_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCAgentSocketServer).
					Health(
						ctx,
			...
			}, DRPCAgentSocketServer.Health, true
	case 2:
		return "/coder.agentsocket.v1.AgentSocket/AgentInfo", drpcEncoding_File_agent_agentsocket_proto_agentsocket_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCAgentSocketServer).
					AgentInfo(
						ctx,
						in1.(*AgentInfoRequest),
					)
			}, DRPCAgentSocketServer.AgentInfo, true
	case 3:
		return "/coder.agentsocket.v1.AgentSocket/ListMethods", drpcEncoding_File_agent_agentsocket_proto_agentsocket_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCAgentSocketServer).
					ListMethods(
						ctx,
						in1.(*ListMethodsRequest),
					)
			}, DRPCAgentSocketServer.ListMethods, true
	case 4:
...
type DRPCAgentSocket_HealthStream interface {
	drpc.Stream
	SendAndClose(*HealthResponse) error
}

type drpcAgentSocket_HealthStream struct {
	drpc.Stream
}

func (x *drpcAgentSocket_HealthStream) SendAndClose(m *HealthResponse) error {
	if err := x.MsgSend(m, drpcEncoding_File_agent_agentsocket_proto_agentsocket_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
...
type DRPCAgentSocket_AgentInfoStream interface {
	drpc.Stream
	SendAndClose(*AgentInfoResponse) error
}

type drpcAgentSocket_AgentInfoStream struct {
	drpc.Stream
}

func (x *drpcAgentSocket_AgentInfoStream) SendAndClose(m *AgentInfoResponse) error {
	if err := x.MsgSend(m, drpcEncoding_File_agent_agentsocket_proto_agentsocket_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
...
type DRPCAgentSocket_ListMethodsStream interface {
	drpc.Stream
	SendAndClose(*ListMethodsResponse) error
}

type drpcAgentSocket_ListMethodsStream struct {
	drpc.Stream
}

func (x *drpcAgentSocket_ListMethodsStream) SendAndClose(m *ListMethodsResponse) error {
	if err := x.MsgSend(m, drpcEncoding_File_agent_agentsocket_proto_agentsocket_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
