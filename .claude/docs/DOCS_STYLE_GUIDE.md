...
> Vale rules under `docs/.style/styles/Coder/` enforce part of that subset, and automated tooling covers 9 of the guide's 71 rules today, all of it advisory in Vale's case.
