...
type CompletedJob_WorkspaceBuild struct {
	...
	ResourceReplacements []*proto.ResourceReplacements `protobuf:"bytes,5,rep,name=resourceReplacements,proto3" json:"resourceReplacements,omitempty"`
}
...
func (x *CompletedJob_WorkspaceBuild) GetResourceReplacements() []*proto.ResourceReplacements {
	if x != nil {
...
var file_provisionerd_proto_provisionerd_proto_rawDesc = []byte{
	...
	0x6c, 0x65, 0x73, 0x12, 0x55, 0x0a, 0x14, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52,
	...
	0x65, 0x6e, 0x74, 0x73, 0x52, 0x14, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52, 0x65,
...
var file_provisionerd_proto_provisionerd_proto_goTypes = []interface{}{
	...
	(*proto.ResourceReplacements)(nil),         // 31: provisioner.ResourceReplacements
...
var file_provisionerd_proto_provisionerd_proto_depIdxs = []int32{
	...
	31, // 30: provisionerd.CompletedJob.WorkspaceBuild.resourceReplacements:type_name -> provisioner.ResourceReplacements
