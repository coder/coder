...
type AcquiredJob_WorkspaceBuild struct {
	...
	ModulesFilesUuid *string `protobuf:"bytes,12,opt,name=modules_files_uuid,json=modulesFilesUuid,proto3,oneof" json:"modules_files_uuid,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *AcquiredJob_WorkspaceBuild) GetModulesFilesUuid() string {
	if x != nil && x.ModulesFilesUuid != nil {
		return *x.ModulesFilesUuid
	}
	return ""
}
...
const file_provisionerd_proto_provisionerd_proto_rawDesc = "" +
	...
	"\x0etrace_metadata\x18\t \x03(\v2,.provisionerd.AcquiredJob.TraceMetadataEntryR\rtraceMetadata\x1a\xd7\x05\n" +
	...
	"\x1dexp_reuse_terraform_workspace\x18\v \x01(\bH\x00R\x1aexpReuseTerraformWorkspace\x88\x01\x01\x121\n" +
	"\x12modules_files_uuid\x18\f \x01(\tH\x01R\x10modulesFilesUuid\x88\x01\x01B \n" +
	"\x1e_exp_reuse_terraform_workspaceB\x15\n" +
	"\x13_modules_files_uuidJ\x04\b\x03\x10\x04\x1a\x91\x01\n" +
	...
	"\tfile_uuid\x18\x01 \x01(\tR\bfileUuid*4\n" +
	"\tLogSource\x12\x16\n" +
	"\x12PROVISIONER_DAEMON\x10\x00\x12\x0f\n" +
	"\vPROVISIONER\x10\x012\xe1\x04\n" +
	...
	"\n" +
	"UploadFile\x12\x1f.provisionerd.UploadFileRequest\x1a\x13.provisionerd.Empty(\x01\x12T\n" +
	"\fDownloadFile\x12!.provisionerd.DownloadFileRequest\x1a\x1f.provisionerd.UploadFileRequest0\x01B.Z,github.com/coder/coder/v2/provisionerd/protob\x06proto3"
...
var file_provisionerd_proto_provisionerd_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_provisionerd_proto_provisionerd_proto_goTypes = []any{
	...
	(*DownloadFileRequest)(nil),                // 12: provisionerd.DownloadFileRequest
	(*AcquiredJob_WorkspaceBuild)(nil),         // 13: provisionerd.AcquiredJob.WorkspaceBuild
	(*AcquiredJob_TemplateImport)(nil),         // 14: provisionerd.AcquiredJob.TemplateImport
	(*AcquiredJob_TemplateDryRun)(nil),         // 15: provisionerd.AcquiredJob.TemplateDryRun
	nil,                                        // 16: provisionerd.AcquiredJob.TraceMetadataEntry
	(*FailedJob_WorkspaceBuild)(nil),           // 17: provisionerd.FailedJob.WorkspaceBuild
	(*FailedJob_TemplateImport)(nil),           // 18: provisionerd.FailedJob.TemplateImport
	(*FailedJob_TemplateDryRun)(nil),           // 19: provisionerd.FailedJob.TemplateDryRun
	(*CompletedJob_WorkspaceBuild)(nil),        // 20: provisionerd.CompletedJob.WorkspaceBuild
	(*CompletedJob_TemplateImport)(nil),        // 21: provisionerd.CompletedJob.TemplateImport
	(*CompletedJob_TemplateDryRun)(nil),        // 22: provisionerd.CompletedJob.TemplateDryRun
	nil,                                        // 23: provisionerd.UpdateJobRequest.WorkspaceTagsEntry
	...
	(*proto.DataUpload)(nil),                   // 27: provisioner.DataUpload
	(*proto.ChunkPiece)(nil),                   // 28: provisioner.ChunkPiece
...
var file_provisionerd_proto_provisionerd_proto_depIdxs = []int32{
	13, // 0: provisionerd.AcquiredJob.workspace_build:type_name -> provisionerd.AcquiredJob.WorkspaceBuild
	14, // 1: provisionerd.AcquiredJob.template_import:type_name -> provisionerd.AcquiredJob.TemplateImport
	15, // 2: provisionerd.AcquiredJob.template_dry_run:type_name -> provisionerd.AcquiredJob.TemplateDryRun
	16, // 3: provisionerd.AcquiredJob.trace_metadata:type_name -> provisionerd.AcquiredJob.TraceMetadataEntry
	17, // 4: provisionerd.FailedJob.workspace_build:type_name -> provisionerd.FailedJob.WorkspaceBuild
	18, // 5: provisionerd.FailedJob.template_import:type_name -> provisionerd.FailedJob.TemplateImport
	19, // 6: provisionerd.FailedJob.template_dry_run:type_name -> provisionerd.FailedJob.TemplateDryRun
	20, // 7: provisionerd.CompletedJob.workspace_build:type_name -> provisionerd.CompletedJob.WorkspaceBuild
	21, // 8: provisionerd.CompletedJob.template_import:type_name -> provisionerd.CompletedJob.TemplateImport
	22, // 9: provisionerd.CompletedJob.template_dry_run:type_name -> provisionerd.CompletedJob.TemplateDryRun
	0,  // 10: provisionerd.Log.source:type_name -> provisionerd.LogSource
	24, // 11: provisionerd.Log.level:type_name -> provisioner.LogLevel
	5,  // 12: provisionerd.UpdateJobRequest.logs:type_name -> provisionerd.Log
	25, // 13: provisionerd.UpdateJobRequest.template_variables:type_name -> provisioner.TemplateVariable
	26, // 14: provisionerd.UpdateJobRequest.user_variable_values:type_name -> provisioner.VariableValue
	23, // 15: provisionerd.UpdateJobRequest.workspace_tags:type_name -> provisionerd.UpdateJobRequest.WorkspaceTagsEntry
	26, // 16: provisionerd.UpdateJobResponse.variable_values:type_name -> provisioner.VariableValue
	27, // 17: provisionerd.UploadFileRequest.data_upload:type_name -> provisioner.DataUpload
	28, // 18: provisionerd.UploadFileRequest.chunk_piece:type_name -> provisioner.ChunkPiece
	29, // 19: provisionerd.AcquiredJob.WorkspaceBuild.rich_parameter_values:type_name -> provisioner.RichParameterValue
	26, // 20: provisionerd.AcquiredJob.WorkspaceBuild.variable_values:type_name -> provisioner.VariableValue
	30, // 21: provisionerd.AcquiredJob.WorkspaceBuild.external_auth_providers:type_name -> provisioner.ExternalAuthProvider
	31, // 22: provisionerd.AcquiredJob.WorkspaceBuild.metadata:type_name -> provisioner.Metadata
	29, // 23: provisionerd.AcquiredJob.WorkspaceBuild.previous_parameter_values:type_name -> provisioner.RichParameterValue
	31, // 24: provisionerd.AcquiredJob.TemplateImport.metadata:type_name -> provisioner.Metadata
	26, // 25: provisionerd.AcquiredJob.TemplateImport.user_variable_values:type_name -> provisioner.VariableValue
	29, // 26: provisionerd.AcquiredJob.TemplateDryRun.rich_parameter_values:type_name -> provisioner.RichParameterValue
	26, // 27: provisionerd.AcquiredJob.TemplateDryRun.variable_values:type_name -> provisioner.VariableValue
	31, // 28: provisionerd.AcquiredJob.TemplateDryRun.metadata:type_name -> provisioner.Metadata
	32, // 29: provisionerd.FailedJob.WorkspaceBuild.timings:type_name -> provisioner.Timing
	33, // 30: provisionerd.CompletedJob.WorkspaceBuild.resources:type_name -> provisioner.Resource
	32, // 31: provisionerd.CompletedJob.WorkspaceBuild.timings:type_name -> provisioner.Timing
	34, // 32: provisionerd.CompletedJob.WorkspaceBuild.modules:type_name -> provisioner.Module
	35, // 33: provisionerd.CompletedJob.WorkspaceBuild.resource_replacements:type_name -> provisioner.ResourceReplacement
	36, // 34: provisionerd.CompletedJob.WorkspaceBuild.ai_tasks:type_name -> provisioner.AITask
	...
	37, // 37: provisionerd.CompletedJob.TemplateImport.rich_parameters:type_name -> provisioner.RichParameter
	38, // 38: provisionerd.CompletedJob.TemplateImport.external_auth_providers:type_name -> provisioner.ExternalAuthProviderResource
	...
	12, // 51: provisionerd.ProvisionerDaemon.DownloadFile:input_type -> provisionerd.DownloadFileRequest
	...
	11, // 59: provisionerd.ProvisionerDaemon.DownloadFile:output_type -> provisionerd.UploadFileRequest
