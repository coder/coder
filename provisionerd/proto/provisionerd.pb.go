...
const file_provisionerd_proto_provisionerd_proto_rawDesc = "" +
	...
	"\x0etrace_metadata\x18\t \x03(\v2,.provisionerd.AcquiredJob.TraceMetadataEntryR\rtraceMetadata\x1a\xa3\x04\n" +
	...
	" \x03(\v2\x1f.provisioner.RichParameterValueR\x17previousParameterValuesJ\x04\b\x03\x10\x04\x1a\x91\x01\n" +
	...
	"\x10template_dry_run\x18\x04 \x01(\v2).provisionerd.CompletedJob.TemplateDryRunH\x00R\x0etemplateDryRun\x1a\xb9\x01\n" +
	"\x0eWorkspaceBuild\x12\x14\n" +
	...
	"\amodules\x18\x04 \x03(\v2\x13.provisioner.ModuleR\amodules\x1a\xd1\x04\n" +
	...
	"\vCompleteJob\x12\x1a.provisionerd.CompletedJob\x1a\x13.provisionerd.EmptyB.Z,github.com/coder/coder/v2/provisionerd/protob\x06proto3"
