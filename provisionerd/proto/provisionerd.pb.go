...
const file_provisionerd_proto_provisionerd_proto_rawDesc = "" +
	...
	"\x0etrace_metadata\x18\t \x03(\v2,.provisionerd.AcquiredJob.TraceMetadataEntryR\rtraceMetadata\x1a\xa9\x04\n" +
	...
	" \x03(\v2\x1f.provisioner.RichParameterValueR\x17previousParameterValuesJ\x04\b\x03\x10\x04J\x04\b\v\x10\f\x1a\x91\x01\n" +
	...
	"\bai_tasks\x18\x06 \x03(\v2\x13.provisioner.AITaskR\aaiTasks\x1a\x9d\x05\n" +
	...
	"\rstart_modules\x18\x06 \x03(\v2\x13.provisioner.ModuleR\fstartModules\x12-\n" +
	...
	"hasAiTasks\x12.\n" +
	"\x13has_external_agents\x18\r \x01(\bR\x11hasExternalAgentsJ\x04\b\a\x10\b\x1at\n" +
	...
	"\vupload_type\x18\x02 \x01(\x0e2\x1b.provisioner.DataUploadTypeR\n" +
	"uploadType*4\n" +
	"\tLogSource\x12\x16\n" +
