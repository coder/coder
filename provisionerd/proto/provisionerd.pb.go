...
type Log_WorkspaceProvision_ struct {
	WorkspaceProvision *Log_WorkspaceProvision `protobuf:"bytes,5,opt,name=workspace_provision,json=workspaceProvision,proto3,oneof"`
}

type Log_ProjectImport_ struct {
	ProjectImport *Log_ProjectImport `protobuf:"bytes,6,opt,name=project_import,json=projectImport,proto3,oneof"`
}
...
var file_provisionerd_proto_provisionerd_proto_rawDesc = []byte{
	...
	0x61, 0x73, 0x42, 0x06, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0xc8, 0x03, 0x0a, 0x03, 0x4c,
	...
	0x65, 0x78, 0x74, 0x12, 0x57, 0x0a, 0x13, 0x77, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65,
	0x5f, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b,
	...
	0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x5f, 0x69, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x18, 0x06,
	...
	0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x1a, 0x46, 0x0a, 0x12, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70,
	...
	0x73, 0x70, 0x61, 0x63, 0x65, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x49, 0x64, 0x1a, 0x3d,
	...
	,
...
var file_provisionerd_proto_provisionerd_proto_depIdxs = []int32{
	...
	13, // 5: provisionerd.Log.level:type_name -> provisioner.LogLevel
	...
	1,  // 12: provisionerd.ProvisionerDaemon.AcquireJob:input_type -> provisionerd.Empty
	6,  // 13: provisionerd.ProvisionerDaemon.UpdateJob:input_type -> provisionerd.JobUpdate
	3,  // 14: provisionerd.ProvisionerDaemon.CancelJob:input_type -> provisionerd.CancelledJob
	4,  // 15: provisionerd.ProvisionerDaemon.CompleteJob:input_type -> provisionerd.CompletedJob
	2,  // 16: provisionerd.ProvisionerDaemon.AcquireJob:output_type -> provisionerd.AcquiredJob
	1,  // 17: provisionerd.ProvisionerDaemon.UpdateJob:output_type -> provisionerd.Empty
	1,  // 18: provisionerd.ProvisionerDaemon.CancelJob:output_type -> provisionerd.Empty
	1,  // 19: provisionerd.ProvisionerDaemon.CompleteJob:output_type -> provisionerd.Empty
