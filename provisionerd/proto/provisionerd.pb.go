...
import (
	proto1 "github.com/coder/coder/provisionersdk/proto"
...
type Log struct {
	...
	Level     proto1.LogLevel `protobuf:"varint,2,opt,name=level,proto3,enum=provisioner.LogLevel" json:"level,omitempty"`
...
func (x *Log) GetLevel() proto1.LogLevel {
	if x != nil {
		return x.Level
	}
	return proto1.LogLevel_TRACE
}
...
type UpdateJobRequest struct {
	...
	ParameterSchemas []*proto1.ParameterSchema `protobuf:"bytes,3,rep,name=parameter_schemas,json=parameterSchemas,proto3" json:"parameter_schemas,omitempty"`
}
...
func (x *UpdateJobRequest) GetParameterSchemas() []*proto1.ParameterSchema {
	if x != nil {
...
type UpdateJobResponse struct {
	...
	ParameterValues []*proto1.ParameterValue `protobuf:"bytes,1,rep,name=parameter_values,json=parameterValues,proto3" json:"parameter_values,omitempty"`
}
...
func (x *UpdateJobResponse) GetParameterValues() []*proto1.ParameterValue {
	if x != nil {
...
type AcquiredJob_WorkspaceBuild struct {
	...
	ParameterValues  []*proto1.ParameterValue   `protobuf:"bytes,3,rep,name=parameter_values,json=parameterValues,proto3" json:"parameter_values,omitempty"`
	Metadata         *proto1.Provision_Metadata `protobuf:"bytes,4,opt,name=metadata,proto3" json:"metadata,omitempty"`
...
func (x *AcquiredJob_WorkspaceBuild) GetParameterValues() []*proto1.ParameterValue {
	if x != nil {
		return x.ParameterValues
	}
	return nil
...
func (x *AcquiredJob_WorkspaceBuild) GetMetadata() *proto1.Provision_Metadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
type AcquiredJob_ProjectImport struct {
	...
	Metadata *proto1.Provision_Metadata `protobuf:"bytes,1,opt,name=metadata,proto3" json:"metadata,omitempty"`
}
...
func (x *AcquiredJob_ProjectImport) GetMetadata() *proto1.Provision_Metadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
type CompletedJob_WorkspaceBuild struct {
	...
	State     []byte             `protobuf:"bytes,1,opt,name=state,proto3" json:"state,omitempty"`
	Resources []*proto1.Resource `protobuf:"bytes,2,rep,name=resources,proto3" json:"resources,omitempty"`
}
...
func (x *CompletedJob_WorkspaceBuild) GetResources() []*proto1.Resource {
	if x != nil {
		return x.Resources
	}
	return nil
...
type CompletedJob_ProjectImport struct {
	...
	StartResources []*proto1.Resource `protobuf:"bytes,1,rep,name=start_resources,json=startResources,proto3" json:"start_resources,omitempty"`
	StopResources  []*proto1.Resource `protobuf:"bytes,2,rep,name=stop_resources,json=stopResources,proto3" json:"stop_resources,omitempty"`
}
...
func (x *CompletedJob_ProjectImport) GetStartResources() []*proto1.Resource {
	if x != nil {
...
func (x *CompletedJob_ProjectImport) GetStopResources() []*proto1.Resource {
	if x != nil {
...
var file_provisionerd_proto_provisionerd_proto_goTypes = []interface{}{
	...
	(proto1.LogLevel)(0),                // 14: provisioner.LogLevel
	(*proto1.ParameterSchema)(nil),      // 15: provisioner.ParameterSchema
	(*proto1.ParameterValue)(nil),       // 16: provisioner.ParameterValue
	(*proto1.Provision_Metadata)(nil),   // 17: provisioner.Provision.Metadata
	(*proto1.Resource)(nil),             // 18: provisioner.Resource
}
