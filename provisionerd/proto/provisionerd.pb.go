...
var file_provisionerd_proto_provisionerd_proto_rawDesc = []byte{
	...
	0x52, 0x75, 0x6e, 0x1a, 0xd5, 0x02, 0x0a, 0x0e, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63,
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x1a, 0x4d, 0x0a, 0x0e, 0x54,
	0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x3b, 0x0a,
	...
	0x52, 0x06, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x22, 0x81, 0x02, 0x0a, 0x10, 0x55, 0x70, 0x64,
	...
	0x63, 0x68, 0x65, 0x6d, 0x61, 0x73, 0x12, 0x4c, 0x0a, 0x12, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61,
	...
	0x62, 0x6c, 0x65, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x65, 0x61, 0x64, 0x6d, 0x65, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x06, 0x72, 0x65, 0x61, 0x64, 0x6d, 0x65, 0x22, 0x77, 0x0a, 0x11,
	...
	0x69, 0x6f, 0x6e, 0x65, 0x72, 0x2e, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x56,
	0x61, 0x6c, 0x75, 0x65, 0x52, 0x0f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x56,
	0x61, 0x6c, 0x75, 0x65, 0x73, 0x22, 0x4a, 0x0a, 0x12, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x51,
...
var file_provisionerd_proto_provisionerd_proto_goTypes = []interface{}{
	...
	(*proto.ParameterValue)(nil),        // 22: provisioner.ParameterValue
	(*proto.RichParameterValue)(nil),    // 23: provisioner.RichParameterValue
	(*proto.Provision_Metadata)(nil),    // 24: provisioner.Provision.Metadata
	(*proto.Resource)(nil),              // 25: provisioner.Resource
	(*proto.RichParameter)(nil),         // 26: provisioner.RichParameter
}
var file_provisionerd_proto_provisionerd_proto_depIdxs = []int32{
	...
	22, // 14: provisionerd.UpdateJobResponse.parameter_values:type_name -> provisioner.ParameterValue
	22, // 15: provisionerd.AcquiredJob.WorkspaceBuild.parameter_values:type_name -> provisioner.ParameterValue
	23, // 16: provisionerd.AcquiredJob.WorkspaceBuild.rich_parameter_values:type_name -> provisioner.RichParameterValue
	24, // 17: provisionerd.AcquiredJob.WorkspaceBuild.metadata:type_name -> provisioner.Provision.Metadata
	24, // 18: provisionerd.AcquiredJob.TemplateImport.metadata:type_name -> provisioner.Provision.Metadata
	22, // 19: provisionerd.AcquiredJob.TemplateDryRun.parameter_values:type_name -> provisioner.ParameterValue
	23, // 20: provisionerd.AcquiredJob.TemplateDryRun.rich_parameter_values:type_name -> provisioner.RichParameterValue
	24, // 21: provisionerd.AcquiredJob.TemplateDryRun.metadata:type_name -> provisioner.Provision.Metadata
	25, // 22: provisionerd.CompletedJob.WorkspaceBuild.resources:type_name -> provisioner.Resource
	25, // 23: provisionerd.CompletedJob.TemplateImport.start_resources:type_name -> provisioner.Resource
	25, // 24: provisionerd.CompletedJob.TemplateImport.stop_resources:type_name -> provisioner.Resource
	26, // 25: provisionerd.CompletedJob.TemplateImport.rich_parameters:type_name -> provisioner.RichParameter
	25, // 26: provisionerd.CompletedJob.TemplateDryRun.resources:type_name -> provisioner.Resource
	1,  // 27: provisionerd.ProvisionerDaemon.AcquireJob:input_type -> provisionerd.Empty
	8,  // 28: provisionerd.ProvisionerDaemon.CommitQuota:input_type -> provisionerd.CommitQuotaRequest
	6,  // 29: provisionerd.ProvisionerDaemon.UpdateJob:input_type -> provisionerd.UpdateJobRequest
	3,  // 30: provisionerd.ProvisionerDaemon.FailJob:input_type -> provisionerd.FailedJob
	4,  // 31: provisionerd.ProvisionerDaemon.CompleteJob:input_type -> provisionerd.CompletedJob
	2,  // 32: provisionerd.ProvisionerDaemon.AcquireJob:output_type -> provisionerd.AcquiredJob
	9,  // 33: provisionerd.ProvisionerDaemon.CommitQuota:output_type -> provisionerd.CommitQuotaResponse
	7,  // 34: provisionerd.ProvisionerDaemon.UpdateJob:output_type -> provisionerd.UpdateJobResponse
	1,  // 35: provisionerd.ProvisionerDaemon.FailJob:output_type -> provisionerd.Empty
	1,  // 36: provisionerd.ProvisionerDaemon.CompleteJob:output_type -> provisionerd.Empty
