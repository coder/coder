...
const file_provisionerd_proto_provisionerd_proto_rawDesc = "" +
	...
	"\x0etrace_metadata\x18\t \x03(\v2,.provisionerd.AcquiredJob.TraceMetadataEntryR\rtraceMetadata\x1a\xbd\x05\n" +
	...
	"\x1dexp_reuse_terraform_workspace\x18\v \x01(\bH\x00R\x1aexpReuseTerraformWorkspace\x88\x01\x01\x12.\n" +
	"\x13initial_modules_tar\x18\f \x01(\fR\x11initialModulesTarB \n" +
