...
replace tailscale.com => github.com/coder/tailscale v1.1.1-0.20260226032809-e408c09d998a

// This is replaced to include
// 1. a fix for a data race: c.f. https://github.com/tailscale/wireguard-go/pull/25
// 2. update to the latest gVisor
replace github.com/tailscale/wireguard-go => github.com/coder/wireguard-go v0.0.0-20260226024330-5f94dcc47a39
