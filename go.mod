...
replace github.com/cloudflare/cloudflared => github.com/kylecarbs/cloudflared v0.0.0-20220309211552-7f1fc77731ce
...
require (
	...
	github.com/gohugoio/hugo v0.93.3
...
require (
	...
	github.com/coredns/coredns v1.8.7 // indirect
