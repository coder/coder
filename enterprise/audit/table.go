...
var auditableResourcesTypes = map[any]map[string]Action{
	...
	&database.TemplateVersion{}: {
		...
		"has_ai_agent":            ActionIgnore, // Never changes.
	...
	&database.APIKey{}: {
		...
		"holder_id":        ActionTrack,
		"holder_type":      ActionTrack,
	...
	&database.MCPServerConfig{}: {
		...
		"oauth2_client_secret_key_id": ActionSecret,
		"oauth2_auth_url":             ActionTrack,
		"oauth2_token_url":            ActionTrack,
		"oauth2_scopes":               ActionTrack,
		"api_key_header":              ActionSecret,
		"api_key_value":               ActionSecret,
		"api_key_value_key_id":        ActionSecret,
		"custom_headers":              ActionSecret,
		"custom_headers_key_id":       ActionSecret,
		...
		"external_auth_provider_id":   ActionTrack,
		"tool_rules":                  ActionTrack,
		"tool_default":                ActionTrack,
	},
