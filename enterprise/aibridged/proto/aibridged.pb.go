...
func (x *RecordInterceptionEndedRequest) GetToolCallId() string {
	if x != nil {
		return x.ToolCallId
	}
	return ""
...
type RecordToolUsageRequest struct {
	...
	InterceptionId  string                 `protobuf:"bytes,1,opt,name=interception_id,json=interceptionId,proto3" json:"interception_id,omitempty"` // UUID.
	MsgId           string                 `protobuf:"bytes,2,opt,name=msg_id,json=msgId,proto3" json:"msg_id,omitempty"`                            // ID provided by provider.
	ToolCallId      string                 `protobuf:"bytes,10,opt,name=tool_call_id,json=toolCallId,proto3" json:"tool_call_id,omitempty"`          // The ID of the tool call provided by provider.
...
const file_enterprise_aibridged_proto_aibridged_proto_rawDesc = "" +
	...
	"\x1aRecordInterceptionResponse\"\x89\x01\n" +
	...
	"\n" +
	"api_key_id\x18\x02 \x01(\tR\bapiKeyId2\xce\x03\n" +
	"\bRecorder\x12Y\n" +
