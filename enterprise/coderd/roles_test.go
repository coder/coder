	...
	testCases := []struct {
		...
		},
		{
			...
			ExpectedRoles: convertRoles(map[rbac.RoleIdentifier]bool{
				...
				{Name: codersdk.RoleOrganizationAIGatewayAccess, OrganizationID: owner.OrganizationID}:      false,
		...
		},
		{
			...
			ExpectedRoles: convertRoles(map[rbac.RoleIdentifier]bool{
				...
				{Name: codersdk.RoleOrganizationAIGatewayAccess, OrganizationID: owner.OrganizationID}:      true,
