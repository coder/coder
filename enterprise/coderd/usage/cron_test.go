...
func TestUsagePublisherCanInsertHeartbeats(t *testing.T) {
	...
	err := inserter.InsertHeartbeatUsageEvent(ctx, authzDB, "hb_ai_seats_v1:2025-01-01_00:00:00", time.Date(2025, 1, 1, 0, 0, 0, 0, time.UTC), usagetypes.HBAISeats{Count: 1})
