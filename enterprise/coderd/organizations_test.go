...
func TestPostOrganizationsByUser(t *testing.T) {
	...
	t.Run("DefaultOrgMemberRoles", func(t *testing.T) {
		...
		t.Run("Unset", func(t *testing.T) {
			...
			//nolint:gocritic // only owners can create orgs
			o, err := client.CreateOrganization(ctx, codersdk.CreateOrganizationRequest{
				Name: "default-roles-unset",
			})
			require.NoError(t, err)
			require.Equal(t, rbac.DefaultOrgMemberRoles(), o.DefaultOrgMemberRoles)
		})
		...
		t.Run("Explicit", func(t *testing.T) {
			...
			//nolint:gocritic // only owners can create orgs
			o, err := client.CreateOrganization(ctx, codersdk.CreateOrganizationRequest{
				Name:                  "default-roles-explicit",
				DefaultOrgMemberRoles: ptr.Ref([]string{codersdk.RoleOrganizationTemplateAdmin}),
			})
			require.NoError(t, err)
			require.Equal(t, []string{codersdk.RoleOrganizationTemplateAdmin}, o.DefaultOrgMemberRoles)
		})
		...
		t.Run("Empty", func(t *testing.T) {
			...
			// An explicit empty list grants new members no roles, unlike an
			// omitted field which falls back to the deployment default.
			//nolint:gocritic // only owners can create orgs
			o, err := client.CreateOrganization(ctx, codersdk.CreateOrganizationRequest{
				Name:                  "default-roles-empty",
				DefaultOrgMemberRoles: ptr.Ref([]string{}),
			})
			require.NoError(t, err)
			require.Empty(t, o.DefaultOrgMemberRoles)
		})
