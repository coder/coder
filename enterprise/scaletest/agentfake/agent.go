...
// rpcDialer is the subset of agentsdk.Client agentfake uses. Local so
// tests can plug a small fake in without depending on the rest of the
// agentsdk.Client surface.
...
// avoid standing up a real coderd.
