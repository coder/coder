	...
	cmd := &serpent.Command{
		...
		Handler: func(inv *serpent.Invocation) error {
			...
			options := &wsproxy.Options{
				...
				ProxyHeaderPassUserID:    cfg.ProxyHeaderPassUserID.Value(),
				ProxyHeaderPassUsername:  cfg.ProxyHeaderPassUsername.Value(),
				ProxyHeaderPassUserEmail: cfg.ProxyHeaderPassUserEmail.Value(),
