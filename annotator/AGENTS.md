...
- `pnpm.overrides` mirrors the repository root. CI installs every package
  recursively from the root, and pnpm refuses a frozen install when a
  lockfile was written under different overrides than the ones in force.
