...
Thank you for your interest in contributing to Coder.
This guide covers how to set up a development environment, the day-to-day workflow, and what we expect from pull requests.
All participation is governed by the [Code of Conduct](./CODE_OF_CONDUCT.md).

Area-specific guides live in [`contributing/`](./contributing/):

- [Backend](./contributing/backend.md): how the Go services fit together and how to test them.
- [Frontend](./contributing/frontend.md): the React codebase and its conventions.
- [Documentation](./contributing/documentation.md): the style guide for `docs/`.
- [Modules](./contributing/modules.md) and [templates](./contributing/templates.md): contributing to the Coder Registry.
- [AI contribution guidelines](./contributing/AI_CONTRIBUTING.md): rules for pull requests where an AI system is the primary author.

To report a security vulnerability, follow the [security policy](./SECURITY.md) instead of opening an issue.
...
- [Frontend styling guide](./contributing/frontend.md#styling)
...
Using AI to help with contributions is acceptable, but only if the [AI Contribution Guidelines](./contributing/AI_CONTRIBUTING.md)
