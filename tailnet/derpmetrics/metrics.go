...
func NewDERPExpvarCollector(server *derp.Server) *DERPExpvarCollector {
	return &DERPExpvarCollector{
		...
		accepts:              prometheus.NewDesc("coder_derp_accepts_total", "Total DERP connections accepted.", nil, nil),
		bytesReceived:        prometheus.NewDesc("coder_derp_bytes_received_total", "Total bytes received.", nil, nil),
		bytesSent:            prometheus.NewDesc("coder_derp_bytes_sent_total", "Total bytes sent.", nil, nil),
		packetsReceived:      prometheus.NewDesc("coder_derp_packets_received_total", "Total packets received.", nil, nil),
		packetsSent:          prometheus.NewDesc("coder_derp_packets_sent_total", "Total packets sent.", nil, nil),
		packetsDropped:       prometheus.NewDesc("coder_derp_packets_dropped_total", "Total packets dropped.", nil, nil),
		packetsForwardedIn:   prometheus.NewDesc("coder_derp_packets_forwarded_in_total", "Total packets forwarded in from mesh peers.", nil, nil),
		packetsForwardedOut:  prometheus.NewDesc("coder_derp_packets_forwarded_out_total", "Total packets forwarded out to mesh peers.", nil, nil),
		homeMovesIn:          prometheus.NewDesc("coder_derp_home_moves_in_total", "Total home moves in.", nil, nil),
		homeMovesOut:         prometheus.NewDesc("coder_derp_home_moves_out_total", "Total home moves out.", nil, nil),
		gotPing:              prometheus.NewDesc("coder_derp_got_ping_total", "Total pings received.", nil, nil),
		sentPong:             prometheus.NewDesc("coder_derp_sent_pong_total", "Total pongs sent.", nil, nil),
		peerGoneDisconnected: prometheus.NewDesc("coder_derp_peer_gone_disconnected_total", "Total peer gone (disconnected) frames sent.", nil, nil),
		peerGoneNotHere:      prometheus.NewDesc("coder_derp_peer_gone_not_here_total", "Total peer gone (not here) frames sent.", nil, nil),
		unknownFrames:        prometheus.NewDesc("coder_derp_unknown_frames_total", "Total unknown frames received.", nil, nil),

		packetsDroppedByReason: prometheus.NewDesc("coder_derp_packets_dropped_reason_total", "Packets dropped by reason.", []string{"reason"}, nil),
		packetsDroppedByType:   prometheus.NewDesc("coder_derp_packets_dropped_type_total", "Packets dropped by type.", []string{"type"}, nil),
		packetsReceivedByKind:  prometheus.NewDesc("coder_derp_packets_received_kind_total", "Packets received by kind.", []string{"kind"}, nil),

		connections:     prometheus.NewDesc("coder_derp_connections", "Current DERP connections.", nil, nil),
		homeConnections: prometheus.NewDesc("coder_derp_home_connections", "Current home DERP connections.", nil, nil),
		clientsTotal:    prometheus.NewDesc("coder_derp_clients", "Total clients (local + remote).", nil, nil),
		clientsLocal:    prometheus.NewDesc("coder_derp_clients_local", "Local clients.", nil, nil),
		clientsRemote:   prometheus.NewDesc("coder_derp_clients_remote", "Remote (mesh) clients.", nil, nil),
		watchers:        prometheus.NewDesc("coder_derp_watchers", "Current watchers.", nil, nil),
		avgQueueDurMS:   prometheus.NewDesc("coder_derp_average_queue_duration_ms", "Average queue duration in milliseconds.", nil, nil),
	}
}
