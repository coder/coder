...
type CoordinateRequest struct {
	...
	TunnelAck    *CoordinateRequest_Ack        `protobuf:"bytes,5,opt,name=tunnel_ack,json=tunnelAck,proto3" json:"tunnel_ack,omitempty"`
}
...
func (x *CoordinateRequest) GetTunnelAck() *CoordinateRequest_Ack {
	if x != nil {
		return x.TunnelAck
	}
	return nil
...
type CoordinateResponse struct {
	...
	TunnelAck   *CoordinateResponse_Ack          `protobuf:"bytes,2,opt,name=tunnel_ack,json=tunnelAck,proto3" json:"tunnel_ack,omitempty"`
}
...
func (x *CoordinateResponse) GetTunnelAck() *CoordinateResponse_Ack {
	if x != nil {
		return x.TunnelAck
	}
	return nil
...
// Acks are sent from agents back to the client, acknowledging receipt of
// the client's node. If the client starts pinging before an ACK, the
// handshake will likely be dropped.
type CoordinateRequest_Ack struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CoordinateRequest_Ack) Reset() {
	*x = CoordinateRequest_Ack{}
	if protoimpl.UnsafeEnabled {
...
func (x *CoordinateRequest_Ack) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CoordinateRequest_Ack) ProtoMessage() {}

func (x *CoordinateRequest_Ack) ProtoReflect() protoreflect.Message {
	mi := &file_tailnet_proto_tailnet_proto_msgTypes[15]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CoordinateRequest_Ack.ProtoReflect.Descriptor instead.
func (*CoordinateRequest_Ack) Descriptor() ([]byte, []int) {
	return file_tailnet_proto_tailnet_proto_rawDescGZIP(), []int{3, 3}
}

func (x *CoordinateRequest_Ack) GetId() []byte {
	if x != nil {
		return x.Id
	}
	return nil
...
type CoordinateResponse_Ack struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CoordinateResponse_Ack) Reset() {
	*x = CoordinateResponse_Ack{}
	if protoimpl.UnsafeEnabled {
...
func (x *CoordinateResponse_Ack) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CoordinateResponse_Ack) ProtoMessage() {}

func (x *CoordinateResponse_Ack) ProtoReflect() protoreflect.Message {
	mi := &file_tailnet_proto_tailnet_proto_msgTypes[17]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CoordinateResponse_Ack.ProtoReflect.Descriptor instead.
func (*CoordinateResponse_Ack) Descriptor() ([]byte, []int) {
	return file_tailnet_proto_tailnet_proto_rawDescGZIP(), []int{4, 1}
}

func (x *CoordinateResponse_Ack) GetId() []byte {
	if x != nil {
		return x.Id
	}
	return nil
...
var file_tailnet_proto_tailnet_proto_rawDesc = []byte{
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x91, 0x04, 0x0a, 0x11, 0x43,
	...
	,
	...
	0x65, 0x2e, 0x50, 0x65, 0x65, 0x72, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x0b, 0x70, 0x65,
	0x65, 0x72, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x73, 0x12, 0x47, 0x0a, 0x0a, 0x74, 0x75, 0x6e,
	0x6e, 0x65, 0x6c, 0x5f, 0x61, 0x63, 0x6b, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28, 0x2e,
	...
	0x6e, 0x73, 0x65, 0x2e, 0x41, 0x63, 0x6b, 0x52, 0x09, 0x74, 0x75, 0x6e, 0x6e, 0x65, 0x6c, 0x41,
	0x63, 0x6b, 0x1a, 0xee, 0x01, 0x0a, 0x0a, 0x50, 0x65, 0x65, 0x72, 0x55, 0x70, 0x64, 0x61, 0x74,
	...
	0x54, 0x10, 0x03, 0x1a, 0x15, 0x0a, 0x03, 0x41, 0x63, 0x6b, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x02, 0x69, 0x64, 0x32, 0xbe, 0x01, 0x0a, 0x07, 0x54,
	0x61, 0x69, 0x6c, 0x6e, 0x65, 0x74, 0x12, 0x56, 0x0a, 0x0e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d,
...
var file_tailnet_proto_tailnet_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_tailnet_proto_tailnet_proto_goTypes = []interface{}{
	...
	(*CoordinateRequest_Ack)(nil),           // 16: coder.tailnet.v2.CoordinateRequest.Ack
	(*CoordinateResponse_PeerUpdate)(nil),   // 17: coder.tailnet.v2.CoordinateResponse.PeerUpdate
	(*CoordinateResponse_Ack)(nil),          // 18: coder.tailnet.v2.CoordinateResponse.Ack
...
var file_tailnet_proto_tailnet_proto_depIdxs = []int32{
	...
	19, // 2: coder.tailnet.v2.Node.as_of:type_name -> google.protobuf.Timestamp
	...
	16, // 9: coder.tailnet.v2.CoordinateRequest.tunnel_ack:type_name -> coder.tailnet.v2.CoordinateRequest.Ack
	17, // 10: coder.tailnet.v2.CoordinateResponse.peer_updates:type_name -> coder.tailnet.v2.CoordinateResponse.PeerUpdate
	18, // 11: coder.tailnet.v2.CoordinateResponse.tunnel_ack:type_name -> coder.tailnet.v2.CoordinateResponse.Ack
	9,  // 12: coder.tailnet.v2.DERPMap.HomeParams.region_score:type_name -> coder.tailnet.v2.DERPMap.HomeParams.RegionScoreEntry
	10, // 13: coder.tailnet.v2.DERPMap.Region.nodes:type_name -> coder.tailnet.v2.DERPMap.Region.Node
	7,  // 14: coder.tailnet.v2.DERPMap.RegionsEntry.value:type_name -> coder.tailnet.v2.DERPMap.Region
	3,  // 15: coder.tailnet.v2.CoordinateRequest.UpdateSelf.node:type_name -> coder.tailnet.v2.Node
	3,  // 16: coder.tailnet.v2.CoordinateResponse.PeerUpdate.node:type_name -> coder.tailnet.v2.Node
	0,  // 17: coder.tailnet.v2.CoordinateResponse.PeerUpdate.kind:type_name -> coder.tailnet.v2.CoordinateResponse.PeerUpdate.Kind
	2,  // 18: coder.tailnet.v2.Tailnet.StreamDERPMaps:input_type -> coder.tailnet.v2.StreamDERPMapsRequest
	4,  // 19: coder.tailnet.v2.Tailnet.Coordinate:input_type -> coder.tailnet.v2.CoordinateRequest
	1,  // 20: coder.tailnet.v2.Tailnet.StreamDERPMaps:output_type -> coder.tailnet.v2.DERPMap
	5,  // 21: coder.tailnet.v2.Tailnet.Coordinate:output_type -> coder.tailnet.v2.CoordinateResponse
...
func file_tailnet_proto_tailnet_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_tailnet_proto_tailnet_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CoordinateRequest_Ack); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_tailnet_proto_tailnet_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CoordinateResponse_Ack); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
