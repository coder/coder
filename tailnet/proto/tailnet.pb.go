...
type TelemetryEvent struct {
	...
	NodeIdSelf          []byte                      `protobuf:"bytes,7,opt,name=node_id_self,json=nodeIdSelf,proto3" json:"node_id_self,omitempty"`
	NodeIdRemote        []byte                      `protobuf:"bytes,8,opt,name=node_id_remote,json=nodeIdRemote,proto3" json:"node_id_remote,omitempty"`
...
func (x *TelemetryEvent) GetNodeIdSelf() []byte {
	if x != nil {
		return x.NodeIdSelf
	}
	return nil
...
func (x *TelemetryEvent) GetNodeIdRemote() []byte {
	if x != nil {
...
var file_tailnet_proto_tailnet_proto_rawDesc = []byte{
	...
	0x65, 0x5f, 0x69, 0x64, 0x5f, 0x73, 0x65, 0x6c, 0x66, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0c, 0x52,
	...
	0x01, 0x28, 0x0c, 0x52, 0x0c, 0x6e, 0x6f, 0x64, 0x65, 0x49, 0x64, 0x52, 0x65, 0x6d, 0x6f, 0x74,
