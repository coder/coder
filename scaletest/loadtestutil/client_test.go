...
func TestDupClientCopyingHeaders(t *testing.T) {
	...
	require.True(t, ok)
	require.Equal(t, "bar", ht.Headers().Get("X-Coder-Test"))
	require.Equal(t, "baz", ht.Headers().Get("X-Coder-Test2"))
	require.Equal(t, "clocks", ht.Headers().Get("X-Coder-Test3"))
	require.Equal(t, "bears", ht.Headers().Get("X-Coder-Test4"))
	require.Equal(t, "ninjas", ht.Headers().Get("X-Coder-Test5"))
