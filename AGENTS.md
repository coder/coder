...
- Audit: Read [Audit Approach](poc_audit/audit_approach.md) before working on audit journals, entity lifecycle, or entity identity. Its sections are marked by standing: Established holds decided positions, Derived holds reasoning that is offered for challenge, Findings holds verified facts about this codebase, and Open holds undecided questions. Do not treat Derived or Open content as decided. Its Terminology section fixes the three senses of "agent", including which one takes the bare word.
