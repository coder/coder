...
func TestRequestPayloadLastUserPrompt(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name:           "trailing system message steps back to user prompt",
			requestBody:    `{"model":"claude-opus-4-5","max_tokens":1024,"messages":[{"role":"user","content":"hello"},{"role":"system","content":"available skills: ..."}]}`,
			expectedPrompt: "hello",
			expectedFound:  true,
			expectError:    false,
		},
		{
			name:           "trailing system message with typed user content returns last text block",
			requestBody:    `{"model":"claude-opus-4-5","max_tokens":1024,"messages":[{"role":"user","content":[{"type":"text","text":"first"},{"type":"text","text":"last"}]},{"role":"system","content":"available skills: ..."}]}`,
			expectedPrompt: "last",
			expectedFound:  true,
			expectError:    false,
		},
		{
			name:           "trailing system message after non user does not record",
			requestBody:    `{"model":"claude-opus-4-5","max_tokens":1024,"messages":[{"role":"assistant","content":"response"},{"role":"system","content":"available skills: ..."}]}`,
			expectedPrompt: "",
			expectedFound:  false,
			expectError:    false,
		},
		{
			name:           "only system message does not step out of bounds",
			requestBody:    `{"model":"claude-opus-4-5","max_tokens":1024,"messages":[{"role":"system","content":"available skills: ..."}]}`,
			expectedPrompt: "",
			expectedFound:  false,
			expectError:    false,
		},
		{
			name:           "two trailing system messages only steps back once",
			requestBody:    `{"model":"claude-opus-4-5","max_tokens":1024,"messages":[{"role":"user","content":"hello"},{"role":"system","content":"a"},{"role":"system","content":"b"}]}`,
			expectedPrompt: "",
			expectedFound:  false,
			expectError:    false,
		},
