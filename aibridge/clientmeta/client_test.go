...
func TestGuessClient(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantClient: clientmeta.ClientRoo,
		},
		{
		...
		},
		{
			...
			wantClient: clientmeta.ClientCoderAgents,
		},
		{
		...
		},
		{
			...
			wantClient: clientmeta.ClientCrush,
		},
		{
		...
		},
		{
			...
			wantClient: clientmeta.ClientCursor,
		},
		{
		...
		},
		{
			...
			wantClient: clientmeta.ClientOpenCode,
		},
		{
			name:       "junie_cli",
			userAgent:  "Junie:SNAPSHOT",
			wantClient: clientmeta.ClientJunie,
		},
		{
			name:       "unknown_client",
			userAgent:  "ccclaude-cli/calude-with-wrong-prefix",
			wantClient: clientmeta.ClientUnknown,
		},
		{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got := clientmeta.GuessClient(req)
