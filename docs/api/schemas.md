...
| `created_at`                       | string                                                             | false    |              |                                                                                                                                                                                 |
| `created_by_id`                    | string                                                             | false    |              | Created by ID is an enterprise feature. It's value is only used if your license is entitled to use the advanced template scheduling feature. TODO: fix and comment              |
