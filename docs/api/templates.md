...
| `»» latency`                         | object                                                                                                 | false    |              | Latency is mapped by region name (such as "New York City" or  "Seattle").                                                                                                                                                                      |
