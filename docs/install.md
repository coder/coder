...
Once installed, configure Coder by setting the following variables in `etc/coder.d/coder.env`:
...
For a full list of the Coder environment variables, run `coder server --help`
on the host.
