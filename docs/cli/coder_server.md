...
```
  ...
  -h, --help                                              help for server
      ...
      --strict-transport-security int                     Controls if the 'Strict-Transport-Security' header is set on all responses. This header should only be set if the server is accessed via HTTPS. The value should be a whole number in seconds.
