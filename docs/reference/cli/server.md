...
The base URL to use for the AWS Bedrock API. Use this setting to specify an exact URL to use. Most users should prefer setting CODER_AIBRIDGE_BEDROCK_REGION instead.
