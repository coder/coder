...
| Name                               | Purpose                    |
|------------------------------------|----------------------------|
| [<code>pause</code>](./pause.md)   | Pause notifications        |
| [<code>resume</code>](./resume.md) | Resume notifications       |
| [<code>test</code>](./test.md)     | Send a test notification   |
| [<code>custom</code>](./custom.md) | Send a custom notification |
