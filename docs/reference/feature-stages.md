...
A few GA features are off by default and have a deployment setting to turn them on, such as the [OAuth2 provider](../admin/integrations/oauth2-provider.md) with `CODER_OAUTH2_PROVIDER_ENABLE`.
