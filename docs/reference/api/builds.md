...
## Get or create a workspace build debugging chat

### Code samples

```sh
# Example request using curl
curl -X POST http://coder-server:8080/api/experimental/workspacebuilds/{workspacebuild}/debug-chat \
  -H 'Accept: application/json' \
  -H 'Coder-Session-Token: API_KEY'
```

`POST /api/experimental/workspacebuilds/{workspacebuild}/debug-chat`
...
|--------|--------------------------------------------------------------|-------------|--------------------------------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)      | OK          | [codersdk.WorkspaceDebugChatResponse](schemas.md#codersdkworkspacedebugchatresponse) |
| 201    | [Created](https://tools.ietf.org/html/rfc7231#section-6.3.2) | Created     | [codersdk.WorkspaceDebugChatResponse](schemas.md#codersdkworkspacedebugchatresponse) |
