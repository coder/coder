...
| `»»» origin_kind`        | [codersdk.ChatContextResourceOriginKind](schemas.md#codersdkchatcontextresourceoriginkind) | false    |              | Origin kind classifies OriginRoot. Empty (unspecified) for resources pushed by pre-origin agents.                                                                                                                                                                          |
...
| `origin_kind` | `builtin`, `unspecified`, `user_source`, `working_dir`                                                                                                                                                   |
