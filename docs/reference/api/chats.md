...
| `» context`               | [codersdk.ChatContext](schemas.md#codersdkchatcontext)                                   | false    |              | Context reports the chat's pinned workspace-context state and whether it has drifted from the agent's latest pushed snapshot. Nil until context is pinned, except on the single-chat GET, which also returns it for a chat bound to an agent before its first snapshot so mcp_discovery can report pending. Resources and mcp_discovery are only populated by the single-chat GET. |
...
| `»» mcp_discovery`        | [codersdk.ChatContextMCPDiscovery](schemas.md#codersdkchatcontextmcpdiscovery)           | false    |              | Mcp discovery reports how far the bound agent's workspace MCP discovery has progressed and whether the pinned MCP rows are current. Populated only on the single-chat GET response for chats bound to a workspace agent; nil otherwise.                                                                                                                                            |
| `»»» phase`               | [codersdk.ChatContextMCPDiscoveryPhase](schemas.md#codersdkchatcontextmcpdiscoveryphase) | false    |              |                                                                                                                                                                                                                                                                                                                                                                                    |
...
|---------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `client_type` | `api`, `ui`                                                                                                                                                                                                                                                       |
| `phase`       | `complete`, `pending`, `unknown`                                                                                                                                                                                                                                  |
