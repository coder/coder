...
| `»» url`                           | string                                                                             | false    |              |                                                                                                                                                                                                                                                                            |
| `» disabled_workspace_mcp_servers` | array                                                                              | false    |              | Disabled workspace mcp servers lists workspace .mcp.json server names whose tools are excluded from this chat.                                                                                                                                                             |
| `» files`                          | array                                                                              | false    |              |                                                                                                                                                                                                                                                                            |
| `»» created_at`                    | string(date-time)                                                                  | false    |              |                                                                                                                                                                                                                                                                            |
