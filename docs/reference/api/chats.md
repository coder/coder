...
| `»» context_file_agent_id`        | [uuid.NullUUID](schemas.md#uuidnulluuid)                               | false    |              | Context file agent ID is the workspace agent that provided this context part. Used to detect when the agent changes (e.g. workspace rebuilt) so instruction files can be re-persisted with fresh content.                                                                                                                                                                                                  |
| `»»» uuid`                        | string                                                                 | false    |              |                                                                                                                                                                                                                                                                                                                                                                                                            |
