...
```shell
# Example request using curl
curl -X GET http://coder-server:8080/api/v2/chats/system-prompt \
  -H 'Accept: application/json' \
  -H 'Coder-Session-Token: API_KEY'
```

`GET /chats/system-prompt`
...
```shell
# Example request using curl
curl -X PUT http://coder-server:8080/api/v2/chats/system-prompt \
  -H 'Content-Type: application/json' \
  -H 'Coder-Session-Token: API_KEY'
```

`PUT /chats/system-prompt`
...
| Name   | In   | Type                                                                                       | Required | Description                       |
|--------|------|--------------------------------------------------------------------------------------------|----------|-----------------------------------|
| `body` | body | [codersdk.UpdateChatSystemPromptRequest](schemas.md#codersdkupdatechatsystempromptrequest) | true     | Update chat system prompt request |
