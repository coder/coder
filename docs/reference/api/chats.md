...
| `» diff_status`           | [codersdk.ChatDiffStatus](schemas.md#codersdkchatdiffstatus)                       | false    |              | Diff status is the primary pull request, picked by the server. New consumers should use DiffStatuses, which lists every pull request the chat tracks.                                                                                                                      |
