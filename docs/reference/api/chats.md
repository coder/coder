...
| `» queued_for_capacity_at` | string(date-time)                                                                  | false    |              | Queued for capacity at is when the chat began waiting for a concurrent-agent capacity slot. Nil unless the chat is queued.                                                                                                                                                 |
