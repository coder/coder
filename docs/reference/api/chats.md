...
| `» title`                  | string                                                                             | false    |              |                                                                                                                                                                                                                                                                            |
| `» title_source`           | [codersdk.ChatTitleSource](schemas.md#codersdkchattitlesource)                     | false    |              | Title source is where Title came from. Automatic title generation replaces only a fallback title; a rename replaces any title.                                                                                                                                             |
