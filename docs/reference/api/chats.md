...
| `» queued_for_capacity_at` | string(date-time)                                                                  | false    |              | Queued for capacity at is when the chat began waiting for an agent slot. Status can remain running or interrupting while queued.                                                                                                                                           |
