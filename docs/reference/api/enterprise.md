...
| `» replicas`             | array                                                                      | false    |              | Replicas includes live, stale, and stopped replicas.                                                                               |
...
| `»» tailnet_address`     | string                                                                     | false    |              | Tailnet address is derived from the server-assigned peer ID.                                                                       |
| `»» updated_at`          | string(date-time)                                                          | false    |              |                                                                                                                                    |
| `»» version`             | string                                                                     | false    |              |                                                                                                                                    |
| `»» wireguard_endpoints` | array                                                                      | false    |              | Wireguard endpoints are direct endpoints agents exempt from enforcement.                                                           |
