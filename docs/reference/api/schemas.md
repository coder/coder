...
| `error_type`                     | string                                                                                 | false    |              | Error type is the categorized terminal upstream error from the root interception. Nil when the interception succeeded. One of bad_request, unauthorized, rate_limited, overloaded, server_error, or unknown.                              |
| `id`                             | string                                                                                 | false    |              |                                                                                                                                                                                                                                           |
| `model`                          | string                                                                                 | false    |              |                                                                                                                                                                                                                                           |
| `prompt`                         | string                                                                                 | false    |              |                                                                                                                                                                                                                                           |
