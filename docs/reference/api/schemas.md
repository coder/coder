...
| `queued_for_capacity_at` | string                                                          | false    |              | Queued for capacity at is when the chat began waiting for a concurrent-agent capacity slot. Nil unless the chat is queued. Status may be running or interrupting while queued, so clients must check this field.                                                           |
...
| Value(s)                                                                                                                                                                    |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `action_required`, `capacity_change`, `chat_summary_change`, `context_dirty`, `created`, `deleted`, `diff_status_change`, `status_change`, `summary_change`, `title_change` |
