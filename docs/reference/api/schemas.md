...
| `reasoning_effort` | string                                                    | false    |              | Reasoning effort is the user-selected reasoning effort for the turn triggered by this message. Clamped to the model config's max effort at generation time. Ignored when the model config has no reasoning effort configured. |
...
| `organization_id`      | string                                                    | false    |              |                                                                                                                                                                                                           |
| `plan_mode`            | [codersdk.ChatPlanMode](#codersdkchatplanmode)            | false    |              |                                                                                                                                                                                                           |
| `reasoning_effort`     | string                                                    | false    |              | Reasoning effort is the user-selected reasoning effort for the first turn. Clamped to the model config's max effort at generation time. Ignored when the model config has no reasoning effort configured. |
...
| `reasoning_effort` | string                                                    | false    |              | Reasoning effort when set, overrides the reasoning effort for the replacement user message. When nil the original message's reasoning effort is preserved.                   |
