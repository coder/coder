...
| `allow_workspace_renames`             | boolean                                                                        | false    |              | Allow workspace renames permits users to rename workspaces built from this template. Renaming is destructive for templates whose Terraform references the workspace name in a resource identifier, so this defaults to false.                                                                                       |
...
| `allow_workspace_renames`                      | boolean                                                                                              | false    |              | Deprecated: Use the per-template allow_workspace_renames setting instead. Removed in v2.41.0. |
