...
| Name            | Type    | Required | Restrictions | Description                                                                                                                           |
|-----------------|---------|----------|--------------|---------------------------------------------------------------------------------------------------------------------------------------|
| `close_reason`  | string  | false    |              | Close reason is omitted if a disconnect event with the same connection ID has not yet been seen.                                      |
| `close_time`    | string  | false    |              | Close time is omitted if a disconnect event with the same connection ID has not yet been seen.                                        |
