...
| `inject_coder_mcp_tools`            | boolean                                                              | false    |              | Deprecated: Injected MCP in AI Gateway is deprecated and will be removed in a future release.                                                                                 |
...
| `mcp_tool_allow_regex`             | string          | false    |              | Deprecated: Injected MCP in AI Gateway is deprecated and will be removed in a future release.                                                               |
| `mcp_tool_deny_regex`              | string          | false    |              | Deprecated: Injected MCP in AI Gateway is deprecated and will be removed in a future release.                                                               |
| `mcp_url`                          | string          | false    |              | Deprecated: Injected MCP in AI Gateway is deprecated and will be removed in a future release.                                                               |
