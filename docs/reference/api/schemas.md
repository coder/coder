...
| Name      | Type                                                          | Required | Restrictions | Description                                                                                                                                             |
|-----------|---------------------------------------------------------------|----------|--------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|
| `chat_id` | string                                                        | false    |              | Chat ID optionally identifies the chat to add context to. If empty, auto-detection is used (CODER_CHAT_ID env, or the only active chat for this agent). |
| `parts`   | array of [codersdk.ChatMessagePart](#codersdkchatmessagepart) | false    |              | Parts are the context-file parts to add.                                                                                                                |
