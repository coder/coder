...
| `model_config_id`      | string                                                    | false    |              |                                                                                                                                                                                                                                                                                  |
| `organization_id`      | string                                                    | false    |              |                                                                                                                                                                                                                                                                                  |
| `owner_id`             | string                                                    | false    |              | Owner ID is the user that should own the new chat. When unset the chat is owned by the authenticated caller. Setting this to another user requires site-level chat create permission (e.g. the Owner role); the target user must also be a member of the specified organization. |
| `plan_mode`            | [codersdk.ChatPlanMode](#codersdkchatplanmode)            | false    |              |                                                                                                                                                                                                                                                                                  |
