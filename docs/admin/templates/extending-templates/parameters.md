...
|----------------|--------------------------------------------|---------|---------------------------------------------------------------------------------------------------------------------------------|----|<details><summary>checkbox</summary>  ``` tf data "coder_parameter" "enable_gpu" {   name         = "enable_gpu"   display_name = "Enable GPU"   type         = "bool"   form_type    = "checkbox" # This is the default for boolean parameters   default      = false } ```  </ details > |
| `checkbox`     | `bool`                                     | No      | A single checkbox for boolean parameters.<br>Default for boolean parameters.                                                    | placeholder |
