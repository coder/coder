...
You should also avoid using `coder_workspace.me.name` if the template enables
the **Allow users to rename their workspaces** setting under **Template
settings** > **General**. Renames are disabled by default for this reason.
