...
- The web UI cannot set or change a scope allowlist; declare one at [Dynamic Client Registration](./index.md#dynamic-client-registration) or set it through the management API, as described under [Scopes](./integration.md#scopes)
...
Coder now treats the registered `scope` as the list of scopes the application is allowed to request, as described under [Scopes](./integration.md#scopes).
