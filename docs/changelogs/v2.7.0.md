...
are backwards-compatible and have been tested significantly with the goal of improving network reliability, improved session control, and stable versioning/backwards-compatibility.
