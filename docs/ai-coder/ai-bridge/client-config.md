...
| [Cursor](https://cursor.com/docs/settings/api-keys)                                                                                 | ❌              | ❌                 | Requests transit Cursor's cloud and it seems like they dropped support for `v1/chat/completions` endpoints. Support for `v1/responses` is in progress [#16](https://github.com/coder/aibridge/issues/16) |
