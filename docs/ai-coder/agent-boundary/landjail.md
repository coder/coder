...
landjail is Agent Boundary's alternative jail type that uses Landlock V4 for network isolation.

## Overview

Agent Boundary uses Landlock V4 to enforce network restrictions:
