...
> [!NOTE]
> Both Community and Premium deployments include 1,000 Agent Workspace Builds for proof-of-concept use. Community deployments do not have access to [AI Gateway](./ai-gateway/index.md) or [Agent Firewall](./agent-firewall/index.md). A Premium license expands the Agent Workspace Build allowance to scale with your user count and unlocks [AI Governance](./ai-governance.md) features. [Contact us](https://coder.com/contact) to discuss pricing.
