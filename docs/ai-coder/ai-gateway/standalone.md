...
To route these clients to the standalone gateway, replace the Coder access URL with the standalone endpoint.
You can use either root routes or the compatibility-prefixed `/api/v2/ai-gateway/<provider-name>/` routes.
