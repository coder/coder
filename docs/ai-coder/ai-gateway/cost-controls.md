...
- The **Spend** page under **Admin settings** > **AI** lists AI Gateway spend
  for every user over a date range, with a per-model and per-client breakdown
  for each user. It requires the AI Gateway entitlement.
