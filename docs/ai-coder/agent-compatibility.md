...
restart until the module is updated.

Agents marked **not supported** cannot resume a previous session. They start a
fresh conversation on each restart, even if some chat history is visible in the
UI.

## Compatibility matrix

| Agent           | Module                                                                           | Support       | Tracking                                                     | Session data paths                                   | Min storage               |
|-----------------|----------------------------------------------------------------------------------|---------------|--------------------------------------------------------------|------------------------------------------------------|---------------------------|
