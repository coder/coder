...
- Message content becomes searchable shortly after it is written (background indexing, usually within 10&nbsp;minutes).
  Titles and PR titles are searchable immediately.
