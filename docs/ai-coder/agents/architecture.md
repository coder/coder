...
| `message_agent`                             | Sends a prioritized instruction when the active assignment is wrong or its scope changed. It interrupts active work and requests that the new instruction run ahead of queued follow-ups, but preserves those follow-ups.                                            |
