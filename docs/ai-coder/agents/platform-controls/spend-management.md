...
- **Admin settings** > **AI** > **Spend**: AI Gateway spend for one organization at a time, as a total and per user with the providers, models, and clients each user spent through, over a date range of up to 31&nbsp;days within the retention period.
