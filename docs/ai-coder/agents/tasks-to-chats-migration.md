...
> [!WARNING]
> Coder Tasks is deprecated as of Coder v2.34. Coder Tasks product and API
> reference documentation is no longer published in the current documentation.
> To read about Coder Tasks, use a previous version of the Coder documentation,
> from a release before v2.36.
...
Migrate now. Coder Tasks was deprecated as of Coder v2.34. Starting June 2, 2026,
Coder Tasks moved to a 12-month Extended Support Release (ESR) for Premium
customers.
