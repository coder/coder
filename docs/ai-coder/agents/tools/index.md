...
Administrators can restrict which templates these tools can see with the switches on the [Templates page](../platform-controls/template-optimization.md#restrict-available-templates).
