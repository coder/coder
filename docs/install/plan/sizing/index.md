...
A [user](../../../admin/users/index.md) is an individual who utilizes the Coder platform
...
1. Follow our documented
   [steps for installing Coder via Helm](../../server/kubernetes.md).
...
1. Maintain Coder templates using
   [version control](../../../admin/templates/managing-templates/change-management.md).
...
1. Evaluate enabling
   [automatic template updates](../../../admin/templates/managing-templates/index.md#template-update-policies)
...
1. Deploy the
   ...
   Alertmanager.
1. Review the [Prometheus response](../../../admin/integrations/prometheus.md) and set up
   alarms on selected metrics.

### User support

1. Incorporate [support links](../../../admin/setup/appearance.md#support-links) into
