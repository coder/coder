...
[Kubernetes](../server/kubernetes.md) documentation and modify the Helm values to
...
- [Mirror the Coder Registry with JFrog Artifactory](./registry-mirror.md) (recommended)
