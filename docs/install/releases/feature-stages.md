...
A few GA features are off by default and have a server setting to turn them on, such as the [OAuth2 provider](../../admin/integrations/oauth2-provider/index.md) with `CODER_OAUTH2_PROVIDER_ENABLE`.
