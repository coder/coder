...
| AI Governance Usage Count | By default, deployments with the [AI Governance Add On](../ai-coder/ai-governance.md#usage-data-reporting) report usage data                                                                                                                                       | [Contact us](https://coder.com/contact) to request a license with usage reporting off.                                                                                                                                                                                                               |
