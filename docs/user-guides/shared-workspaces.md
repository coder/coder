...
- AI workflows where an agent prepares a workspace and a developer takes over to review or finalize the work (for example, with [Coder Agents](https://coder.com/docs/ai-coder/agents)).
