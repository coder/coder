...
<blockquote class="warning">
  <p>
  If you are a Coder v1 customer, view [the docs](https://coder.com/docs/coder) or [the v1 sunset support plans](https://coder.com/docs/coder/latest/guides/v2-faq).
  </p>
</blockquote>
