...
|-----|---------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| S0  | PASS    |                                                                                                                                                                           |
| S1  | PASS    | With the full scope set. The two smaller sets failed as described above.                                                                                                  |
| S2  | PASS    |                                                                                                                                                                           |
| S3  | PASS    |                                                                                                                                                                           |
| S4A | PASS    | Smoke run before S4.                                                                                                                                                      |
| S4  | PASS    |                                                                                                                                                                           |
| S5  | PASS    |                                                                                                                                                                           |
| S6  | PASS    |                                                                                                                                                                           |
| S7  | PASS    | First full run failed because carol's read-only post returned 404 and the check accepted only 403. The check now accepts 403 or 404; the rerun passed.                    |
| S8  | PASS    |                                                                                                                                                                           |
| S9  | FAIL    | In the bound chat the model called `create_workspace`, which returned `already_exists` for `alice-ws`; `bob/bob-from-chat` was never created. Superseded by S9B.           |
| S9B | PASS    | Run 1 failed step 5 because the model passed a nonexistent `workdir`; the harness now retries with an explicit prompt. Run 2 (`-only S9B -new-chat=false`) passed fully. |
