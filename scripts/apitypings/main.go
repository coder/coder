...
func (g *Generator) typescriptType(ty types.Type) (TypescriptType, error) {
	...
	case *types.Map:
		...
		var tsValueType string
		if keyType.ValueType == "string" {
			tsValueType = fmt.Sprintf("Record<%s, %s>", keyType.ValueType, valueType.ValueType)
		} else {
			tsValueType = fmt.Sprintf("PartialRecord<%s, %s>", keyType.ValueType, valueType.ValueType)
		}
