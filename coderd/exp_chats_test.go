...
func TestSendMessageWithModelOverrideUpdatesLastModelConfigID(t *testing.T) {
	...
	modelConfigB := createAdditionalChatModelConfig(t, client, "gpt-4o-mini-override-"+uuid.NewString())
...
func TestSendMessageQueuesEffectiveModelConfigID(t *testing.T) {
	...
	user := coderdtest.CreateFirstUser(t, client.Client)
	modelConfigA := createChatModelConfig(t, client)
	modelConfigB := createAdditionalChatModelConfig(t, client, "gpt-4o-mini-queued-"+uuid.NewString())
...
func TestQueuedMessageWithoutOverrideCapturesEnqueueTimeModel(t *testing.T) {
	...
	user := coderdtest.CreateFirstUser(t, client.Client)
	modelConfigA := createChatModelConfig(t, client)
	modelConfigB := createAdditionalChatModelConfig(t, client, "gpt-4o-mini-later-"+uuid.NewString())
...
func TestSubsequentSendWithoutOverrideUsesPersistedModel(t *testing.T) {
	...
	user := coderdtest.CreateFirstUser(t, client.Client)
	_ = createChatModelConfig(t, client)
	modelConfigB := createAdditionalChatModelConfig(t, client, "gpt-4o-mini-persisted-"+uuid.NewString())
...
func TestWatchChatsStatusChangeCarriesUpdatedLastModelConfigID(t *testing.T) {
	...
	t.Run("DirectSend", func(t *testing.T) {
		...
		user := coderdtest.CreateFirstUser(t, client.Client)
		modelConfigA := createChatModelConfig(t, client)
		modelConfigB := createAdditionalChatModelConfig(t, client, "gpt-4o-mini-watch-direct-"+uuid.NewString())
	...
	t.Run("QueuedPromotion", func(t *testing.T) {
		...
		user := coderdtest.CreateFirstUser(t, client.Client)
		modelConfigA := createChatModelConfig(t, client)
		modelConfigB := createAdditionalChatModelConfig(t, client, "gpt-4o-mini-watch-promote-"+uuid.NewString())
...
func createAdditionalChatModelConfig(t *testing.T, client *codersdk.ExperimentalClient, model string) codersdk.ChatModelConfig {
	t.Helper()
