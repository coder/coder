				...
				resource: &sdkproto.Resource{
					...
					Agents: []*sdkproto.Agent{{
						...
						Devcontainers: []*sdkproto.Devcontainer{
							...
							{Name: "abc", WorkspaceFolder: "/workspace3", SubagentId: subAgentID.String()},
						},
					}},
				},
				check: func(t *testing.T, db database.Store, parentAgent, subAgent database.WorkspaceAgent) {
					...
					assert.Equal(t, "abc", devcontainers[2].Name)
					assert.Equal(t, "/workspace3", devcontainers[2].WorkspaceFolder)
					assert.True(t, devcontainers[2].SubagentID.Valid)
					assert.Equal(t, subAgentID, devcontainers[2].SubagentID.UUID)
				},
			},
			{
