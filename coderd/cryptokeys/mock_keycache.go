...
//
//	mockgen -destination mock_keycache.go -package cryptokeys . Keycache
//
...
func (m *MockKeycache) Feature() codersdk.CryptoKeyFeature {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Feature")
	ret0, _ := ret[0].(codersdk.CryptoKeyFeature)
	return ret0
}

// Feature indicates an expected call of Feature.
func (mr *MockKeycacheMockRecorder) Feature() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Feature", reflect.TypeOf((*MockKeycache)(nil).Feature))
}
