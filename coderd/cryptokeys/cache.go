...
var (
	...
	ErrKeyInvalid     = errors.New("key is invalid for use")

	ErrClosed         = errors.New("closed")
	ErrInvalidFeature = errors.New("invalid feature for this operation")
)
...
func (d *DBFetcher) Fetch(ctx context.Context, feature codersdk.CryptoKeyFeature) ([]codersdk.CryptoKey, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("get crypto keys by feature: %w", err)
	}
