        ...
        "/api/experimental/chats": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Search query. Supports title:\u003csubstring\u003e (case-insensitive, quote multi-word values), archived:bool, has_unread:bool, pr_status:\u003cdraft\\|open\\|merged\\|closed\u003e as repeated or comma-separated values, diff_url:\u003curl\u003e (quote URLs), pr:\u003cnumber\u003e (exact PR number match), repo:\u003cowner/repo\u003e (substring match against git remote or URL), pr_title:\u003ctext\u003e (case-insensitive PR title substring), and archives_on:\u003cYYYY-MM-DD\u003e (chats that will auto-archive on the given date). Bare terms are not supported; use title:\u003cvalue\u003e for title filtering.",
                        "name": "q",
                        "in": "query"
                    },
                    {
