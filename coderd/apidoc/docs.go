...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/workspaceagents/me/experimental/chat-context": {
            "post": {
                "consumes": [
                    "application/json"
                ],
                ...
                "operationId": "add-workspace-agent-chat-context",
                "parameters": [
                    {
                        "description": "Chat context request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "delete": {
                ...
                "operationId": "clear-workspace-agent-chat-context",
                "parameters": [
                    {
                        "description": "Clear context request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
