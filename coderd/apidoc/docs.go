    ...
    "paths": {
        ...
        "/chats/cost/users": {
            "get": {
                ...
                "operationId": "get-chat-cost-users",
                "parameters": [
                    {
                        "type": "string",
        ...
        "/chats/cost/{user}/summary": {
            "get": {
                ...
                "operationId": "get-chat-cost-summary",
                "parameters": [
                    {
                        "type": "string",
        ...
        "codersdk.ChatCostSummary": {
            ...
            "properties": {
                "by_chat": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/codersdk.ChatCostChatBreakdown"
                    }
                },
                "by_model": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/codersdk.ChatCostModelBreakdown"
                    }
                },
                "end_date": {
                    "type": "string",
        ...
        "codersdk.ChatCostUsersResponse": {
            ...
            "properties": {
                ...
                "users": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/codersdk.ChatCostUserRollup"
                    }
                }
            }
        },
