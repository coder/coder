...
func guardedStream(
	...
	// nil err is the first streamed part and feeds both the TTFT and the
	// stage histogram, so both histograms hold only windows a first
	// content part closed. Any non-nil err (an open failure, an error
