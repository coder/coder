...
func generateCompactionSummary(
	...
	// NopMetrics and NopStageTracer: time to first token is an
	// assistant-generation measurement, so the summary stream records
	// neither the TTFT histogram nor a time_to_first_token stage.
