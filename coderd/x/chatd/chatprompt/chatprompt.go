...
var partNulFields = []partNulField{
	...
	{name: "MCPResult", policy: nulEncode, raw: func(p *codersdk.ChatMessagePart) *json.RawMessage { return &p.MCPResult }},
	...
	{name: "MCPAppResourceURI", policy: nulReject, str: func(p *codersdk.ChatMessagePart) *string { return &p.MCPAppResourceURI }},
