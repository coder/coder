...
- project and personal memory; <!-- TODO(chat-memory): document memory metadata -->
- file links.
...
<!-- TODO(chat-memory): document memory guidance with the index in read_memory, detached extraction, and detached consolidation after FinishTurn. -->

- chat compaction (automatic and manual, see [Manual compaction](#manual-compaction))
- MCP tools
- memory tools <!-- TODO(chat-memory): document root-chat memory tools -->
