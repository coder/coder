...
<!-- TODO: Document that pinned workspace prompt context is metadata updated
outside state-machine transitions through the dirty-then-refresh flow, while
MCP resources are live capabilities read from the currently bound agent. -->
