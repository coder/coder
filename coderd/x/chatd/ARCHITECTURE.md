...
TODO: Document how `execute` and `process_output` reserve their requested wait plus result-commit time within the task watchdog, including shared deadlines for parallel tools.
