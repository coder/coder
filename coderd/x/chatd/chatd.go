...
func formatPlanPathBlock(chatPath, home string) string {
	...
	_, _ = b.WriteString("\n")
	_, _ = b.WriteString("Use this path for the chat's working plan. Plan Mode requires this path for its submitted plan. Outside Plan Mode, use a project-specific path when the task calls for it. Do not use ")
