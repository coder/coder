...
// agent. Hash-neutral MCP changes synchronize these pinned rows on subsequent
// agent pushes, so there is no per-chat cache to invalidate and a nil
// invalidate callback (a 404 no-op) is correct here.
