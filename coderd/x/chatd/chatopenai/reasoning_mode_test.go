...
func TestValidateReasoningMode(t *testing.T) {
	...
	for _, model := range []string{"gpt-5.5", "gpt-5.6-pro", "gpt-5.6-sol-pro", "gpt-5.6-preview", "gpt-5.6-sol-preview", "gpt-6", "gpt-6-astra-next", "gpt-7", "openai/gpt-5.6", "GPT-5.6", "gpt-5.6-2026-8-12"} {
