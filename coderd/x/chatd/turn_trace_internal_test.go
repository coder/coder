...
func TestCompactionStageModel(t *testing.T) {
	...
	t.Run("ChatModelKeepsEffort", func(t *testing.T) {
		...
		require.Equal(t, chatloop.StageModel{Model: "claude", Effort: "high"},
			compactionStageModel(prepared, "claude"))
	})
	...
	t.Run("OverrideDropsEffort", func(t *testing.T) {
		...
		require.Equal(t, chatloop.StageModel{Model: "gpt-5"},
			compactionStageModel(prepared, "gpt-5"))
	})

	t.Run("NoCompactionDropsEffort", func(t *testing.T) {
		t.Parallel()
		require.Equal(t, chatloop.StageModel{Model: "claude"},
			compactionStageModel(prepared, "claude"))
	})
}
