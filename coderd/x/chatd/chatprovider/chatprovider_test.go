...
// TestModelFromConfig_BedrockStreamingHeaders is a regression test for
// Bedrock streaming requests. InvokeModelWithResponseStream requires AWS
// event stream frames at the HTTP layer, while the model response MIME type
// is requested separately with X-Amzn-Bedrock-Accept.
