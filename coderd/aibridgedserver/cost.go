...
// interception and computes its cost. A model absent from the price table yields
// NULL prices and cost rather than an error (a NULL cost unambiguously means
// "model not priced"). Any other error is returned.
