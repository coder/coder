...
// 	_, err = enq.Enqueue(ctx, user.ID, uuid.Nil, notifications.TemplateWorkspaceDeleted, map[string]string{"nice": "true", "i": "0"}, "") // Will succeed.
// 	require.NoError(t, err)
// 	_, err = enq.Enqueue(ctx, user.ID, uuid.Nil, notifications.TemplateWorkspaceDeleted, map[string]string{"nice": "true", "i": "1"}, "") // Will succeed.
// 	require.NoError(t, err)
// 	_, err = enq.Enqueue(ctx, user.ID, uuid.Nil, notifications.TemplateWorkspaceDeleted, map[string]string{"nice": "false", "i": "2"}, "") // Will fail.
// 	require.NoError(t, err)
//
// 	mgr.Run(ctx)
//
...
// 	_, err = enq.Enqueue(ctx, uuid.New(), uuid.Nil, notifications.TemplateWorkspaceDeleted, map[string]string{
// 		"name": "my-workspace",
// 	}, "test")
// 	require.NoError(t, err)
//
