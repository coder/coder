...
func TestBufferedUpdates(t *testing.T) {
	...
	mgr, err := notifications.NewManager(cfg, interceptor, pubsub, defaultHelpers(), createMetrics(), logger.Named("notifications-manager"))
...
func TestStopBeforeRun(t *testing.T) {
	...
	mgr, err := notifications.NewManager(defaultNotificationsConfig(database.NotificationMethodSmtp), store, pubsub, defaultHelpers(), createMetrics(), logger.Named("notifications-manager"))
	require.NoError(t, err)
