...
func AGPLRoutes(a *AuthTester) (map[string]string, map[string]RouteCheck) {
	...
	assertRoute := map[string]RouteCheck{
		...
		"GET:/api/v2/organizations/{organization}/templates/{templatename}/versions/{templateversionname}":          {StatusCode: http.StatusBadRequest, NoAuthorize: true},
		"GET:/api/v2/organizations/{organization}/templates/{templatename}/versions/{templateversionname}/previous": {StatusCode: http.StatusBadRequest, NoAuthorize: true},
