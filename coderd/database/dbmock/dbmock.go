...
// GetWorkspaceAgentByInstanceIDAndName mocks base method.
func (m *MockStore) GetWorkspaceAgentByInstanceIDAndName(ctx context.Context, arg database.GetWorkspaceAgentByInstanceIDAndNameParams) (database.WorkspaceAgent, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetWorkspaceAgentByInstanceIDAndName", ctx, arg)
	ret0, _ := ret[0].(database.WorkspaceAgent)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetWorkspaceAgentByInstanceIDAndName indicates an expected call of GetWorkspaceAgentByInstanceIDAndName.
func (mr *MockStoreMockRecorder) GetWorkspaceAgentByInstanceIDAndName(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetWorkspaceAgentByInstanceIDAndName", reflect.TypeOf((*MockStore)(nil).GetWorkspaceAgentByInstanceIDAndName), ctx, arg)
}
