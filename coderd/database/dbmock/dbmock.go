...
// GetTemplatesByIDs mocks base method.
func (m *MockStore) GetTemplatesByIDs(ctx context.Context, ids []uuid.UUID) ([]database.Template, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTemplatesByIDs", ctx, ids)
	ret0, _ := ret[0].([]database.Template)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetTemplatesByIDs indicates an expected call of GetTemplatesByIDs.
func (mr *MockStoreMockRecorder) GetTemplatesByIDs(ctx, ids any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTemplatesByIDs", reflect.TypeOf((*MockStore)(nil).GetTemplatesByIDs), ctx, ids)
}
