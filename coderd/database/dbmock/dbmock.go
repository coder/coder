...
func (m *MockStore) CleanTailnetLostPeers(arg0 context.Context) ([]uuid.UUID, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) CleanTailnetTunnels(arg0 context.Context) ([]database.CleanTailnetTunnelsRow, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) DeleteUserSecretByUserIDAndName(arg0 context.Context, arg1 database.DeleteUserSecretByUserIDAndNameParams) (int64, error) {
	m.ctrl.T.Helper()
