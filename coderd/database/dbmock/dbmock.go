...
func (m *MockStore) GetProvisionerDaemonsByProvisionerJobs(ctx context.Context, provisionerJobIds []uuid.UUID) ([]database.GetProvisionerDaemonsByProvisionerJobsRow, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetProvisionerDaemonsByProvisionerJobs", ctx, provisionerJobIds)
...
func (mr *MockStoreMockRecorder) GetProvisionerDaemonsByProvisionerJobs(ctx, provisionerJobIds any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetProvisionerDaemonsByProvisionerJobs", reflect.TypeOf((*MockStore)(nil).GetProvisionerDaemonsByProvisionerJobs), ctx, provisionerJobIds)
}
