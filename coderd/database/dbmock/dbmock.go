...
// GetChatGoalMessageIDsByRootChatAndMessageIDs mocks base method.
func (m *MockStore) GetChatGoalMessageIDsByRootChatAndMessageIDs(ctx context.Context, arg database.GetChatGoalMessageIDsByRootChatAndMessageIDsParams) ([]int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetChatGoalMessageIDsByRootChatAndMessageIDs", ctx, arg)
	ret0, _ := ret[0].([]int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetChatGoalMessageIDsByRootChatAndMessageIDs indicates an expected call of GetChatGoalMessageIDsByRootChatAndMessageIDs.
func (mr *MockStoreMockRecorder) GetChatGoalMessageIDsByRootChatAndMessageIDs(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetChatGoalMessageIDsByRootChatAndMessageIDs", reflect.TypeOf((*MockStore)(nil).GetChatGoalMessageIDsByRootChatAndMessageIDs), ctx, arg)
}
