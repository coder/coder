...
func (m *MockStore) DeleteChatMemoriesByRootChatIDAndPathPrefix(ctx context.Context, arg database.DeleteChatMemoriesByRootChatIDAndPathPrefixParams) ([]database.ChatMemory, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) DeleteUserMemoriesByUserIDAndPathPrefix(ctx context.Context, arg database.DeleteUserMemoriesByUserIDAndPathPrefixParams) ([]database.UserMemory, error) {
	m.ctrl.T.Helper()
