...
// DeleteWorkspaceAgentPortSharesByWorkspace mocks base method.
func (m *MockStore) DeleteWorkspaceAgentPortSharesByWorkspace(arg0 context.Context, arg1 uuid.UUID) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteWorkspaceAgentPortSharesByWorkspace", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteWorkspaceAgentPortSharesByWorkspace indicates an expected call of DeleteWorkspaceAgentPortSharesByWorkspace.
func (mr *MockStoreMockRecorder) DeleteWorkspaceAgentPortSharesByWorkspace(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteWorkspaceAgentPortSharesByWorkspace", reflect.TypeOf((*MockStore)(nil).DeleteWorkspaceAgentPortSharesByWorkspace), arg0, arg1)
}
