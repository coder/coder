...
SELECT
	...
	pj.completed_at AS provisioner_job_completed_at
FROM
	workspace_build_with_user AS wb
JOIN
	workspaces AS w
...
type GetFailedWorkspaceBuildsByTemplateIDRow struct {
	...
	ProvisionerJobCompletedAt sql.NullTime `db:"provisioner_job_completed_at" json:"provisioner_job_completed_at"`
}
