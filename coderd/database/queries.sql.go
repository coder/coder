...
VALUES
	($1, $2, $3, $4, $5, $6, $7, $8, $9, false) RETURNING id, organization_id, name, display_name, icon, url, wildcard_hostname, created_at, updated_at, deleted
`
...
WHERE
	id = $6
RETURNING id, organization_id, name, display_name, icon, url, wildcard_hostname, created_at, updated_at, deleted
`
