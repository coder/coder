...
const getWorkspaceAgentByIDWithWorkspace = `-- name: GetWorkspaceAgentByIDWithWorkspace :one
SELECT
	workspace_agents.id, workspace_agents.created_at, workspace_agents.updated_at, workspace_agents.name, workspace_agents.first_connected_at, workspace_agents.last_connected_at, workspace_agents.disconnected_at, workspace_agents.resource_id, workspace_agents.auth_token, workspace_agents.auth_instance_id, workspace_agents.architecture, workspace_agents.environment_variables, workspace_agents.operating_system, workspace_agents.instance_metadata, workspace_agents.resource_metadata, workspace_agents.directory, workspace_agents.version, workspace_agents.last_connected_replica_id, workspace_agents.connection_timeout_seconds, workspace_agents.troubleshooting_url, workspace_agents.motd_file, workspace_agents.lifecycle_state, workspace_agents.expanded_directory, workspace_agents.logs_length, workspace_agents.logs_overflowed, workspace_agents.started_at, workspace_agents.ready_at, workspace_agents.subsystems, workspace_agents.display_apps, workspace_agents.api_version, workspace_agents.display_order, workspace_agents.parent_id, workspace_agents.api_key_scope, workspace_agents.deleted,
	workspaces_expanded.id, workspaces_expanded.created_at, workspaces_expanded.updated_at, workspaces_expanded.owner_id, workspaces_expanded.organization_id, workspaces_expanded.template_id, workspaces_expanded.deleted, workspaces_expanded.name, workspaces_expanded.autostart_schedule, workspaces_expanded.ttl, workspaces_expanded.last_used_at, workspaces_expanded.dormant_at, workspaces_expanded.deleting_at, workspaces_expanded.automatic_updates, workspaces_expanded.favorite, workspaces_expanded.next_start_at, workspaces_expanded.group_acl, workspaces_expanded.user_acl, workspaces_expanded.owner_avatar_url, workspaces_expanded.owner_username, workspaces_expanded.owner_name, workspaces_expanded.organization_name, workspaces_expanded.organization_display_name, workspaces_expanded.organization_icon, workspaces_expanded.organization_description, workspaces_expanded.template_name, workspaces_expanded.template_display_name, workspaces_expanded.template_icon, workspaces_expanded.template_description, workspaces_expanded.task_id, workspaces_expanded.group_acl_display_info, workspaces_expanded.user_acl_display_info
FROM
	workspace_agents
JOIN
...
type GetWorkspaceAgentByIDWithWorkspaceRow struct {
	WorkspaceAgent WorkspaceAgent `db:"workspace_agent" json:"workspace_agent"`
	Workspace      Workspace      `db:"workspace" json:"workspace"`
}

func (q *sqlQuerier) GetWorkspaceAgentByIDWithWorkspace(ctx context.Context, id uuid.UUID) (GetWorkspaceAgentByIDWithWorkspaceRow, error) {
	row := q.db.QueryRowContext(ctx, getWorkspaceAgentByIDWithWorkspace, id)
	var i GetWorkspaceAgentByIDWithWorkspaceRow
	err := row.Scan(
		&i.WorkspaceAgent.ID,
		&i.WorkspaceAgent.CreatedAt,
		&i.WorkspaceAgent.UpdatedAt,
		...
		&i.Workspace.NextStartAt,
		&i.Workspace.GroupACL,
		&i.Workspace.UserACL,
		&i.Workspace.OwnerAvatarUrl,
		&i.Workspace.OwnerUsername,
		&i.Workspace.OwnerName,
		&i.Workspace.OrganizationName,
		&i.Workspace.OrganizationDisplayName,
		&i.Workspace.OrganizationIcon,
		&i.Workspace.OrganizationDescription,
		&i.Workspace.TemplateName,
		&i.Workspace.TemplateDisplayName,
		&i.Workspace.TemplateIcon,
		&i.Workspace.TemplateDescription,
		&i.Workspace.TaskID,
		&i.Workspace.GroupACLDisplayInfo,
		&i.Workspace.UserACLDisplayInfo,
	)
	return i, err
}
