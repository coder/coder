...
RETURNING
    id, owner_id, workspace_id, title, status, worker_id, started_at, heartbeat_at, created_at, updated_at, parent_chat_id, root_chat_id, last_model_config_id, archived, last_error, mode, mcp_server_ids, labels, build_id, agent_id, pin_order, last_read_message_id, last_workspace_context
`
...
SELECT id, owner_id, workspace_id, title, status, worker_id, started_at, heartbeat_at, created_at, updated_at, parent_chat_id, root_chat_id, last_model_config_id, archived, last_error, mode, mcp_server_ids, labels, build_id, agent_id, pin_order, last_read_message_id, last_workspace_context FROM chats WHERE id = $1::uuid FOR UPDATE
`
...
SELECT id, owner_id, workspace_id, title, status, worker_id, started_at, heartbeat_at, created_at, updated_at, parent_chat_id, root_chat_id, last_model_config_id, archived, last_error, mode, mcp_server_ids, labels, build_id, agent_id, pin_order, last_read_message_id, last_workspace_context
FROM chats
...
WHERE
    id = $3::uuid
RETURNING id, owner_id, workspace_id, title, status, worker_id, started_at, heartbeat_at, created_at, updated_at, parent_chat_id, root_chat_id, last_model_config_id, archived, last_error, mode, mcp_server_ids, labels, build_id, agent_id, pin_order, last_read_message_id, last_workspace_context
`
...
const updateChatLastWorkspaceContext = `-- name: UpdateChatLastWorkspaceContext :one
UPDATE chats SET
    last_workspace_context = $1::jsonb
WHERE
    id = $2::uuid
RETURNING id, owner_id, workspace_id, title, status, worker_id, started_at, heartbeat_at, created_at, updated_at, parent_chat_id, root_chat_id, last_model_config_id, archived, last_error, mode, mcp_server_ids, labels, build_id, agent_id, pin_order, last_read_message_id, last_workspace_context
`

type UpdateChatLastWorkspaceContextParams struct {
	LastWorkspaceContext json.RawMessage `db:"last_workspace_context" json:"last_workspace_context"`
	ID                   uuid.UUID       `db:"id" json:"id"`
}
...
func (q *sqlQuerier) UpdateChatLastWorkspaceContext(ctx context.Context, arg UpdateChatLastWorkspaceContextParams) (Chat, error) {
	row := q.db.QueryRowContext(ctx, updateChatLastWorkspaceContext, arg.LastWorkspaceContext, arg.ID)
	var i Chat
	err := row.Scan(
		&i.ID,
		&i.OwnerID,
