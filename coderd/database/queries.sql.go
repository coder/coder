...
func (q *sqlQuerier) GetNotificationReportGeneratorLogByTemplate(ctx context.Context, notificationTemplateID uuid.UUID) (NotificationReportGeneratorLog, error) {
	row := q.db.QueryRowContext(ctx, getNotificationReportGeneratorLogByTemplate, notificationTemplateID)
