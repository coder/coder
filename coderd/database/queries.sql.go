...
SELECT
	id, initiator_id, provider, model, started_at, metadata, ended_at, api_key_id, client, thread_parent_id, thread_root_id, client_session_id, session_id, credential_kind, credential_hint, provider_name
FROM
	aibridge_interceptions
WHERE
	id = $1::uuid
...
RETURNING id, initiator_id, provider, model, started_at, metadata, ended_at, api_key_id, client, thread_parent_id, thread_root_id, client_session_id, session_id, credential_kind, credential_hint, provider_name
`
