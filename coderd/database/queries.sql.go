...
SELECT
	...
	workspace_agents.id, workspace_agents.created_at, workspace_agents.updated_at, workspace_agents.name, workspace_agents.first_connected_at, workspace_agents.last_connected_at, workspace_agents.disconnected_at, workspace_agents.resource_id, workspace_agents.auth_token, workspace_agents.auth_instance_id, workspace_agents.architecture, workspace_agents.environment_variables, workspace_agents.operating_system, workspace_agents.instance_metadata, workspace_agents.resource_metadata, workspace_agents.directory, workspace_agents.version, workspace_agents.last_connected_replica_id, workspace_agents.connection_timeout_seconds, workspace_agents.troubleshooting_url, workspace_agents.motd_file, workspace_agents.lifecycle_state, workspace_agents.expanded_directory, workspace_agents.logs_length, workspace_agents.logs_overflowed, workspace_agents.started_at, workspace_agents.ready_at, workspace_agents.subsystems, workspace_agents.display_apps, workspace_agents.api_version, workspace_agents.display_order, workspace_agents.parent_id, workspace_agents.api_key_scope, workspace_agents.deleted, workspace_agents.restart_count, workspace_agents.last_restarted_at,
...
func (q *sqlQuerier) GetAuthenticatedWorkspaceAgentAndBuildByAuthToken(ctx context.Context, authToken uuid.UUID) (GetAuthenticatedWorkspaceAgentAndBuildByAuthTokenRow, error) {
	...
	err := row.Scan(
		...
		&i.WorkspaceAgent.RestartCount,
		&i.WorkspaceAgent.LastRestartedAt,
		&i.WorkspaceBuild.ID,
...
SELECT id, created_at, updated_at, name, first_connected_at, last_connected_at, disconnected_at, resource_id, auth_token, auth_instance_id, architecture, environment_variables, operating_system, instance_metadata, resource_metadata, directory, version, last_connected_replica_id, connection_timeout_seconds, troubleshooting_url, motd_file, lifecycle_state, expanded_directory, logs_length, logs_overflowed, started_at, ready_at, subsystems, display_apps, api_version, display_order, parent_id, api_key_scope, deleted, restart_count, last_restarted_at FROM workspace_agents
WHERE
	created_at > $1
	-- Filter out deleted sub agents.
	AND deleted = FALSE
...
const updateWorkspaceAgentRestartCount = `-- name: UpdateWorkspaceAgentRestartCount :exec
UPDATE
	workspace_agents
SET
	restart_count = $1,
...
type UpdateWorkspaceAgentRestartCountParams struct {
...
func (q *sqlQuerier) UpdateWorkspaceAgentRestartCount(ctx context.Context, arg UpdateWorkspaceAgentRestartCountParams) error {
	_, err := q.db.ExecContext(ctx, updateWorkspaceAgentRestartCount, arg.RestartCount, arg.LastRestartedAt, arg.ID)
	return err
}
