...
func (q *sqlQuerier) DeleteGitSSHKey(ctx context.Context, userID string) error {
...
<<<<<<< HEAD:coderd/database/queries.sql.go
...
func (q *sqlQuerier) GetGitSSHKey(ctx context.Context, userID string) (GitSshKey, error) {
	...
	err := row.Scan(
		...
		&i.PrivateKey,
		&i.PublicKey,
>>>>>>> feat: Add user scoped git ssh keys:coderd/database/query.sql.go
	)
	return i, err
}
