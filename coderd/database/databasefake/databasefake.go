...
func (q *fakeQuerier) GetWorkspaceBuildsByWorkspaceIDAndBuildNumber(_ context.Context, arg database.GetWorkspaceBuildsByWorkspaceIDAndBuildNumberParams) (database.WorkspaceBuild, error) {
	q.mutex.RLock()
	defer q.mutex.RUnlock()
