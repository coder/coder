...
var skipMethods = map[string]string{
	...
	"PruneChatMemoryConsolidationsByUser":       "Requires the chatd actor",
	"GetChatMemoryConsolidationsByProject":      "Covered by HTTP handler tests",
	"GetChatMemoryConsolidationsByUser":         "Covered by HTTP handler tests",
	"GetLatestChatMemoryConsolidationByProject": "Covered by consolidation worker tests",
	"GetLatestChatMemoryConsolidationByUser":    "Covered by consolidation worker tests",
}
