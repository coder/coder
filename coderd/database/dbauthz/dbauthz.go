...
func (q *querier) DeleteChatMemoriesByRootChatIDAndPathPrefix(ctx context.Context, arg database.DeleteChatMemoriesByRootChatIDAndPathPrefixParams) ([]database.DeleteChatMemoriesByRootChatIDAndPathPrefixRow, error) {
...
func (q *querier) DeleteUserMemoriesByUserIDAndPathPrefix(ctx context.Context, arg database.DeleteUserMemoriesByUserIDAndPathPrefixParams) ([]database.DeleteUserMemoriesByUserIDAndPathPrefixRow, error) {
