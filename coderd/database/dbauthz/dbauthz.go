...
func (q *querier) GetChatGoalMessageIDsByRootChatAndMessageIDs(ctx context.Context, arg database.GetChatGoalMessageIDsByRootChatAndMessageIDsParams) ([]int64, error) {
	_, err := q.GetChatByID(ctx, arg.RootChatID)
	if err != nil {
		return nil, err
	}
	return q.db.GetChatGoalMessageIDsByRootChatAndMessageIDs(ctx, arg)
}
