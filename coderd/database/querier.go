...
type sqlcQuerier interface {
	...
	GetAIBridgeSessionByID(ctx context.Context, id uuid.UUID) (AIBridgeSession, error)
	...
	InsertAIBridgeSession(ctx context.Context, arg InsertAIBridgeSessionParams) (AIBridgeSession, error)
