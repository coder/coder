...
type sqlcQuerier interface {
	...
	GetUserTerminalFontSize(ctx context.Context, userID uuid.UUID) (string, error)
	...
	UpdateUserTerminalFontSize(ctx context.Context, arg UpdateUserTerminalFontSizeParams) (UserConfig, error)
