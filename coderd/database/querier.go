...
type sqlcQuerier interface {
	...
	DeleteWorkspaceAgentByID(ctx context.Context, id uuid.UUID) error
	...
	GetWorkspaceAgentsWithParentID(ctx context.Context, parentID uuid.NullUUID) ([]WorkspaceAgent, error)
