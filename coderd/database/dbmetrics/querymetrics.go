...
func (m queryMetricsStore) LockWorkspaceByID(ctx context.Context, id uuid.UUID) (uuid.UUID, error) {
	start := time.Now()
	r0, r1 := m.s.LockWorkspaceByID(ctx, id)
	m.queryLatencies.WithLabelValues("LockWorkspaceByID").Observe(time.Since(start).Seconds())
	m.queryCounts.WithLabelValues(httpmw.ExtractHTTPRoute(ctx), httpmw.ExtractHTTPMethod(ctx), "LockWorkspaceByID").Inc()
	return r0, r1
}
...
func (m queryMetricsStore) NextAIAgentLifecycleJournalEntryID(ctx context.Context) (int64, error) {
	start := time.Now()
	r0, r1 := m.s.NextAIAgentLifecycleJournalEntryID(ctx)
	m.queryLatencies.WithLabelValues("NextAIAgentLifecycleJournalEntryID").Observe(time.Since(start).Seconds())
	m.queryCounts.WithLabelValues(httpmw.ExtractHTTPRoute(ctx), httpmw.ExtractHTTPMethod(ctx), "NextAIAgentLifecycleJournalEntryID").Inc()
	return r0, r1
}
...
func (m queryMetricsStore) RetireAIAgent(ctx context.Context, arg database.RetireAIAgentParams) (database.AIAgentLedger, error) {
	...
	m.queryCounts.WithLabelValues(httpmw.ExtractHTTPRoute(ctx), httpmw.ExtractHTTPMethod(ctx), "RetireAIAgent").Inc()
	return r0, r1
}
...
func (m queryMetricsStore) UpdateWorkspaceAgentAIAgentID(ctx context.Context, arg database.UpdateWorkspaceAgentAIAgentIDParams) (database.WorkspaceAgent, error) {
	start := time.Now()
	r0, r1 := m.s.UpdateWorkspaceAgentAIAgentID(ctx, arg)
	m.queryLatencies.WithLabelValues("UpdateWorkspaceAgentAIAgentID").Observe(time.Since(start).Seconds())
	m.queryCounts.WithLabelValues(httpmw.ExtractHTTPRoute(ctx), httpmw.ExtractHTTPMethod(ctx), "UpdateWorkspaceAgentAIAgentID").Inc()
	return r0, r1
}
