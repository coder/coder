...
func (m queryMetricsStore) SoftDeleteBoundChatModelConfigsByProviderConfigID(ctx context.Context, arg database.SoftDeleteBoundChatModelConfigsByProviderConfigIDParams) (int64, error) {
	start := time.Now()
	r0, r1 := m.s.SoftDeleteBoundChatModelConfigsByProviderConfigID(ctx, arg)
...
func (m queryMetricsStore) SoftDeleteUnboundChatModelConfigsByProvider(ctx context.Context, arg database.SoftDeleteUnboundChatModelConfigsByProviderParams) (int64, error) {
	start := time.Now()
	r0, r1 := m.s.SoftDeleteUnboundChatModelConfigsByProvider(ctx, arg)
