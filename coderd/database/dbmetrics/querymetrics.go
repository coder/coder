...
func (m queryMetricsStore) DeleteChatMemoriesByRootChatIDAndPathPrefix(ctx context.Context, arg database.DeleteChatMemoriesByRootChatIDAndPathPrefixParams) ([]database.ChatMemory, error) {
	start := time.Now()
...
func (m queryMetricsStore) DeleteUserMemoriesByUserIDAndPathPrefix(ctx context.Context, arg database.DeleteUserMemoriesByUserIDAndPathPrefixParams) ([]database.UserMemory, error) {
	start := time.Now()
