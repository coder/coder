...
type Chat struct {
	...
	DisabledWorkspaceMCPServers []string                `db:"disabled_workspace_mcp_servers" json:"disabled_workspace_mcp_servers"`
}
...
type ChatTable struct {
	...
	Summary               sql.NullString `db:"summary" json:"summary"`
	SummaryGeneratedAt    sql.NullTime   `db:"summary_generated_at" json:"summary_generated_at"`
	// Names of workspace .mcp.json MCP servers whose tools are excluded from this chat. Unknown names are inert.
	DisabledWorkspaceMCPServers []string `db:"disabled_workspace_mcp_servers" json:"disabled_workspace_mcp_servers"`
}
