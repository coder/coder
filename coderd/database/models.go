...
type WorkspaceAgentSessionCount struct {
	...
	CreatedAt time.Time `db:"created_at" json:"created_at"`
	// App name as reported by the client, canonicalized at ingestion (lowercased, hyphens folded to underscores). Stored ungrouped; family grouping can be applied at read time.
