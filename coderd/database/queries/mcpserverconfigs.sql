...
INSERT INTO mcp_server_configs (
    ...
    @url::text,
    @auth_type::text,
    sqlc.narg('external_auth_provider_id')::text,
    ...
    @tool_deny_list::text[],
    COALESCE(sqlc.narg('tool_rules')::jsonb, '[]'::jsonb),
    COALESCE(NULLIF(@tool_default::text, ''), 'enabled'),
    @availability::text,
    @enabled::boolean,
...
SET
    ...
    external_auth_provider_id = sqlc.narg('external_auth_provider_id')::text,
    ...
    tool_rules = COALESCE(sqlc.narg('tool_rules')::jsonb, tool_rules),
    tool_default = COALESCE(NULLIF(@tool_default::text, ''), tool_default),
