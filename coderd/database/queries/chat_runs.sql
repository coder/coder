...
-- Marks a step as completed with usage stats, message references,
-- cost, and tool call counts.
UPDATE chat_run_steps
SET
    completed_at = @completed_at::timestamptz,
    continuation_reason = sqlc.narg('continuation_reason')::text,
    response_message_id = sqlc.narg('response_message_id')::bigint,
    first_message_id = sqlc.narg('first_message_id')::bigint,
    last_message_id = sqlc.narg('last_message_id')::bigint,
    ...
    total_cost_micros = sqlc.narg('total_cost_micros')::bigint,
