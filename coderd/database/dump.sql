...
CREATE TABLE organizations (
    ...
    restrict_models_to_configured boolean DEFAULT true NOT NULL
);
...
COMMENT ON COLUMN organizations.restrict_models_to_configured IS 'Restricts direct AI Gateway model access granted by this organization to enabled configured models.';
