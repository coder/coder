...
CREATE TABLE exit_node_replicas (
    ...
    policy_hash text DEFAULT ''::text NOT NULL,
    created_at timestamp with time zone NOT NULL,
    started_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL,
...
ALTER TABLE ONLY exit_node_replicas
    ADD CONSTRAINT exit_node_replicas_pkey PRIMARY KEY (id);
...
CREATE INDEX exit_node_replicas_exit_node_id_idx ON exit_node_replicas USING btree (exit_node_id);
...
ALTER TABLE ONLY exit_node_replicas
    ADD CONSTRAINT exit_node_replicas_exit_node_id_fkey FOREIGN KEY (exit_node_id) REFERENCES exit_nodes(id) ON DELETE CASCADE;
