...
CREATE INDEX idx_chat_messages_chat_visible_id ON chat_messages USING btree (chat_id, id DESC) WHERE ((deleted = false) AND (visibility = ANY (ARRAY['user'::chat_message_visibility, 'both'::chat_message_visibility])));
