...
const (
	...
	UniqueWorkspaceAgentStartupLogsAgentIDIDKey             UniqueConstraint = "workspace_agent_startup_logs_agent_id_id_key"             // ALTER TABLE ONLY workspace_agent_startup_logs ADD CONSTRAINT workspace_agent_startup_logs_agent_id_id_key UNIQUE (agent_id, id);
