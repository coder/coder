...
const (
	...
	UniqueStartupScriptLogsAgentIDJobIDKey                  UniqueConstraint = "startup_script_logs_agent_id_job_id_key"                  // ALTER TABLE ONLY startup_script_logs ADD CONSTRAINT startup_script_logs_agent_id_job_id_key UNIQUE (agent_id, job_id);
