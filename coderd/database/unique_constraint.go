...
const (
	...
	UniqueWorkspaceProxiesOrganizationIDNameIndex           UniqueConstraint = "workspace_proxies_organization_id_name_idx"               // CREATE UNIQUE INDEX workspace_proxies_organization_id_name_idx ON workspace_proxies USING btree (organization_id, name) WHERE (deleted = false);
