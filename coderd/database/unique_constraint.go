...
const (
	...
	UniqueWorkspaceAppsAgentIDSlugKey              UniqueConstraint = "workspace_apps_agent_id_slug_key"               // ALTER TABLE ONLY workspace_apps ADD CONSTRAINT workspace_apps_agent_id_slug_key UNIQUE (agent_id, slug);
