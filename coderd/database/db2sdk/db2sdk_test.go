...
func TestChat_AllFieldsPopulated(t *testing.T) {
	...
	input := database.Chat{
		...
		ConcurrencyState:     database.NullChatConcurrencyState{ChatConcurrencyState: database.ChatConcurrencyStateQueued, Valid: true},
		ConcurrencyQueuedAt:  sql.NullTime{Time: now, Valid: true},
	}
