...
-- the concurrency columns, matching the 000551 chats_expanded definition.
DROP VIEW IF EXISTS chats_expanded;

ALTER TABLE chats
    DROP COLUMN concurrency_state,
    DROP COLUMN concurrency_queued_at;

DROP TYPE chat_concurrency_state;
