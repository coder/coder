-- Fixture for 000562 (org-scope chat model configs). Fixtures apply at
...
FROM
    ...
    (
        VALUES
            (
                '552c0001-0000-4000-8000-000000000001'::uuid,
                'gpt-5.2',
                'Fixture Default 552',
                TRUE,
                TRUE,
            ...
            (
                '552c0002-0000-4000-8000-000000000002'::uuid,
                'gpt-5.2-mini',
                'Fixture Non Default 552',
                TRUE,
                FALSE,
                128000,
                70
            ...
            (
                '552c0003-0000-4000-8000-000000000003'::uuid,
                'gpt-4-legacy',
                'Fixture Deleted 552',
                FALSE,
                FALSE,
...
WHERE id = '552c0003-0000-4000-8000-000000000003';
