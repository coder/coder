-- Restores the last_injected_context column on chats and recreates the
-- view with that column in its original position between
-- last_read_message_id and dynamic_tools.
