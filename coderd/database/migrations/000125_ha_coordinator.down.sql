...
DROP TRIGGER IF EXISTS notify_client_change ON tailnet_clients;
DROP FUNCTION IF EXISTS notify_client_change;
...
DROP TRIGGER IF EXISTS notify_agent_change ON tailnet_agents;
...
DROP TRIGGER IF EXISTS notify_coordinator_heartbeat ON tailnet_coordinators;
DROP FUNCTION IF EXISTS notify_coordinator_heartbeat;
