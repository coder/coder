-- Restore last_turn_summary as a column on chats and drop the side table.
DROP VIEW IF EXISTS chats_expanded;

ALTER TABLE chats ADD COLUMN last_turn_summary text;

UPDATE chats c
SET last_turn_summary = lts.last_turn_summary
FROM chat_last_turn_summaries lts
WHERE lts.chat_id = c.id;
...
DROP TABLE chat_last_turn_summaries;
