-- Org-scope chat model configs (CODAGT-709, stage 1 of 3): every config
-- gains an owning organization, backfilled to the default org. Runtime
-- behavior stays deployment-wide until the cutover migration; the
-- per-org unique index below is what makes at-most-one-default per org
-- enforceable from here on.
