ALTER TABLE ONLY workspaces ADD COLUMN IF NOT EXISTS last_activity_source text;
ALTER TABLE ONLY workspaces ADD COLUMN IF NOT EXISTS last_activity_at timestamp with time zone;
