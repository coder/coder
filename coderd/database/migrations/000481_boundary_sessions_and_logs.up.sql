CREATE TABLE boundary_sessions (
    ...
    confined_process TEXT NOT NULL,
...
COMMENT ON COLUMN boundary_sessions.confined_process IS 'Name of the confined process (e.g. claude-code, codex, copilot).';
...
COMMENT ON COLUMN boundary_logs.matched_rule IS 'The allow-list rule that matched. Empty when the request was denied.';
