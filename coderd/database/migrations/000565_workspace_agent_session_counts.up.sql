...
-- Backfill so rollups and deployment stats see no gap during upgrade. The
-- migration stall is bounded by DeleteOldWorkspaceAgentStats (~1 day of
-- rows, up to 180 days on a fresh deployment).
