...
CREATE TABLE chat_shared_snapshots (
	...
	workspace_owner_username TEXT        NOT NULL DEFAULT '',
...
COMMENT ON COLUMN chat_shared_snapshots.workspace_id IS 'Optional workspace ID that produced this work, for linking to the live workspace.';
COMMENT ON COLUMN chat_shared_snapshots.workspace_name IS 'Denormalized workspace name at snapshot time.';
COMMENT ON COLUMN chat_shared_snapshots.workspace_owner_username IS 'Denormalized workspace owner username for building /@owner/workspace links.';
