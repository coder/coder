...
const (
	...
	CheckChatUsageLimitGroupOverridesLimitMicrosCheck CheckConstraint = "chat_usage_limit_group_overrides_limit_micros_check" // chat_usage_limit_group_overrides
	CheckChatUsageLimitOverridesLimitMicrosCheck      CheckConstraint = "chat_usage_limit_overrides_limit_micros_check"       // chat_usage_limit_overrides
