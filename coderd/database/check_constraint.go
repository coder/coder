...
const (
	...
	CheckChatMcpServersAuthTypeCheck               CheckConstraint = "chat_mcp_servers_auth_type_check"               // chat_mcp_servers
	CheckChatMcpServersSlugCheck                   CheckConstraint = "chat_mcp_servers_slug_check"                    // chat_mcp_servers
