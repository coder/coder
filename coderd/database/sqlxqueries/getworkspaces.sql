...
SELECT
	...
	latest_build.created_at AS "latest_build.created_at",
	latest_build.updated_at AS "latest_build.updated_at",
	latest_build.deadline AS "latest_build.deadline",
	latest_build.template_version_id AS "latest_build.template_version_id",
	latest_build.build_number AS "latest_build.build_number",
	latest_build.transition AS "latest_build.transition",
	latest_build.job_id AS "latest_build.job_id",
	latest_build.initiator_id AS "latest_build.initiator_id",
	latest_build.reason AS "latest_build.reason",
	latest_build.daily_cost AS "latest_build.daily_cost",
	-- Provisioner job fields
	latest_build_job.id AS "latest_build_job.id",
	latest_build_job.created_at AS "latest_build_job.created_at",
	latest_build_job.updated_at AS "latest_build_job.updated_at",
	latest_build_job.started_at AS "latest_build_job.started_at",
	latest_build_job.completed_at AS "latest_build_job.completed_at",
	latest_build_job.canceled_at AS "latest_build_job.canceled_at",
	latest_build_job.error AS "latest_build_job.error",
	latest_build_job.organization_id AS "latest_build_job.organization_id",
	latest_build_job.provisioner AS "latest_build_job.provisioner",
	latest_build_job.storage_method AS "latest_build_job.storage_method",
	latest_build_job.type AS "latest_build_job.type",
	latest_build_job.worker_id AS "latest_build_job.worker_id",
	latest_build_job.file_id AS "latest_build_job.file_id",
	latest_build_job.tags AS "latest_build_job.tags",
