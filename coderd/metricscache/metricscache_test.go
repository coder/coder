		...
		t.Run(tc.name, func(t *testing.T) {
			...
			require.Equal(t, codersdk.SessionCountDeploymentStats{
				Apps: map[string]codersdk.SessionCountApp{
					...
					"cursor":           {Count: 2, DisplayName: "Cursor", Icon: "/icon/cursor.svg"},
					"zed":              {Count: 3, DisplayName: "Zed", Icon: "/icon/zed.svg"},
					"future_ide":       {Count: 4, DisplayName: "future_ide"},
					"jetbrains":        {Count: 5, DisplayName: "JetBrains", Icon: "/icon/jetbrains.svg"},
					"reconnecting_pty": {Count: 6, DisplayName: "Web Terminal"},
				},
