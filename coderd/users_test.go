...
func TestGetUsersFilter(t *testing.T) {
	...
	coderdtest.TestUsersFilter(setupCtx, t, client, api.Database, nil, func(testCtx context.Context, req codersdk.UsersRequest) []codersdk.ReducedUser {
...
func TestGetUsersPagination(t *testing.T) {
	...
	coderdtest.TestUsersPagination(ctx, t, client, nil, func(req codersdk.UsersRequest) ([]codersdk.ReducedUser, int) {
