...
func TestFirstUser(t *testing.T) {
	...
	t.Run("AutoImportsTemplates", func(t *testing.T) {
		...
		for _, template := range templates {
			...
			templateParams, err := client.DeprecatedParameters(ctx, codersdk.DeprecatedParameterTemplate, template.ID)
			...
			jobParams, err := client.DeprecatedParameters(ctx, codersdk.DeprecatedParameterImportJob, templateVersion.Job.ID)
