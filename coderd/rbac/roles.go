			...
			return Role{
				...
				ByOrgID: map[string]OrgPermissions{
					...
					organizationID.String(): {
						Org: append(
							allPermsExcept(ResourceWorkspace, ResourceWorkspaceDormant, ResourcePrebuiltWorkspace, ResourceAssignRole, ResourceUserSecret, ResourceBoundaryUsage, ResourceAiSeat, ResourceWorkspaceBuildOrchestration),
							Permissions(map[string][]policy.Action{
