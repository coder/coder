...
func ReloadBuiltinRoles(opts *RoleOptions) {
	...
	ownerRole := Role{
		...
		Site: append(
			...
			allPermsExcept(ResourceWorkspaceDormant, ResourcePrebuiltWorkspace, ResourceWorkspace, ResourceUserSecret, ResourceUserSkill, ResourceAgentMemory, ResourceUsageEvent, ResourceBoundaryUsage, ResourceBoundaryLog, ResourceAiSeat, ResourceAIGatewayKey),
			...
			Permissions(map[string][]policy.Action{
				...
				ResourceAgentMemory.Type:      {policy.ActionRead, policy.ActionDelete},
