...
var (
	...
	TerraformVersion = version.Must(version.NewVersion("1.15.5"))

	minTerraformVersion = version.Must(version.NewVersion("1.1.0"))
	maxTerraformVersion = version.Must(version.NewVersion("1.15.9")) // use .9 to automatically allow patch releases
