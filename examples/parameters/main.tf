...
// Rich parameters
// See: https://coder.com/docs/admin/templates/extending-templates/parameters
...
// See: https://coder.com/docs/admin/templates/extending-templates/parameters#ephemeral-parameters
