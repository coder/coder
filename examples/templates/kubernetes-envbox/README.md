...
| `CODER_AGENT_TOKEN`        | The [Coder Agent](https://coder.com/docs/admin/infrastructure/architecture#agents) token to pass to the inner container.                                                                                                                                                                                                                                                                                                                                                        | True     |
...
Due to the [deprecation and removal of legacy parameters](https://coder.com/docs/admin/templates/extending-templates/parameters#legacy)
it may be necessary to migrate existing envbox templates on newer versions of
Coder. Consult the [migration](https://coder.com/docs/admin/templates/extending-templates/parameters#migration)
