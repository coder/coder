...
tags: [vm, linux, gcp]
agent_description: >-
  Google Compute Engine Linux VM workspaces for development on GCP. Use when
  the work needs a full virtual machine, access to GCP services, or region-
  specific placement rather than a container.
---
