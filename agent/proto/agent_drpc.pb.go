...
func (c *drpcAgentClient) PushResourcesUsage(ctx context.Context, in *PushResourcesUsageRequest) (*PushResourcesUsageResponse, error) {
	out := new(PushResourcesUsageResponse)
	err := c.cc.Invoke(ctx, "/coder.agent.v2.Agent/PushResourcesUsage", drpcEncoding_File_agent_proto_agent_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DRPCAgentServer interface {
	...
	PushResourcesUsage(context.Context, *PushResourcesUsageRequest) (*PushResourcesUsageResponse, error)
}
...
func (s *DRPCAgentUnimplementedServer) PushResourcesUsage(context.Context, *PushResourcesUsageRequest) (*PushResourcesUsageResponse, error) {
	return nil, drpcerr.WithCode(errors.New("Unimplemented"), drpcerr.Unimplemented)
}
...
func (DRPCAgentDescription) Method(n int) (string, drpc.Encoding, drpc.Receiver, interface{}, bool) {
	...
	case 10:
		return "/coder.agent.v2.Agent/PushResourcesUsage", drpcEncoding_File_agent_proto_agent_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCAgentServer).
					PushResourcesUsage(
						ctx,
						in1.(*PushResourcesUsageRequest),
					)
			}, DRPCAgentServer.PushResourcesUsage, true
	default:
...
type DRPCAgent_PushResourcesUsageStream interface {
	drpc.Stream
	SendAndClose(*PushResourcesUsageResponse) error
}

type drpcAgent_PushResourcesUsageStream struct {
	drpc.Stream
}

func (x *drpcAgent_PushResourcesUsageStream) SendAndClose(m *PushResourcesUsageResponse) error {
	if err := x.MsgSend(m, drpcEncoding_File_agent_proto_agent_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
