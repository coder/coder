...
// OriginKind classifies the scan root in origin_root.
type ContextResource_OriginKind int32

const (
	ContextResource_ORIGIN_KIND_UNSPECIFIED ContextResource_OriginKind = 0
	// WORKING_DIR is the agent's working directory.
	ContextResource_WORKING_DIR ContextResource_OriginKind = 1
	// BUILTIN is a default root layered in by the agent
	// (e.g. ~/.coder, ~/.coder/skills).
	ContextResource_BUILTIN ContextResource_OriginKind = 2
	// USER_SOURCE is a scan root a user or template author
	// added explicitly (HTTP API or CODER_AGENT_EXP_*_DIRS).
	ContextResource_USER_SOURCE ContextResource_OriginKind = 3
)

// Enum value maps for ContextResource_OriginKind.
var (
	ContextResource_OriginKind_name = map[int32]string{
		0: "ORIGIN_KIND_UNSPECIFIED",
		1: "WORKING_DIR",
		2: "BUILTIN",
		3: "USER_SOURCE",
	}
	ContextResource_OriginKind_value = map[string]int32{
...
func (x ContextResource_OriginKind) Enum() *ContextResource_OriginKind {
	p := new(ContextResource_OriginKind)
	*p = x
	return p
}

func (x ContextResource_OriginKind) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ContextResource_OriginKind) Descriptor() protoreflect.EnumDescriptor {
	return file_agent_proto_agent_proto_enumTypes[16].Descriptor()
}

func (ContextResource_OriginKind) Type() protoreflect.EnumType {
	return &file_agent_proto_agent_proto_enumTypes[16]
}

func (x ContextResource_OriginKind) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ContextResource_OriginKind.Descriptor instead.
func (ContextResource_OriginKind) EnumDescriptor() ([]byte, []int) {
...
type ContextResource struct {
	...
	// origin_root is the scan root that discovered this resource:
	// the agent working directory, a built-in default root, or a
	// user-declared source. It is the (lexical) path of that root,
	// always populated for file-backed kinds (instruction_file,
	// skill, mcp_config). For mcp_server resources it is empty; a
	// live server links to its declaring .mcp.json via
	// MCPServerBody.config_source instead.
	//
	// Renamed in place from the pre-release "source_path" field
	// (same tag 2, same type) so an already-deployed agent that
	// set it stays wire-compatible: such agents only ever set it
	// to a user-declared source path, which coderd maps to
	// origin_kind = USER_SOURCE.
	OriginRoot *string `protobuf:"bytes,2,opt,name=origin_root,json=originRoot,proto3,oneof" json:"origin_root,omitempty"`
	...
	// origin_kind classifies origin_root so consumers can tell a
	// bespoke user-added source from a built-in default or the
	// working directory. ORIGIN_KIND_UNSPECIFIED when pushed by an
	// agent that predates this field; coderd backfills USER_SOURCE
	// when only the legacy origin_root (source_path) is present.
	OriginKind ContextResource_OriginKind `protobuf:"varint,17,opt,name=origin_kind,json=originKind,proto3,enum=coder.agent.v2.ContextResource_OriginKind" json:"origin_kind,omitempty"`
...
func (x *ContextResource) GetOriginRoot() string {
	if x != nil && x.OriginRoot != nil {
		return *x.OriginRoot
	}
	return ""
}
...
func (x *ContextResource) GetOriginKind() ContextResource_OriginKind {
	if x != nil {
		return x.OriginKind
	}
	return ContextResource_ORIGIN_KIND_UNSPECIFIED
}
...
type MCPServerBody struct {
	...
	// config_source is the absolute path of the .mcp.json that
	// declared this server. It equals the `source` of the
	// corresponding mcp_config ContextResource, so consumers can
	// link a live server back to its declaring config file. When a
	// server name is declared in multiple files the first file wins
	// (matching the agent's dedup). Empty when pushed by an agent
	// that predates this field or when the declaring file is unknown.
	ConfigSource string `protobuf:"bytes,4,opt,name=config_source,json=configSource,proto3" json:"config_source,omitempty"`
}
...
func (x *MCPServerBody) GetConfigSource() string {
	if x != nil {
...
var file_agent_proto_agent_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xb6, 0x06, 0x0a,
	...
	0x52, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x24, 0x0a, 0x0b, 0x6f, 0x72, 0x69, 0x67,
	0x69, 0x6e, 0x5f, 0x72, 0x6f, 0x6f, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x48, 0x01, 0x52,
	0x0a, 0x6f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x52, 0x6f, 0x6f, 0x74, 0x88, 0x01, 0x01, 0x12, 0x21,
	...
	0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x4b, 0x0a, 0x0b, 0x6f, 0x72, 0x69, 0x67, 0x69, 0x6e,
	0x5f, 0x6b, 0x69, 0x6e, 0x64, 0x18, 0x11, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2a, 0x2e, 0x63, 0x6f,
	0x64, 0x65, 0x72, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x2e, 0x76, 0x32, 0x2e, 0x43, 0x6f, 0x6e,
	0x74, 0x65, 0x78, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x4f, 0x72, 0x69,
	0x67, 0x69, 0x6e, 0x4b, 0x69, 0x6e, 0x64, 0x52, 0x0a, 0x6f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x4b,
	0x69, 0x6e, 0x64, 0x12, 0x50, 0x0a, 0x10, 0x69, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69,
	...
	,
	...
	0x64, 0x79, 0x22, 0xa6, 0x01, 0x0a, 0x0d, 0x4d, 0x43, 0x50, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72,
	...
	0x05, 0x74, 0x6f, 0x6f, 0x6c, 0x73, 0x12, 0x23, 0x0a, 0x0d, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	0x5f, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x63,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x22, 0x7b, 0x0a, 0x07, 0x4d,
...
var file_agent_proto_agent_proto_goTypes = []interface{}{
	...
	(ContextResource_OriginKind)(0),                     // 16: coder.agent.v2.ContextResource.OriginKind
...
var file_agent_proto_agent_proto_depIdxs = []int32{
	...
	91, // 16: coder.agent.v2.UpdateStatsResponse.report_interval:type_name -> google.protobuf.Duration
	4,  // 17: coder.agent.v2.Lifecycle.state:type_name -> coder.agent.v2.Lifecycle.State
	93, // 18: coder.agent.v2.Lifecycle.changed_at:type_name -> google.protobuf.Timestamp
	29, // 19: coder.agent.v2.UpdateLifecycleRequest.lifecycle:type_name -> coder.agent.v2.Lifecycle
	80, // 20: coder.agent.v2.BatchUpdateAppHealthRequest.updates:type_name -> coder.agent.v2.BatchUpdateAppHealthRequest.HealthUpdate
	...
	74, // 23: coder.agent.v2.Metadata.result:type_name -> coder.agent.v2.WorkspaceAgentMetadata.Result
	35, // 24: coder.agent.v2.BatchUpdateMetadataRequest.metadata:type_name -> coder.agent.v2.Metadata
	93, // 25: coder.agent.v2.Log.created_at:type_name -> google.protobuf.Timestamp
	...
	93, // 30: coder.agent.v2.Timing.start:type_name -> google.protobuf.Timestamp
	93, // 31: coder.agent.v2.Timing.end:type_name -> google.protobuf.Timestamp
	...
	81, // 34: coder.agent.v2.GetResourcesMonitoringConfigurationResponse.config:type_name -> coder.agent.v2.GetResourcesMonitoringConfigurationResponse.Config
	82, // 35: coder.agent.v2.GetResourcesMonitoringConfigurationResponse.memory:type_name -> coder.agent.v2.GetResourcesMonitoringConfigurationResponse.Memory
	83, // 36: coder.agent.v2.GetResourcesMonitoringConfigurationResponse.volumes:type_name -> coder.agent.v2.GetResourcesMonitoringConfigurationResponse.Volume
	84, // 37: coder.agent.v2.PushResourcesMonitoringUsageRequest.datapoints:type_name -> coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint
	...
	93, // 40: coder.agent.v2.Connection.timestamp:type_name -> google.protobuf.Timestamp
	51, // 41: coder.agent.v2.ReportConnectionRequest.connection:type_name -> coder.agent.v2.Connection
	87, // 42: coder.agent.v2.CreateSubAgentRequest.apps:type_name -> coder.agent.v2.CreateSubAgentRequest.App
	...
	89, // 45: coder.agent.v2.CreateSubAgentResponse.app_creation_errors:type_name -> coder.agent.v2.CreateSubAgentResponse.AppCreationError
	53, // 46: coder.agent.v2.ListSubAgentsResponse.agents:type_name -> coder.agent.v2.SubAgent
	93, // 47: coder.agent.v2.BoundaryLog.time:type_name -> google.protobuf.Timestamp
	90, // 48: coder.agent.v2.BoundaryLog.http_request:type_name -> coder.agent.v2.BoundaryLog.HttpRequest
	...
	16, // 52: coder.agent.v2.ContextResource.origin_kind:type_name -> coder.agent.v2.ContextResource.OriginKind
