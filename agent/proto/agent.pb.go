...
type GetAnnouncementBannersResponse struct {
	...
	AccouncementBanners []*BannerConfig `protobuf:"bytes,1,rep,name=accouncement_banners,json=accouncementBanners,proto3" json:"accouncement_banners,omitempty"`
}
...
func (x *GetAnnouncementBannersResponse) GetAccouncementBanners() []*BannerConfig {
	if x != nil {
		return x.AccouncementBanners
	}
	return nil
}
...
var file_agent_proto_agent_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4f, 0x0a, 0x14, 0x61, 0x63, 0x63, 0x6f, 0x75,
	...
	0x66, 0x69, 0x67, 0x52, 0x13, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x63, 0x65, 0x6d, 0x65, 0x6e,
...
var file_agent_proto_agent_proto_depIdxs = []int32{
	...
	31, // 26: coder.agent.v2.GetAnnouncementBannersResponse.accouncement_banners:type_name -> coder.agent.v2.BannerConfig
