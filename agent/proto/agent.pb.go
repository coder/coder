...
type CreateChildAgentRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CreateChildAgentRequest) Reset() {
	*x = CreateChildAgentRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *CreateChildAgentRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateChildAgentRequest) ProtoMessage() {}

func (x *CreateChildAgentRequest) ProtoReflect() protoreflect.Message {
	mi := &file_agent_proto_agent_proto_msgTypes[35]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateChildAgentRequest.ProtoReflect.Descriptor instead.
func (*CreateChildAgentRequest) Descriptor() ([]byte, []int) {
	return file_agent_proto_agent_proto_rawDescGZIP(), []int{35}
}

func (x *CreateChildAgentRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *CreateChildAgentRequest) GetDirectory() string {
	if x != nil {
		return x.Directory
	}
	return ""
...
type CreateChildAgentResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CreateChildAgentResponse) Reset() {
	*x = CreateChildAgentResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *CreateChildAgentResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateChildAgentResponse) ProtoMessage() {}

func (x *CreateChildAgentResponse) ProtoReflect() protoreflect.Message {
	mi := &file_agent_proto_agent_proto_msgTypes[36]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateChildAgentResponse.ProtoReflect.Descriptor instead.
func (*CreateChildAgentResponse) Descriptor() ([]byte, []int) {
	return file_agent_proto_agent_proto_rawDescGZIP(), []int{36}
}

func (x *CreateChildAgentResponse) GetId() []byte {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *CreateChildAgentResponse) GetAuthToken() []byte {
	if x != nil {
		return x.AuthToken
	}
	return nil
...
var file_agent_proto_agent_proto_rawDesc = []byte{
	...
	0x22, 0x4b, 0x0a, 0x17, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x68, 0x69, 0x6c, 0x64, 0x41,
	...
	0x28, 0x09, 0x52, 0x09, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x22, 0x49, 0x0a,
	0x18, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x68, 0x69, 0x6c, 0x64, 0x41, 0x67, 0x65, 0x6e,
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x61, 0x75, 0x74,
	0x68, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x09, 0x61,
	0x75, 0x74, 0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x2a, 0x63, 0x0a, 0x09, 0x41, 0x70, 0x70, 0x48,
	...
	0x0a, 0x09, 0x55, 0x4e, 0x48, 0x45, 0x41, 0x4c, 0x54, 0x48, 0x59, 0x10, 0x04, 0x32, 0xd8, 0x0b,
	...
	0x79, 0x12, 0x65, 0x0a, 0x10, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x68, 0x69, 0x6c, 0x64,
	0x41, 0x67, 0x65, 0x6e, 0x74, 0x12, 0x27, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x72, 0x2e, 0x61, 0x67,
	0x65, 0x6e, 0x74, 0x2e, 0x76, 0x32, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x68, 0x69,
	0x6c, 0x64, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x28,
	0x2e, 0x63, 0x6f, 0x64, 0x65, 0x72, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x2e, 0x76, 0x32, 0x2e,
	0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x68, 0x69, 0x6c, 0x64, 0x41, 0x67, 0x65, 0x6e, 0x74,
...
var file_agent_proto_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 51)
var file_agent_proto_agent_proto_goTypes = []interface{}{
	...
	(*CreateChildAgentRequest)(nil),                     // 46: coder.agent.v2.CreateChildAgentRequest
	(*CreateChildAgentResponse)(nil),                    // 47: coder.agent.v2.CreateChildAgentResponse
	(*WorkspaceApp_Healthcheck)(nil),                    // 48: coder.agent.v2.WorkspaceApp.Healthcheck
	(*WorkspaceAgentMetadata_Result)(nil),               // 49: coder.agent.v2.WorkspaceAgentMetadata.Result
	(*WorkspaceAgentMetadata_Description)(nil),          // 50: coder.agent.v2.WorkspaceAgentMetadata.Description
	nil,                        // 51: coder.agent.v2.Manifest.EnvironmentVariablesEntry
	nil,                        // 52: coder.agent.v2.Stats.ConnectionsByProtoEntry
	(*Stats_Metric)(nil),       // 53: coder.agent.v2.Stats.Metric
	(*Stats_Metric_Label)(nil), // 54: coder.agent.v2.Stats.Metric.Label
	(*BatchUpdateAppHealthRequest_HealthUpdate)(nil),                  // 55: coder.agent.v2.BatchUpdateAppHealthRequest.HealthUpdate
	(*GetResourcesMonitoringConfigurationResponse_Config)(nil),        // 56: coder.agent.v2.GetResourcesMonitoringConfigurationResponse.Config
	(*GetResourcesMonitoringConfigurationResponse_Memory)(nil),        // 57: coder.agent.v2.GetResourcesMonitoringConfigurationResponse.Memory
	(*GetResourcesMonitoringConfigurationResponse_Volume)(nil),        // 58: coder.agent.v2.GetResourcesMonitoringConfigurationResponse.Volume
	(*PushResourcesMonitoringUsageRequest_Datapoint)(nil),             // 59: coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint
	(*PushResourcesMonitoringUsageRequest_Datapoint_MemoryUsage)(nil), // 60: coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.MemoryUsage
	(*PushResourcesMonitoringUsageRequest_Datapoint_VolumeUsage)(nil), // 61: coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.VolumeUsage
	(*durationpb.Duration)(nil),                                       // 62: google.protobuf.Duration
	(*proto.DERPMap)(nil),                                             // 63: coder.tailnet.v2.DERPMap
...
var file_agent_proto_agent_proto_depIdxs = []int32{
	...
	48, // 1: coder.agent.v2.WorkspaceApp.healthcheck:type_name -> coder.agent.v2.WorkspaceApp.Healthcheck
	2,  // 2: coder.agent.v2.WorkspaceApp.health:type_name -> coder.agent.v2.WorkspaceApp.Health
	62, // 3: coder.agent.v2.WorkspaceAgentScript.timeout:type_name -> google.protobuf.Duration
	49, // 4: coder.agent.v2.WorkspaceAgentMetadata.result:type_name -> coder.agent.v2.WorkspaceAgentMetadata.Result
	50, // 5: coder.agent.v2.WorkspaceAgentMetadata.description:type_name -> coder.agent.v2.WorkspaceAgentMetadata.Description
	51, // 6: coder.agent.v2.Manifest.environment_variables:type_name -> coder.agent.v2.Manifest.EnvironmentVariablesEntry
	63, // 7: coder.agent.v2.Manifest.derp_map:type_name -> coder.tailnet.v2.DERPMap
	...
	50, // 10: coder.agent.v2.Manifest.metadata:type_name -> coder.agent.v2.WorkspaceAgentMetadata.Description
	15, // 11: coder.agent.v2.Manifest.devcontainers:type_name -> coder.agent.v2.WorkspaceAgentDevcontainer
	52, // 12: coder.agent.v2.Stats.connections_by_proto:type_name -> coder.agent.v2.Stats.ConnectionsByProtoEntry
	53, // 13: coder.agent.v2.Stats.metrics:type_name -> coder.agent.v2.Stats.Metric
	19, // 14: coder.agent.v2.UpdateStatsRequest.stats:type_name -> coder.agent.v2.Stats
	62, // 15: coder.agent.v2.UpdateStatsResponse.report_interval:type_name -> google.protobuf.Duration
	4,  // 16: coder.agent.v2.Lifecycle.state:type_name -> coder.agent.v2.Lifecycle.State
	64, // 17: coder.agent.v2.Lifecycle.changed_at:type_name -> google.protobuf.Timestamp
	22, // 18: coder.agent.v2.UpdateLifecycleRequest.lifecycle:type_name -> coder.agent.v2.Lifecycle
	55, // 19: coder.agent.v2.BatchUpdateAppHealthRequest.updates:type_name -> coder.agent.v2.BatchUpdateAppHealthRequest.HealthUpdate
	...
	49, // 22: coder.agent.v2.Metadata.result:type_name -> coder.agent.v2.WorkspaceAgentMetadata.Result
	28, // 23: coder.agent.v2.BatchUpdateMetadataRequest.metadata:type_name -> coder.agent.v2.Metadata
	64, // 24: coder.agent.v2.Log.created_at:type_name -> google.protobuf.Timestamp
	...
	64, // 29: coder.agent.v2.Timing.start:type_name -> google.protobuf.Timestamp
	64, // 30: coder.agent.v2.Timing.end:type_name -> google.protobuf.Timestamp
	...
	56, // 33: coder.agent.v2.GetResourcesMonitoringConfigurationResponse.config:type_name -> coder.agent.v2.GetResourcesMonitoringConfigurationResponse.Config
	57, // 34: coder.agent.v2.GetResourcesMonitoringConfigurationResponse.memory:type_name -> coder.agent.v2.GetResourcesMonitoringConfigurationResponse.Memory
	58, // 35: coder.agent.v2.GetResourcesMonitoringConfigurationResponse.volumes:type_name -> coder.agent.v2.GetResourcesMonitoringConfigurationResponse.Volume
	59, // 36: coder.agent.v2.PushResourcesMonitoringUsageRequest.datapoints:type_name -> coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint
	...
	64, // 39: coder.agent.v2.Connection.timestamp:type_name -> google.protobuf.Timestamp
	44, // 40: coder.agent.v2.ReportConnectionRequest.connection:type_name -> coder.agent.v2.Connection
	62, // 41: coder.agent.v2.WorkspaceApp.Healthcheck.interval:type_name -> google.protobuf.Duration
	64, // 42: coder.agent.v2.WorkspaceAgentMetadata.Result.collected_at:type_name -> google.protobuf.Timestamp
	62, // 43: coder.agent.v2.WorkspaceAgentMetadata.Description.interval:type_name -> google.protobuf.Duration
	62, // 44: coder.agent.v2.WorkspaceAgentMetadata.Description.timeout:type_name -> google.protobuf.Duration
	3,  // 45: coder.agent.v2.Stats.Metric.type:type_name -> coder.agent.v2.Stats.Metric.Type
	54, // 46: coder.agent.v2.Stats.Metric.labels:type_name -> coder.agent.v2.Stats.Metric.Label
	0,  // 47: coder.agent.v2.BatchUpdateAppHealthRequest.HealthUpdate.health:type_name -> coder.agent.v2.AppHealth
	64, // 48: coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.collected_at:type_name -> google.protobuf.Timestamp
	60, // 49: coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.memory:type_name -> coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.MemoryUsage
	61, // 50: coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.volumes:type_name -> coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.VolumeUsage
	...
	46, // 64: coder.agent.v2.Agent.CreateChildAgent:input_type -> coder.agent.v2.CreateChildAgentRequest
	14, // 65: coder.agent.v2.Agent.GetManifest:output_type -> coder.agent.v2.Manifest
	17, // 66: coder.agent.v2.Agent.GetServiceBanner:output_type -> coder.agent.v2.ServiceBanner
	21, // 67: coder.agent.v2.Agent.UpdateStats:output_type -> coder.agent.v2.UpdateStatsResponse
	22, // 68: coder.agent.v2.Agent.UpdateLifecycle:output_type -> coder.agent.v2.Lifecycle
	25, // 69: coder.agent.v2.Agent.BatchUpdateAppHealths:output_type -> coder.agent.v2.BatchUpdateAppHealthResponse
	26, // 70: coder.agent.v2.Agent.UpdateStartup:output_type -> coder.agent.v2.Startup
	30, // 71: coder.agent.v2.Agent.BatchUpdateMetadata:output_type -> coder.agent.v2.BatchUpdateMetadataResponse
	33, // 72: coder.agent.v2.Agent.BatchCreateLogs:output_type -> coder.agent.v2.BatchCreateLogsResponse
	35, // 73: coder.agent.v2.Agent.GetAnnouncementBanners:output_type -> coder.agent.v2.GetAnnouncementBannersResponse
	38, // 74: coder.agent.v2.Agent.ScriptCompleted:output_type -> coder.agent.v2.WorkspaceAgentScriptCompletedResponse
	41, // 75: coder.agent.v2.Agent.GetResourcesMonitoringConfiguration:output_type -> coder.agent.v2.GetResourcesMonitoringConfigurationResponse
	43, // 76: coder.agent.v2.Agent.PushResourcesMonitoringUsage:output_type -> coder.agent.v2.PushResourcesMonitoringUsageResponse
	65, // 77: coder.agent.v2.Agent.ReportConnection:output_type -> google.protobuf.Empty
	47, // 78: coder.agent.v2.Agent.CreateChildAgent:output_type -> coder.agent.v2.CreateChildAgentResponse
...
func file_agent_proto_agent_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_agent_proto_agent_proto_msgTypes[35].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateChildAgentRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_agent_proto_agent_proto_msgTypes[36].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateChildAgentResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
