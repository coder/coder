...
// Status is the launcher-observed execution status. The
// pending state is DB-only: it exists before any launcher
// reports, so agents never send it.
type ReportSubagentExecutionStatusRequest_Status int32

const (
	ReportSubagentExecutionStatusRequest_STATUS_UNSPECIFIED ReportSubagentExecutionStatusRequest_Status = 0
	ReportSubagentExecutionStatusRequest_STARTING           ReportSubagentExecutionStatusRequest_Status = 1
	ReportSubagentExecutionStatusRequest_RUNNING            ReportSubagentExecutionStatusRequest_Status = 2
	ReportSubagentExecutionStatusRequest_STOPPING           ReportSubagentExecutionStatusRequest_Status = 3
	ReportSubagentExecutionStatusRequest_STOPPED            ReportSubagentExecutionStatusRequest_Status = 4
	ReportSubagentExecutionStatusRequest_FAILED             ReportSubagentExecutionStatusRequest_Status = 5
)

// Enum value maps for ReportSubagentExecutionStatusRequest_Status.
var (
	ReportSubagentExecutionStatusRequest_Status_name = map[int32]string{
	...
	ReportSubagentExecutionStatusRequest_Status_value = map[string]int32{
...
func (x ReportSubagentExecutionStatusRequest_Status) Enum() *ReportSubagentExecutionStatusRequest_Status {
	p := new(ReportSubagentExecutionStatusRequest_Status)
	*p = x
	return p
}

func (x ReportSubagentExecutionStatusRequest_Status) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ReportSubagentExecutionStatusRequest_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_agent_proto_agent_proto_enumTypes[3].Descriptor()
}

func (ReportSubagentExecutionStatusRequest_Status) Type() protoreflect.EnumType {
	return &file_agent_proto_agent_proto_enumTypes[3]
}

func (x ReportSubagentExecutionStatusRequest_Status) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ReportSubagentExecutionStatusRequest_Status.Descriptor instead.
func (ReportSubagentExecutionStatusRequest_Status) EnumDescriptor() ([]byte, []int) {
	return file_agent_proto_agent_proto_rawDescGZIP(), []int{7, 0}
}
...
func (Stats_Metric_Type) EnumDescriptor() ([]byte, []int) {
	return file_agent_proto_agent_proto_rawDescGZIP(), []int{14, 1, 0}
}
...
func (Log_Level) EnumDescriptor() ([]byte, []int) {
	return file_agent_proto_agent_proto_rawDescGZIP(), []int{26, 0}
}
...
func (Connection_Type) EnumDescriptor() ([]byte, []int) {
	return file_agent_proto_agent_proto_rawDescGZIP(), []int{39, 1}
}
...
func (CreateSubAgentRequest_App_OpenIn) EnumDescriptor() ([]byte, []int) {
	return file_agent_proto_agent_proto_rawDescGZIP(), []int{42, 0, 0}
}
...
func (CreateSubAgentRequest_App_SharingLevel) EnumDescriptor() ([]byte, []int) {
	return file_agent_proto_agent_proto_rawDescGZIP(), []int{42, 0, 1}
}
...
func (ContextResource_Status) EnumDescriptor() ([]byte, []int) {
	return file_agent_proto_agent_proto_rawDescGZIP(), []int{53, 0}
}
...
type Manifest struct {
	...
	SubagentExecutions       []*SubagentExecution                  `protobuf:"bytes,20,rep,name=subagent_executions,json=subagentExecutions,proto3" json:"subagent_executions,omitempty"`
}
...
func (x *Manifest) GetSubagentExecutions() []*SubagentExecution {
	if x != nil {
...
// agent's ID or auth token. The parent acquires those separately via
// AcquireSubagentExecution so credentials are not distributed to
// agents that never launch the execution.
type SubagentExecution struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// execution_id is the stable declaration ID for this execution.
	ExecutionId []byte `protobuf:"bytes,1,opt,name=execution_id,json=executionId,proto3" json:"execution_id,omitempty"`
	// generation changes whenever the declaration's desired
	// launch identity changes, fencing stale launchers.
	Generation []byte `protobuf:"bytes,2,opt,name=generation,proto3" json:"generation,omitempty"`
	// name is the declared execution name, used for logging and
	// state directory naming.
	Name string `protobuf:"bytes,3,opt,name=name,proto3" json:"name,omitempty"`
	// driver names the vetted driver responsible for launching
	// the execution.
	Driver string `protobuf:"bytes,4,opt,name=driver,proto3" json:"driver,omitempty"`
	// driver_protocol is the driver protocol version the parent
	// must speak when invoking the driver.
	...
	// shared_host_path is the single declared path shared from
	...
	// shared_child_path is the single declared path the child
	// sees for the shared host path.
	...
	// startup_timeout_seconds bounds how long the parent waits
	// for the child agent to connect before treating the launch
	// as failed.
	...
	// restart_policy is the declared restart behavior, for
	// example "never" or "on_failure".
...
func (x *SubagentExecution) GetExecutionId() []byte {
	if x != nil {
...
func (x *SubagentExecution) GetGeneration() []byte {
	if x != nil {
		return x.Generation
	}
	return nil
...
// AcquireSubagentExecutionRequest asks coderd for the pre-created
// child agent's credentials for a declared execution. The generation
// fences the request against a superseded declaration.
type AcquireSubagentExecutionRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *AcquireSubagentExecutionRequest) Reset() {
	*x = AcquireSubagentExecutionRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *AcquireSubagentExecutionRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AcquireSubagentExecutionRequest) ProtoMessage() {}

func (x *AcquireSubagentExecutionRequest) ProtoReflect() protoreflect.Message {
	mi := &file_agent_proto_agent_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AcquireSubagentExecutionRequest.ProtoReflect.Descriptor instead.
func (*AcquireSubagentExecutionRequest) Descriptor() ([]byte, []int) {
	return file_agent_proto_agent_proto_rawDescGZIP(), []int{5}
}

func (x *AcquireSubagentExecutionRequest) GetExecutionId() []byte {
	if x != nil {
		return x.ExecutionId
	}
	return nil
...
func (x *AcquireSubagentExecutionRequest) GetGeneration() []byte {
	if x != nil {
		return x.Generation
	}
	return nil
...
// AcquireSubagentExecutionResponse returns only the pre-created
// child's identity and token. It cannot create a new child or
// override any persisted declaration field.
type AcquireSubagentExecutionResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	ChildAgentId []byte `protobuf:"bytes,1,opt,name=child_agent_id,json=childAgentId,proto3" json:"child_agent_id,omitempty"`
	AuthToken    string `protobuf:"bytes,2,opt,name=auth_token,json=authToken,proto3" json:"auth_token,omitempty"`
	// acquisition_version increases on every successful
	// acquisition. The parent echoes it back in status reports so
	// coderd can reject reports from a superseded launcher.
	AcquisitionVersion int64 `protobuf:"varint,3,opt,name=acquisition_version,json=acquisitionVersion,proto3" json:"acquisition_version,omitempty"`
}

func (x *AcquireSubagentExecutionResponse) Reset() {
	*x = AcquireSubagentExecutionResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *AcquireSubagentExecutionResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AcquireSubagentExecutionResponse) ProtoMessage() {}

func (x *AcquireSubagentExecutionResponse) ProtoReflect() protoreflect.Message {
	mi := &file_agent_proto_agent_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AcquireSubagentExecutionResponse.ProtoReflect.Descriptor instead.
func (*AcquireSubagentExecutionResponse) Descriptor() ([]byte, []int) {
	return file_agent_proto_agent_proto_rawDescGZIP(), []int{6}
}

func (x *AcquireSubagentExecutionResponse) GetChildAgentId() []byte {
	if x != nil {
		return x.ChildAgentId
	}
	return nil
}

func (x *AcquireSubagentExecutionResponse) GetAuthToken() string {
	if x != nil {
		return x.AuthToken
	}
	return ""
...
func (x *AcquireSubagentExecutionResponse) GetAcquisitionVersion() int64 {
	if x != nil {
		return x.AcquisitionVersion
	}
	return 0
}

// ReportSubagentExecutionStatusRequest reports launcher-observed
// status for an execution the parent previously acquired.
type ReportSubagentExecutionStatusRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	ExecutionId []byte `protobuf:"bytes,1,opt,name=execution_id,json=executionId,proto3" json:"execution_id,omitempty"`
	Generation  []byte `protobuf:"bytes,2,opt,name=generation,proto3" json:"generation,omitempty"`
	// acquisition_version must match the value returned by the
	// acquisition that produced this launcher.
	AcquisitionVersion int64                                       `protobuf:"varint,3,opt,name=acquisition_version,json=acquisitionVersion,proto3" json:"acquisition_version,omitempty"`
	Status             ReportSubagentExecutionStatusRequest_Status `protobuf:"varint,4,opt,name=status,proto3,enum=coder.agent.v2.ReportSubagentExecutionStatusRequest_Status" json:"status,omitempty"`
	// error carries the failure string when status is FAILED.
	Error string `protobuf:"bytes,5,opt,name=error,proto3" json:"error,omitempty"`
}

func (x *ReportSubagentExecutionStatusRequest) Reset() {
	*x = ReportSubagentExecutionStatusRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ReportSubagentExecutionStatusRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReportSubagentExecutionStatusRequest) ProtoMessage() {}

func (x *ReportSubagentExecutionStatusRequest) ProtoReflect() protoreflect.Message {
	mi := &file_agent_proto_agent_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReportSubagentExecutionStatusRequest.ProtoReflect.Descriptor instead.
func (*ReportSubagentExecutionStatusRequest) Descriptor() ([]byte, []int) {
	return file_agent_proto_agent_proto_rawDescGZIP(), []int{7}
}

func (x *ReportSubagentExecutionStatusRequest) GetExecutionId() []byte {
	if x != nil {
		return x.ExecutionId
	}
	return nil
...
func (x *ReportSubagentExecutionStatusRequest) GetGeneration() []byte {
	if x != nil {
		return x.Generation
	}
	return nil
...
func (x *ReportSubagentExecutionStatusRequest) GetAcquisitionVersion() int64 {
	if x != nil {
		return x.AcquisitionVersion
	}
	return 0
...
func (x *ReportSubagentExecutionStatusRequest) GetStatus() ReportSubagentExecutionStatusRequest_Status {
	if x != nil {
		return x.Status
	}
	return ReportSubagentExecutionStatusRequest_STATUS_UNSPECIFIED
}

func (x *ReportSubagentExecutionStatusRequest) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
type ReportSubagentExecutionStatusResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *ReportSubagentExecutionStatusResponse) Reset() {
	*x = ReportSubagentExecutionStatusResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ReportSubagentExecutionStatusResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReportSubagentExecutionStatusResponse) ProtoMessage() {}

func (x *ReportSubagentExecutionStatusResponse) ProtoReflect() protoreflect.Message {
	mi := &file_agent_proto_agent_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReportSubagentExecutionStatusResponse.ProtoReflect.Descriptor instead.
func (*ReportSubagentExecutionStatusResponse) Descriptor() ([]byte, []int) {
...
func (*PushContextStateRequest) Descriptor() ([]byte, []int) {
	return file_agent_proto_agent_proto_rawDescGZIP(), []int{59}
}
...
func (*PushContextStateResponse) Descriptor() ([]byte, []int) {
	return file_agent_proto_agent_proto_rawDescGZIP(), []int{60}
}
...
func (*Stats_Metric) Descriptor() ([]byte, []int) {
	return file_agent_proto_agent_proto_rawDescGZIP(), []int{14, 1}
}
...
func (*GetResourcesMonitoringConfigurationResponse_Memory) Descriptor() ([]byte, []int) {
	return file_agent_proto_agent_proto_rawDescGZIP(), []int{36, 1}
}
...
func (*GetResourcesMonitoringConfigurationResponse_Volume) Descriptor() ([]byte, []int) {
	return file_agent_proto_agent_proto_rawDescGZIP(), []int{36, 2}
}
...
func (x *BoundaryLog_HttpRequest) Reset() {
	*x = BoundaryLog_HttpRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_agent_proto_agent_proto_msgTypes[78]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_agent_proto_agent_proto_rawDesc = []byte{
	...
	0x22, 0xfb, 0x08, 0x0a, 0x08, 0x4d, 0x61, 0x6e, 0x69, 0x66, 0x65, 0x73, 0x74, 0x12, 0x19, 0x0a,
	...
	0x65, 0x74, 0x73, 0x12, 0x52, 0x0a, 0x13, 0x73, 0x75, 0x62, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x5f,
	0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x14, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x21, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x72, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x2e, 0x76,
	0x32, 0x2e, 0x53, 0x75, 0x62, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74,
	0x69, 0x6f, 0x6e, 0x52, 0x12, 0x73, 0x75, 0x62, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x45, 0x78, 0x65,
	0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x1a, 0x47, 0x0a, 0x19, 0x45, 0x6e, 0x76, 0x69, 0x72,
	...
	0x42, 0x0c, 0x0a, 0x0a, 0x5f, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x22, 0xe0,
	0x02, 0x0a, 0x11, 0x53, 0x75, 0x62, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x45, 0x78, 0x65, 0x63, 0x75,
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x21, 0x0a, 0x0c, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f,
	0x6e, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0b, 0x65, 0x78, 0x65, 0x63,
	0x75, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x1e, 0x0a, 0x0a, 0x67, 0x65, 0x6e, 0x65, 0x72,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0a, 0x67, 0x65, 0x6e,
	...
	,
	...
	0x75, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x1e, 0x0a, 0x0a, 0x67, 0x65, 0x6e, 0x65, 0x72,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0a, 0x67, 0x65, 0x6e,
	0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x98, 0x01, 0x0a, 0x20, 0x41, 0x63, 0x71, 0x75,
	0x69, 0x72, 0x65, 0x53, 0x75, 0x62, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x45, 0x78, 0x65, 0x63, 0x75,
	0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x24, 0x0a, 0x0e,
	0x63, 0x68, 0x69, 0x6c, 0x64, 0x5f, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x0c, 0x63, 0x68, 0x69, 0x6c, 0x64, 0x41, 0x67, 0x65, 0x6e, 0x74,
	...
	0x6e, 0x12, 0x2f, 0x0a, 0x13, 0x61, 0x63, 0x71, 0x75, 0x69, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e,
	0x5f, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x12,
	0x61, 0x63, 0x71, 0x75, 0x69, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x56, 0x65, 0x72, 0x73, 0x69,
	0x6f, 0x6e, 0x22, 0xe9, 0x02, 0x0a, 0x24, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x53, 0x75, 0x62,
	0x61, 0x67, 0x65, 0x6e, 0x74, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74,
	...
	,
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x62, 0x0a, 0x06, 0x53, 0x74,
	...
	0x10, 0x04, 0x12, 0x0a, 0x0a, 0x06, 0x46, 0x41, 0x49, 0x4c, 0x45, 0x44, 0x10, 0x05, 0x22, 0x27,
	0x0a, 0x25, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x53, 0x75, 0x62, 0x61, 0x67, 0x65, 0x6e, 0x74,
	0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x5f, 0x0a, 0x0f, 0x57, 0x6f, 0x72, 0x6b, 0x73,
	0x70, 0x61, 0x63, 0x65, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x12, 0x19, 0x0a, 0x08, 0x65, 0x6e,
	...
	0x0c, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0xc2, 0x01, 0x0a, 0x1a, 0x57, 0x6f, 0x72,
	...
	0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x24, 0x0a, 0x0b, 0x73, 0x75, 0x62, 0x61, 0x67,
	0x65, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0c, 0x48, 0x00, 0x52, 0x0a,
	0x73, 0x75, 0x62, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x88, 0x01, 0x01, 0x42, 0x0e, 0x0a,
	0x0c, 0x5f, 0x73, 0x75, 0x62, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x22, 0x14, 0x0a,
	...
	0x4d, 0x0a, 0x08, 0x53, 0x75, 0x62, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x6e,
	...
	0x01, 0x28, 0x0c, 0x52, 0x09, 0x61, 0x75, 0x74, 0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xb9,
	0x0a, 0x0a, 0x15, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x53, 0x75, 0x62, 0x41, 0x67, 0x65, 0x6e,
	...
	0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x09, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x22, 0x0a, 0x0c, 0x61, 0x72,
	...
	0x65, 0x6d, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74,
	0x69, 0x6e, 0x67, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x12, 0x3d, 0x0a, 0x04, 0x61, 0x70, 0x70,
	0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x72, 0x2e,
	...
	,
	...
	0x6d, 0x65, 0x88, 0x01, 0x01, 0x12, 0x1f, 0x0a, 0x08, 0x65, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61,
	0x6c, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x48, 0x02, 0x52, 0x08, 0x65, 0x78, 0x74, 0x65, 0x72,
	0x6e, 0x61, 0x6c, 0x88, 0x01, 0x01, 0x12, 0x19, 0x0a, 0x05, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x18,
	0x05, 0x20, 0x01, 0x28, 0x09, 0x48, 0x03, 0x52, 0x05, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x88, 0x01,
	0x01, 0x12, 0x5c, 0x0a, 0x0b, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x63, 0x68, 0x65, 0x63, 0x6b,
	0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x35, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x72, 0x2e, 0x61,
	...
	,
	...
	0x65, 0x73, 0x68, 0x6f, 0x6c, 0x64, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x72, 0x6c, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x22, 0x22, 0x0a, 0x06, 0x4f, 0x70, 0x65, 0x6e,
	0x49, 0x6e, 0x12, 0x0f, 0x0a, 0x0b, 0x53, 0x4c, 0x49, 0x4d, 0x5f, 0x57, 0x49, 0x4e, 0x44, 0x4f,
	0x57, 0x10, 0x00, 0x12, 0x07, 0x0a, 0x03, 0x54, 0x41, 0x42, 0x10, 0x01, 0x22, 0x4a, 0x0a, 0x0c,
	...
	,
	...
	0x65, 0x6e, 0x63, 0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x1a, 0x5a, 0x0a, 0x0b, 0x48, 0x74,
	...
	0x63, 0x65, 0x22, 0x9f, 0x01, 0x0a, 0x19, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x42, 0x6f, 0x75,
	...
	0x2e, 0x63, 0x6f, 0x64, 0x65, 0x72, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x2e, 0x76, 0x32, 0x2e,
	0x42, 0x6f, 0x75, 0x6e, 0x64, 0x61, 0x72, 0x79, 0x4c, 0x6f, 0x67, 0x52, 0x04, 0x6c, 0x6f, 0x67,
	...
	0x12, 0x32, 0x0a, 0x15, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x6e, 0x65, 0x64, 0x5f, 0x70, 0x72, 0x6f,
	0x63, 0x65, 0x73, 0x73, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x13, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x6e, 0x65, 0x64, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73,
	0x4e, 0x61, 0x6d, 0x65, 0x22, 0x1c, 0x0a, 0x1a, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x42, 0x6f,
	0x75, 0x6e, 0x64, 0x61, 0x72, 0x79, 0x4c, 0x6f, 0x67, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x22, 0xe9, 0x01, 0x0a, 0x16, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x41, 0x70, 0x70,
	...
	0x67, 0x12, 0x4b, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e,
	...
	,
	...
	0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x53,
	...
	,
	...
	,
	...
	,
	...
	0x70, 0x75, 0x74, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x22, 0xe0, 0x01, 0x0a, 0x17, 0x50, 0x75,
	...
	0x25, 0x0a, 0x0e, 0x61, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65, 0x5f, 0x68, 0x61, 0x73,
	0x68, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0d, 0x61, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61,
	0x74, 0x65, 0x48, 0x61, 0x73, 0x68, 0x12, 0x3d, 0x0a, 0x09, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x63, 0x6f, 0x64, 0x65,
	0x72, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x2e, 0x76, 0x32, 0x2e, 0x43, 0x6f, 0x6e, 0x74, 0x65,
	0x78, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52, 0x09, 0x72, 0x65, 0x73, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x6c,
	...
	0x74, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x4a, 0x04, 0x08, 0x05, 0x10, 0x06, 0x22, 0x36, 0x0a, 0x18,
	...
	0x70, 0x74, 0x65, 0x64, 0x2a, 0x63, 0x0a, 0x09, 0x41, 0x70, 0x70, 0x48, 0x65, 0x61, 0x6c, 0x74,
	...
	0x48, 0x45, 0x41, 0x4c, 0x54, 0x48, 0x59, 0x10, 0x04, 0x32, 0xd7, 0x11, 0x0a, 0x05, 0x41, 0x67,
	...
	0x73, 0x65, 0x12, 0x77, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x41, 0x6e, 0x6e, 0x6f, 0x75, 0x6e, 0x63,
	0x65, 0x6d, 0x65, 0x6e, 0x74, 0x42, 0x61, 0x6e, 0x6e, 0x65, 0x72, 0x73, 0x12, 0x2d, 0x2e, 0x63,
	0x6f, 0x64, 0x65, 0x72, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x2e, 0x76, 0x32, 0x2e, 0x47, 0x65,
	0x74, 0x41, 0x6e, 0x6e, 0x6f, 0x75, 0x6e, 0x63, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x42, 0x61, 0x6e,
	0x6e, 0x65, 0x72, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2e, 0x2e, 0x63, 0x6f,
	...
	0x65, 0x72, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x7e, 0x0a, 0x0f, 0x53,
	0x63, 0x72, 0x69, 0x70, 0x74, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x12, 0x34,
	0x2e, 0x63, 0x6f, 0x64, 0x65, 0x72, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x2e, 0x76, 0x32, 0x2e,
	0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x53, 0x63,
	0x72, 0x69, 0x70, 0x74, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x35, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x72, 0x2e, 0x61, 0x67, 0x65,
	...
	0x74, 0x65, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x9e, 0x01, 0x0a, 0x23,
	0x47, 0x65, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x4d, 0x6f, 0x6e, 0x69,
	0x74, 0x6f, 0x72, 0x69, 0x6e, 0x67, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x12, 0x3a, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x72, 0x2e, 0x61, 0x67, 0x65, 0x6e,
	...
	0x1c, 0x50, 0x75, 0x73, 0x68, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x4d, 0x6f,
	0x6e, 0x69, 0x74, 0x6f, 0x72, 0x69, 0x6e, 0x67, 0x55, 0x73, 0x61, 0x67, 0x65, 0x12, 0x33, 0x2e,
	0x63, 0x6f, 0x64, 0x65, 0x72, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x2e, 0x76, 0x32, 0x2e, 0x50,
	0x75, 0x73, 0x68, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x4d, 0x6f, 0x6e, 0x69,
	0x74, 0x6f, 0x72, 0x69, 0x6e, 0x67, 0x55, 0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x34, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x72, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x53, 0x0a, 0x10, 0x52, 0x65, 0x70, 0x6f,
	0x72, 0x74, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x27, 0x2e, 0x63,
	...
	0x0e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x53, 0x75, 0x62, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x12,
	...
	0x67, 0x65, 0x6e, 0x74, 0x2e, 0x76, 0x32, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x53, 0x75,
	0x62, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x5f,
	0x0a, 0x0e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x53, 0x75, 0x62, 0x41, 0x67, 0x65, 0x6e, 0x74,
	...
	0x61, 0x67, 0x65, 0x6e, 0x74, 0x2e, 0x76, 0x32, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x53,
	0x75, 0x62, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x5c, 0x0a, 0x0d, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x75, 0x62, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x73,
	...
	,
	...
	,
...
var file_agent_proto_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 79)
var file_agent_proto_agent_proto_goTypes = []interface{}{
	...
	(ReportSubagentExecutionStatusRequest_Status)(0),    // 3: coder.agent.v2.ReportSubagentExecutionStatusRequest.Status
	...
	(*SubagentExecution)(nil),                           // 21: coder.agent.v2.SubagentExecution
	(*AcquireSubagentExecutionRequest)(nil),             // 22: coder.agent.v2.AcquireSubagentExecutionRequest
	(*AcquireSubagentExecutionResponse)(nil),            // 23: coder.agent.v2.AcquireSubagentExecutionResponse
	(*ReportSubagentExecutionStatusRequest)(nil),        // 24: coder.agent.v2.ReportSubagentExecutionStatusRequest
	(*ReportSubagentExecutionStatusResponse)(nil),       // 25: coder.agent.v2.ReportSubagentExecutionStatusResponse
	(*WorkspaceSecret)(nil),                             // 26: coder.agent.v2.WorkspaceSecret
	(*WorkspaceAgentDevcontainer)(nil),                  // 27: coder.agent.v2.WorkspaceAgentDevcontainer
	(*GetManifestRequest)(nil),                          // 28: coder.agent.v2.GetManifestRequest
	(*ServiceBanner)(nil),                               // 29: coder.agent.v2.ServiceBanner
	(*GetServiceBannerRequest)(nil),                     // 30: coder.agent.v2.GetServiceBannerRequest
	(*Stats)(nil),                                       // 31: coder.agent.v2.Stats
	(*UpdateStatsRequest)(nil),                          // 32: coder.agent.v2.UpdateStatsRequest
	(*UpdateStatsResponse)(nil),                         // 33: coder.agent.v2.UpdateStatsResponse
	(*Lifecycle)(nil),                                   // 34: coder.agent.v2.Lifecycle
	(*UpdateLifecycleRequest)(nil),                      // 35: coder.agent.v2.UpdateLifecycleRequest
	(*BatchUpdateAppHealthRequest)(nil),                 // 36: coder.agent.v2.BatchUpdateAppHealthRequest
	(*BatchUpdateAppHealthResponse)(nil),                // 37: coder.agent.v2.BatchUpdateAppHealthResponse
	(*Startup)(nil),                                     // 38: coder.agent.v2.Startup
	(*UpdateStartupRequest)(nil),                        // 39: coder.agent.v2.UpdateStartupRequest
	(*Metadata)(nil),                                    // 40: coder.agent.v2.Metadata
	(*BatchUpdateMetadataRequest)(nil),                  // 41: coder.agent.v2.BatchUpdateMetadataRequest
	(*BatchUpdateMetadataResponse)(nil),                 // 42: coder.agent.v2.BatchUpdateMetadataResponse
	(*Log)(nil),                                         // 43: coder.agent.v2.Log
	(*BatchCreateLogsRequest)(nil),                      // 44: coder.agent.v2.BatchCreateLogsRequest
	(*BatchCreateLogsResponse)(nil),                     // 45: coder.agent.v2.BatchCreateLogsResponse
	(*GetAnnouncementBannersRequest)(nil),               // 46: coder.agent.v2.GetAnnouncementBannersRequest
	(*GetAnnouncementBannersResponse)(nil),              // 47: coder.agent.v2.GetAnnouncementBannersResponse
	(*BannerConfig)(nil),                                // 48: coder.agent.v2.BannerConfig
	(*WorkspaceAgentScriptCompletedRequest)(nil),        // 49: coder.agent.v2.WorkspaceAgentScriptCompletedRequest
	(*WorkspaceAgentScriptCompletedResponse)(nil),       // 50: coder.agent.v2.WorkspaceAgentScriptCompletedResponse
	(*Timing)(nil),                                      // 51: coder.agent.v2.Timing
	(*GetResourcesMonitoringConfigurationRequest)(nil),  // 52: coder.agent.v2.GetResourcesMonitoringConfigurationRequest
	(*GetResourcesMonitoringConfigurationResponse)(nil), // 53: coder.agent.v2.GetResourcesMonitoringConfigurationResponse
	(*PushResourcesMonitoringUsageRequest)(nil),         // 54: coder.agent.v2.PushResourcesMonitoringUsageRequest
	(*PushResourcesMonitoringUsageResponse)(nil),        // 55: coder.agent.v2.PushResourcesMonitoringUsageResponse
	(*Connection)(nil),                                  // 56: coder.agent.v2.Connection
	(*ReportConnectionRequest)(nil),                     // 57: coder.agent.v2.ReportConnectionRequest
	(*SubAgent)(nil),                                    // 58: coder.agent.v2.SubAgent
	(*CreateSubAgentRequest)(nil),                       // 59: coder.agent.v2.CreateSubAgentRequest
	(*CreateSubAgentResponse)(nil),                      // 60: coder.agent.v2.CreateSubAgentResponse
	(*DeleteSubAgentRequest)(nil),                       // 61: coder.agent.v2.DeleteSubAgentRequest
	(*DeleteSubAgentResponse)(nil),                      // 62: coder.agent.v2.DeleteSubAgentResponse
	(*ListSubAgentsRequest)(nil),                        // 63: coder.agent.v2.ListSubAgentsRequest
	(*ListSubAgentsResponse)(nil),                       // 64: coder.agent.v2.ListSubAgentsResponse
	(*BoundaryLog)(nil),                                 // 65: coder.agent.v2.BoundaryLog
	(*ReportBoundaryLogsRequest)(nil),                   // 66: coder.agent.v2.ReportBoundaryLogsRequest
	(*ReportBoundaryLogsResponse)(nil),                  // 67: coder.agent.v2.ReportBoundaryLogsResponse
	(*UpdateAppStatusRequest)(nil),                      // 68: coder.agent.v2.UpdateAppStatusRequest
	(*UpdateAppStatusResponse)(nil),                     // 69: coder.agent.v2.UpdateAppStatusResponse
	(*ContextResource)(nil),                             // 70: coder.agent.v2.ContextResource
	(*InstructionFileBody)(nil),                         // 71: coder.agent.v2.InstructionFileBody
	(*SkillMetaBody)(nil),                               // 72: coder.agent.v2.SkillMetaBody
	(*MCPConfigBody)(nil),                               // 73: coder.agent.v2.MCPConfigBody
	(*MCPServerBody)(nil),                               // 74: coder.agent.v2.MCPServerBody
	(*MCPTool)(nil),                                     // 75: coder.agent.v2.MCPTool
	(*PushContextStateRequest)(nil),                     // 76: coder.agent.v2.PushContextStateRequest
	(*PushContextStateResponse)(nil),                    // 77: coder.agent.v2.PushContextStateResponse
	(*WorkspaceApp_Healthcheck)(nil),                    // 78: coder.agent.v2.WorkspaceApp.Healthcheck
	(*WorkspaceAgentMetadata_Result)(nil),               // 79: coder.agent.v2.WorkspaceAgentMetadata.Result
	(*WorkspaceAgentMetadata_Description)(nil),          // 80: coder.agent.v2.WorkspaceAgentMetadata.Description
	nil,                        // 81: coder.agent.v2.Manifest.EnvironmentVariablesEntry
	nil,                        // 82: coder.agent.v2.Stats.ConnectionsByProtoEntry
	(*Stats_Metric)(nil),       // 83: coder.agent.v2.Stats.Metric
	(*Stats_Metric_Label)(nil), // 84: coder.agent.v2.Stats.Metric.Label
	(*BatchUpdateAppHealthRequest_HealthUpdate)(nil),                  // 85: coder.agent.v2.BatchUpdateAppHealthRequest.HealthUpdate
	(*GetResourcesMonitoringConfigurationResponse_Config)(nil),        // 86: coder.agent.v2.GetResourcesMonitoringConfigurationResponse.Config
	(*GetResourcesMonitoringConfigurationResponse_Memory)(nil),        // 87: coder.agent.v2.GetResourcesMonitoringConfigurationResponse.Memory
	(*GetResourcesMonitoringConfigurationResponse_Volume)(nil),        // 88: coder.agent.v2.GetResourcesMonitoringConfigurationResponse.Volume
	(*PushResourcesMonitoringUsageRequest_Datapoint)(nil),             // 89: coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint
	(*PushResourcesMonitoringUsageRequest_Datapoint_MemoryUsage)(nil), // 90: coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.MemoryUsage
	(*PushResourcesMonitoringUsageRequest_Datapoint_VolumeUsage)(nil), // 91: coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.VolumeUsage
	(*CreateSubAgentRequest_App)(nil),                                 // 92: coder.agent.v2.CreateSubAgentRequest.App
	(*CreateSubAgentRequest_App_Healthcheck)(nil),                     // 93: coder.agent.v2.CreateSubAgentRequest.App.Healthcheck
	(*CreateSubAgentResponse_AppCreationError)(nil),                   // 94: coder.agent.v2.CreateSubAgentResponse.AppCreationError
	(*BoundaryLog_HttpRequest)(nil),                                   // 95: coder.agent.v2.BoundaryLog.HttpRequest
	(*durationpb.Duration)(nil),                                       // 96: google.protobuf.Duration
	(*proto.DERPMap)(nil),                                             // 97: coder.tailnet.v2.DERPMap
...
var file_agent_proto_agent_proto_depIdxs = []int32{
	...
	78,  // 1: coder.agent.v2.WorkspaceApp.healthcheck:type_name -> coder.agent.v2.WorkspaceApp.Healthcheck
	2,   // 2: coder.agent.v2.WorkspaceApp.health:type_name -> coder.agent.v2.WorkspaceApp.Health
	96,  // 3: coder.agent.v2.WorkspaceAgentScript.timeout:type_name -> google.protobuf.Duration
	79,  // 4: coder.agent.v2.WorkspaceAgentMetadata.result:type_name -> coder.agent.v2.WorkspaceAgentMetadata.Result
	80,  // 5: coder.agent.v2.WorkspaceAgentMetadata.description:type_name -> coder.agent.v2.WorkspaceAgentMetadata.Description
	81,  // 6: coder.agent.v2.Manifest.environment_variables:type_name -> coder.agent.v2.Manifest.EnvironmentVariablesEntry
	97,  // 7: coder.agent.v2.Manifest.derp_map:type_name -> coder.tailnet.v2.DERPMap
	...
	80,  // 10: coder.agent.v2.Manifest.metadata:type_name -> coder.agent.v2.WorkspaceAgentMetadata.Description
	27,  // 11: coder.agent.v2.Manifest.devcontainers:type_name -> coder.agent.v2.WorkspaceAgentDevcontainer
	26,  // 12: coder.agent.v2.Manifest.secrets:type_name -> coder.agent.v2.WorkspaceSecret
	21,  // 13: coder.agent.v2.Manifest.subagent_executions:type_name -> coder.agent.v2.SubagentExecution
	3,   // 14: coder.agent.v2.ReportSubagentExecutionStatusRequest.status:type_name -> coder.agent.v2.ReportSubagentExecutionStatusRequest.Status
	82,  // 15: coder.agent.v2.Stats.connections_by_proto:type_name -> coder.agent.v2.Stats.ConnectionsByProtoEntry
	83,  // 16: coder.agent.v2.Stats.metrics:type_name -> coder.agent.v2.Stats.Metric
	31,  // 17: coder.agent.v2.UpdateStatsRequest.stats:type_name -> coder.agent.v2.Stats
	96,  // 18: coder.agent.v2.UpdateStatsResponse.report_interval:type_name -> google.protobuf.Duration
	5,   // 19: coder.agent.v2.Lifecycle.state:type_name -> coder.agent.v2.Lifecycle.State
	98,  // 20: coder.agent.v2.Lifecycle.changed_at:type_name -> google.protobuf.Timestamp
	34,  // 21: coder.agent.v2.UpdateLifecycleRequest.lifecycle:type_name -> coder.agent.v2.Lifecycle
	85,  // 22: coder.agent.v2.BatchUpdateAppHealthRequest.updates:type_name -> coder.agent.v2.BatchUpdateAppHealthRequest.HealthUpdate
	6,   // 23: coder.agent.v2.Startup.subsystems:type_name -> coder.agent.v2.Startup.Subsystem
	38,  // 24: coder.agent.v2.UpdateStartupRequest.startup:type_name -> coder.agent.v2.Startup
	79,  // 25: coder.agent.v2.Metadata.result:type_name -> coder.agent.v2.WorkspaceAgentMetadata.Result
	40,  // 26: coder.agent.v2.BatchUpdateMetadataRequest.metadata:type_name -> coder.agent.v2.Metadata
	98,  // 27: coder.agent.v2.Log.created_at:type_name -> google.protobuf.Timestamp
	7,   // 28: coder.agent.v2.Log.level:type_name -> coder.agent.v2.Log.Level
	43,  // 29: coder.agent.v2.BatchCreateLogsRequest.logs:type_name -> coder.agent.v2.Log
	48,  // 30: coder.agent.v2.GetAnnouncementBannersResponse.announcement_banners:type_name -> coder.agent.v2.BannerConfig
	51,  // 31: coder.agent.v2.WorkspaceAgentScriptCompletedRequest.timing:type_name -> coder.agent.v2.Timing
	98,  // 32: coder.agent.v2.Timing.start:type_name -> google.protobuf.Timestamp
	98,  // 33: coder.agent.v2.Timing.end:type_name -> google.protobuf.Timestamp
	8,   // 34: coder.agent.v2.Timing.stage:type_name -> coder.agent.v2.Timing.Stage
	9,   // 35: coder.agent.v2.Timing.status:type_name -> coder.agent.v2.Timing.Status
	86,  // 36: coder.agent.v2.GetResourcesMonitoringConfigurationResponse.config:type_name -> coder.agent.v2.GetResourcesMonitoringConfigurationResponse.Config
	87,  // 37: coder.agent.v2.GetResourcesMonitoringConfigurationResponse.memory:type_name -> coder.agent.v2.GetResourcesMonitoringConfigurationResponse.Memory
	88,  // 38: coder.agent.v2.GetResourcesMonitoringConfigurationResponse.volumes:type_name -> coder.agent.v2.GetResourcesMonitoringConfigurationResponse.Volume
	89,  // 39: coder.agent.v2.PushResourcesMonitoringUsageRequest.datapoints:type_name -> coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint
	10,  // 40: coder.agent.v2.Connection.action:type_name -> coder.agent.v2.Connection.Action
	11,  // 41: coder.agent.v2.Connection.type:type_name -> coder.agent.v2.Connection.Type
	98,  // 42: coder.agent.v2.Connection.timestamp:type_name -> google.protobuf.Timestamp
	56,  // 43: coder.agent.v2.ReportConnectionRequest.connection:type_name -> coder.agent.v2.Connection
	92,  // 44: coder.agent.v2.CreateSubAgentRequest.apps:type_name -> coder.agent.v2.CreateSubAgentRequest.App
	12,  // 45: coder.agent.v2.CreateSubAgentRequest.display_apps:type_name -> coder.agent.v2.CreateSubAgentRequest.DisplayApp
	58,  // 46: coder.agent.v2.CreateSubAgentResponse.agent:type_name -> coder.agent.v2.SubAgent
	94,  // 47: coder.agent.v2.CreateSubAgentResponse.app_creation_errors:type_name -> coder.agent.v2.CreateSubAgentResponse.AppCreationError
	58,  // 48: coder.agent.v2.ListSubAgentsResponse.agents:type_name -> coder.agent.v2.SubAgent
	98,  // 49: coder.agent.v2.BoundaryLog.time:type_name -> google.protobuf.Timestamp
	95,  // 50: coder.agent.v2.BoundaryLog.http_request:type_name -> coder.agent.v2.BoundaryLog.HttpRequest
	65,  // 51: coder.agent.v2.ReportBoundaryLogsRequest.logs:type_name -> coder.agent.v2.BoundaryLog
	15,  // 52: coder.agent.v2.UpdateAppStatusRequest.state:type_name -> coder.agent.v2.UpdateAppStatusRequest.AppStatusState
	16,  // 53: coder.agent.v2.ContextResource.status:type_name -> coder.agent.v2.ContextResource.Status
	71,  // 54: coder.agent.v2.ContextResource.instruction_file:type_name -> coder.agent.v2.InstructionFileBody
	72,  // 55: coder.agent.v2.ContextResource.skill:type_name -> coder.agent.v2.SkillMetaBody
	73,  // 56: coder.agent.v2.ContextResource.mcp_config:type_name -> coder.agent.v2.MCPConfigBody
	74,  // 57: coder.agent.v2.ContextResource.mcp_server:type_name -> coder.agent.v2.MCPServerBody
	75,  // 58: coder.agent.v2.MCPServerBody.tools:type_name -> coder.agent.v2.MCPTool
	99,  // 59: coder.agent.v2.MCPTool.input_schema:type_name -> google.protobuf.Struct
	70,  // 60: coder.agent.v2.PushContextStateRequest.resources:type_name -> coder.agent.v2.ContextResource
	96,  // 61: coder.agent.v2.WorkspaceApp.Healthcheck.interval:type_name -> google.protobuf.Duration
	98,  // 62: coder.agent.v2.WorkspaceAgentMetadata.Result.collected_at:type_name -> google.protobuf.Timestamp
	96,  // 63: coder.agent.v2.WorkspaceAgentMetadata.Description.interval:type_name -> google.protobuf.Duration
	96,  // 64: coder.agent.v2.WorkspaceAgentMetadata.Description.timeout:type_name -> google.protobuf.Duration
	4,   // 65: coder.agent.v2.Stats.Metric.type:type_name -> coder.agent.v2.Stats.Metric.Type
	84,  // 66: coder.agent.v2.Stats.Metric.labels:type_name -> coder.agent.v2.Stats.Metric.Label
	0,   // 67: coder.agent.v2.BatchUpdateAppHealthRequest.HealthUpdate.health:type_name -> coder.agent.v2.AppHealth
	98,  // 68: coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.collected_at:type_name -> google.protobuf.Timestamp
	90,  // 69: coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.memory:type_name -> coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.MemoryUsage
	91,  // 70: coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.volumes:type_name -> coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.VolumeUsage
	93,  // 71: coder.agent.v2.CreateSubAgentRequest.App.healthcheck:type_name -> coder.agent.v2.CreateSubAgentRequest.App.Healthcheck
	...
	28,  // 74: coder.agent.v2.Agent.GetManifest:input_type -> coder.agent.v2.GetManifestRequest
	30,  // 75: coder.agent.v2.Agent.GetServiceBanner:input_type -> coder.agent.v2.GetServiceBannerRequest
	32,  // 76: coder.agent.v2.Agent.UpdateStats:input_type -> coder.agent.v2.UpdateStatsRequest
	35,  // 77: coder.agent.v2.Agent.UpdateLifecycle:input_type -> coder.agent.v2.UpdateLifecycleRequest
	36,  // 78: coder.agent.v2.Agent.BatchUpdateAppHealths:input_type -> coder.agent.v2.BatchUpdateAppHealthRequest
	39,  // 79: coder.agent.v2.Agent.UpdateStartup:input_type -> coder.agent.v2.UpdateStartupRequest
	41,  // 80: coder.agent.v2.Agent.BatchUpdateMetadata:input_type -> coder.agent.v2.BatchUpdateMetadataRequest
	44,  // 81: coder.agent.v2.Agent.BatchCreateLogs:input_type -> coder.agent.v2.BatchCreateLogsRequest
	46,  // 82: coder.agent.v2.Agent.GetAnnouncementBanners:input_type -> coder.agent.v2.GetAnnouncementBannersRequest
	49,  // 83: coder.agent.v2.Agent.ScriptCompleted:input_type -> coder.agent.v2.WorkspaceAgentScriptCompletedRequest
	52,  // 84: coder.agent.v2.Agent.GetResourcesMonitoringConfiguration:input_type -> coder.agent.v2.GetResourcesMonitoringConfigurationRequest
	54,  // 85: coder.agent.v2.Agent.PushResourcesMonitoringUsage:input_type -> coder.agent.v2.PushResourcesMonitoringUsageRequest
	57,  // 86: coder.agent.v2.Agent.ReportConnection:input_type -> coder.agent.v2.ReportConnectionRequest
	59,  // 87: coder.agent.v2.Agent.CreateSubAgent:input_type -> coder.agent.v2.CreateSubAgentRequest
	61,  // 88: coder.agent.v2.Agent.DeleteSubAgent:input_type -> coder.agent.v2.DeleteSubAgentRequest
	63,  // 89: coder.agent.v2.Agent.ListSubAgents:input_type -> coder.agent.v2.ListSubAgentsRequest
	66,  // 90: coder.agent.v2.Agent.ReportBoundaryLogs:input_type -> coder.agent.v2.ReportBoundaryLogsRequest
	68,  // 91: coder.agent.v2.Agent.UpdateAppStatus:input_type -> coder.agent.v2.UpdateAppStatusRequest
	76,  // 92: coder.agent.v2.Agent.PushContextState:input_type -> coder.agent.v2.PushContextStateRequest
	22,  // 93: coder.agent.v2.Agent.AcquireSubagentExecution:input_type -> coder.agent.v2.AcquireSubagentExecutionRequest
	24,  // 94: coder.agent.v2.Agent.ReportSubagentExecutionStatus:input_type -> coder.agent.v2.ReportSubagentExecutionStatusRequest
	20,  // 95: coder.agent.v2.Agent.GetManifest:output_type -> coder.agent.v2.Manifest
	29,  // 96: coder.agent.v2.Agent.GetServiceBanner:output_type -> coder.agent.v2.ServiceBanner
	33,  // 97: coder.agent.v2.Agent.UpdateStats:output_type -> coder.agent.v2.UpdateStatsResponse
	34,  // 98: coder.agent.v2.Agent.UpdateLifecycle:output_type -> coder.agent.v2.Lifecycle
	37,  // 99: coder.agent.v2.Agent.BatchUpdateAppHealths:output_type -> coder.agent.v2.BatchUpdateAppHealthResponse
	38,  // 100: coder.agent.v2.Agent.UpdateStartup:output_type -> coder.agent.v2.Startup
	42,  // 101: coder.agent.v2.Agent.BatchUpdateMetadata:output_type -> coder.agent.v2.BatchUpdateMetadataResponse
	45,  // 102: coder.agent.v2.Agent.BatchCreateLogs:output_type -> coder.agent.v2.BatchCreateLogsResponse
	47,  // 103: coder.agent.v2.Agent.GetAnnouncementBanners:output_type -> coder.agent.v2.GetAnnouncementBannersResponse
	50,  // 104: coder.agent.v2.Agent.ScriptCompleted:output_type -> coder.agent.v2.WorkspaceAgentScriptCompletedResponse
	53,  // 105: coder.agent.v2.Agent.GetResourcesMonitoringConfiguration:output_type -> coder.agent.v2.GetResourcesMonitoringConfigurationResponse
	55,  // 106: coder.agent.v2.Agent.PushResourcesMonitoringUsage:output_type -> coder.agent.v2.PushResourcesMonitoringUsageResponse
	100, // 107: coder.agent.v2.Agent.ReportConnection:output_type -> google.protobuf.Empty
	60,  // 108: coder.agent.v2.Agent.CreateSubAgent:output_type -> coder.agent.v2.CreateSubAgentResponse
	62,  // 109: coder.agent.v2.Agent.DeleteSubAgent:output_type -> coder.agent.v2.DeleteSubAgentResponse
	64,  // 110: coder.agent.v2.Agent.ListSubAgents:output_type -> coder.agent.v2.ListSubAgentsResponse
	67,  // 111: coder.agent.v2.Agent.ReportBoundaryLogs:output_type -> coder.agent.v2.ReportBoundaryLogsResponse
	69,  // 112: coder.agent.v2.Agent.UpdateAppStatus:output_type -> coder.agent.v2.UpdateAppStatusResponse
	77,  // 113: coder.agent.v2.Agent.PushContextState:output_type -> coder.agent.v2.PushContextStateResponse
	23,  // 114: coder.agent.v2.Agent.AcquireSubagentExecution:output_type -> coder.agent.v2.AcquireSubagentExecutionResponse
	25,  // 115: coder.agent.v2.Agent.ReportSubagentExecutionStatus:output_type -> coder.agent.v2.ReportSubagentExecutionStatusResponse
...
func file_agent_proto_agent_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_agent_proto_agent_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AcquireSubagentExecutionRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_agent_proto_agent_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AcquireSubagentExecutionResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_agent_proto_agent_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReportSubagentExecutionStatusRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_agent_proto_agent_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReportSubagentExecutionStatusResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_agent_proto_agent_proto_msgTypes[78].Exporter = func(v interface{}, i int) interface{} {
	...
	file_agent_proto_agent_proto_msgTypes[10].OneofWrappers = []interface{}{}
	file_agent_proto_agent_proto_msgTypes[36].OneofWrappers = []interface{}{}
	file_agent_proto_agent_proto_msgTypes[39].OneofWrappers = []interface{}{}
	...
	file_agent_proto_agent_proto_msgTypes[75].OneofWrappers = []interface{}{}
	file_agent_proto_agent_proto_msgTypes[77].OneofWrappers = []interface{}{}
	type x struct{}
