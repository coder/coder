...
type Timing struct {
	...
	RanOnStart   bool                   `protobuf:"varint,5,opt,name=ran_on_start,json=ranOnStart,proto3" json:"ran_on_start,omitempty"`
	BlockedLogin bool                   `protobuf:"varint,6,opt,name=blocked_login,json=blockedLogin,proto3" json:"blocked_login,omitempty"`
}
...
func (x *Timing) GetRanOnStart() bool {
	if x != nil {
		return x.RanOnStart
	}
	return false
...
func (x *Timing) GetBlockedLogin() bool {
	if x != nil {
		return x.BlockedLogin
	}
	return false
}
...
var file_agent_proto_agent_proto_rawDesc = []byte{
	...
	0x0d, 0x0a, 0x09, 0x55, 0x4e, 0x48, 0x45, 0x41, 0x4c, 0x54, 0x48, 0x59, 0x10, 0x04, 0x22, 0xc9,
	...
	0x69, 0x73, 0x70, 0x6c, 0x61, 0x79, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x86, 0x04, 0x0a, 0x16, 0x57,
	...
	0x6e, 0x73, 0x65, 0x22, 0xef, 0x01, 0x0a, 0x06, 0x54, 0x69, 0x6d, 0x69, 0x6e, 0x67, 0x12, 0x21,
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x65, 0x78, 0x69, 0x74, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x20,
	0x0a, 0x0c, 0x72, 0x61, 0x6e, 0x5f, 0x6f, 0x6e, 0x5f, 0x73, 0x74, 0x61, 0x72, 0x74, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x72, 0x61, 0x6e, 0x4f, 0x6e, 0x53, 0x74, 0x61, 0x72, 0x74,
	0x12, 0x23, 0x0a, 0x0d, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x65, 0x64, 0x5f, 0x6c, 0x6f, 0x67, 0x69,
	0x6e, 0x18, 0x06, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0c, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x65, 0x64,
	0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x2a, 0x63, 0x0a, 0x09, 0x41, 0x70, 0x70, 0x48, 0x65, 0x61, 0x6c,
	...
	0x4e, 0x48, 0x45, 0x41, 0x4c, 0x54, 0x48, 0x59, 0x10, 0x04, 0x32, 0xef, 0x07, 0x0a, 0x05, 0x41,
	...
	0x65, 0x74, 0x65, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x27, 0x5a, 0x25,
...
var file_agent_proto_agent_proto_goTypes = []interface{}{
	...
	(*WorkspaceAgentScriptCompletedRequest)(nil),  // 32: coder.agent.v2.WorkspaceAgentScriptCompletedRequest
	(*WorkspaceAgentScriptCompletedResponse)(nil), // 33: coder.agent.v2.WorkspaceAgentScriptCompletedResponse
	(*Timing)(nil),                                // 34: coder.agent.v2.Timing
	(*WorkspaceApp_Healthcheck)(nil),              // 35: coder.agent.v2.WorkspaceApp.Healthcheck
	(*WorkspaceAgentMetadata_Result)(nil),         // 36: coder.agent.v2.WorkspaceAgentMetadata.Result
	(*WorkspaceAgentMetadata_Description)(nil),    // 37: coder.agent.v2.WorkspaceAgentMetadata.Description
	nil,                        // 38: coder.agent.v2.Manifest.EnvironmentVariablesEntry
	nil,                        // 39: coder.agent.v2.Stats.ConnectionsByProtoEntry
	(*Stats_Metric)(nil),       // 40: coder.agent.v2.Stats.Metric
	(*Stats_Metric_Label)(nil), // 41: coder.agent.v2.Stats.Metric.Label
	(*BatchUpdateAppHealthRequest_HealthUpdate)(nil), // 42: coder.agent.v2.BatchUpdateAppHealthRequest.HealthUpdate
	(*durationpb.Duration)(nil),                      // 43: google.protobuf.Duration
	(*proto.DERPMap)(nil),                            // 44: coder.tailnet.v2.DERPMap
...
var file_agent_proto_agent_proto_depIdxs = []int32{
	...
	35, // 1: coder.agent.v2.WorkspaceApp.healthcheck:type_name -> coder.agent.v2.WorkspaceApp.Healthcheck
	2,  // 2: coder.agent.v2.WorkspaceApp.health:type_name -> coder.agent.v2.WorkspaceApp.Health
	43, // 3: coder.agent.v2.WorkspaceAgentScript.timeout:type_name -> google.protobuf.Duration
	36, // 4: coder.agent.v2.WorkspaceAgentMetadata.result:type_name -> coder.agent.v2.WorkspaceAgentMetadata.Result
	37, // 5: coder.agent.v2.WorkspaceAgentMetadata.description:type_name -> coder.agent.v2.WorkspaceAgentMetadata.Description
	38, // 6: coder.agent.v2.Manifest.environment_variables:type_name -> coder.agent.v2.Manifest.EnvironmentVariablesEntry
	44, // 7: coder.agent.v2.Manifest.derp_map:type_name -> coder.tailnet.v2.DERPMap
	...
	37, // 10: coder.agent.v2.Manifest.metadata:type_name -> coder.agent.v2.WorkspaceAgentMetadata.Description
	39, // 11: coder.agent.v2.Stats.connections_by_proto:type_name -> coder.agent.v2.Stats.ConnectionsByProtoEntry
	40, // 12: coder.agent.v2.Stats.metrics:type_name -> coder.agent.v2.Stats.Metric
	14, // 13: coder.agent.v2.UpdateStatsRequest.stats:type_name -> coder.agent.v2.Stats
	43, // 14: coder.agent.v2.UpdateStatsResponse.report_interval:type_name -> google.protobuf.Duration
	4,  // 15: coder.agent.v2.Lifecycle.state:type_name -> coder.agent.v2.Lifecycle.State
	45, // 16: coder.agent.v2.Lifecycle.changed_at:type_name -> google.protobuf.Timestamp
	17, // 17: coder.agent.v2.UpdateLifecycleRequest.lifecycle:type_name -> coder.agent.v2.Lifecycle
	42, // 18: coder.agent.v2.BatchUpdateAppHealthRequest.updates:type_name -> coder.agent.v2.BatchUpdateAppHealthRequest.HealthUpdate
	...
	36, // 21: coder.agent.v2.Metadata.result:type_name -> coder.agent.v2.WorkspaceAgentMetadata.Result
	23, // 22: coder.agent.v2.BatchUpdateMetadataRequest.metadata:type_name -> coder.agent.v2.Metadata
	45, // 23: coder.agent.v2.Log.created_at:type_name -> google.protobuf.Timestamp
	...
	34, // 27: coder.agent.v2.WorkspaceAgentScriptCompletedRequest.timing:type_name -> coder.agent.v2.Timing
	45, // 28: coder.agent.v2.Timing.start:type_name -> google.protobuf.Timestamp
	45, // 29: coder.agent.v2.Timing.end:type_name -> google.protobuf.Timestamp
	43, // 30: coder.agent.v2.WorkspaceApp.Healthcheck.interval:type_name -> google.protobuf.Duration
	45, // 31: coder.agent.v2.WorkspaceAgentMetadata.Result.collected_at:type_name -> google.protobuf.Timestamp
	43, // 32: coder.agent.v2.WorkspaceAgentMetadata.Description.interval:type_name -> google.protobuf.Duration
	43, // 33: coder.agent.v2.WorkspaceAgentMetadata.Description.timeout:type_name -> google.protobuf.Duration
	3,  // 34: coder.agent.v2.Stats.Metric.type:type_name -> coder.agent.v2.Stats.Metric.Type
	41, // 35: coder.agent.v2.Stats.Metric.labels:type_name -> coder.agent.v2.Stats.Metric.Label
	0,  // 36: coder.agent.v2.BatchUpdateAppHealthRequest.HealthUpdate.health:type_name -> coder.agent.v2.AppHealth
	11, // 37: coder.agent.v2.Agent.GetManifest:input_type -> coder.agent.v2.GetManifestRequest
	13, // 38: coder.agent.v2.Agent.GetServiceBanner:input_type -> coder.agent.v2.GetServiceBannerRequest
	15, // 39: coder.agent.v2.Agent.UpdateStats:input_type -> coder.agent.v2.UpdateStatsRequest
	18, // 40: coder.agent.v2.Agent.UpdateLifecycle:input_type -> coder.agent.v2.UpdateLifecycleRequest
	19, // 41: coder.agent.v2.Agent.BatchUpdateAppHealths:input_type -> coder.agent.v2.BatchUpdateAppHealthRequest
	22, // 42: coder.agent.v2.Agent.UpdateStartup:input_type -> coder.agent.v2.UpdateStartupRequest
	24, // 43: coder.agent.v2.Agent.BatchUpdateMetadata:input_type -> coder.agent.v2.BatchUpdateMetadataRequest
	27, // 44: coder.agent.v2.Agent.BatchCreateLogs:input_type -> coder.agent.v2.BatchCreateLogsRequest
	29, // 45: coder.agent.v2.Agent.GetAnnouncementBanners:input_type -> coder.agent.v2.GetAnnouncementBannersRequest
	32, // 46: coder.agent.v2.Agent.ScriptCompleted:input_type -> coder.agent.v2.WorkspaceAgentScriptCompletedRequest
	10, // 47: coder.agent.v2.Agent.GetManifest:output_type -> coder.agent.v2.Manifest
	12, // 48: coder.agent.v2.Agent.GetServiceBanner:output_type -> coder.agent.v2.ServiceBanner
	16, // 49: coder.agent.v2.Agent.UpdateStats:output_type -> coder.agent.v2.UpdateStatsResponse
	17, // 50: coder.agent.v2.Agent.UpdateLifecycle:output_type -> coder.agent.v2.Lifecycle
	20, // 51: coder.agent.v2.Agent.BatchUpdateAppHealths:output_type -> coder.agent.v2.BatchUpdateAppHealthResponse
	21, // 52: coder.agent.v2.Agent.UpdateStartup:output_type -> coder.agent.v2.Startup
	25, // 53: coder.agent.v2.Agent.BatchUpdateMetadata:output_type -> coder.agent.v2.BatchUpdateMetadataResponse
	28, // 54: coder.agent.v2.Agent.BatchCreateLogs:output_type -> coder.agent.v2.BatchCreateLogsResponse
	30, // 55: coder.agent.v2.Agent.GetAnnouncementBanners:output_type -> coder.agent.v2.GetAnnouncementBannersResponse
	33, // 56: coder.agent.v2.Agent.ScriptCompleted:output_type -> coder.agent.v2.WorkspaceAgentScriptCompletedResponse
