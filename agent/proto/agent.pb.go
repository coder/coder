...
type Timing struct {
	...
	Stage       Timing_Stage           `protobuf:"varint,6,opt,name=stage,proto3,enum=coder.agent.v2.Timing_Stage" json:"stage,omitempty"`
...
func (x *Timing) GetDisplayName() string {
	if x != nil {
		return x.DisplayName
	}
	return ""
...
func (x *Timing) GetTimedOut() bool {
	if x != nil {
		return x.TimedOut
	}
	return false
...
var file_agent_proto_agent_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x65, 0x22, 0xbe, 0x02, 0x0a, 0x06, 0x54, 0x69, 0x6d, 0x69, 0x6e, 0x67, 0x12, 0x1b,
	0x0a, 0x09, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0c, 0x52, 0x08, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x49, 0x64, 0x12, 0x21, 0x0a, 0x0c, 0x64,
	0x69, 0x73, 0x70, 0x6c, 0x61, 0x79, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0b, 0x64, 0x69, 0x73, 0x70, 0x6c, 0x61, 0x79, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x30,
	...
	0x74, 0x61, 0x67, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x63, 0x6f, 0x64,
	0x65, 0x72, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x2e, 0x76, 0x32, 0x2e, 0x54, 0x69, 0x6d, 0x69,
	0x6e, 0x67, 0x2e, 0x53, 0x74, 0x61, 0x67, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x67, 0x65, 0x12,
	0x1b, 0x0a, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x64, 0x5f, 0x6f, 0x75, 0x74, 0x18, 0x07, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x08, 0x74, 0x69, 0x6d, 0x65, 0x64, 0x4f, 0x75, 0x74, 0x22, 0x26, 0x0a, 0x05,
	...
	0x4f, 0x4e, 0x10, 0x02, 0x2a, 0x63, 0x0a, 0x09, 0x41, 0x70, 0x70, 0x48, 0x65, 0x61, 0x6c, 0x74,
	...
	0x48, 0x45, 0x41, 0x4c, 0x54, 0x48, 0x59, 0x10, 0x04, 0x32, 0xef, 0x07, 0x0a, 0x05, 0x41, 0x67,
	...
	0x6e, 0x74, 0x2e, 0x76, 0x32, 0x2e, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x41,
	0x67, 0x65, 0x6e, 0x74, 0x53, 0x63, 0x72, 0x69, 0x70, 0x74, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65,
	0x74, 0x65, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x27, 0x5a, 0x25, 0x67,
...
var file_agent_proto_agent_proto_enumTypes = make([]protoimpl.EnumInfo, 8)
...
var file_agent_proto_agent_proto_goTypes = []interface{}{
	...
	(*WorkspaceApp)(nil),                          // 8: coder.agent.v2.WorkspaceApp
	(*WorkspaceAgentScript)(nil),                  // 9: coder.agent.v2.WorkspaceAgentScript
	(*WorkspaceAgentMetadata)(nil),                // 10: coder.agent.v2.WorkspaceAgentMetadata
	(*Manifest)(nil),                              // 11: coder.agent.v2.Manifest
	(*GetManifestRequest)(nil),                    // 12: coder.agent.v2.GetManifestRequest
	(*ServiceBanner)(nil),                         // 13: coder.agent.v2.ServiceBanner
	(*GetServiceBannerRequest)(nil),               // 14: coder.agent.v2.GetServiceBannerRequest
	(*Stats)(nil),                                 // 15: coder.agent.v2.Stats
	(*UpdateStatsRequest)(nil),                    // 16: coder.agent.v2.UpdateStatsRequest
	(*UpdateStatsResponse)(nil),                   // 17: coder.agent.v2.UpdateStatsResponse
	(*Lifecycle)(nil),                             // 18: coder.agent.v2.Lifecycle
	(*UpdateLifecycleRequest)(nil),                // 19: coder.agent.v2.UpdateLifecycleRequest
	(*BatchUpdateAppHealthRequest)(nil),           // 20: coder.agent.v2.BatchUpdateAppHealthRequest
	(*BatchUpdateAppHealthResponse)(nil),          // 21: coder.agent.v2.BatchUpdateAppHealthResponse
	(*Startup)(nil),                               // 22: coder.agent.v2.Startup
	(*UpdateStartupRequest)(nil),                  // 23: coder.agent.v2.UpdateStartupRequest
	(*Metadata)(nil),                              // 24: coder.agent.v2.Metadata
	(*BatchUpdateMetadataRequest)(nil),            // 25: coder.agent.v2.BatchUpdateMetadataRequest
	(*BatchUpdateMetadataResponse)(nil),           // 26: coder.agent.v2.BatchUpdateMetadataResponse
	(*Log)(nil),                                   // 27: coder.agent.v2.Log
	(*BatchCreateLogsRequest)(nil),                // 28: coder.agent.v2.BatchCreateLogsRequest
	(*BatchCreateLogsResponse)(nil),               // 29: coder.agent.v2.BatchCreateLogsResponse
	(*GetAnnouncementBannersRequest)(nil),         // 30: coder.agent.v2.GetAnnouncementBannersRequest
	(*GetAnnouncementBannersResponse)(nil),        // 31: coder.agent.v2.GetAnnouncementBannersResponse
	(*BannerConfig)(nil),                          // 32: coder.agent.v2.BannerConfig
	(*WorkspaceAgentScriptCompletedRequest)(nil),  // 33: coder.agent.v2.WorkspaceAgentScriptCompletedRequest
	(*WorkspaceAgentScriptCompletedResponse)(nil), // 34: coder.agent.v2.WorkspaceAgentScriptCompletedResponse
	(*Timing)(nil),                                // 35: coder.agent.v2.Timing
	(*WorkspaceApp_Healthcheck)(nil),              // 36: coder.agent.v2.WorkspaceApp.Healthcheck
	(*WorkspaceAgentMetadata_Result)(nil),         // 37: coder.agent.v2.WorkspaceAgentMetadata.Result
	(*WorkspaceAgentMetadata_Description)(nil),    // 38: coder.agent.v2.WorkspaceAgentMetadata.Description
	nil,                        // 39: coder.agent.v2.Manifest.EnvironmentVariablesEntry
	nil,                        // 40: coder.agent.v2.Stats.ConnectionsByProtoEntry
	(*Stats_Metric)(nil),       // 41: coder.agent.v2.Stats.Metric
	(*Stats_Metric_Label)(nil), // 42: coder.agent.v2.Stats.Metric.Label
	(*BatchUpdateAppHealthRequest_HealthUpdate)(nil), // 43: coder.agent.v2.BatchUpdateAppHealthRequest.HealthUpdate
	(*durationpb.Duration)(nil),                      // 44: google.protobuf.Duration
	(*proto.DERPMap)(nil),                            // 45: coder.tailnet.v2.DERPMap
...
var file_agent_proto_agent_proto_depIdxs = []int32{
	...
	36, // 1: coder.agent.v2.WorkspaceApp.healthcheck:type_name -> coder.agent.v2.WorkspaceApp.Healthcheck
	2,  // 2: coder.agent.v2.WorkspaceApp.health:type_name -> coder.agent.v2.WorkspaceApp.Health
	44, // 3: coder.agent.v2.WorkspaceAgentScript.timeout:type_name -> google.protobuf.Duration
	37, // 4: coder.agent.v2.WorkspaceAgentMetadata.result:type_name -> coder.agent.v2.WorkspaceAgentMetadata.Result
	38, // 5: coder.agent.v2.WorkspaceAgentMetadata.description:type_name -> coder.agent.v2.WorkspaceAgentMetadata.Description
	39, // 6: coder.agent.v2.Manifest.environment_variables:type_name -> coder.agent.v2.Manifest.EnvironmentVariablesEntry
	45, // 7: coder.agent.v2.Manifest.derp_map:type_name -> coder.tailnet.v2.DERPMap
	9,  // 8: coder.agent.v2.Manifest.scripts:type_name -> coder.agent.v2.WorkspaceAgentScript
	8,  // 9: coder.agent.v2.Manifest.apps:type_name -> coder.agent.v2.WorkspaceApp
	38, // 10: coder.agent.v2.Manifest.metadata:type_name -> coder.agent.v2.WorkspaceAgentMetadata.Description
	40, // 11: coder.agent.v2.Stats.connections_by_proto:type_name -> coder.agent.v2.Stats.ConnectionsByProtoEntry
	41, // 12: coder.agent.v2.Stats.metrics:type_name -> coder.agent.v2.Stats.Metric
	15, // 13: coder.agent.v2.UpdateStatsRequest.stats:type_name -> coder.agent.v2.Stats
	44, // 14: coder.agent.v2.UpdateStatsResponse.report_interval:type_name -> google.protobuf.Duration
	4,  // 15: coder.agent.v2.Lifecycle.state:type_name -> coder.agent.v2.Lifecycle.State
	46, // 16: coder.agent.v2.Lifecycle.changed_at:type_name -> google.protobuf.Timestamp
	18, // 17: coder.agent.v2.UpdateLifecycleRequest.lifecycle:type_name -> coder.agent.v2.Lifecycle
	43, // 18: coder.agent.v2.BatchUpdateAppHealthRequest.updates:type_name -> coder.agent.v2.BatchUpdateAppHealthRequest.HealthUpdate
	5,  // 19: coder.agent.v2.Startup.subsystems:type_name -> coder.agent.v2.Startup.Subsystem
	22, // 20: coder.agent.v2.UpdateStartupRequest.startup:type_name -> coder.agent.v2.Startup
	37, // 21: coder.agent.v2.Metadata.result:type_name -> coder.agent.v2.WorkspaceAgentMetadata.Result
	24, // 22: coder.agent.v2.BatchUpdateMetadataRequest.metadata:type_name -> coder.agent.v2.Metadata
	46, // 23: coder.agent.v2.Log.created_at:type_name -> google.protobuf.Timestamp
	6,  // 24: coder.agent.v2.Log.level:type_name -> coder.agent.v2.Log.Level
	27, // 25: coder.agent.v2.BatchCreateLogsRequest.logs:type_name -> coder.agent.v2.Log
	32, // 26: coder.agent.v2.GetAnnouncementBannersResponse.announcement_banners:type_name -> coder.agent.v2.BannerConfig
	35, // 27: coder.agent.v2.WorkspaceAgentScriptCompletedRequest.timing:type_name -> coder.agent.v2.Timing
	46, // 28: coder.agent.v2.Timing.start:type_name -> google.protobuf.Timestamp
	46, // 29: coder.agent.v2.Timing.end:type_name -> google.protobuf.Timestamp
	7,  // 30: coder.agent.v2.Timing.stage:type_name -> coder.agent.v2.Timing.Stage
	44, // 31: coder.agent.v2.WorkspaceApp.Healthcheck.interval:type_name -> google.protobuf.Duration
	46, // 32: coder.agent.v2.WorkspaceAgentMetadata.Result.collected_at:type_name -> google.protobuf.Timestamp
	44, // 33: coder.agent.v2.WorkspaceAgentMetadata.Description.interval:type_name -> google.protobuf.Duration
	44, // 34: coder.agent.v2.WorkspaceAgentMetadata.Description.timeout:type_name -> google.protobuf.Duration
	3,  // 35: coder.agent.v2.Stats.Metric.type:type_name -> coder.agent.v2.Stats.Metric.Type
	42, // 36: coder.agent.v2.Stats.Metric.labels:type_name -> coder.agent.v2.Stats.Metric.Label
	0,  // 37: coder.agent.v2.BatchUpdateAppHealthRequest.HealthUpdate.health:type_name -> coder.agent.v2.AppHealth
	12, // 38: coder.agent.v2.Agent.GetManifest:input_type -> coder.agent.v2.GetManifestRequest
	14, // 39: coder.agent.v2.Agent.GetServiceBanner:input_type -> coder.agent.v2.GetServiceBannerRequest
	16, // 40: coder.agent.v2.Agent.UpdateStats:input_type -> coder.agent.v2.UpdateStatsRequest
	19, // 41: coder.agent.v2.Agent.UpdateLifecycle:input_type -> coder.agent.v2.UpdateLifecycleRequest
	20, // 42: coder.agent.v2.Agent.BatchUpdateAppHealths:input_type -> coder.agent.v2.BatchUpdateAppHealthRequest
	23, // 43: coder.agent.v2.Agent.UpdateStartup:input_type -> coder.agent.v2.UpdateStartupRequest
	25, // 44: coder.agent.v2.Agent.BatchUpdateMetadata:input_type -> coder.agent.v2.BatchUpdateMetadataRequest
	28, // 45: coder.agent.v2.Agent.BatchCreateLogs:input_type -> coder.agent.v2.BatchCreateLogsRequest
	30, // 46: coder.agent.v2.Agent.GetAnnouncementBanners:input_type -> coder.agent.v2.GetAnnouncementBannersRequest
	33, // 47: coder.agent.v2.Agent.ScriptCompleted:input_type -> coder.agent.v2.WorkspaceAgentScriptCompletedRequest
	11, // 48: coder.agent.v2.Agent.GetManifest:output_type -> coder.agent.v2.Manifest
	13, // 49: coder.agent.v2.Agent.GetServiceBanner:output_type -> coder.agent.v2.ServiceBanner
	17, // 50: coder.agent.v2.Agent.UpdateStats:output_type -> coder.agent.v2.UpdateStatsResponse
	18, // 51: coder.agent.v2.Agent.UpdateLifecycle:output_type -> coder.agent.v2.Lifecycle
	21, // 52: coder.agent.v2.Agent.BatchUpdateAppHealths:output_type -> coder.agent.v2.BatchUpdateAppHealthResponse
	22, // 53: coder.agent.v2.Agent.UpdateStartup:output_type -> coder.agent.v2.Startup
	26, // 54: coder.agent.v2.Agent.BatchUpdateMetadata:output_type -> coder.agent.v2.BatchUpdateMetadataResponse
	29, // 55: coder.agent.v2.Agent.BatchCreateLogs:output_type -> coder.agent.v2.BatchCreateLogsResponse
	31, // 56: coder.agent.v2.Agent.GetAnnouncementBanners:output_type -> coder.agent.v2.GetAnnouncementBannersResponse
	34, // 57: coder.agent.v2.Agent.ScriptCompleted:output_type -> coder.agent.v2.WorkspaceAgentScriptCompletedResponse
