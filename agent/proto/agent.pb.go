...
type InstructionFileBody struct {
	...
	// global is set for a file that sits directly in the agent's
	// ~/.coder directory, which applies to the whole conversation
	// rather than to a directory tree, whichever scan root reached
	// it.
...
func (x *InstructionFileBody) GetGlobal() bool {
	if x != nil {
		return x.Global
	}
	return false
...
var file_agent_proto_agent_proto_rawDesc = []byte{
	...
	0x11, 0x22, 0x47, 0x0a, 0x13, 0x49, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x6e, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x67, 0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x06, 0x67, 0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x22, 0x59, 0x0a, 0x0d, 0x53, 0x6b,
