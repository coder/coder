...
const file_agent_proto_agent_proto_rawDesc = "" +
	...
	"\atimeout\x18\x05 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\xa7\b\n" +
	"\bManifest\x12\x19\n" +
	...
	"\rdevcontainers\x18\x11 \x03(\v2*.coder.agent.v2.WorkspaceAgentDevcontainerR\rdevcontainers\x129\n" +
	"\asecrets\x18\x13 \x03(\v2\x1f.coder.agent.v2.WorkspaceSecretR\asecrets\x1aG\n" +
	"\x19EnvironmentVariablesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\f\n" +
	"\n" +
	"_parent_id\"_\n" +
	"\x0fWorkspaceSecret\x12\x19\n" +
	"\benv_name\x18\x01 \x01(\tR\aenvName\x12\x1b\n" +
	"\tfile_path\x18\x02 \x01(\tR\bfilePath\x12\x14\n" +
	"\x05value\x18\x03 \x01(\fR\x05value\"\xc2\x01\n" +
	...
	"\vsubagent_id\x18\x05 \x01(\fH\x00R\n" +
	"subagentId\x88\x01\x01B\x0e\n" +
	"\f_subagent_id\"\x14\n" +
	...
	"\n" +
	"auth_token\x18\x03 \x01(\fR\tauthToken\"\xb9\n" +
	"\n" +
	...
	"\fdisplay_apps\x18\x06 \x03(\x0e20.coder.agent.v2.CreateSubAgentRequest.DisplayAppR\vdisplayApps\x12\x13\n" +
	"\x02id\x18\a \x01(\fH\x00R\x02id\x88\x01\x01\x1a\x81\a\n" +
	"\x03App\x12\x12\n" +
	...
	"\x16PORT_FORWARDING_HELPER\x10\x04B\x05\n" +
	"\x03_id\"\x96\x02\n" +
	...
	"\x1aReportBoundaryLogsResponse\"\xe9\x01\n" +
	"\x16UpdateAppStatusRequest\x12\x12\n" +
	"\x04slug\x18\x01 \x01(\tR\x04slug\x12K\n" +
	"\x05state\x18\x02 \x01(\x0e25.coder.agent.v2.UpdateAppStatusRequest.AppStatusStateR\x05state\x12\x18\n" +
	"\amessage\x18\x03 \x01(\tR\amessage\x12\x10\n" +
	"\x03uri\x18\x04 \x01(\tR\x03uri\"B\n" +
	"\x0eAppStatusState\x12\v\n" +
	"\aWORKING\x10\x00\x12\b\n" +
	"\x04IDLE\x10\x01\x12\f\n" +
	"\bCOMPLETE\x10\x02\x12\v\n" +
	"\aFAILURE\x10\x03\"\x19\n" +
	"\x17UpdateAppStatusResponse*c\n" +
	"\tAppHealth\x12\x1a\n" +
	"\x16APP_HEALTH_UNSPECIFIED\x10\x00\x12\f\n" +
	"\bDISABLED\x10\x01\x12\x10\n" +
	"\fINITIALIZING\x10\x02\x12\v\n" +
	"\aHEALTHY\x10\x03\x12\r\n" +
	"\tUNHEALTHY\x10\x042\xe2\x0e\n" +
	"\x05Agent\x12K\n" +
	...
	"\rListSubAgents\x12$.coder.agent.v2.ListSubAgentsRequest\x1a%.coder.agent.v2.ListSubAgentsResponse\x12k\n" +
	"\x12ReportBoundaryLogs\x12).coder.agent.v2.ReportBoundaryLogsRequest\x1a*.coder.agent.v2.ReportBoundaryLogsResponse\x12b\n" +
	"\x0fUpdateAppStatus\x12&.coder.agent.v2.UpdateAppStatusRequest\x1a'.coder.agent.v2.UpdateAppStatusResponseB'Z%github.com/coder/coder/v2/agent/protob\x06proto3"
...
func file_agent_proto_agent_proto_init() {
	...
	file_agent_proto_agent_proto_msgTypes[5].OneofWrappers = []any{}
	file_agent_proto_agent_proto_msgTypes[31].OneofWrappers = []any{}
	file_agent_proto_agent_proto_msgTypes[34].OneofWrappers = []any{}
	file_agent_proto_agent_proto_msgTypes[37].OneofWrappers = []any{}
	file_agent_proto_agent_proto_msgTypes[43].OneofWrappers = []any{
	...
	file_agent_proto_agent_proto_msgTypes[64].OneofWrappers = []any{}
	type x struct{}
