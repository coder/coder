...
const file_agent_proto_agent_proto_rawDesc = "" +
	...
	"\a_memory\"&\n" +
	"$PushResourcesMonitoringUsageResponse\"\x96\x04\n" +
	"\n" +
	"Connection\x12\x0e\n" +
	...
	"\fslug_or_port\x18\b \x01(\tH\x01R\n" +
	"slugOrPort\x88\x01\x01\"=\n" +
	"\x06Action\x12\x16\n" +
	...
	"\x10RECONNECTING_PTY\x10\x04\x12\x11\n" +
	"\rWORKSPACE_APP\x10\x05\x12\x13\n" +
	"\x0fPORT_FORWARDING\x10\x06B\t\n" +
	"\a_reasonB\x0f\n" +
	"\r_slug_or_port\"U\n" +
	...
	"\x12ReportBoundaryLogs\x12).coder.agent.v2.ReportBoundaryLogsRequest\x1a*.coder.agent.v2.ReportBoundaryLogsResponseB'Z%github.com/coder/coder/v2/agent/protob\x06proto3"
