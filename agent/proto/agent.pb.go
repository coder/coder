...
func (x *CreateSubAgentResponse) GetId() []byte {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *CreateSubAgentResponse) GetAuthToken() []byte {
	if x != nil {
		return x.AuthToken
	}
	return nil
...
type ListSubAgentsResponse struct {
	...
	Agents []*ListSubAgentsResponse_SubAgent `protobuf:"bytes,1,rep,name=agents,proto3" json:"agents,omitempty"`
}
...
func (x *ListSubAgentsResponse) GetAgents() []*ListSubAgentsResponse_SubAgent {
	if x != nil {
		return x.Agents
	}
	return nil
...
type ListSubAgentsResponse_SubAgent struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ListSubAgentsResponse_SubAgent) Reset() {
	*x = ListSubAgentsResponse_SubAgent{}
	if protoimpl.UnsafeEnabled {
...
func (x *ListSubAgentsResponse_SubAgent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListSubAgentsResponse_SubAgent) ProtoMessage() {}

func (x *ListSubAgentsResponse_SubAgent) ProtoReflect() protoreflect.Message {
	mi := &file_agent_proto_agent_proto_msgTypes[55]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListSubAgentsResponse_SubAgent.ProtoReflect.Descriptor instead.
func (*ListSubAgentsResponse_SubAgent) Descriptor() ([]byte, []int) {
	return file_agent_proto_agent_proto_rawDescGZIP(), []int{40, 0}
}

func (x *ListSubAgentsResponse_SubAgent) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ListSubAgentsResponse_SubAgent) GetId() []byte {
	if x != nil {
		return x.Id
	}
	return nil
...
var file_agent_proto_agent_proto_rawDesc = []byte{
	...
	0x22, 0x98, 0x01, 0x0a, 0x15, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x53, 0x75, 0x62, 0x41, 0x67,
	...
	0x61, 0x74, 0x69, 0x6e, 0x67, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x22, 0x47, 0x0a, 0x16, 0x43,
	...
	0x6b, 0x65, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x09, 0x61, 0x75, 0x74, 0x68, 0x54,
	0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x27, 0x0a, 0x15, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x53, 0x75,
	...
	0x8f, 0x01, 0x0a, 0x15, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x75, 0x62, 0x41, 0x67, 0x65, 0x6e, 0x74,
	0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x46, 0x0a, 0x06, 0x61, 0x67, 0x65,
	0x6e, 0x74, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x63, 0x6f, 0x64, 0x65,
	...
	0x73, 0x1a, 0x2e, 0x0a, 0x08, 0x53, 0x75, 0x62, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x12, 0x12, 0x0a,
	...
	0x4c, 0x54, 0x48, 0x59, 0x10, 0x04, 0x32, 0x91, 0x0d, 0x0a, 0x05, 0x41, 0x67, 0x65, 0x6e, 0x74,
	...
	0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x5f, 0x0a, 0x0e, 0x43, 0x72,
...
var file_agent_proto_agent_proto_goTypes = []interface{}{
	...
	(*CreateSubAgentRequest)(nil),                       // 46: coder.agent.v2.CreateSubAgentRequest
	(*CreateSubAgentResponse)(nil),                      // 47: coder.agent.v2.CreateSubAgentResponse
	(*DeleteSubAgentRequest)(nil),                       // 48: coder.agent.v2.DeleteSubAgentRequest
	(*DeleteSubAgentResponse)(nil),                      // 49: coder.agent.v2.DeleteSubAgentResponse
	(*ListSubAgentsRequest)(nil),                        // 50: coder.agent.v2.ListSubAgentsRequest
	(*ListSubAgentsResponse)(nil),                       // 51: coder.agent.v2.ListSubAgentsResponse
	...
	(*ListSubAgentsResponse_SubAgent)(nil),                            // 66: coder.agent.v2.ListSubAgentsResponse.SubAgent
...
var file_agent_proto_agent_proto_depIdxs = []int32{
	...
	66, // 41: coder.agent.v2.ListSubAgentsResponse.agents:type_name -> coder.agent.v2.ListSubAgentsResponse.SubAgent
	...
	46, // 65: coder.agent.v2.Agent.CreateSubAgent:input_type -> coder.agent.v2.CreateSubAgentRequest
	48, // 66: coder.agent.v2.Agent.DeleteSubAgent:input_type -> coder.agent.v2.DeleteSubAgentRequest
	50, // 67: coder.agent.v2.Agent.ListSubAgents:input_type -> coder.agent.v2.ListSubAgentsRequest
	...
	47, // 81: coder.agent.v2.Agent.CreateSubAgent:output_type -> coder.agent.v2.CreateSubAgentResponse
	49, // 82: coder.agent.v2.Agent.DeleteSubAgent:output_type -> coder.agent.v2.DeleteSubAgentResponse
	51, // 83: coder.agent.v2.Agent.ListSubAgents:output_type -> coder.agent.v2.ListSubAgentsResponse
...
func file_agent_proto_agent_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_agent_proto_agent_proto_msgTypes[55].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListSubAgentsResponse_SubAgent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
