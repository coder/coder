...
type MCPDiscovery_Phase int32

const (
	// PHASE_UNSPECIFIED means the agent gave no completeness
	// guarantee (legacy agents).
	MCPDiscovery_PHASE_UNSPECIFIED MCPDiscovery_Phase = 0
	// PENDING means the initial MCP reload has not finished; the
	// mcp_server rows in this snapshot may be incomplete.
	MCPDiscovery_PENDING MCPDiscovery_Phase = 1
	// COMPLETE means the initial reload reached a terminal result
	// (success, failure, or zero servers) before this snapshot was
	// resolved. Later reloads update outcomes but never move the
	// phase back for the rest of the process lifetime.
	MCPDiscovery_COMPLETE MCPDiscovery_Phase = 2
)

// Enum value maps for MCPDiscovery_Phase.
var (
	MCPDiscovery_Phase_name = map[int32]string{
		0: "PHASE_UNSPECIFIED",
		1: "PENDING",
		2: "COMPLETE",
	}
	MCPDiscovery_Phase_value = map[string]int32{
		"PHASE_UNSPECIFIED": 0,
		"PENDING":           1,
		"COMPLETE":          2,
	}
...
func (x MCPDiscovery_Phase) Enum() *MCPDiscovery_Phase {
	p := new(MCPDiscovery_Phase)
	*p = x
	return p
}

func (x MCPDiscovery_Phase) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (MCPDiscovery_Phase) Descriptor() protoreflect.EnumDescriptor {
	return file_agent_proto_agent_proto_enumTypes[16].Descriptor()
}

func (MCPDiscovery_Phase) Type() protoreflect.EnumType {
	return &file_agent_proto_agent_proto_enumTypes[16]
}

func (x MCPDiscovery_Phase) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use MCPDiscovery_Phase.Descriptor instead.
func (MCPDiscovery_Phase) EnumDescriptor() ([]byte, []int) {
	return file_agent_proto_agent_proto_rawDescGZIP(), []int{54, 0}
}
...
type Startup struct {
	...
	// agent_run_id identifies the agent process: a UUID generated once
	// per process, stable across RPC reconnects, and different after a
	// process restart. coderd stores it on the agent row so a context
	// snapshot carrying the same id is known to describe the current
	// process. Empty from agents that predate the field.
...
func (x *Startup) GetAgentRunId() string {
	if x != nil {
		return x.AgentRunId
	}
	return ""
...
// MCPDiscovery reports how far the agent's workspace MCP discovery has
// progressed for the process that produced a snapshot. It is
// completeness only: per-server outcomes travel on the mcp_server and
// mcp_config ContextResource rows, and it says nothing about whether a
// later tool invocation will succeed.
type MCPDiscovery struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Phase MCPDiscovery_Phase `protobuf:"varint,1,opt,name=phase,proto3,enum=coder.agent.v2.MCPDiscovery_Phase" json:"phase,omitempty"`
}

func (x *MCPDiscovery) Reset() {
	*x = MCPDiscovery{}
	if protoimpl.UnsafeEnabled {
...
func (x *MCPDiscovery) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MCPDiscovery) ProtoMessage() {}

func (x *MCPDiscovery) ProtoReflect() protoreflect.Message {
	mi := &file_agent_proto_agent_proto_msgTypes[54]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MCPDiscovery.ProtoReflect.Descriptor instead.
func (*MCPDiscovery) Descriptor() ([]byte, []int) {
	return file_agent_proto_agent_proto_rawDescGZIP(), []int{54}
}

func (x *MCPDiscovery) GetPhase() MCPDiscovery_Phase {
	if x != nil {
		return x.Phase
	}
	return MCPDiscovery_PHASE_UNSPECIFIED
}
...
type PushContextStateRequest struct {
	...
	// agent_run_id is the same per-process UUID the agent reports in
	// Startup.agent_run_id. A snapshot is current when it equals the
	// agent row's stored id; coderd ignores a push whose non-empty id
	// differs from the agent row's non-empty id because it describes a
	// previous process. Empty from agents that predate the field.
	AgentRunId string `protobuf:"bytes,7,opt,name=agent_run_id,json=agentRunId,proto3" json:"agent_run_id,omitempty"`
	// mcp_discovery reports MCP discovery completeness for this
	// snapshot. Absent (PHASE_UNSPECIFIED) from legacy agents.
	McpDiscovery *MCPDiscovery `protobuf:"bytes,8,opt,name=mcp_discovery,json=mcpDiscovery,proto3" json:"mcp_discovery,omitempty"`
}
...
func (x *PushContextStateRequest) GetAgentRunId() string {
	if x != nil {
		return x.AgentRunId
	}
	return ""
...
func (x *PushContextStateRequest) GetMcpDiscovery() *MCPDiscovery {
	if x != nil {
		return x.McpDiscovery
	}
	return nil
}
...
var file_agent_proto_agent_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x65, 0x22, 0x8a, 0x02, 0x0a, 0x07, 0x53, 0x74, 0x61, 0x72, 0x74, 0x75, 0x70, 0x12,
	...
	0x0a, 0x73, 0x75, 0x62, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x73, 0x12, 0x20, 0x0a, 0x0c, 0x61,
	0x67, 0x65, 0x6e, 0x74, 0x5f, 0x72, 0x75, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0a, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x52, 0x75, 0x6e, 0x49, 0x64, 0x22, 0x51, 0x0a,
	...
	0x61, 0x22, 0x83, 0x01, 0x0a, 0x0c, 0x4d, 0x43, 0x50, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65,
	0x72, 0x79, 0x12, 0x38, 0x0a, 0x05, 0x70, 0x68, 0x61, 0x73, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x22, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x72, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x2e,
	0x76, 0x32, 0x2e, 0x4d, 0x43, 0x50, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x79, 0x2e,
	0x50, 0x68, 0x61, 0x73, 0x65, 0x52, 0x05, 0x70, 0x68, 0x61, 0x73, 0x65, 0x22, 0x39, 0x0a, 0x05,
	...
	0x50, 0x4c, 0x45, 0x54, 0x45, 0x10, 0x02, 0x22, 0xc5, 0x02, 0x0a, 0x17, 0x50, 0x75, 0x73, 0x68,
	...
	0x72, 0x72, 0x6f, 0x72, 0x12, 0x20, 0x0a, 0x0c, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x5f, 0x72, 0x75,
	0x6e, 0x5f, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x61, 0x67, 0x65, 0x6e,
	0x74, 0x52, 0x75, 0x6e, 0x49, 0x64, 0x12, 0x41, 0x0a, 0x0d, 0x6d, 0x63, 0x70, 0x5f, 0x64, 0x69,
	0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x79, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e,
	0x63, 0x6f, 0x64, 0x65, 0x72, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x2e, 0x76, 0x32, 0x2e, 0x4d,
	0x43, 0x50, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x79, 0x52, 0x0c, 0x6d, 0x63, 0x70,
	0x44, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x79, 0x4a, 0x04, 0x08, 0x05, 0x10, 0x06, 0x22,
...
var file_agent_proto_agent_proto_goTypes = []interface{}{
	...
	(MCPDiscovery_Phase)(0),                             // 16: coder.agent.v2.MCPDiscovery.Phase
	...
	(*MCPDiscovery)(nil),                                // 71: coder.agent.v2.MCPDiscovery
	(*PushContextStateRequest)(nil),                     // 72: coder.agent.v2.PushContextStateRequest
	(*PushContextStateResponse)(nil),                    // 73: coder.agent.v2.PushContextStateResponse
	...
	nil,                        // 80: coder.agent.v2.Stats.SessionCountsEntry
	(*Stats_Metric_Label)(nil), // 81: coder.agent.v2.Stats.Metric.Label
	(*BatchUpdateAppHealthRequest_HealthUpdate)(nil),                  // 82: coder.agent.v2.BatchUpdateAppHealthRequest.HealthUpdate
	(*GetResourcesMonitoringConfigurationResponse_Config)(nil),        // 83: coder.agent.v2.GetResourcesMonitoringConfigurationResponse.Config
	(*GetResourcesMonitoringConfigurationResponse_Memory)(nil),        // 84: coder.agent.v2.GetResourcesMonitoringConfigurationResponse.Memory
	(*GetResourcesMonitoringConfigurationResponse_Volume)(nil),        // 85: coder.agent.v2.GetResourcesMonitoringConfigurationResponse.Volume
	(*PushResourcesMonitoringUsageRequest_Datapoint)(nil),             // 86: coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint
	(*PushResourcesMonitoringUsageRequest_Datapoint_MemoryUsage)(nil), // 87: coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.MemoryUsage
	(*PushResourcesMonitoringUsageRequest_Datapoint_VolumeUsage)(nil), // 88: coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.VolumeUsage
	(*CreateSubAgentRequest_App)(nil),                                 // 89: coder.agent.v2.CreateSubAgentRequest.App
	(*CreateSubAgentRequest_App_Healthcheck)(nil),                     // 90: coder.agent.v2.CreateSubAgentRequest.App.Healthcheck
	(*CreateSubAgentResponse_AppCreationError)(nil),                   // 91: coder.agent.v2.CreateSubAgentResponse.AppCreationError
	(*BoundaryLog_HttpRequest)(nil),                                   // 92: coder.agent.v2.BoundaryLog.HttpRequest
	(*durationpb.Duration)(nil),                                       // 93: google.protobuf.Duration
	(*proto.DERPMap)(nil),                                             // 94: coder.tailnet.v2.DERPMap
...
var file_agent_proto_agent_proto_depIdxs = []int32{
	...
	93, // 3: coder.agent.v2.WorkspaceAgentScript.timeout:type_name -> google.protobuf.Duration
	...
	94, // 7: coder.agent.v2.Manifest.derp_map:type_name -> coder.tailnet.v2.DERPMap
	...
	80, // 15: coder.agent.v2.Stats.session_counts:type_name -> coder.agent.v2.Stats.SessionCountsEntry
	26, // 16: coder.agent.v2.UpdateStatsRequest.stats:type_name -> coder.agent.v2.Stats
	93, // 17: coder.agent.v2.UpdateStatsResponse.report_interval:type_name -> google.protobuf.Duration
	4,  // 18: coder.agent.v2.Lifecycle.state:type_name -> coder.agent.v2.Lifecycle.State
	95, // 19: coder.agent.v2.Lifecycle.changed_at:type_name -> google.protobuf.Timestamp
	29, // 20: coder.agent.v2.UpdateLifecycleRequest.lifecycle:type_name -> coder.agent.v2.Lifecycle
	82, // 21: coder.agent.v2.BatchUpdateAppHealthRequest.updates:type_name -> coder.agent.v2.BatchUpdateAppHealthRequest.HealthUpdate
	...
	95, // 26: coder.agent.v2.Log.created_at:type_name -> google.protobuf.Timestamp
	...
	95, // 31: coder.agent.v2.Timing.start:type_name -> google.protobuf.Timestamp
	95, // 32: coder.agent.v2.Timing.end:type_name -> google.protobuf.Timestamp
	...
	83, // 35: coder.agent.v2.GetResourcesMonitoringConfigurationResponse.config:type_name -> coder.agent.v2.GetResourcesMonitoringConfigurationResponse.Config
	84, // 36: coder.agent.v2.GetResourcesMonitoringConfigurationResponse.memory:type_name -> coder.agent.v2.GetResourcesMonitoringConfigurationResponse.Memory
	85, // 37: coder.agent.v2.GetResourcesMonitoringConfigurationResponse.volumes:type_name -> coder.agent.v2.GetResourcesMonitoringConfigurationResponse.Volume
	86, // 38: coder.agent.v2.PushResourcesMonitoringUsageRequest.datapoints:type_name -> coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint
	...
	95, // 41: coder.agent.v2.Connection.timestamp:type_name -> google.protobuf.Timestamp
	51, // 42: coder.agent.v2.ReportConnectionRequest.connection:type_name -> coder.agent.v2.Connection
	89, // 43: coder.agent.v2.CreateSubAgentRequest.apps:type_name -> coder.agent.v2.CreateSubAgentRequest.App
	...
	91, // 46: coder.agent.v2.CreateSubAgentResponse.app_creation_errors:type_name -> coder.agent.v2.CreateSubAgentResponse.AppCreationError
	53, // 47: coder.agent.v2.ListSubAgentsResponse.agents:type_name -> coder.agent.v2.SubAgent
	95, // 48: coder.agent.v2.BoundaryLog.time:type_name -> google.protobuf.Timestamp
	92, // 49: coder.agent.v2.BoundaryLog.http_request:type_name -> coder.agent.v2.BoundaryLog.HttpRequest
	...
	96, // 58: coder.agent.v2.MCPTool.input_schema:type_name -> google.protobuf.Struct
	16, // 59: coder.agent.v2.MCPDiscovery.phase:type_name -> coder.agent.v2.MCPDiscovery.Phase
	65, // 60: coder.agent.v2.PushContextStateRequest.resources:type_name -> coder.agent.v2.ContextResource
	71, // 61: coder.agent.v2.PushContextStateRequest.mcp_discovery:type_name -> coder.agent.v2.MCPDiscovery
	93, // 62: coder.agent.v2.WorkspaceApp.Healthcheck.interval:type_name -> google.protobuf.Duration
	95, // 63: coder.agent.v2.WorkspaceAgentMetadata.Result.collected_at:type_name -> google.protobuf.Timestamp
	93, // 64: coder.agent.v2.WorkspaceAgentMetadata.Description.interval:type_name -> google.protobuf.Duration
	93, // 65: coder.agent.v2.WorkspaceAgentMetadata.Description.timeout:type_name -> google.protobuf.Duration
	3,  // 66: coder.agent.v2.Stats.Metric.type:type_name -> coder.agent.v2.Stats.Metric.Type
	81, // 67: coder.agent.v2.Stats.Metric.labels:type_name -> coder.agent.v2.Stats.Metric.Label
	0,  // 68: coder.agent.v2.BatchUpdateAppHealthRequest.HealthUpdate.health:type_name -> coder.agent.v2.AppHealth
	95, // 69: coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.collected_at:type_name -> google.protobuf.Timestamp
	87, // 70: coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.memory:type_name -> coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.MemoryUsage
	88, // 71: coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.volumes:type_name -> coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.VolumeUsage
	90, // 72: coder.agent.v2.CreateSubAgentRequest.App.healthcheck:type_name -> coder.agent.v2.CreateSubAgentRequest.App.Healthcheck
	...
	23, // 75: coder.agent.v2.Agent.GetManifest:input_type -> coder.agent.v2.GetManifestRequest
	25, // 76: coder.agent.v2.Agent.GetServiceBanner:input_type -> coder.agent.v2.GetServiceBannerRequest
	27, // 77: coder.agent.v2.Agent.UpdateStats:input_type -> coder.agent.v2.UpdateStatsRequest
	30, // 78: coder.agent.v2.Agent.UpdateLifecycle:input_type -> coder.agent.v2.UpdateLifecycleRequest
	31, // 79: coder.agent.v2.Agent.BatchUpdateAppHealths:input_type -> coder.agent.v2.BatchUpdateAppHealthRequest
	34, // 80: coder.agent.v2.Agent.UpdateStartup:input_type -> coder.agent.v2.UpdateStartupRequest
	36, // 81: coder.agent.v2.Agent.BatchUpdateMetadata:input_type -> coder.agent.v2.BatchUpdateMetadataRequest
	39, // 82: coder.agent.v2.Agent.BatchCreateLogs:input_type -> coder.agent.v2.BatchCreateLogsRequest
	41, // 83: coder.agent.v2.Agent.GetAnnouncementBanners:input_type -> coder.agent.v2.GetAnnouncementBannersRequest
	44, // 84: coder.agent.v2.Agent.ScriptCompleted:input_type -> coder.agent.v2.WorkspaceAgentScriptCompletedRequest
	47, // 85: coder.agent.v2.Agent.GetResourcesMonitoringConfiguration:input_type -> coder.agent.v2.GetResourcesMonitoringConfigurationRequest
	49, // 86: coder.agent.v2.Agent.PushResourcesMonitoringUsage:input_type -> coder.agent.v2.PushResourcesMonitoringUsageRequest
	52, // 87: coder.agent.v2.Agent.ReportConnection:input_type -> coder.agent.v2.ReportConnectionRequest
	54, // 88: coder.agent.v2.Agent.CreateSubAgent:input_type -> coder.agent.v2.CreateSubAgentRequest
	56, // 89: coder.agent.v2.Agent.DeleteSubAgent:input_type -> coder.agent.v2.DeleteSubAgentRequest
	58, // 90: coder.agent.v2.Agent.ListSubAgents:input_type -> coder.agent.v2.ListSubAgentsRequest
	61, // 91: coder.agent.v2.Agent.ReportBoundaryLogs:input_type -> coder.agent.v2.ReportBoundaryLogsRequest
	63, // 92: coder.agent.v2.Agent.UpdateAppStatus:input_type -> coder.agent.v2.UpdateAppStatusRequest
	72, // 93: coder.agent.v2.Agent.PushContextState:input_type -> coder.agent.v2.PushContextStateRequest
	20, // 94: coder.agent.v2.Agent.GetManifest:output_type -> coder.agent.v2.Manifest
	24, // 95: coder.agent.v2.Agent.GetServiceBanner:output_type -> coder.agent.v2.ServiceBanner
	28, // 96: coder.agent.v2.Agent.UpdateStats:output_type -> coder.agent.v2.UpdateStatsResponse
	29, // 97: coder.agent.v2.Agent.UpdateLifecycle:output_type -> coder.agent.v2.Lifecycle
	32, // 98: coder.agent.v2.Agent.BatchUpdateAppHealths:output_type -> coder.agent.v2.BatchUpdateAppHealthResponse
	33, // 99: coder.agent.v2.Agent.UpdateStartup:output_type -> coder.agent.v2.Startup
	37, // 100: coder.agent.v2.Agent.BatchUpdateMetadata:output_type -> coder.agent.v2.BatchUpdateMetadataResponse
	40, // 101: coder.agent.v2.Agent.BatchCreateLogs:output_type -> coder.agent.v2.BatchCreateLogsResponse
	42, // 102: coder.agent.v2.Agent.GetAnnouncementBanners:output_type -> coder.agent.v2.GetAnnouncementBannersResponse
	45, // 103: coder.agent.v2.Agent.ScriptCompleted:output_type -> coder.agent.v2.WorkspaceAgentScriptCompletedResponse
	48, // 104: coder.agent.v2.Agent.GetResourcesMonitoringConfiguration:output_type -> coder.agent.v2.GetResourcesMonitoringConfigurationResponse
	50, // 105: coder.agent.v2.Agent.PushResourcesMonitoringUsage:output_type -> coder.agent.v2.PushResourcesMonitoringUsageResponse
	97, // 106: coder.agent.v2.Agent.ReportConnection:output_type -> google.protobuf.Empty
	55, // 107: coder.agent.v2.Agent.CreateSubAgent:output_type -> coder.agent.v2.CreateSubAgentResponse
	57, // 108: coder.agent.v2.Agent.DeleteSubAgent:output_type -> coder.agent.v2.DeleteSubAgentResponse
	59, // 109: coder.agent.v2.Agent.ListSubAgents:output_type -> coder.agent.v2.ListSubAgentsResponse
	62, // 110: coder.agent.v2.Agent.ReportBoundaryLogs:output_type -> coder.agent.v2.ReportBoundaryLogsResponse
	64, // 111: coder.agent.v2.Agent.UpdateAppStatus:output_type -> coder.agent.v2.UpdateAppStatusResponse
	73, // 112: coder.agent.v2.Agent.PushContextState:output_type -> coder.agent.v2.PushContextStateResponse
