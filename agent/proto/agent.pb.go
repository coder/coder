...
type Stats struct {
	...
	// SessionCounts is the number of sessions per app, keyed by the app
	// identifier reported by the client, normalized at ingestion (e.g.
	// "vscode", "jetbrains", "ssh", "reconnecting_pty"). Replaces the
	// deprecated session_count_* fields.
