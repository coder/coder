...
type PushContextStateRequest struct {
	...
	// mcp_settled reports that the agent's first MCP registration
	// attempt has reached a terminal state (success, failure, or
	// zero configured servers). Absent for legacy agents.
	McpSettled *bool `protobuf:"varint,7,opt,name=mcp_settled,json=mcpSettled,proto3,oneof" json:"mcp_settled,omitempty"`
}
...
func (x *PushContextStateRequest) GetMcpSettled() bool {
	if x != nil && x.McpSettled != nil {
		return *x.McpSettled
	}
	return false
}
...
var file_agent_proto_agent_proto_rawDesc = []byte{
	...
	0x96, 0x02, 0x0a, 0x17, 0x50, 0x75, 0x73, 0x68, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x53,
	...
	0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x24, 0x0a, 0x0b,
	0x6d, 0x63, 0x70, 0x5f, 0x73, 0x65, 0x74, 0x74, 0x6c, 0x65, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28,
	0x08, 0x48, 0x00, 0x52, 0x0a, 0x6d, 0x63, 0x70, 0x53, 0x65, 0x74, 0x74, 0x6c, 0x65, 0x64, 0x88,
	0x01, 0x01, 0x42, 0x0e, 0x0a, 0x0c, 0x5f, 0x6d, 0x63, 0x70, 0x5f, 0x73, 0x65, 0x74, 0x74, 0x6c,
	0x65, 0x64, 0x4a, 0x04, 0x08, 0x05, 0x10, 0x06, 0x22, 0x36, 0x0a, 0x18, 0x50, 0x75, 0x73, 0x68,
	...
	0x54, 0x48, 0x59, 0x10, 0x04, 0x32, 0xc9, 0x0f, 0x0a, 0x05, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x12,
