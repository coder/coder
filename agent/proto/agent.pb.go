...
const (
	...
	Connection_FILE_TRANSFER    Connection_Type = 5
)
...
type FileTransferOperation_Protocol int32

const (
	FileTransferOperation_PROTOCOL_UNSPECIFIED FileTransferOperation_Protocol = 0
	FileTransferOperation_SFTP                 FileTransferOperation_Protocol = 1
	FileTransferOperation_SCP                  FileTransferOperation_Protocol = 2
	FileTransferOperation_RSYNC                FileTransferOperation_Protocol = 3
)

// Enum value maps for FileTransferOperation_Protocol.
var (
	FileTransferOperation_Protocol_name = map[int32]string{
		0: "PROTOCOL_UNSPECIFIED",
		1: "SFTP",
		2: "SCP",
		3: "RSYNC",
	}
	FileTransferOperation_Protocol_value = map[string]int32{
...
func (x FileTransferOperation_Protocol) Enum() *FileTransferOperation_Protocol {
	p := new(FileTransferOperation_Protocol)
	*p = x
	return p
}

func (x FileTransferOperation_Protocol) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (FileTransferOperation_Protocol) Descriptor() protoreflect.EnumDescriptor {
	return file_agent_proto_agent_proto_enumTypes[11].Descriptor()
}

func (FileTransferOperation_Protocol) Type() protoreflect.EnumType {
	return &file_agent_proto_agent_proto_enumTypes[11]
}

func (x FileTransferOperation_Protocol) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use FileTransferOperation_Protocol.Descriptor instead.
func (FileTransferOperation_Protocol) EnumDescriptor() ([]byte, []int) {
	return file_agent_proto_agent_proto_rawDescGZIP(), []int{36, 0}
}

type FileTransferOperation_Action int32

const (
	FileTransferOperation_ACTION_UNSPECIFIED FileTransferOperation_Action = 0
	FileTransferOperation_DOWNLOAD           FileTransferOperation_Action = 1
	FileTransferOperation_UPLOAD             FileTransferOperation_Action = 2
	FileTransferOperation_BIDIRECTIONAL      FileTransferOperation_Action = 3
	FileTransferOperation_MKDIR              FileTransferOperation_Action = 4
	FileTransferOperation_REMOVE             FileTransferOperation_Action = 5
	FileTransferOperation_RMDIR              FileTransferOperation_Action = 6
	FileTransferOperation_RENAME             FileTransferOperation_Action = 7
	FileTransferOperation_SYMLINK            FileTransferOperation_Action = 8
	FileTransferOperation_SETATTR            FileTransferOperation_Action = 9
	FileTransferOperation_HARDLINK           FileTransferOperation_Action = 10
)

// Enum value maps for FileTransferOperation_Action.
var (
	FileTransferOperation_Action_name = map[int32]string{
		0:  "ACTION_UNSPECIFIED",
		1:  "DOWNLOAD",
		2:  "UPLOAD",
		3:  "BIDIRECTIONAL",
	...
	FileTransferOperation_Action_value = map[string]int32{
		"ACTION_UNSPECIFIED": 0,
		"DOWNLOAD":           1,
		"UPLOAD":             2,
		"BIDIRECTIONAL":      3,
...
func (x FileTransferOperation_Action) Enum() *FileTransferOperation_Action {
	p := new(FileTransferOperation_Action)
	*p = x
	return p
}

func (x FileTransferOperation_Action) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (FileTransferOperation_Action) Descriptor() protoreflect.EnumDescriptor {
	return file_agent_proto_agent_proto_enumTypes[12].Descriptor()
}

func (FileTransferOperation_Action) Type() protoreflect.EnumType {
	return &file_agent_proto_agent_proto_enumTypes[12]
}

func (x FileTransferOperation_Action) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use FileTransferOperation_Action.Descriptor instead.
func (FileTransferOperation_Action) EnumDescriptor() ([]byte, []int) {
...
func (ContextResource_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_agent_proto_agent_proto_enumTypes[17].Descriptor()
}

func (ContextResource_Status) Type() protoreflect.EnumType {
	return &file_agent_proto_agent_proto_enumTypes[17]
}
...
// FileTransferOperation is a single observed file operation within a
// file-transfer session (SFTP, SCP, or rsync). The connection_id matches
// the id of the Connection report for the session so operations can be
// grouped with it in the connection log.
type FileTransferOperation struct {
	...
	Protocol     FileTransferOperation_Protocol `protobuf:"varint,2,opt,name=protocol,proto3,enum=coder.agent.v2.FileTransferOperation_Protocol" json:"protocol,omitempty"`
	Action       FileTransferOperation_Action   `protobuf:"varint,3,opt,name=action,proto3,enum=coder.agent.v2.FileTransferOperation_Action" json:"action,omitempty"`
	Path         string                         `protobuf:"bytes,4,opt,name=path,proto3" json:"path,omitempty"`
	// target is the second path for operations that have one, such as the
...
func (x *FileTransferOperation) Reset() {
	*x = FileTransferOperation{}
	if protoimpl.UnsafeEnabled {
...
func (x *FileTransferOperation) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FileTransferOperation) ProtoMessage() {}

func (x *FileTransferOperation) ProtoReflect() protoreflect.Message {
	mi := &file_agent_proto_agent_proto_msgTypes[36]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FileTransferOperation.ProtoReflect.Descriptor instead.
func (*FileTransferOperation) Descriptor() ([]byte, []int) {
	return file_agent_proto_agent_proto_rawDescGZIP(), []int{36}
}

func (x *FileTransferOperation) GetConnectionId() []byte {
	if x != nil {
...
func (x *FileTransferOperation) GetProtocol() FileTransferOperation_Protocol {
	if x != nil {
		return x.Protocol
	}
	return FileTransferOperation_PROTOCOL_UNSPECIFIED
}

func (x *FileTransferOperation) GetAction() FileTransferOperation_Action {
	if x != nil {
		return x.Action
	}
	return FileTransferOperation_ACTION_UNSPECIFIED
}

func (x *FileTransferOperation) GetPath() string {
	if x != nil {
		return x.Path
	}
	return ""
...
func (x *FileTransferOperation) GetTarget() string {
...
func (x *FileTransferOperation) GetTimestamp() *timestamppb.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
type ReportFileOperationsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Operations []*FileTransferOperation `protobuf:"bytes,1,rep,name=operations,proto3" json:"operations,omitempty"`
}

func (x *ReportFileOperationsRequest) Reset() {
	*x = ReportFileOperationsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ReportFileOperationsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReportFileOperationsRequest) ProtoMessage() {}

func (x *ReportFileOperationsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_agent_proto_agent_proto_msgTypes[37]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReportFileOperationsRequest.ProtoReflect.Descriptor instead.
func (*ReportFileOperationsRequest) Descriptor() ([]byte, []int) {
	return file_agent_proto_agent_proto_rawDescGZIP(), []int{37}
}

func (x *ReportFileOperationsRequest) GetOperations() []*FileTransferOperation {
	if x != nil {
		return x.Operations
	}
	return nil
...
type ReportFileOperationsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *ReportFileOperationsResponse) Reset() {
	*x = ReportFileOperationsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ReportFileOperationsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReportFileOperationsResponse) ProtoMessage() {}

func (x *ReportFileOperationsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_agent_proto_agent_proto_msgTypes[38]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReportFileOperationsResponse.ProtoReflect.Descriptor instead.
func (*ReportFileOperationsResponse) Descriptor() ([]byte, []int) {
...
var file_agent_proto_agent_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x22, 0xc9, 0x03, 0x0a, 0x0a, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f,
	...
	0x4f, 0x4e, 0x4e, 0x45, 0x43, 0x54, 0x10, 0x02, 0x22, 0x69, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65,
	...
	0x52, 0x10, 0x05, 0x42, 0x09, 0x0a, 0x07, 0x5f, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x22, 0x55,
	...
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xae, 0x04, 0x0a, 0x15, 0x46, 0x69, 0x6c, 0x65, 0x54, 0x72,
	...
	,
	...
	,
	...
	0x72, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x22, 0x0a, 0x0c, 0x61, 0x72, 0x63, 0x68, 0x69,
	...
	0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x12, 0x3d, 0x0a, 0x04, 0x61, 0x70, 0x70, 0x73, 0x18, 0x05,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x72, 0x2e, 0x61, 0x67, 0x65,
	0x6e, 0x74, 0x2e, 0x76, 0x32, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x53, 0x75, 0x62, 0x41,
	0x67, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x41, 0x70, 0x70, 0x52,
	0x04, 0x61, 0x70, 0x70, 0x73, 0x12, 0x53, 0x0a, 0x0c, 0x64, 0x69, 0x73, 0x70, 0x6c, 0x61, 0x79,
	0x5f, 0x61, 0x70, 0x70, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0e, 0x32, 0x30, 0x2e, 0x63, 0x6f,
	...
	0x73, 0x74, 0x2e, 0x44, 0x69, 0x73, 0x70, 0x6c, 0x61, 0x79, 0x41, 0x70, 0x70, 0x52, 0x0b, 0x64,
	0x69, 0x73, 0x70, 0x6c, 0x61, 0x79, 0x41, 0x70, 0x70, 0x73, 0x12, 0x13, 0x0a, 0x02, 0x69, 0x64,
	0x18, 0x07, 0x20, 0x01, 0x28, 0x0c, 0x48, 0x00, 0x52, 0x02, 0x69, 0x64, 0x88, 0x01, 0x01, 0x1a,
	0x81, 0x07, 0x0a, 0x03, 0x41, 0x70, 0x70, 0x12, 0x12, 0x0a, 0x04, 0x73, 0x6c, 0x75, 0x67, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x73, 0x6c, 0x75, 0x67, 0x12, 0x1d, 0x0a, 0x07, 0x63,
	0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x07,
	0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x88, 0x01, 0x01, 0x12, 0x26, 0x0a, 0x0c, 0x64, 0x69,
	...
	,
	...
	0x65, 0x73, 0x74, 0x2e, 0x41, 0x70, 0x70, 0x2e, 0x53, 0x68, 0x61, 0x72, 0x69, 0x6e, 0x67, 0x4c,
	0x65, 0x76, 0x65, 0x6c, 0x48, 0x09, 0x52, 0x05, 0x73, 0x68, 0x61, 0x72, 0x65, 0x88, 0x01, 0x01,
	0x12, 0x21, 0x0a, 0x09, 0x73, 0x75, 0x62, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x18, 0x0c, 0x20,
	0x01, 0x28, 0x08, 0x48, 0x0a, 0x52, 0x09, 0x73, 0x75, 0x62, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e,
	0x88, 0x01, 0x01, 0x12, 0x15, 0x0a, 0x03, 0x75, 0x72, 0x6c, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x09,
	0x48, 0x0b, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x88, 0x01, 0x01, 0x1a, 0x59, 0x0a, 0x0b, 0x48, 0x65,
	0x61, 0x6c, 0x74, 0x68, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x12, 0x1a, 0x0a, 0x08, 0x69, 0x6e, 0x74,
	...
	0x6f, 0x6c, 0x64, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x72, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x03, 0x75, 0x72, 0x6c, 0x22, 0x22, 0x0a, 0x06, 0x4f, 0x70, 0x65, 0x6e, 0x49, 0x6e, 0x12,
	0x0f, 0x0a, 0x0b, 0x53, 0x4c, 0x49, 0x4d, 0x5f, 0x57, 0x49, 0x4e, 0x44, 0x4f, 0x57, 0x10, 0x00,
	0x12, 0x07, 0x0a, 0x03, 0x54, 0x41, 0x42, 0x10, 0x01, 0x22, 0x4a, 0x0a, 0x0c, 0x53, 0x68, 0x61,
	...
	,
	...
	,
	...
	0x6e, 0x74, 0x2e, 0x76, 0x32, 0x2e, 0x53, 0x75, 0x62, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x52, 0x06,
	0x61, 0x67, 0x65, 0x6e, 0x74, 0x73, 0x22, 0xb6, 0x02, 0x0a, 0x0b, 0x42, 0x6f, 0x75, 0x6e, 0x64,
	...
	0x12, 0x4c, 0x0a, 0x0c, 0x68, 0x74, 0x74, 0x70, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x72, 0x2e, 0x61,
	0x67, 0x65, 0x6e, 0x74, 0x2e, 0x76, 0x32, 0x2e, 0x42, 0x6f, 0x75, 0x6e, 0x64, 0x61, 0x72, 0x79,
	0x4c, 0x6f, 0x67, 0x2e, 0x48, 0x74, 0x74, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x48,
	...
	0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0e, 0x73, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63,
	0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x1a, 0x5a, 0x0a, 0x0b, 0x48, 0x74, 0x74, 0x70, 0x52,
	...
	0x12, 0x21, 0x0a, 0x0c, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x64, 0x5f, 0x72, 0x75, 0x6c, 0x65,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x64, 0x52,
	0x75, 0x6c, 0x65, 0x42, 0x0a, 0x0a, 0x08, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x22,
	0x9f, 0x01, 0x0a, 0x19, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x42, 0x6f, 0x75, 0x6e, 0x64, 0x61,
	...
	0x6e, 0x64, 0x61, 0x72, 0x79, 0x4c, 0x6f, 0x67, 0x52, 0x04, 0x6c, 0x6f, 0x67, 0x73, 0x12, 0x1d,
	...
	0x15, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x6e, 0x65, 0x64, 0x5f, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x73,
	0x73, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x13, 0x63, 0x6f,
	0x6e, 0x66, 0x69, 0x6e, 0x65, 0x64, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x4e, 0x61, 0x6d,
	0x65, 0x22, 0x1c, 0x0a, 0x1a, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x42, 0x6f, 0x75, 0x6e, 0x64,
	0x61, 0x72, 0x79, 0x4c, 0x6f, 0x67, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22,
	0xe9, 0x01, 0x0a, 0x16, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x41, 0x70, 0x70, 0x53, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x73, 0x6c,
	...
	,
	...
	,
	...
	0x43, 0x50, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x42, 0x6f, 0x64, 0x79, 0x48, 0x00, 0x52, 0x09,
	0x6d, 0x63, 0x70, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x3e, 0x0a, 0x0a, 0x6d, 0x63, 0x70,
	0x5f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e,
	0x63, 0x6f, 0x64, 0x65, 0x72, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x2e, 0x76, 0x32, 0x2e, 0x4d,
	0x43, 0x50, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x42, 0x6f, 0x64, 0x79, 0x48, 0x00, 0x52, 0x09,
	0x6d, 0x63, 0x70, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x22, 0x61, 0x0a, 0x06, 0x53, 0x74, 0x61,
	...
	,
	...
	0x64, 0x2a, 0x63, 0x0a, 0x09, 0x41, 0x70, 0x70, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x12, 0x1a,
	...
	0x4c, 0x54, 0x48, 0x59, 0x10, 0x04, 0x32, 0xbc, 0x10, 0x0a, 0x05, 0x41, 0x67, 0x65, 0x6e, 0x74,
	...
	0x77, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x41, 0x6e, 0x6e, 0x6f, 0x75, 0x6e, 0x63, 0x65, 0x6d, 0x65,
	0x6e, 0x74, 0x42, 0x61, 0x6e, 0x6e, 0x65, 0x72, 0x73, 0x12, 0x2d, 0x2e, 0x63, 0x6f, 0x64, 0x65,
	...
	0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2e, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x72,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x7e, 0x0a, 0x0f, 0x53, 0x63, 0x72, 0x69,
	0x70, 0x74, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x12, 0x34, 0x2e, 0x63, 0x6f,
	...
	0x74, 0x1a, 0x35, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x72, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x2e,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x9e, 0x01, 0x0a, 0x23, 0x47, 0x65, 0x74,
	...
	0x12, 0x3a, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x72, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x2e, 0x76,
	...
	0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x89, 0x01, 0x0a, 0x1c, 0x50, 0x75,
	0x73, 0x68, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x4d, 0x6f, 0x6e, 0x69, 0x74,
	0x6f, 0x72, 0x69, 0x6e, 0x67, 0x55, 0x73, 0x61, 0x67, 0x65, 0x12, 0x33, 0x2e, 0x63, 0x6f, 0x64,
	...
	0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x71, 0x0a, 0x14, 0x52, 0x65,
	0x70, 0x6f, 0x72, 0x74, 0x46, 0x69, 0x6c, 0x65, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x73, 0x12, 0x2b, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x72, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74,
	0x2e, 0x76, 0x32, 0x2e, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x46, 0x69, 0x6c, 0x65, 0x4f, 0x70,
	...
	0x2e, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x46, 0x69, 0x6c, 0x65, 0x4f, 0x70, 0x65, 0x72, 0x61,
...
var file_agent_proto_agent_proto_enumTypes = make([]protoimpl.EnumInfo, 18)
var file_agent_proto_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 77)
var file_agent_proto_agent_proto_goTypes = []interface{}{
	...
	(FileTransferOperation_Protocol)(0),                 // 11: coder.agent.v2.FileTransferOperation.Protocol
	(FileTransferOperation_Action)(0),                   // 12: coder.agent.v2.FileTransferOperation.Action
	(CreateSubAgentRequest_DisplayApp)(0),               // 13: coder.agent.v2.CreateSubAgentRequest.DisplayApp
	(CreateSubAgentRequest_App_OpenIn)(0),               // 14: coder.agent.v2.CreateSubAgentRequest.App.OpenIn
	(CreateSubAgentRequest_App_SharingLevel)(0),         // 15: coder.agent.v2.CreateSubAgentRequest.App.SharingLevel
	(UpdateAppStatusRequest_AppStatusState)(0),          // 16: coder.agent.v2.UpdateAppStatusRequest.AppStatusState
	(ContextResource_Status)(0),                         // 17: coder.agent.v2.ContextResource.Status
	(*WorkspaceApp)(nil),                                // 18: coder.agent.v2.WorkspaceApp
	(*WorkspaceAgentScript)(nil),                        // 19: coder.agent.v2.WorkspaceAgentScript
	(*WorkspaceAgentMetadata)(nil),                      // 20: coder.agent.v2.WorkspaceAgentMetadata
	(*Manifest)(nil),                                    // 21: coder.agent.v2.Manifest
	(*WorkspaceSecret)(nil),                             // 22: coder.agent.v2.WorkspaceSecret
	(*WorkspaceAgentDevcontainer)(nil),                  // 23: coder.agent.v2.WorkspaceAgentDevcontainer
	(*GetManifestRequest)(nil),                          // 24: coder.agent.v2.GetManifestRequest
	(*ServiceBanner)(nil),                               // 25: coder.agent.v2.ServiceBanner
	(*GetServiceBannerRequest)(nil),                     // 26: coder.agent.v2.GetServiceBannerRequest
	(*Stats)(nil),                                       // 27: coder.agent.v2.Stats
	(*UpdateStatsRequest)(nil),                          // 28: coder.agent.v2.UpdateStatsRequest
	(*UpdateStatsResponse)(nil),                         // 29: coder.agent.v2.UpdateStatsResponse
	(*Lifecycle)(nil),                                   // 30: coder.agent.v2.Lifecycle
	(*UpdateLifecycleRequest)(nil),                      // 31: coder.agent.v2.UpdateLifecycleRequest
	(*BatchUpdateAppHealthRequest)(nil),                 // 32: coder.agent.v2.BatchUpdateAppHealthRequest
	(*BatchUpdateAppHealthResponse)(nil),                // 33: coder.agent.v2.BatchUpdateAppHealthResponse
	(*Startup)(nil),                                     // 34: coder.agent.v2.Startup
	(*UpdateStartupRequest)(nil),                        // 35: coder.agent.v2.UpdateStartupRequest
	(*Metadata)(nil),                                    // 36: coder.agent.v2.Metadata
	(*BatchUpdateMetadataRequest)(nil),                  // 37: coder.agent.v2.BatchUpdateMetadataRequest
	(*BatchUpdateMetadataResponse)(nil),                 // 38: coder.agent.v2.BatchUpdateMetadataResponse
	(*Log)(nil),                                         // 39: coder.agent.v2.Log
	(*BatchCreateLogsRequest)(nil),                      // 40: coder.agent.v2.BatchCreateLogsRequest
	(*BatchCreateLogsResponse)(nil),                     // 41: coder.agent.v2.BatchCreateLogsResponse
	(*GetAnnouncementBannersRequest)(nil),               // 42: coder.agent.v2.GetAnnouncementBannersRequest
	(*GetAnnouncementBannersResponse)(nil),              // 43: coder.agent.v2.GetAnnouncementBannersResponse
	(*BannerConfig)(nil),                                // 44: coder.agent.v2.BannerConfig
	(*WorkspaceAgentScriptCompletedRequest)(nil),        // 45: coder.agent.v2.WorkspaceAgentScriptCompletedRequest
	(*WorkspaceAgentScriptCompletedResponse)(nil),       // 46: coder.agent.v2.WorkspaceAgentScriptCompletedResponse
	(*Timing)(nil),                                      // 47: coder.agent.v2.Timing
	(*GetResourcesMonitoringConfigurationRequest)(nil),  // 48: coder.agent.v2.GetResourcesMonitoringConfigurationRequest
	(*GetResourcesMonitoringConfigurationResponse)(nil), // 49: coder.agent.v2.GetResourcesMonitoringConfigurationResponse
	(*PushResourcesMonitoringUsageRequest)(nil),         // 50: coder.agent.v2.PushResourcesMonitoringUsageRequest
	(*PushResourcesMonitoringUsageResponse)(nil),        // 51: coder.agent.v2.PushResourcesMonitoringUsageResponse
	(*Connection)(nil),                                  // 52: coder.agent.v2.Connection
	(*ReportConnectionRequest)(nil),                     // 53: coder.agent.v2.ReportConnectionRequest
	(*FileTransferOperation)(nil),                       // 54: coder.agent.v2.FileTransferOperation
	(*ReportFileOperationsRequest)(nil),                 // 55: coder.agent.v2.ReportFileOperationsRequest
	(*ReportFileOperationsResponse)(nil),                // 56: coder.agent.v2.ReportFileOperationsResponse
	(*SubAgent)(nil),                                    // 57: coder.agent.v2.SubAgent
	(*CreateSubAgentRequest)(nil),                       // 58: coder.agent.v2.CreateSubAgentRequest
	(*CreateSubAgentResponse)(nil),                      // 59: coder.agent.v2.CreateSubAgentResponse
	(*DeleteSubAgentRequest)(nil),                       // 60: coder.agent.v2.DeleteSubAgentRequest
	(*DeleteSubAgentResponse)(nil),                      // 61: coder.agent.v2.DeleteSubAgentResponse
	(*ListSubAgentsRequest)(nil),                        // 62: coder.agent.v2.ListSubAgentsRequest
	(*ListSubAgentsResponse)(nil),                       // 63: coder.agent.v2.ListSubAgentsResponse
	(*BoundaryLog)(nil),                                 // 64: coder.agent.v2.BoundaryLog
	(*ReportBoundaryLogsRequest)(nil),                   // 65: coder.agent.v2.ReportBoundaryLogsRequest
	(*ReportBoundaryLogsResponse)(nil),                  // 66: coder.agent.v2.ReportBoundaryLogsResponse
	(*UpdateAppStatusRequest)(nil),                      // 67: coder.agent.v2.UpdateAppStatusRequest
	(*UpdateAppStatusResponse)(nil),                     // 68: coder.agent.v2.UpdateAppStatusResponse
	(*ContextResource)(nil),                             // 69: coder.agent.v2.ContextResource
	(*InstructionFileBody)(nil),                         // 70: coder.agent.v2.InstructionFileBody
	(*SkillMetaBody)(nil),                               // 71: coder.agent.v2.SkillMetaBody
	(*MCPConfigBody)(nil),                               // 72: coder.agent.v2.MCPConfigBody
	(*MCPServerBody)(nil),                               // 73: coder.agent.v2.MCPServerBody
	(*MCPTool)(nil),                                     // 74: coder.agent.v2.MCPTool
	(*PushContextStateRequest)(nil),                     // 75: coder.agent.v2.PushContextStateRequest
	(*PushContextStateResponse)(nil),                    // 76: coder.agent.v2.PushContextStateResponse
	(*WorkspaceApp_Healthcheck)(nil),                    // 77: coder.agent.v2.WorkspaceApp.Healthcheck
	(*WorkspaceAgentMetadata_Result)(nil),               // 78: coder.agent.v2.WorkspaceAgentMetadata.Result
	(*WorkspaceAgentMetadata_Description)(nil),          // 79: coder.agent.v2.WorkspaceAgentMetadata.Description
	nil,                        // 80: coder.agent.v2.Manifest.EnvironmentVariablesEntry
	nil,                        // 81: coder.agent.v2.Stats.ConnectionsByProtoEntry
	(*Stats_Metric)(nil),       // 82: coder.agent.v2.Stats.Metric
	(*Stats_Metric_Label)(nil), // 83: coder.agent.v2.Stats.Metric.Label
	(*BatchUpdateAppHealthRequest_HealthUpdate)(nil),                  // 84: coder.agent.v2.BatchUpdateAppHealthRequest.HealthUpdate
	(*GetResourcesMonitoringConfigurationResponse_Config)(nil),        // 85: coder.agent.v2.GetResourcesMonitoringConfigurationResponse.Config
	(*GetResourcesMonitoringConfigurationResponse_Memory)(nil),        // 86: coder.agent.v2.GetResourcesMonitoringConfigurationResponse.Memory
	(*GetResourcesMonitoringConfigurationResponse_Volume)(nil),        // 87: coder.agent.v2.GetResourcesMonitoringConfigurationResponse.Volume
	(*PushResourcesMonitoringUsageRequest_Datapoint)(nil),             // 88: coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint
	(*PushResourcesMonitoringUsageRequest_Datapoint_MemoryUsage)(nil), // 89: coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.MemoryUsage
	(*PushResourcesMonitoringUsageRequest_Datapoint_VolumeUsage)(nil), // 90: coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.VolumeUsage
	(*CreateSubAgentRequest_App)(nil),                                 // 91: coder.agent.v2.CreateSubAgentRequest.App
	(*CreateSubAgentRequest_App_Healthcheck)(nil),                     // 92: coder.agent.v2.CreateSubAgentRequest.App.Healthcheck
	(*CreateSubAgentResponse_AppCreationError)(nil),                   // 93: coder.agent.v2.CreateSubAgentResponse.AppCreationError
	(*BoundaryLog_HttpRequest)(nil),                                   // 94: coder.agent.v2.BoundaryLog.HttpRequest
	(*durationpb.Duration)(nil),                                       // 95: google.protobuf.Duration
	(*proto.DERPMap)(nil),                                             // 96: coder.tailnet.v2.DERPMap
...
var file_agent_proto_agent_proto_depIdxs = []int32{
	...
	77, // 1: coder.agent.v2.WorkspaceApp.healthcheck:type_name -> coder.agent.v2.WorkspaceApp.Healthcheck
	2,  // 2: coder.agent.v2.WorkspaceApp.health:type_name -> coder.agent.v2.WorkspaceApp.Health
	95, // 3: coder.agent.v2.WorkspaceAgentScript.timeout:type_name -> google.protobuf.Duration
	78, // 4: coder.agent.v2.WorkspaceAgentMetadata.result:type_name -> coder.agent.v2.WorkspaceAgentMetadata.Result
	79, // 5: coder.agent.v2.WorkspaceAgentMetadata.description:type_name -> coder.agent.v2.WorkspaceAgentMetadata.Description
	80, // 6: coder.agent.v2.Manifest.environment_variables:type_name -> coder.agent.v2.Manifest.EnvironmentVariablesEntry
	96, // 7: coder.agent.v2.Manifest.derp_map:type_name -> coder.tailnet.v2.DERPMap
	19, // 8: coder.agent.v2.Manifest.scripts:type_name -> coder.agent.v2.WorkspaceAgentScript
	18, // 9: coder.agent.v2.Manifest.apps:type_name -> coder.agent.v2.WorkspaceApp
	79, // 10: coder.agent.v2.Manifest.metadata:type_name -> coder.agent.v2.WorkspaceAgentMetadata.Description
	23, // 11: coder.agent.v2.Manifest.devcontainers:type_name -> coder.agent.v2.WorkspaceAgentDevcontainer
	22, // 12: coder.agent.v2.Manifest.secrets:type_name -> coder.agent.v2.WorkspaceSecret
	81, // 13: coder.agent.v2.Stats.connections_by_proto:type_name -> coder.agent.v2.Stats.ConnectionsByProtoEntry
	82, // 14: coder.agent.v2.Stats.metrics:type_name -> coder.agent.v2.Stats.Metric
	27, // 15: coder.agent.v2.UpdateStatsRequest.stats:type_name -> coder.agent.v2.Stats
	95, // 16: coder.agent.v2.UpdateStatsResponse.report_interval:type_name -> google.protobuf.Duration
	4,  // 17: coder.agent.v2.Lifecycle.state:type_name -> coder.agent.v2.Lifecycle.State
	97, // 18: coder.agent.v2.Lifecycle.changed_at:type_name -> google.protobuf.Timestamp
	30, // 19: coder.agent.v2.UpdateLifecycleRequest.lifecycle:type_name -> coder.agent.v2.Lifecycle
	84, // 20: coder.agent.v2.BatchUpdateAppHealthRequest.updates:type_name -> coder.agent.v2.BatchUpdateAppHealthRequest.HealthUpdate
	5,  // 21: coder.agent.v2.Startup.subsystems:type_name -> coder.agent.v2.Startup.Subsystem
	34, // 22: coder.agent.v2.UpdateStartupRequest.startup:type_name -> coder.agent.v2.Startup
	78, // 23: coder.agent.v2.Metadata.result:type_name -> coder.agent.v2.WorkspaceAgentMetadata.Result
	36, // 24: coder.agent.v2.BatchUpdateMetadataRequest.metadata:type_name -> coder.agent.v2.Metadata
	97, // 25: coder.agent.v2.Log.created_at:type_name -> google.protobuf.Timestamp
	6,  // 26: coder.agent.v2.Log.level:type_name -> coder.agent.v2.Log.Level
	39, // 27: coder.agent.v2.BatchCreateLogsRequest.logs:type_name -> coder.agent.v2.Log
	44, // 28: coder.agent.v2.GetAnnouncementBannersResponse.announcement_banners:type_name -> coder.agent.v2.BannerConfig
	47, // 29: coder.agent.v2.WorkspaceAgentScriptCompletedRequest.timing:type_name -> coder.agent.v2.Timing
	97, // 30: coder.agent.v2.Timing.start:type_name -> google.protobuf.Timestamp
	97, // 31: coder.agent.v2.Timing.end:type_name -> google.protobuf.Timestamp
	...
	85, // 34: coder.agent.v2.GetResourcesMonitoringConfigurationResponse.config:type_name -> coder.agent.v2.GetResourcesMonitoringConfigurationResponse.Config
	86, // 35: coder.agent.v2.GetResourcesMonitoringConfigurationResponse.memory:type_name -> coder.agent.v2.GetResourcesMonitoringConfigurationResponse.Memory
	87, // 36: coder.agent.v2.GetResourcesMonitoringConfigurationResponse.volumes:type_name -> coder.agent.v2.GetResourcesMonitoringConfigurationResponse.Volume
	88, // 37: coder.agent.v2.PushResourcesMonitoringUsageRequest.datapoints:type_name -> coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint
	...
	97, // 40: coder.agent.v2.Connection.timestamp:type_name -> google.protobuf.Timestamp
	52, // 41: coder.agent.v2.ReportConnectionRequest.connection:type_name -> coder.agent.v2.Connection
	11, // 42: coder.agent.v2.FileTransferOperation.protocol:type_name -> coder.agent.v2.FileTransferOperation.Protocol
	12, // 43: coder.agent.v2.FileTransferOperation.action:type_name -> coder.agent.v2.FileTransferOperation.Action
	97, // 44: coder.agent.v2.FileTransferOperation.timestamp:type_name -> google.protobuf.Timestamp
	54, // 45: coder.agent.v2.ReportFileOperationsRequest.operations:type_name -> coder.agent.v2.FileTransferOperation
	91, // 46: coder.agent.v2.CreateSubAgentRequest.apps:type_name -> coder.agent.v2.CreateSubAgentRequest.App
	13, // 47: coder.agent.v2.CreateSubAgentRequest.display_apps:type_name -> coder.agent.v2.CreateSubAgentRequest.DisplayApp
	57, // 48: coder.agent.v2.CreateSubAgentResponse.agent:type_name -> coder.agent.v2.SubAgent
	93, // 49: coder.agent.v2.CreateSubAgentResponse.app_creation_errors:type_name -> coder.agent.v2.CreateSubAgentResponse.AppCreationError
	57, // 50: coder.agent.v2.ListSubAgentsResponse.agents:type_name -> coder.agent.v2.SubAgent
	97, // 51: coder.agent.v2.BoundaryLog.time:type_name -> google.protobuf.Timestamp
	94, // 52: coder.agent.v2.BoundaryLog.http_request:type_name -> coder.agent.v2.BoundaryLog.HttpRequest
	64, // 53: coder.agent.v2.ReportBoundaryLogsRequest.logs:type_name -> coder.agent.v2.BoundaryLog
	16, // 54: coder.agent.v2.UpdateAppStatusRequest.state:type_name -> coder.agent.v2.UpdateAppStatusRequest.AppStatusState
	17, // 55: coder.agent.v2.ContextResource.status:type_name -> coder.agent.v2.ContextResource.Status
	70, // 56: coder.agent.v2.ContextResource.instruction_file:type_name -> coder.agent.v2.InstructionFileBody
	71, // 57: coder.agent.v2.ContextResource.skill:type_name -> coder.agent.v2.SkillMetaBody
	72, // 58: coder.agent.v2.ContextResource.mcp_config:type_name -> coder.agent.v2.MCPConfigBody
	73, // 59: coder.agent.v2.ContextResource.mcp_server:type_name -> coder.agent.v2.MCPServerBody
	74, // 60: coder.agent.v2.MCPServerBody.tools:type_name -> coder.agent.v2.MCPTool
	98, // 61: coder.agent.v2.MCPTool.input_schema:type_name -> google.protobuf.Struct
	69, // 62: coder.agent.v2.PushContextStateRequest.resources:type_name -> coder.agent.v2.ContextResource
	95, // 63: coder.agent.v2.WorkspaceApp.Healthcheck.interval:type_name -> google.protobuf.Duration
	97, // 64: coder.agent.v2.WorkspaceAgentMetadata.Result.collected_at:type_name -> google.protobuf.Timestamp
	95, // 65: coder.agent.v2.WorkspaceAgentMetadata.Description.interval:type_name -> google.protobuf.Duration
	95, // 66: coder.agent.v2.WorkspaceAgentMetadata.Description.timeout:type_name -> google.protobuf.Duration
	3,  // 67: coder.agent.v2.Stats.Metric.type:type_name -> coder.agent.v2.Stats.Metric.Type
	83, // 68: coder.agent.v2.Stats.Metric.labels:type_name -> coder.agent.v2.Stats.Metric.Label
	0,  // 69: coder.agent.v2.BatchUpdateAppHealthRequest.HealthUpdate.health:type_name -> coder.agent.v2.AppHealth
	97, // 70: coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.collected_at:type_name -> google.protobuf.Timestamp
	89, // 71: coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.memory:type_name -> coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.MemoryUsage
	90, // 72: coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.volumes:type_name -> coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.VolumeUsage
	92, // 73: coder.agent.v2.CreateSubAgentRequest.App.healthcheck:type_name -> coder.agent.v2.CreateSubAgentRequest.App.Healthcheck
	14, // 74: coder.agent.v2.CreateSubAgentRequest.App.open_in:type_name -> coder.agent.v2.CreateSubAgentRequest.App.OpenIn
	15, // 75: coder.agent.v2.CreateSubAgentRequest.App.share:type_name -> coder.agent.v2.CreateSubAgentRequest.App.SharingLevel
	24, // 76: coder.agent.v2.Agent.GetManifest:input_type -> coder.agent.v2.GetManifestRequest
	26, // 77: coder.agent.v2.Agent.GetServiceBanner:input_type -> coder.agent.v2.GetServiceBannerRequest
	28, // 78: coder.agent.v2.Agent.UpdateStats:input_type -> coder.agent.v2.UpdateStatsRequest
	31, // 79: coder.agent.v2.Agent.UpdateLifecycle:input_type -> coder.agent.v2.UpdateLifecycleRequest
	32, // 80: coder.agent.v2.Agent.BatchUpdateAppHealths:input_type -> coder.agent.v2.BatchUpdateAppHealthRequest
	35, // 81: coder.agent.v2.Agent.UpdateStartup:input_type -> coder.agent.v2.UpdateStartupRequest
	37, // 82: coder.agent.v2.Agent.BatchUpdateMetadata:input_type -> coder.agent.v2.BatchUpdateMetadataRequest
	40, // 83: coder.agent.v2.Agent.BatchCreateLogs:input_type -> coder.agent.v2.BatchCreateLogsRequest
	42, // 84: coder.agent.v2.Agent.GetAnnouncementBanners:input_type -> coder.agent.v2.GetAnnouncementBannersRequest
	45, // 85: coder.agent.v2.Agent.ScriptCompleted:input_type -> coder.agent.v2.WorkspaceAgentScriptCompletedRequest
	48, // 86: coder.agent.v2.Agent.GetResourcesMonitoringConfiguration:input_type -> coder.agent.v2.GetResourcesMonitoringConfigurationRequest
	50, // 87: coder.agent.v2.Agent.PushResourcesMonitoringUsage:input_type -> coder.agent.v2.PushResourcesMonitoringUsageRequest
	53, // 88: coder.agent.v2.Agent.ReportConnection:input_type -> coder.agent.v2.ReportConnectionRequest
	55, // 89: coder.agent.v2.Agent.ReportFileOperations:input_type -> coder.agent.v2.ReportFileOperationsRequest
	58, // 90: coder.agent.v2.Agent.CreateSubAgent:input_type -> coder.agent.v2.CreateSubAgentRequest
	60, // 91: coder.agent.v2.Agent.DeleteSubAgent:input_type -> coder.agent.v2.DeleteSubAgentRequest
	62, // 92: coder.agent.v2.Agent.ListSubAgents:input_type -> coder.agent.v2.ListSubAgentsRequest
	65, // 93: coder.agent.v2.Agent.ReportBoundaryLogs:input_type -> coder.agent.v2.ReportBoundaryLogsRequest
	67, // 94: coder.agent.v2.Agent.UpdateAppStatus:input_type -> coder.agent.v2.UpdateAppStatusRequest
	75, // 95: coder.agent.v2.Agent.PushContextState:input_type -> coder.agent.v2.PushContextStateRequest
	21, // 96: coder.agent.v2.Agent.GetManifest:output_type -> coder.agent.v2.Manifest
	25, // 97: coder.agent.v2.Agent.GetServiceBanner:output_type -> coder.agent.v2.ServiceBanner
	29, // 98: coder.agent.v2.Agent.UpdateStats:output_type -> coder.agent.v2.UpdateStatsResponse
	30, // 99: coder.agent.v2.Agent.UpdateLifecycle:output_type -> coder.agent.v2.Lifecycle
	33, // 100: coder.agent.v2.Agent.BatchUpdateAppHealths:output_type -> coder.agent.v2.BatchUpdateAppHealthResponse
	34, // 101: coder.agent.v2.Agent.UpdateStartup:output_type -> coder.agent.v2.Startup
	38, // 102: coder.agent.v2.Agent.BatchUpdateMetadata:output_type -> coder.agent.v2.BatchUpdateMetadataResponse
	41, // 103: coder.agent.v2.Agent.BatchCreateLogs:output_type -> coder.agent.v2.BatchCreateLogsResponse
	43, // 104: coder.agent.v2.Agent.GetAnnouncementBanners:output_type -> coder.agent.v2.GetAnnouncementBannersResponse
	46, // 105: coder.agent.v2.Agent.ScriptCompleted:output_type -> coder.agent.v2.WorkspaceAgentScriptCompletedResponse
	49, // 106: coder.agent.v2.Agent.GetResourcesMonitoringConfiguration:output_type -> coder.agent.v2.GetResourcesMonitoringConfigurationResponse
	51, // 107: coder.agent.v2.Agent.PushResourcesMonitoringUsage:output_type -> coder.agent.v2.PushResourcesMonitoringUsageResponse
	99, // 108: coder.agent.v2.Agent.ReportConnection:output_type -> google.protobuf.Empty
	56, // 109: coder.agent.v2.Agent.ReportFileOperations:output_type -> coder.agent.v2.ReportFileOperationsResponse
	59, // 110: coder.agent.v2.Agent.CreateSubAgent:output_type -> coder.agent.v2.CreateSubAgentResponse
	61, // 111: coder.agent.v2.Agent.DeleteSubAgent:output_type -> coder.agent.v2.DeleteSubAgentResponse
	63, // 112: coder.agent.v2.Agent.ListSubAgents:output_type -> coder.agent.v2.ListSubAgentsResponse
	66, // 113: coder.agent.v2.Agent.ReportBoundaryLogs:output_type -> coder.agent.v2.ReportBoundaryLogsResponse
	68, // 114: coder.agent.v2.Agent.UpdateAppStatus:output_type -> coder.agent.v2.UpdateAppStatusResponse
	76, // 115: coder.agent.v2.Agent.PushContextState:output_type -> coder.agent.v2.PushContextStateResponse
...
func file_agent_proto_agent_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_agent_proto_agent_proto_msgTypes[36].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FileTransferOperation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_agent_proto_agent_proto_msgTypes[37].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReportFileOperationsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_agent_proto_agent_proto_msgTypes[38].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReportFileOperationsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
