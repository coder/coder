...
// CreateAIAgentRequest registers an AI agent created inside the workspace.
//
// It names neither the workspace nor a credential. Both are established by
// the connection this request arrives on: coderd resolves the agent, its
// workspace, and its owner while authenticating, so a caller that restated
// them could only restate them wrongly.
type CreateAIAgentRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// poc_marker_path is a proof of concept stub and is not part of the
	// intended interface. The handler touches this path so that the call can
	// be observed before there is anything downstream to observe. It only
	// works because the test runs coderd on the same host as the workspace.
	// Remove it, and the stub in the handler, once the handler persists.
	PocMarkerPath string `protobuf:"bytes,1,opt,name=poc_marker_path,json=pocMarkerPath,proto3" json:"poc_marker_path,omitempty"`
}
...
func (x *CreateAIAgentRequest) GetPocMarkerPath() string {
	if x != nil {
		return x.PocMarkerPath
	}
	return ""
}

// CreateAIAgentResponse will eventually carry the identifier coderd mints for
// the AI agent, and the credential it issues. It is empty while the handler is
// a stub.
...
var file_agent_proto_agent_proto_rawDesc = []byte{
	...
	0x63, 0x63, 0x65, 0x70, 0x74, 0x65, 0x64, 0x22, 0x3e, 0x0a, 0x14, 0x43, 0x72, 0x65, 0x61, 0x74,
	0x65, 0x41, 0x49, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	0x26, 0x0a, 0x0f, 0x70, 0x6f, 0x63, 0x5f, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x72, 0x5f, 0x70, 0x61,
	0x74, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x70, 0x6f, 0x63, 0x4d, 0x61, 0x72,
	0x6b, 0x65, 0x72, 0x50, 0x61, 0x74, 0x68, 0x22, 0x17, 0x0a, 0x15, 0x43, 0x72, 0x65, 0x61, 0x74,
	0x65, 0x41, 0x49, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	...
	0x54, 0x48, 0x59, 0x10, 0x04, 0x32, 0xa7, 0x10, 0x0a, 0x05, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x12,
	...
	0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x6b, 0x0a, 0x12, 0x52, 0x65, 0x70,
	0x6f, 0x72, 0x74, 0x42, 0x6f, 0x75, 0x6e, 0x64, 0x61, 0x72, 0x79, 0x4c, 0x6f, 0x67, 0x73, 0x12,
	...
	0x6f, 0x67, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2a, 0x2e, 0x63, 0x6f, 0x64,
	...
	0x75, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x65, 0x0a, 0x10, 0x50, 0x75,
	0x73, 0x68, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x27,
	0x2e, 0x63, 0x6f, 0x64, 0x65, 0x72, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x2e, 0x76, 0x32, 0x2e,
	...
	0x65, 0x12, 0x5c, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x41, 0x49, 0x41, 0x67, 0x65,
	0x6e, 0x74, 0x12, 0x24, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x72, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74,
	0x2e, 0x76, 0x32, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x41, 0x49, 0x41, 0x67, 0x65, 0x6e,
	0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x25, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x72,
	0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x2e, 0x76, 0x32, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	0x41, 0x49, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42,
...
var file_agent_proto_agent_proto_goTypes = []interface{}{
	...
	(*CreateAIAgentRequest)(nil),                        // 72: coder.agent.v2.CreateAIAgentRequest
	(*CreateAIAgentResponse)(nil),                       // 73: coder.agent.v2.CreateAIAgentResponse
...
var file_agent_proto_agent_proto_depIdxs = []int32{
	...
	95, // 57: coder.agent.v2.MCPTool.input_schema:type_name -> google.protobuf.Struct
	64, // 58: coder.agent.v2.PushContextStateRequest.resources:type_name -> coder.agent.v2.ContextResource
	92, // 59: coder.agent.v2.WorkspaceApp.Healthcheck.interval:type_name -> google.protobuf.Duration
	94, // 60: coder.agent.v2.WorkspaceAgentMetadata.Result.collected_at:type_name -> google.protobuf.Timestamp
	92, // 61: coder.agent.v2.WorkspaceAgentMetadata.Description.interval:type_name -> google.protobuf.Duration
	92, // 62: coder.agent.v2.WorkspaceAgentMetadata.Description.timeout:type_name -> google.protobuf.Duration
	3,  // 63: coder.agent.v2.Stats.Metric.type:type_name -> coder.agent.v2.Stats.Metric.Type
	80, // 64: coder.agent.v2.Stats.Metric.labels:type_name -> coder.agent.v2.Stats.Metric.Label
	0,  // 65: coder.agent.v2.BatchUpdateAppHealthRequest.HealthUpdate.health:type_name -> coder.agent.v2.AppHealth
	94, // 66: coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.collected_at:type_name -> google.protobuf.Timestamp
	86, // 67: coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.memory:type_name -> coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.MemoryUsage
	87, // 68: coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.volumes:type_name -> coder.agent.v2.PushResourcesMonitoringUsageRequest.Datapoint.VolumeUsage
	89, // 69: coder.agent.v2.CreateSubAgentRequest.App.healthcheck:type_name -> coder.agent.v2.CreateSubAgentRequest.App.Healthcheck
	...
	72, // 91: coder.agent.v2.Agent.CreateAIAgent:input_type -> coder.agent.v2.CreateAIAgentRequest
	...
	96, // 104: coder.agent.v2.Agent.ReportConnection:output_type -> google.protobuf.Empty
	...
	73, // 111: coder.agent.v2.Agent.CreateAIAgent:output_type -> coder.agent.v2.CreateAIAgentResponse
...
func file_agent_proto_agent_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_agent_proto_agent_proto_msgTypes[56].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateAIAgentRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_agent_proto_agent_proto_msgTypes[57].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateAIAgentResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
