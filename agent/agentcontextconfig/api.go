...
// ConfigFromDir reads instruction files and discovers skills from a
// specific directory, using default file names. This is used by the
// CLI chat context commands to read context from an arbitrary
// directory without consulting agent env vars.
func ConfigFromDir(dir string) []codersdk.ChatMessagePart {
