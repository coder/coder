...
// TestManager_GlobalRootMarksHomeDotCoder runs the production root layout:
// the default ~/.coder instructions source seeded ahead of the built-in
// roots, a registered .coder directory, and the home directory as the
// working directory. Only the files directly in ~/.coder are global, and
// they stay attributed to the seeded source.
//
