...
try {
  const result = await server.transformRequest('src/pages/AgentsPage/AgentDetail.tsx');
  ...
  const hasAgentDetailCache = code.includes('const AgentDetail') && slots.length > 0;
