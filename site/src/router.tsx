  ...
  <Route element={<RoutesWithSuspense />}>
    ...
    <Route element={<RequireAuth />}>
      <Route element={<DashboardLayout />}>
        ...
        <Route path="/external-auth/:provider" element={<ExternalAuthPage />} />
        ...
        <Route path="/deployment" element={<DeploySettingsLayout />}>
          ...
          <Route path="external-auth" element={<ExternalAuthSettingsPage />} />
      ...
      />
      <Route path="/:username/:workspace/terminal" element={<TerminalPage />} />
