...
const AgentSettingsBehaviorPage = lazy(
	() => import("./pages/AgentsPage/settings/AgentSettingsBehaviorPage"),
);
const AgentSettingsProvidersPage = lazy(
	() => import("./pages/AgentsPage/settings/AgentSettingsProvidersPage"),
);
const AgentSettingsModelsPage = lazy(
	() => import("./pages/AgentsPage/settings/AgentSettingsModelsPage"),
);
const AgentSettingsMCPServersPage = lazy(
	() => import("./pages/AgentsPage/settings/AgentSettingsMCPServersPage"),
);
const AgentSettingsLimitsPage = lazy(
	() => import("./pages/AgentsPage/settings/AgentSettingsLimitsPage"),
);
const AgentSettingsUsagePage = lazy(
	() => import("./pages/AgentsPage/settings/AgentSettingsUsagePage"),
);
const AgentSettingsInsightsPage = lazy(
	() => import("./pages/AgentsPage/settings/AgentSettingsInsightsPage"),
);
const AgentSettingsTemplatesPage = lazy(
	() => import("./pages/AgentsPage/settings/AgentSettingsTemplatesPage"),
);
