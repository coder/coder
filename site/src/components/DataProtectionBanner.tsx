...
export const DataProtectionBanner: FC<DataProtectionBannerProps> = ({
	...
	if (isAuditor) {
		return (
			<Alert severity="warning" css={{ marginBottom: 16 }}>
				Data Protection Mode is active. As a designated auditor, you have
				access to unobfuscated user data. All access is logged for compliance
				purposes.
			</Alert>
		);
	}
	...
	return (
		<Alert severity="info" css={{ marginBottom: 16 }}>
			Data Protection Mode is active. Individual user identifiers are
			obfuscated across all interfaces to comply with employee data
