 ...
 * dropdown / inline menu layout), so that 640–767 px viewports — common
 * on landscape phones and small tablets — pick the mobile branch
 * instead of the desktop flyout branch.
 */
