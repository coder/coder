...
export const MockAIAuditAgent: AIAuditAgent = {
	...
	display_name: "ai-ws-00000000-0000-4000-8000-0000000000a1",
	owner_id: MockSponsor.id,
	creation_site_type: "workspace",
	creation_site_id: "00000000-0000-4000-8000-0000000000b1",
	creation_time: "2026-08-25T10:00:00Z",
	state: "active",
};
...
export const MockAIAuditEvents: AIAuditEvent[] = [
	{
		...
		ai_agent_id: MockAIAuditAgent.id,
		sponsor: MockSponsor,
