import aiBridgeSessionResponse from "./TMP_session";
import aiBridgeSessionListResponse from "./TMP_sessions";

// FIXME remove these once we get API responses typed properly
export { aiBridgeSessionListResponse, aiBridgeSessionResponse };

export type AIBridgeSessionResponse = typeof aiBridgeSessionResponse;
export type AIBridgeSessionListResponse = typeof aiBridgeSessionListResponse;
...
export interface AIBridgeSession {
	...
	readonly token_usage_summary: AIBridgeTokenUsageSummary;
	readonly last_prompt: string | null;
}

export interface AIBridgeTokenUsageSummary {
