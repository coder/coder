...
// From codersdk/chats.go
export type ChatStreamEventType = "error" | "message" | "message_part" | "status";

export const ChatStreamEventTypes: ChatStreamEventType[] = ["error", "message", "message_part", "status"];
