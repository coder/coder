...
// From codersdk/deployment.go
export type Experiment = "agents" | "auto-fill-parameters" | "example" | "mcp-server-http" | "notifications" | "oauth2" | "web-push" | "workspace-usage";

export const Experiments: Experiment[] = ["agents", "auto-fill-parameters", "example", "mcp-server-http", "notifications", "oauth2", "web-push", "workspace-usage"];
