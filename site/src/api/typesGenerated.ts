...
// From codersdk/workspacebuilds.go
export type BuildReason = "autostart" | "autostop" | "cli" | "dashboard" | "dormancy" | "initiator" | "jetbrains_connection" | "ssh_connection" | "vscode_connection";

export const BuildReasons: BuildReason[] = ["autostart", "autostop", "cli", "dashboard", "dormancy", "initiator", "jetbrains_connection", "ssh_connection", "vscode_connection"];
...
// From codersdk/chats.go
export type ChatMessagePartType = "file" | "reasoning" | "source" | "text" | "tool-call" | "tool-result";

export const ChatMessagePartTypes: ChatMessagePartType[] = ["file", "reasoning", "source", "text", "tool-call", "tool-result"];
...
// From codersdk/chats.go
export type ChatStreamEventType = "error" | "message" | "message_part" | "queue_update" | "status";

export const ChatStreamEventTypes: ChatStreamEventType[] = ["error", "message", "message_part", "queue_update", "status"];
...
// From codersdk/workspaces.go
export type CreateWorkspaceBuildReason = "cli" | "dashboard" | "jetbrains_connection" | "ssh_connection" | "vscode_connection";

export const CreateWorkspaceBuildReasons: CreateWorkspaceBuildReason[] = ["cli", "dashboard", "jetbrains_connection", "ssh_connection", "vscode_connection"];
...
// From codersdk/deployment.go
export type Experiment = "auto-fill-parameters" | "example" | "mcp-server-http" | "notifications" | "oauth2" | "web-push" | "workspace-sharing" | "workspace-usage";

export const Experiments: Experiment[] = ["auto-fill-parameters", "example", "mcp-server-http", "notifications", "oauth2", "web-push", "workspace-sharing", "workspace-usage"];
...
export type RBACAction = "application_connect" | "assign" | "create" | "create_agent" | "delete" | "delete_agent" | "read" | "read_personal" | "ssh" | "share" | "unassign" | "update" | "update_personal" | "use" | "view_insights" | "start" | "stop";

export const RBACActions: RBACAction[] = ["application_connect", "assign", "create", "create_agent", "delete", "delete_agent", "read", "read_personal", "ssh", "share", "unassign", "update", "update_personal", "use", "view_insights", "start", "stop"];
...
// From codersdk/audit.go
export type ResourceType = "api_key" | "convert_login" | "custom_role" | "git_ssh_key" | "group" | "health_settings" | "idp_sync_settings_group" | "idp_sync_settings_organization" | "idp_sync_settings_role" | "license" | "notification_template" | "notifications_settings" | "oauth2_provider_app" | "oauth2_provider_app_secret" | "organization" | "organization_member" | "prebuilds_settings" | "task" | "template" | "template_version" | "user" | "workspace" | "workspace_agent" | "workspace_app" | "workspace_build" | "workspace_proxy";

export const ResourceTypes: ResourceType[] = ["api_key", "convert_login", "custom_role", "git_ssh_key", "group", "health_settings", "idp_sync_settings_group", "idp_sync_settings_organization", "idp_sync_settings_role", "license", "notification_template", "notifications_settings", "oauth2_provider_app", "oauth2_provider_app_secret", "organization", "organization_member", "prebuilds_settings", "task", "template", "template_version", "user", "workspace", "workspace_agent", "workspace_app", "workspace_build", "workspace_proxy"];
