...
// From codersdk/deployment.go
export type Experiment = "ai-tasks" | "agentic-chat" | "auto-fill-parameters" | "example" | "notifications" | "web-push" | "workspace-prebuilds" | "workspace-usage";
...
export const WorkspaceAppStatusStates: WorkspaceAppStatusState[] = ["complete", "failure", "working"];
