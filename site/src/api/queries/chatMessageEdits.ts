...
export const reconcileEditedMessageInCache = ({
	...
	// Every message the edit inserted, replacement last. Hook notices
	// precede the replacement with lower IDs and must land in the
	// cache too, or a stream reconnect keyed on the highest cached ID
	// would skip them.
