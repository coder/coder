...
export const VSCodeDesktopButton: React.FC<VSCodeDesktopButtonProps> = (
	props,
) => {
...
const VSCodeButton: React.FC<VSCodeDesktopButtonProps> = ({
	userName,
	workspaceName,
	agentName,
	folderPath,
...
const VSCodeInsidersButton: React.FC<VSCodeDesktopButtonProps> = ({
	userName,
	workspaceName,
	agentName,
	folderPath,
