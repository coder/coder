...
interface OrganizationSwitcherProps {
	...
	/** Organizations the user can view. */
	organizations: readonly Organization[];
	/** Whether to offer the create organization action. */
	canCreateOrganization: boolean;
}

/**
 * Combobox for switching the organization whose settings are shown in
 * the admin sidebar. Selecting an organization navigates to its
 * members page.
 */
