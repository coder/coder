...
export const SidebarTopLevelNavItem: FC<SidebarTopLevelNavItemProps> = ({
	...
	return (
		<NavLink
			...
			className={({ isActive }) =>
				cn(
					"flex items-center gap-2 pl-1 pr-0 h-10 rounded-md no-underline text-sm font-medium text-content-secondary hover:bg-surface-secondary transition-colors",
