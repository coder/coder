	...
	args: {
		parameter: {
			...
			options: [
				{
					name: "JavaScript",
					value: { valid: true, value: "javascript" },
					description: "JavaScript programming language",
					icon: "",
				},
				{
					name: "TypeScript",
					value: { valid: true, value: "typescript" },
				...
				{
					name: "Kotlin",
					value: { valid: true, value: "kotlin" },
					description: "Kotlin programming language",
					icon: "",
				},
				{
					name: "Scala",
					value: { valid: true, value: "scala" },
				...
				{
					name: "Perl",
					value: { valid: true, value: "perl" },
					description: "Perl programming language",
					icon: "",
				},
				{
					name: "R",
					value: { valid: true, value: "r" },
					description: "R programming language",
					icon: "",
				},
				{
					name: "MATLAB",
					value: { valid: true, value: "matlab" },
				...
				{
					name: "Lua",
					value: { valid: true, value: "lua" },
					description: "Lua programming language",
					icon: "",
				},
				{
					name: "Haskell",
					value: { valid: true, value: "haskell" },
