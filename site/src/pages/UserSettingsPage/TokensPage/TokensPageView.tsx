									...
									>
										...
										<TableCell className="align-top text-right">
											...
											>
												...
												>
													<RouterLink to={`${encodeURIComponent(token.token_name)}/edit`}>
														<PencilIcon aria-hidden="true" className="size-icon-sm" />
												...
												<Button
													...
													className="text-content-secondary hover:text-content-primary"
												>
													<TrashIcon aria-hidden="true" className="size-icon-sm" />
