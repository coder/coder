...
export const EditOAuth2AppPageView: FC<EditOAuth2AppProps> = ({
	...
	// Owner information is now included in the app response
	const owner =
							...
							{app.grant_types?.includes("client_credentials") && (
								<div className="mt-6">
									<Button
										...
										className="p-0 text-content-secondary text-sm flex items-center"
									>
										Code Example
				...
				{!isLoadingApp && app && (
					<>
						...
						<dl className="grid grid-cols-[max-content_auto] gap-x-2.5 gap-y-2">
							...
							{app.user_id &&
								app.user_id !== "00000000-0000-0000-0000-000000000000" && (
									<>
