...
// it is still sent, and the rows behind it wait.
...
// The chat is paused at the queue head under edit; the head shows no
// Enter-to-send hint because Enter no longer sends it.
