...
export const useChatStore = (
	...
	useEffect(() => {
		...
		// Set when the stream reports a finished turn, cleared by any other
		...
		let streamReportedTurnFinished = false;

		const shouldKeepMessagePart = (): boolean => !streamReportedTurnFinished;
