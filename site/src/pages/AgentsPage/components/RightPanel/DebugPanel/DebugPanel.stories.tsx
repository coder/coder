...
import { chatQueryKeys } from "#/api/queries/chats";
...
const debugRunsQueryKey = chatQueryKeys.debugRuns(CHAT_ID);
...
export const Empty: Story = {
	parameters: {
		queries: [
			{
				key: chatQueryKeys.debugRuns(CHAT_ID),
				data: [],
			},
		],
	},
...
export const RunWithNoSteps: Story = {
	parameters: {
		queries: [
			...
			{
				key: chatQueryKeys.debugRun(CHAT_ID, detailProbeRunId),
				data: {
					...MockRun,
					id: detailProbeRunId,
					summary: { first_message: "Detail state probe" },
...
export const SingleStepSuccessfulRun: Story = {
	parameters: {
		queries: [
			...
			{
				key: chatQueryKeys.debugRun(CHAT_ID, successfulRunDetail.id),
...
export const MultiStepRunWithRetries: Story = {
	parameters: {
		queries: [
			...
			{
				key: chatQueryKeys.debugRun(CHAT_ID, multiStepRunDetail.id),
...
export const ErrorStateWithRedactedHeaders: Story = {
	parameters: {
		queries: [
			...
			{
				key: chatQueryKeys.debugRun(CHAT_ID, errorRunDetail.id),
				data: errorRunDetail,
			},
		],
	},
...
export const LongRawPayloads: Story = {
	parameters: {
		queries: [
			...
			{
				key: chatQueryKeys.debugRun(CHAT_ID, longPayloadRunDetail.id),
...
export const RichPayloadWithTranscript: Story = {
	parameters: {
		queries: [
			...
			{
				key: chatQueryKeys.debugRun(CHAT_ID, richRunDetail.id),
				data: richRunDetail,
			},
		],
	},
...
export const ToolCallStep: Story = {
	parameters: {
		queries: [
			...
			{
				key: chatQueryKeys.debugRun(CHAT_ID, toolCallRunDetail.id),
...
export const BackendNormalizedShape: Story = {
	parameters: {
		queries: [
			...
			{
				key: chatQueryKeys.debugRun(CHAT_ID, backendShapeRunDetail.id),
