...
export function useScrollAnchoring({
	...
	onFetchMoreMessages,
}: UseScrollAnchoringOptions): UseScrollAnchoringReturn {
	...
	const scrollToBottom = (behavior: "smooth" | "instant"): void => {
	...
	useEffect(() => {
		...
		// biome-ignore lint/correctness/useExhaustiveDependencies: scrollToBottom is auto-memoized by React Compiler.
