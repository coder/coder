				...
				<ContextMenuTrigger asChild disabled={!hasMenuActions}>
					<div
						...
						className={cn(
							...
							"[@media(hover:hover)]:hover:-mx-2 [@media(hover:hover)]:hover:rounded-none [@media(hover:hover)]:hover:pl-3 [@media(hover:hover)]:hover:pr-3.5",
							...
							"has-[[aria-current=page]]:-mx-2 has-[[aria-current=page]]:rounded-none has-[[aria-current=page]]:border-l has-[[aria-current=page]]:border-content-primary has-[[aria-current=page]]:pl-[11px] has-[[aria-current=page]]:pr-3.5 [@media(hover:hover)]:has-[[aria-current=page]]:hover:pl-[11px]",
						)}
					>
						<div
							className={cn(
