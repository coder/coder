				...
				<div className="relative my-1 flex w-7 shrink-0 flex-col items-end self-stretch">
					...
					{hasMenuActions && (
						<ChatMoreActions
							...
							onOpenRenameDialog={
								onOpenRenameDialog ? () => onOpenRenameDialog(chat) : undefined
							}
							triggerLabel={`Open actions for ${chat.title}`}
							triggerClassName="absolute inset-0 flex h-6 w-7 min-w-0 justify-end rounded-none px-0 opacity-0 [@media(hover:hover)]:group-hover:opacity-100 data-[state=open]:opacity-100"
