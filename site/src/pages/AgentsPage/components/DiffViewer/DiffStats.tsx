...
export const DiffStatBadge: FC<{ additions: number; deletions: number }> = ({
	...
	return (
		<span className="inline-flex items-center overflow-hidden rounded-sm border border-solid border-border-default font-mono text-(length:--agent-font-size) font-medium leading-5">
			{additions > 0 && (
