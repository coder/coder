		...
		<Popover open={open} onOpenChange={handleOpenChange}>
			<PopoverTrigger asChild disabled={isDisabled}>
				<Button
					...
					variant="subtle"
					className={cn(
						"h-8 min-w-0 shrink justify-start gap-0.5 border-0 bg-transparent px-1 text-xs font-medium shadow-none transition-colors hover:bg-transparent hover:text-content-primary focus:ring-0 focus-visible:ring-2 focus-visible:ring-content-link md:w-auto md:shrink-0 md:gap-1.5 [&>svg]:!size-3.5 [&>svg]:p-0 [&>svg]:shrink-0 [&>svg]:transition-colors [&>svg]:hover:text-content-primary",
						className,
					)}
