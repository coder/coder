	...
	const content = (
		...
		>
			...
			<div
				...
				className={cn(
					"relative z-10 rounded-2xl border border-solid border-border-default bg-surface-secondary sm:bg-surface-secondary/45 p-1 shadow-xs has-[[contenteditable]:focus]:ring-2 has-[[contenteditable]:focus]:ring-content-link/40",
