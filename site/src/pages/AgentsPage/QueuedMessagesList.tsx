	...
	return (
		<div className={cn("flex w-full flex-col", className)}>
			...
			{items.map((item, index) => {
				...
				const isItemBusy =
					busyItem !== null && busyItem.id === item.id;
				...
				return (
					<div
						...
						className={cn(
							...
							isEditing &&
								"rounded-lg opacity-100 ring-2 ring-content-link/40",
						)}
