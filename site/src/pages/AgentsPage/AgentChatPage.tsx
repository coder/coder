...
type _ExcludedAgentFields = Omit<
...
// Decide: does the UI read it? If yes, add it to the comparison
// above AND to the compared-fields record. If no, add it to the
// excluded list.
const _agentFieldGuard: Record<keyof _ExcludedAgentFields, true> = {};
