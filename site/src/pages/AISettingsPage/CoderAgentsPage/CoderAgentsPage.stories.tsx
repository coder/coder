...
const entitlementsWithUnavailableUsage: Entitlements = {
	...entitlementsWithUnrelatedLicense,
	errors: [LicenseAgentRuntimeUsageUnavailableErrorText],
	features: {
		...entitlementsWithUnrelatedLicense.features,
		agent_runtime_hours: {
			...communityRuntimeFeature,
			actual: undefined,
			actual_ms: undefined,
		},
	},
...
export const CommunityUsageWithUnrelatedLicense: Story = {
	parameters: {
		queries: [
			{
				key: entitlementDetailsQueryKey,
				data: entitlementsWithUnrelatedLicense,
			},
			{
...
export const UsageDiagnostic: Story = {
	parameters: {
		queries: [
			{
				key: entitlementDetailsQueryKey,
				data: entitlementsWithUnavailableUsage,
			},
			{
				key: chatPersonalModelOverridesAdminSettings().queryKey,
				data: { allow_users: true },
