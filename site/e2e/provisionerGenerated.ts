...
export interface Script {
   ...
   * meta-argument.
   */
  orderDependencies: ScriptOrderDependency[];
}
 ...
 */
export interface ScriptOrderDependency {
...
export const Script = {
  encode(message: Script, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.orderDependencies) {
      ScriptOrderDependency.encode(v!, writer.uint32(90).fork()).ldelim();
    }
    return writer;
  },
};

export const ScriptOrderDependency = {
  encode(message: ScriptOrderDependency, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.scriptId !== "") {
      writer.uint32(10).string(message.scriptId);
    }
    if (message.requires !== "") {
      writer.uint32(18).string(message.requires);
    }
    return writer;
  },
};
