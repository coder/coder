...
func (c *agentConn) ListeningPorts(ctx context.Context) (codersdk.WorkspaceAgentListeningPortsResponse, error) {
	...
	return resp, json.NewDecoder(res.Body).Decode(&resp) //nolint:gocritic // Agent-direct HTTP API response, not the Coder control-plane API.
}
...
func (c *agentConn) ExecuteDesktopAction(ctx context.Context, action DesktopAction) (DesktopActionResponse, error) {
	...
	if err := json.NewDecoder(resp.Body).Decode(&result); err != nil { //nolint:gocritic // Agent-direct HTTP API response, not the Coder control-plane API.
...
func (c *agentConn) RecreateDevcontainer(ctx context.Context, devcontainerID string) (codersdk.Response, error) {
	...
	if err := json.NewDecoder(res.Body).Decode(&m); err != nil { //nolint:gocritic // Agent-direct HTTP API response, not the Coder control-plane API.
...
func (c *agentConn) ReadFileLines(ctx context.Context, path string, offset, limit int64, limits ReadFileLinesLimits) (ReadFileLinesResponse, error) {
	...
	if err := json.NewDecoder(res.Body).Decode(&resp); err != nil { //nolint:gocritic // Agent-direct HTTP API response, not the Coder control-plane API.
