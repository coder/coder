...
const (
	...
	ResourceTypeAgentsOperationalSettings ResourceType = "agents_operational_settings"
)
...
func (r ResourceType) FriendlyString() string {
	...
	case ResourceTypeUserSkill:
		return "user skill"
	case ResourceTypeAgentsOperationalSettings:
		return "agents operational settings"
	default:
		return "unknown"
	}
}
