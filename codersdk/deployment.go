...
const (
	...
	ExperimentChatMCPApps               Experiment = "chat-mcp-apps"               // Renders MCP Apps from MCP tool results in the agent chat right panel.
)
...
func (e Experiment) DisplayName() string {
	...
	case ExperimentChatMCPApps:
		return "Chat MCP Apps"
	default:
