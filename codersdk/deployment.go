 ...
 when required by your organization's security policy.`,
	...
	opts := serpent.OptionSet{
		...
		},
		{
			...
			Description: "If provided, any group name not matching the regex is ignored. This allows filtering out groups that are not needed. This filter is applied after the group mapping and regex filter.",
