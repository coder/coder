...
const (
	...
	ExperimentChatStructuredOutput      Experiment = "chat-structured-output"      // Accepts structured output response formats on agent chats.
)
...
func (e Experiment) DisplayName() string {
	...
	case ExperimentChatStructuredOutput:
