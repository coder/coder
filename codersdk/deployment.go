...
Write out the current server config as YAML to stdout.`,
		...
		},
		{
			...
			YAML:        "enabled",
			Hidden:      true,
			UseInstead:  serpent.OptionSet{{Flag: "ai-gateway-enabled", Env: "CODER_AI_GATEWAY_ENABLED"}},
		},
		{
		...
		},
		{
			...
			YAML:        "openai_base_url",
			Hidden:      true,
			UseInstead:  serpent.OptionSet{{Flag: "ai-gateway-openai-base-url", Env: "CODER_AI_GATEWAY_OPENAI_BASE_URL"}},
		},
		{
		...
		},
		{
			...
			Annotations: serpent.Annotations{}.Mark(annotationSecretKey, "true"),
			Hidden:      true,
			UseInstead:  serpent.OptionSet{{Flag: "ai-gateway-openai-key", Env: "CODER_AI_GATEWAY_OPENAI_KEY"}},
		},
		{
		...
		},
		{
			...
			YAML:        "anthropic_base_url",
			Hidden:      true,
			UseInstead:  serpent.OptionSet{{Flag: "ai-gateway-anthropic-base-url", Env: "CODER_AI_GATEWAY_ANTHROPIC_BASE_URL"}},
		},
		{
		...
		},
		{
			...
			Annotations: serpent.Annotations{}.Mark(annotationSecretKey, "true"),
			Hidden:      true,
			UseInstead:  serpent.OptionSet{{Flag: "ai-gateway-anthropic-key", Env: "CODER_AI_GATEWAY_ANTHROPIC_KEY"}},
		},
		{
		...
		},
		{
			...
			YAML:       "bedrock_base_url",
			Hidden:     true,
			UseInstead: serpent.OptionSet{{Flag: "ai-gateway-bedrock-base-url", Env: "CODER_AI_GATEWAY_BEDROCK_BASE_URL"}},
		},
		{
		...
		},
		{
			...
			YAML:       "bedrock_region",
			Hidden:     true,
			UseInstead: serpent.OptionSet{{Flag: "ai-gateway-bedrock-region", Env: "CODER_AI_GATEWAY_BEDROCK_REGION"}},
		},
		{
		...
		},
		{
			...
			Annotations: serpent.Annotations{}.Mark(annotationSecretKey, "true"),
			Hidden:      true,
			UseInstead:  serpent.OptionSet{{Flag: "ai-gateway-bedrock-access-key", Env: "CODER_AI_GATEWAY_BEDROCK_ACCESS_KEY"}},
		},
		{
		...
		},
		{
			...
			Annotations: serpent.Annotations{}.Mark(annotationSecretKey, "true"),
			Hidden:      true,
			UseInstead:  serpent.OptionSet{{Flag: "ai-gateway-bedrock-access-key-secret", Env: "CODER_AI_GATEWAY_BEDROCK_ACCESS_KEY_SECRET"}},
		},
		{
		...
		},
		{
			...
			YAML:        "bedrock_model",
			Hidden:      true,
			UseInstead:  serpent.OptionSet{{Flag: "ai-gateway-bedrock-model", Env: "CODER_AI_GATEWAY_BEDROCK_MODEL"}},
		},
		{
		...
		},
		{
			...
			YAML:        "bedrock_small_fast_model",
			Hidden:      true,
			UseInstead:  serpent.OptionSet{{Flag: "ai-gateway-bedrock-small-fastmodel", Env: "CODER_AI_GATEWAY_BEDROCK_SMALL_FAST_MODEL"}},
		},
		{
		...
		},
		{
			...
			YAML:        "inject_coder_mcp_tools",
			Hidden:      true,
			UseInstead:  serpent.OptionSet{{Flag: "ai-gateway-inject-coder-mcp-tools", Env: "CODER_AI_GATEWAY_INJECT_CODER_MCP_TOOLS"}},
		},
		{
		...
		},
		{
			...
			Annotations: serpent.Annotations{}.Mark(annotationFormatDuration, "true"),
			Hidden:      true,
			UseInstead:  serpent.OptionSet{{Flag: "ai-gateway-retention", Env: "CODER_AI_GATEWAY_RETENTION"}},
		},
		{
		...
		},
		{
			...
			YAML:        "max_concurrency",
			Hidden:      true,
			UseInstead:  serpent.OptionSet{{Flag: "ai-gateway-max-concurrency", Env: "CODER_AI_GATEWAY_MAX_CONCURRENCY"}},
		},
		{
		...
		},
		{
			...
			YAML:        "rate_limit",
			Hidden:      true,
			UseInstead:  serpent.OptionSet{{Flag: "ai-gateway-rate-limit", Env: "CODER_AI_GATEWAY_RATE_LIMIT"}},
		},
		{
		...
		},
		{
			...
			YAML:        "structured_logging",
			Hidden:      true,
			UseInstead:  serpent.OptionSet{{Flag: "ai-gateway-structured-logging", Env: "CODER_AI_GATEWAY_STRUCTURED_LOGGING"}},
		},
		{
		...
		},
		{
			...
			YAML:       "send_actor_headers",
			Hidden:     true,
			UseInstead: serpent.OptionSet{{Flag: "ai-gateway-send-actor-headers", Env: "CODER_AI_GATEWAY_SEND_ACTOR_HEADERS"}},
		},
		{
		...
		},
		{
			...
			YAML:        "allow_byok",
			Hidden:      true,
			UseInstead:  serpent.OptionSet{{Flag: "ai-gateway-allow-byok", Env: "CODER_AI_GATEWAY_ALLOW_BYOK"}},
		},
		{
		...
		},
		{
			...
			YAML:        "circuit_breaker_enabled",
			Hidden:      true,
			UseInstead:  serpent.OptionSet{{Flag: "ai-gateway-circuit-breaker-enabled", Env: "CODER_AI_GATEWAY_CIRCUIT_BREAKER_ENABLED"}},
		},
		{
		...
		},
		{
			...
			Group:      &deploymentGroupAIBridge,
			YAML:       "circuit_breaker_failure_threshold",
			UseInstead: serpent.OptionSet{{Flag: "ai-gateway-circuit-breaker-failure-threshold", Env: "CODER_AI_GATEWAY_CIRCUIT_BREAKER_FAILURE_THRESHOLD"}},
		},
		{
		...
		},
		{
			...
			YAML:        "circuit_breaker_interval",
			Annotations: serpent.Annotations{}.Mark(annotationFormatDuration, "true"),
			UseInstead:  serpent.OptionSet{{Flag: "ai-gateway-circuit-breaker-interval", Env: "CODER_AI_GATEWAY_CIRCUIT_BREAKER_INTERVAL"}},
		},
		{
		...
		},
		{
			...
			YAML:        "circuit_breaker_timeout",
			Annotations: serpent.Annotations{}.Mark(annotationFormatDuration, "true"),
			UseInstead:  serpent.OptionSet{{Flag: "ai-gateway-circuit-breaker-timeout", Env: "CODER_AI_GATEWAY_CIRCUIT_BREAKER_TIMEOUT"}},
		},
		{
		...
		},
		{
			...
			Group:      &deploymentGroupAIBridge,
			YAML:       "circuit_breaker_max_requests",
			UseInstead: serpent.OptionSet{{Flag: "ai-gateway-circuit-breaker-max-requests", Env: "CODER_AI_GATEWAY_CIRCUIT_BREAKER_MAX_REQUESTS"}},
		},
		...
		},
		{
			...
			YAML:        "enabled",
			Hidden:      true,
			UseInstead:  serpent.OptionSet{{Flag: "ai-gateway-proxy-enabled", Env: "CODER_AI_GATEWAY_PROXY_ENABLED"}},
		},
		{
		...
		},
		{
			...
			YAML:        "listen_addr",
			Hidden:      true,
			UseInstead:  serpent.OptionSet{{Flag: "ai-gateway-proxy-listen-addr", Env: "CODER_AI_GATEWAY_PROXY_LISTEN_ADDR"}},
		},
		{
		...
		},
		{
			...
			YAML:        "tls_cert_file",
			Hidden:      true,
			UseInstead:  serpent.OptionSet{{Flag: "ai-gateway-proxy-tls-cert-file", Env: "CODER_AI_GATEWAY_PROXY_TLS_CERT_FILE"}},
		},
		{
		...
		},
		{
			...
			YAML:        "tls_key_file",
			Hidden:      true,
			UseInstead:  serpent.OptionSet{{Flag: "ai-gateway-proxy-tls-key-file", Env: "CODER_AI_GATEWAY_PROXY_TLS_KEY_FILE"}},
		},
		{
		...
		},
		{
			...
			YAML:        "cert_file",
			Hidden:      true,
			UseInstead:  serpent.OptionSet{{Flag: "ai-gateway-proxy-cert-file", Env: "CODER_AI_GATEWAY_PROXY_CERT_FILE"}},
		},
		{
		...
		},
		{
			...
			YAML:        "key_file",
			Hidden:      true,
			UseInstead:  serpent.OptionSet{{Flag: "ai-gateway-proxy-key-file", Env: "CODER_AI_GATEWAY_PROXY_KEY_FILE"}},
		},
		{
		...
		},
		{
			...
			Group:       &deploymentGroupAIBridgeProxy,
			YAML:        "domain_allowlist",
			UseInstead:  serpent.OptionSet{{Flag: "ai-gateway-proxy-domain-allowlist", Env: "CODER_AI_GATEWAY_PROXY_DOMAIN_ALLOWLIST"}},
		},
		{
		...
		},
		{
			...
			YAML:        "upstream_proxy",
			Hidden:      true,
			UseInstead:  serpent.OptionSet{{Flag: "ai-gateway-proxy-upstream", Env: "CODER_AI_GATEWAY_PROXY_UPSTREAM"}},
		},
		{
		...
		},
		{
			...
			YAML:        "upstream_proxy_ca",
			Hidden:      true,
			UseInstead:  serpent.OptionSet{{Flag: "ai-gateway-proxy-upstream-ca", Env: "CODER_AI_GATEWAY_PROXY_UPSTREAM_CA"}},
		},
		{
		...
		},
		{
			...
			YAML:        "allowed_private_cidrs",
			Hidden:      true,
			UseInstead:  serpent.OptionSet{{Flag: "ai-gateway-proxy-allowed-private-cidrs", Env: "CODER_AI_GATEWAY_PROXY_ALLOWED_PRIVATE_CIDRS"}},
		},
		{
		...
		},
		{
			...
			YAML:        "api_dump_dir",
			Hidden:      true,
			UseInstead:  serpent.OptionSet{{Flag: "ai-gateway-proxy-dump-dir", Env: "CODER_AI_GATEWAY_PROXY_DUMP_DIR"}},
		},
