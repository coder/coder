...
Write out the current server config as YAML to stdout.`,
		...
		},
		{
			...
			Description: "Path to the TLS certificate file for the AI Bridge Proxy listener.",
		...
		},
		{
			...
			Description: "Path to the TLS private key file for the AI Bridge Proxy listener.",
