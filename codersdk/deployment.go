...
communicating directly.`,
 ...
 when required by your organization's security policy.`,
	...
	aiGatewayDisableContentRecording := serpent.Option{
		...
		Description: "Stop recording the content of intercepted conversations: user prompts, tool call arguments and model thoughts. Interceptions and token usage are still recorded, so cost controls, budget enforcement and spend reporting are unaffected. Sessions pages, prompt and tool call telemetry, and the audit trail of what was asked are lost. Combine with --ai-gateway-structured-logging-source=gateway to keep exporting the dropped records to a SIEM.",
