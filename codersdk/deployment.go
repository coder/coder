...
Write out the current server config as YAML to stdout.`,
		...
		},
		{
			...
			Description: "Maximum number of client-provided dynamic tools a chat can be created with. Set to 0 to use the default.",
		...
		},
		{
			...
			Description: "Maximum number of bytes of workspace command output the execute and process tools return to the model. Longer output is truncated. Set to 0 to use the default.",
		...
		},
		{
			...
			Description: "Maximum number of characters of each message part, tool argument, and tool result kept in chat debug run records. Longer text is truncated. Set to 0 to use the default.",
		...
		},
		{
			...
			Description: "Maximum number of bytes of streamed model output and of each recorded provider HTTP request or response body kept in chat debug run records. Set to 0 to use the default.",
