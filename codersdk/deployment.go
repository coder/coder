...
const (
	...
	ExperimentChatOrchestrator          Experiment = "chat-orchestrator"           // Enables the per-user orchestrator chat that spawns and inspects other chats.
)
...
func (e Experiment) DisplayName() string {
	...
	case ExperimentChatOrchestrator:
