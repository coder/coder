...
when required by your organization's security policy.`,
	...
	opts := clibase.OptionSet{
		...
		},
		{
			...
			Description: "Use Tailscale's global relay and STUN network for your DERP mapping. This value will be ignored if you set a `--derp-config-url` or use `--derp-server-enable`.",
