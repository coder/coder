...
Write out the current server config as YAML to stdout.`,
		...
		aiGatewayRetention,
		{
			...
			Description: "Deprecated: use --ai-gateway-max-concurrency or CODER_AI_GATEWAY_MAX_CONCURRENCY instead. Maximum number of concurrent AI Gateway requests per replica. Set to 0 to disable (unlimited).",
		...
		aiGatewayMaxConcurrency,
		{
			...
			Description: "Deprecated: use --ai-gateway-rate-limit or CODER_AI_GATEWAY_RATE_LIMIT instead. Maximum number of AI Gateway requests per second per replica. Set to 0 to disable (unlimited).",
		...
		aiGatewayRateLimit,
		{
			...
			Description: "Deprecated: use --ai-gateway-structured-logging or CODER_AI_GATEWAY_STRUCTURED_LOGGING instead. Emit structured logs for AI Gateway interception records. Use this for exporting these records to external SIEM or observability systems.",
		...
		aiGatewayStructuredLogging,
		{
			...
			Description: "Deprecated: use --ai-gateway-send-actor-headers or CODER_AI_GATEWAY_SEND_ACTOR_HEADERS instead. Once enabled, extra headers will be added to upstream requests to identify the user (actor) making requests to AI Gateway. " +
				"This is only needed if you are using a proxy between AI Gateway and an upstream AI provider. " +
				"This will send X-Ai-Bridge-Actor-Id (the ID of the user making the request) and X-Ai-Bridge-Actor-Metadata-Username (their username).",
		...
		// AI Gateway Proxy Options
		{
			...
			Description: "Deprecated: use --ai-gateway-proxy-enabled or CODER_AI_GATEWAY_PROXY_ENABLED instead. Enable the AI Gateway MITM Proxy for intercepting and decrypting AI provider requests.",
		...
		aiGatewayProxyEnabled,
		{
			...
			Description: "Deprecated: use --ai-gateway-proxy-listen-addr or CODER_AI_GATEWAY_PROXY_LISTEN_ADDR instead. The address the AI Gateway Proxy will listen on.",
		...
		aiGatewayProxyListenAddr,
		{
			...
			Description: "Deprecated: use --ai-gateway-proxy-tls-cert-file or CODER_AI_GATEWAY_PROXY_TLS_CERT_FILE instead. Path to the TLS certificate file for the AI Gateway Proxy listener. Must be set together with AI Gateway Proxy TLS Key File.",
		...
		aiGatewayProxyTLSCertFile,
		{
			...
			Description: "Deprecated: use --ai-gateway-proxy-tls-key-file or CODER_AI_GATEWAY_PROXY_TLS_KEY_FILE instead. Path to the TLS private key file for the AI Gateway Proxy listener. Must be set together with AI Gateway Proxy TLS Certificate File.",
