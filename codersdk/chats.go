...
const (
	// MaxChatGoalObjectiveBytes limits goal objective text accepted by
	// chat goal mutations.
	MaxChatGoalObjectiveBytes = 4096
	// MaxChatGoalCompletionSummaryBytes limits goal completion summaries
	// accepted by chat goal mutations.
	MaxChatGoalCompletionSummaryBytes = 4096
	// MaxChatGoalBlockedReasonBytes limits blocked reasons accepted by
	// the block_goal tool.
