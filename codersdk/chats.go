...
const (
	...
	// pushed snapshot, hydration first populated it, or hash-neutral MCP
	// resources synchronized in place. The chat stays usable; a refresh
	// re-pins a drifted chat to the latest snapshot.
