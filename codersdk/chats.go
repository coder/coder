...
// CreateUserChat creates a new chat owned by user, on behalf of that
// user. The caller must have permission to create chats owned by that
// user, such as a deployment owner; other callers should use CreateChat
// to create a chat for themselves.
