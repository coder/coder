...
type Task struct {
	...
	WorkspaceStatus         WorkspaceStatus          `json:"workspace_status" enums:"pending,starting,running,stopping,stopped,failed,canceling,canceled,deleting,deleted" table:"status"`
...
type TasksFilter struct {
	...
	//
	// TODO(mafredri): This field is no-op currently.
