...
func Flags() *codersdk.DeploymentFlags {
	return &codersdk.DeploymentFlags{
		...
		WildcardAccessURL: &codersdk.StringFlag{
			...
			Description: `Specifies the wildcard hostname to use for workspace applications in the form "*.example.com" or "*-suffix.example.com". Ports or schemes may not be provided. The scheme will be copied from the access URL.`,
		},
