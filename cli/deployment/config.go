...
// The data for populating this file is from codersdk.DeploymentConfig.
package deployment
...
func NewViper() *viper.Viper {
	...
	v.SetDefault("tls_config.tls_client_auth", "request")
