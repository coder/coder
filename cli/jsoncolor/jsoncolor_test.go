...
func TestShouldUseColor(t *testing.T) {
	...
	defer func() {
		...
		os.Setenv("CODER_COLOR", origCoderColor)
	}()
	...
	tests := []struct {
		...
		},
		{
			...
			envSetup:   func() { os.Setenv("FORCE_COLOR", "1"); os.Setenv("NO_COLOR", "") },
			writer:     func() *bytes.Buffer { return &bytes.Buffer{} },
			wantResult: true,
		},
		{
			...
			mode:       jsoncolor.ColorModeAuto,
			envSetup:   func() { os.Setenv("NO_COLOR", "1"); os.Setenv("FORCE_COLOR", "") },
			writer:     func() *bytes.Buffer { return &bytes.Buffer{} },
			wantResult: false,
		},
		{
			...
			mode:       jsoncolor.ColorModeAuto,
			envSetup:   func() { os.Setenv("CODER_COLOR", "always"); os.Setenv("NO_COLOR", ""); os.Setenv("FORCE_COLOR", "") },
			writer:     func() *bytes.Buffer { return &bytes.Buffer{} },
			wantResult: true,
		},
		{
			...
			mode:       jsoncolor.ColorModeAuto,
			envSetup:   func() { os.Setenv("CODER_COLOR", "never"); os.Setenv("NO_COLOR", ""); os.Setenv("FORCE_COLOR", "") },
			writer:     func() *bytes.Buffer { return &bytes.Buffer{} },
			wantResult: false,
		},
		{
			...
			mode:       jsoncolor.ColorModeAuto,
			envSetup:   func() { os.Setenv("NO_COLOR", ""); os.Setenv("FORCE_COLOR", ""); os.Setenv("CODER_COLOR", "") },
			writer:     func() *bytes.Buffer { return &bytes.Buffer{} },
			wantResult: false,
		},
		{
			...
			mode:       jsoncolor.ColorModeAuto,
			envSetup:   func() { os.Setenv("FORCE_COLOR", "0"); os.Setenv("NO_COLOR", ""); os.Setenv("CODER_COLOR", "") },
			writer:     func() *bytes.Buffer { return &bytes.Buffer{} },
			wantResult: false,
		},
	}
