...
func TestUpdate(t *testing.T) {
	...
	t.Run("OK", func(t *testing.T) {
		...
		version1 := coderdtest.CreateTemplateVersion(t, client, admin.OrganizationID, nil)
		...
		version2 := coderdtest.UpdateTemplateVersion(t, client, admin.OrganizationID, &echo.Responses{
...
func TestUpdateValidateRichParameters(t *testing.T) {
	...
	t.Run("ValidateString", func(t *testing.T) {
		...
		admin := coderdtest.CreateFirstUser(t, client)
		member, _ := coderdtest.CreateAnotherUser(t, client, admin.OrganizationID)
		version := coderdtest.CreateTemplateVersion(t, client, admin.OrganizationID, prepareEchoResponses(stringRichParameters))
		coderdtest.AwaitTemplateVersionJobCompleted(t, client, version.ID)
		template := coderdtest.CreateTemplate(t, client, admin.OrganizationID, version.ID)
	...
	t.Run("ValidateNumber", func(t *testing.T) {
		...
		admin := coderdtest.CreateFirstUser(t, client)
		member, _ := coderdtest.CreateAnotherUser(t, client, admin.OrganizationID)
		version := coderdtest.CreateTemplateVersion(t, client, admin.OrganizationID, prepareEchoResponses(numberRichParameters))
		coderdtest.AwaitTemplateVersionJobCompleted(t, client, version.ID)
	...
	t.Run("ValidateBool", func(t *testing.T) {
		...
		admin := coderdtest.CreateFirstUser(t, client)
		member, _ := coderdtest.CreateAnotherUser(t, client, admin.OrganizationID)
		version := coderdtest.CreateTemplateVersion(t, client, admin.OrganizationID, prepareEchoResponses(boolRichParameters))
		coderdtest.AwaitTemplateVersionJobCompleted(t, client, version.ID)
	...
	t.Run("RequiredParameterAdded", func(t *testing.T) {
		...
		version = coderdtest.UpdateTemplateVersion(t, client, admin.OrganizationID, prepareEchoResponses(modifiedParameters), template.ID)
		coderdtest.AwaitTemplateVersionJobCompleted(t, client, version.ID)
		err = client.UpdateActiveTemplateVersion(context.Background(), template.ID, codersdk.UpdateActiveTemplateVersion{
			ID: version.ID,
		})
	...
	t.Run("ParameterOptionDisappeared", func(t *testing.T) {
		...
		version := coderdtest.CreateTemplateVersion(t, client, admin.OrganizationID, prepareEchoResponses(templateParameters))
		coderdtest.AwaitTemplateVersionJobCompleted(t, client, version.ID)
		template := coderdtest.CreateTemplate(t, client, admin.OrganizationID, version.ID)
		...
		updatedVersion := coderdtest.UpdateTemplateVersion(t, client, admin.OrganizationID, prepareEchoResponses(updatedTemplateParameters), template.ID)
		coderdtest.AwaitTemplateVersionJobCompleted(t, client, updatedVersion.ID)
		err = client.UpdateActiveTemplateVersion(context.Background(), template.ID, codersdk.UpdateActiveTemplateVersion{
			ID: updatedVersion.ID,
		})
