...
func TestStatter(t *testing.T) {
	...
	t.Run("cgroupns=host", func(t *testing.T) {
		t.Parallel()
		fs := initFS(t, fsContainerCgroupV2NsHost)
		s, err := New(WithFS(fs), withNoWait)
		require.NoError(t, err)
		mem, err := s.ContainerMemory(PrefixDefault)
		require.NoError(t, err)
...
func TestIsContainerized(t *testing.T) {
	...
	for _, tt := range []struct {
		...
		{
			Name:     "Docker (Cgroupns=host)",
			FS:       fsContainerCgroupV2NsHost,
			Expected: true,
			Error:    "",
		},
	} {
...
proc /proc/sys proc ro,nosuid,nodev,noexec,relatime 0 0`,
	...
	// Generated by: docker run -it --rm --cgroupns=host debian:bookworm cat $PATH
	fsContainerCgroupV2NsHost = map[string]string{
		procOneCgroup: "0::/system.slice/docker-3384dbfd412abed993f06cb84276cd1387d8c10245f5b2d81d71d9b61a9daaf8.scope",
		procMounts: `overlay / overlay rw,relatime,lowerdir=/var/lib/docker/overlay2/l/5XAOWHREXBQQ3HPTMAELLVWXVU:/var/lib/docker/overlay2/l/566DSRTVFMFTCM2GQRS7KPVJJY,upperdir=/var/lib/docker/overlay2/107e0915758e44b269828524e4ff0f4673e92e86a4e8269ca59974b0448a2b1b/diff,workdir=/var/lib/docker/overlay2/107e0915758e44b269828524e4ff0f4673e92e86a4e8269ca59974b0448a2b1b/work,nouserxattr 0 0
...
/dev/vda1 /coder ext4 rw,relatime,discard,errors=remount-ro,commit=30 0 0
/dev/vda1 /etc/resolv.conf ext4 rw,relatime,discard,errors=remount-ro,commit=30 0 0
/dev/vda1 /etc/hostname ext4 rw,relatime,discard,errors=remount-ro,commit=30 0 0
/dev/vda1 /etc/hosts ext4 rw,relatime,discard,errors=remount-ro,commit=30 0 0
