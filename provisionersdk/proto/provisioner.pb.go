...
// ResourceState represents the update of a resource.
type ResourceState int32

const (
	ResourceState_CREATED   ResourceState = 0
	ResourceState_CHANGED   ResourceState = 1
	ResourceState_DESTROYED ResourceState = 2
)
...
type Resource struct {
	...
	State ResourceState `protobuf:"varint,1,opt,name=state,proto3,enum=provisioner.ResourceState" json:"state,omitempty"`
	Name  string        `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
...
var file_provisionersdk_proto_provisioner_proto_rawDesc = []byte{
	...
	0x22, 0x64, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x30, 0x0a, 0x05,
	0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x70, 0x72,
	...
	0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0xfc, 0x01, 0x0a, 0x05, 0x50, 0x61, 0x72, 0x73, 0x65,
	...
	0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0xfc, 0x02, 0x0a, 0x09, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x73,
	0x69, 0x6f, 0x6e, 0x1a, 0x9e, 0x01, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	...
	0x79, 0x52, 0x75, 0x6e, 0x1a, 0x55, 0x0a, 0x08, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65,
	...
	0x52, 0x4f, 0x52, 0x10, 0x04, 0x2a, 0x38, 0x0a, 0x0d, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x0b, 0x0a, 0x07, 0x43, 0x52, 0x45, 0x41, 0x54, 0x45,
	...
	0xa1, 0x01, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x65, 0x72, 0x12,
	...
	0x65, 0x30, 0x01, 0x12, 0x4e, 0x0a, 0x09, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e,
...
var file_provisionersdk_proto_provisioner_proto_goTypes = []interface{}{
	...
	(ResourceState)(0),               // 1: provisioner.ResourceState
	...
	(*Parse_Request)(nil),            // 13: provisioner.Parse.Request
	(*Parse_Complete)(nil),           // 14: provisioner.Parse.Complete
	(*Parse_Response)(nil),           // 15: provisioner.Parse.Response
	(*Provision_Request)(nil),        // 16: provisioner.Provision.Request
	(*Provision_Complete)(nil),       // 17: provisioner.Provision.Complete
	(*Provision_Response)(nil),       // 18: provisioner.Provision.Response
}
var file_provisionersdk_proto_provisioner_proto_depIdxs = []int32{
	...
	1,  // 7: provisioner.Resource.state:type_name -> provisioner.ResourceState
	8,  // 8: provisioner.Parse.Complete.parameter_schemas:type_name -> provisioner.ParameterSchema
	9,  // 9: provisioner.Parse.Response.log:type_name -> provisioner.Log
	14, // 10: provisioner.Parse.Response.complete:type_name -> provisioner.Parse.Complete
	7,  // 11: provisioner.Provision.Request.parameter_values:type_name -> provisioner.ParameterValue
	10, // 12: provisioner.Provision.Complete.resources:type_name -> provisioner.Resource
	9,  // 13: provisioner.Provision.Response.log:type_name -> provisioner.Log
	17, // 14: provisioner.Provision.Response.complete:type_name -> provisioner.Provision.Complete
	13, // 15: provisioner.Provisioner.Parse:input_type -> provisioner.Parse.Request
	16, // 16: provisioner.Provisioner.Provision:input_type -> provisioner.Provision.Request
	15, // 17: provisioner.Provisioner.Parse:output_type -> provisioner.Parse.Response
	18, // 18: provisioner.Provisioner.Provision:output_type -> provisioner.Provision.Response
