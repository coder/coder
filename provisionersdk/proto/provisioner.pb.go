...
func (*Provision_Apply) Descriptor() ([]byte, []int) {
	return file_provisionersdk_proto_provisioner_proto_rawDescGZIP(), []int{16, 3}
}
...
func (*Provision_Cancel) Descriptor() ([]byte, []int) {
	return file_provisionersdk_proto_provisioner_proto_rawDescGZIP(), []int{16, 4}
}
...
func (*Provision_Request) Descriptor() ([]byte, []int) {
	return file_provisionersdk_proto_provisioner_proto_rawDescGZIP(), []int{16, 5}
}
...
func (*Provision_Complete) Descriptor() ([]byte, []int) {
	return file_provisionersdk_proto_provisioner_proto_rawDescGZIP(), []int{16, 6}
}
...
func (*Provision_Response) Descriptor() ([]byte, []int) {
	return file_provisionersdk_proto_provisioner_proto_rawDescGZIP(), []int{16, 7}
}
...
var file_provisionersdk_proto_provisioner_proto_rawDesc = []byte{
	...
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x4a,
	...
	0x65, 0x49, 0x64, 0x22, 0x8e, 0x05, 0x0a, 0x05, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x12, 0x0e, 0x0a,
	...
	0x65, 0x12, 0x2c, 0x0a, 0x12, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x5f, 0x62, 0x65, 0x66, 0x6f, 0x72,
	0x65, 0x5f, 0x72, 0x65, 0x61, 0x64, 0x79, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x08, 0x52, 0x10, 0x6c,
	0x6f, 0x67, 0x69, 0x6e, 0x42, 0x65, 0x66, 0x6f, 0x72, 0x65, 0x52, 0x65, 0x61, 0x64, 0x79, 0x12,
	0x43, 0x0a, 0x1e, 0x73, 0x74, 0x61, 0x72, 0x74, 0x75, 0x70, 0x5f, 0x73, 0x63, 0x72, 0x69, 0x70,
	0x74, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x5f, 0x73, 0x65, 0x63, 0x6f, 0x6e, 0x64,
	0x73, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x05, 0x52, 0x1b, 0x73, 0x74, 0x61, 0x72, 0x74, 0x75, 0x70,
	0x53, 0x63, 0x72, 0x69, 0x70, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x53, 0x65, 0x63,
	...
	0x01, 0x0a, 0x08, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x12, 0x49, 0x0a, 0x11, 0x70,
	0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x5f, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x73,
	0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69,
	...
	0x62, 0x6c, 0x65, 0x73, 0x1a, 0x73, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
...
var file_provisionersdk_proto_provisioner_proto_goTypes = []interface{}{
	...
	(*Parse)(nil),                    // 21: provisioner.Parse
	(*Provision)(nil),                // 22: provisioner.Provision
	nil,                              // 23: provisioner.Agent.EnvEntry
	(*Resource_Metadata)(nil),        // 24: provisioner.Resource.Metadata
	(*Parse_Request)(nil),            // 25: provisioner.Parse.Request
	(*Parse_Complete)(nil),           // 26: provisioner.Parse.Complete
	(*Parse_Response)(nil),           // 27: provisioner.Parse.Response
	(*Provision_Metadata)(nil),       // 28: provisioner.Provision.Metadata
	(*Provision_Config)(nil),         // 29: provisioner.Provision.Config
	(*Provision_Plan)(nil),           // 30: provisioner.Provision.Plan
	(*Provision_Apply)(nil),          // 31: provisioner.Provision.Apply
	(*Provision_Cancel)(nil),         // 32: provisioner.Provision.Cancel
	(*Provision_Request)(nil),        // 33: provisioner.Provision.Request
	(*Provision_Complete)(nil),       // 34: provisioner.Provision.Complete
	(*Provision_Response)(nil),       // 35: provisioner.Provision.Response
}
var file_provisionersdk_proto_provisioner_proto_depIdxs = []int32{
	...
	23, // 8: provisioner.Agent.env:type_name -> provisioner.Agent.EnvEntry
	18, // 9: provisioner.Agent.apps:type_name -> provisioner.App
	19, // 10: provisioner.App.healthcheck:type_name -> provisioner.Healthcheck
	1,  // 11: provisioner.App.sharing_level:type_name -> provisioner.AppSharingLevel
	17, // 12: provisioner.Resource.agents:type_name -> provisioner.Agent
	24, // 13: provisioner.Resource.metadata:type_name -> provisioner.Resource.Metadata
	...
	15, // 16: provisioner.Parse.Response.log:type_name -> provisioner.Log
	26, // 17: provisioner.Parse.Response.complete:type_name -> provisioner.Parse.Complete
	2,  // 18: provisioner.Provision.Metadata.workspace_transition:type_name -> provisioner.WorkspaceTransition
	28, // 19: provisioner.Provision.Config.metadata:type_name -> provisioner.Provision.Metadata
	29, // 20: provisioner.Provision.Plan.config:type_name -> provisioner.Provision.Config
	...
	29, // 23: provisioner.Provision.Apply.config:type_name -> provisioner.Provision.Config
	30, // 24: provisioner.Provision.Request.plan:type_name -> provisioner.Provision.Plan
	31, // 25: provisioner.Provision.Request.apply:type_name -> provisioner.Provision.Apply
	32, // 26: provisioner.Provision.Request.cancel:type_name -> provisioner.Provision.Cancel
	20, // 27: provisioner.Provision.Complete.resources:type_name -> provisioner.Resource
	13, // 28: provisioner.Provision.Complete.parameters:type_name -> provisioner.RichParameter
	15, // 29: provisioner.Provision.Response.log:type_name -> provisioner.Log
	34, // 30: provisioner.Provision.Response.complete:type_name -> provisioner.Provision.Complete
	25, // 31: provisioner.Provisioner.Parse:input_type -> provisioner.Parse.Request
	33, // 32: provisioner.Provisioner.Provision:input_type -> provisioner.Provision.Request
	27, // 33: provisioner.Provisioner.Parse:output_type -> provisioner.Parse.Response
	35, // 34: provisioner.Provisioner.Provision:output_type -> provisioner.Provision.Response
...
func file_provisionersdk_proto_provisioner_proto_init() {
	...
	file_provisionersdk_proto_provisioner_proto_msgTypes[11].OneofWrappers = []interface{}{
		(*Agent_Token)(nil),
