...
type ParameterSource_Target int32

const (
	ParameterSource_DATA ParameterSource_Target = 0
)

// Enum value maps for ParameterSource_Target.
var (
	ParameterSource_Target_name = map[int32]string{
		0: "DATA",
	}
	ParameterSource_Target_value = map[string]int32{
		"DATA": 0,
	}
)

func (x ParameterSource_Target) Enum() *ParameterSource_Target {
	p := new(ParameterSource_Target)
	*p = x
	return p
}

func (x ParameterSource_Target) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ParameterSource_Target) Descriptor() protoreflect.EnumDescriptor {
	return file_provisionersdk_proto_provisioner_proto_enumTypes[0].Descriptor()
}

func (ParameterSource_Target) Type() protoreflect.EnumType {
	return &file_provisionersdk_proto_provisioner_proto_enumTypes[0]
}

func (x ParameterSource_Target) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ParameterSource_Target.Descriptor instead.
func (ParameterSource_Target) EnumDescriptor() ([]byte, []int) {
	return file_provisionersdk_proto_provisioner_proto_rawDescGZIP(), []int{0, 0}
}

type ParameterDestination_Target int32

const (
	ParameterDestination_ENVIRONMENT_VARIABLE ParameterDestination_Target = 0
	ParameterDestination_PROVISIONER_VARIABLE ParameterDestination_Target = 1
)

// Enum value maps for ParameterDestination_Target.
var (
	ParameterDestination_Target_name = map[int32]string{
		0: "ENVIRONMENT_VARIABLE",
		1: "PROVISIONER_VARIABLE",
	}
	ParameterDestination_Target_value = map[string]int32{
		"ENVIRONMENT_VARIABLE": 0,
		"PROVISIONER_VARIABLE": 1,
	}
)

func (x ParameterDestination_Target) Enum() *ParameterDestination_Target {
	p := new(ParameterDestination_Target)
	*p = x
	return p
}

func (x ParameterDestination_Target) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ParameterDestination_Target) Descriptor() protoreflect.EnumDescriptor {
	return file_provisionersdk_proto_provisioner_proto_enumTypes[1].Descriptor()
}

func (ParameterDestination_Target) Type() protoreflect.EnumType {
	return &file_provisionersdk_proto_provisioner_proto_enumTypes[1]
}

func (x ParameterDestination_Target) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ParameterDestination_Target.Descriptor instead.
func (ParameterDestination_Target) EnumDescriptor() ([]byte, []int) {
...
type ParameterSource struct {
	...
	Target ParameterSource_Target `protobuf:"varint,1,opt,name=target,proto3,enum=provisioner.ParameterSource_Target" json:"target,omitempty"`
...
func (x *ParameterSource) GetTarget() ParameterSource_Target {
	if x != nil {
		return x.Target
	}
...
type ParameterDestination struct {
	...
	Target ParameterDestination_Target `protobuf:"varint,1,opt,name=target,proto3,enum=provisioner.ParameterDestination_Target" json:"target,omitempty"`
	Value  string                      `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty"`
}
...
func (x *ParameterDestination) GetTarget() ParameterDestination_Target {
	if x != nil {
		return x.Target
	}
...
type ParameterValue struct {
	...
	DestinationTarget ParameterDestination_Target `protobuf:"varint,1,opt,name=destination_target,json=destinationTarget,proto3,enum=provisioner.ParameterDestination_Target" json:"destination_target,omitempty"`
...
func (x *ParameterValue) GetDestinationTarget() ParameterDestination_Target {
	if x != nil {
...
func (x *Metadata_Request) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Metadata_Request) ProtoMessage() {}

func (x *Metadata_Request) ProtoReflect() protoreflect.Message {
	mi := &file_provisionersdk_proto_provisioner_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Metadata_Request.ProtoReflect.Descriptor instead.
func (*Metadata_Request) Descriptor() ([]byte, []int) {
...
func (x *Metadata_Response) Reset() {
	*x = Metadata_Response{}
	if protoimpl.UnsafeEnabled {
...
func (x *Metadata_Response) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Metadata_Response) ProtoMessage() {}

func (x *Metadata_Response) ProtoReflect() protoreflect.Message {
	mi := &file_provisionersdk_proto_provisioner_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Metadata_Response.ProtoReflect.Descriptor instead.
func (*Metadata_Response) Descriptor() ([]byte, []int) {
	return file_provisionersdk_proto_provisioner_proto_rawDescGZIP(), []int{7, 1}
}

func (x *Metadata_Response) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
var file_provisionersdk_proto_provisioner_proto_rawDesc = []byte{
	...
	,
	...
	0x5f, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x28, 0x2e,
	...
	0x2e, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x52, 0x11, 0x64, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61,
	...
	,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4c, 0x0a, 0x09, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69,
...
var file_provisionersdk_proto_provisioner_proto_goTypes = []interface{}{
	(ParameterSource_Target)(0),      // 0: provisioner.ParameterSource.Target
	(ParameterDestination_Target)(0), // 1: provisioner.ParameterDestination.Target
	...
	(*Metadata)(nil),                 // 10: provisioner.Metadata
	(*Parse_Request)(nil),            // 11: provisioner.Parse.Request
	(*Parse_Response)(nil),           // 12: provisioner.Parse.Response
	(*Provision_Request)(nil),        // 13: provisioner.Provision.Request
	(*Provision_Response)(nil),       // 14: provisioner.Provision.Response
	(*Metadata_Request)(nil),         // 15: provisioner.Metadata.Request
	(*Metadata_Response)(nil),        // 16: provisioner.Metadata.Response
}
var file_provisionersdk_proto_provisioner_proto_depIdxs = []int32{
	0,  // 0: provisioner.ParameterSource.target:type_name -> provisioner.ParameterSource.Target
	1,  // 1: provisioner.ParameterDestination.target:type_name -> provisioner.ParameterDestination.Target
	1,  // 2: provisioner.ParameterValue.destination_target:type_name -> provisioner.ParameterDestination.Target
	...
	15, // 9: provisioner.Provisioner.Metadata:input_type -> provisioner.Metadata.Request
	11, // 10: provisioner.Provisioner.Parse:input_type -> provisioner.Parse.Request
	13, // 11: provisioner.Provisioner.Provision:input_type -> provisioner.Provision.Request
	16, // 12: provisioner.Provisioner.Metadata:output_type -> provisioner.Metadata.Response
	12, // 13: provisioner.Provisioner.Parse:output_type -> provisioner.Parse.Response
	14, // 14: provisioner.Provisioner.Provision:output_type -> provisioner.Provision.Response
...
func file_provisionersdk_proto_provisioner_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_provisionersdk_proto_provisioner_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Metadata_Response); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
