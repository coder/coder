...
type PreApplyPlanComplete struct {
	...
	Error string `protobuf:"bytes,1,opt,name=error,proto3" json:"error,omitempty"`
	Plan  []byte `protobuf:"bytes,2,opt,name=plan,proto3" json:"plan,omitempty"` // TODO: The rest (modules, timings, ...)
}
...
var file_provisionersdk_proto_provisioner_proto_rawDesc = []byte{
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xbe, 0x03, 0x0a, 0x0b, 0x50, 0x6c, 0x61, 0x6e, 0x52, 0x65,
	...
	0x65, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x22, 0x40, 0x0a, 0x14, 0x50, 0x72, 0x65, 0x41, 0x70, 0x70,
	0x6c, 0x79, 0x50, 0x6c, 0x61, 0x6e, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x12, 0x14,
	0x0a, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65,
	0x72, 0x72, 0x6f, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x6c, 0x61, 0x6e, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0c, 0x52, 0x04, 0x70, 0x6c, 0x61, 0x6e, 0x22, 0xc1, 0x05, 0x0a, 0x0c, 0x50, 0x6c, 0x61,
	...
	0x61, 0x6e, 0x63, 0x65, 0x6c, 0x42, 0x06, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0x8c, 0x03,
	...
	0x65, 0x12, 0x41, 0x0a, 0x09, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x50, 0x6c, 0x61, 0x6e, 0x18, 0x07,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e,
	0x65, 0x72, 0x2e, 0x50, 0x72, 0x65, 0x41, 0x70, 0x70, 0x6c, 0x79, 0x50, 0x6c, 0x61, 0x6e, 0x43,
	0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x48, 0x00, 0x52, 0x09, 0x62, 0x75, 0x69, 0x6c, 0x64,
	0x50, 0x6c, 0x61, 0x6e, 0x42, 0x06, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0x9c, 0x01, 0x0a,
...
var file_provisionersdk_proto_provisioner_proto_depIdxs = []int32{
	...
	50, // 38: provisioner.PlanComplete.timings:type_name -> provisioner.Timing
	...
	50, // 47: provisioner.ApplyComplete.timings:type_name -> provisioner.Timing
	40, // 48: provisioner.ApplyComplete.ai_tasks:type_name -> provisioner.AITask
	60, // 49: provisioner.Timing.start:type_name -> google.protobuf.Timestamp
	60, // 50: provisioner.Timing.end:type_name -> google.protobuf.Timestamp
	...
	48, // 55: provisioner.Request.apply:type_name -> provisioner.ApplyRequest
	51, // 56: provisioner.Request.cancel:type_name -> provisioner.CancelRequest
	...
	47, // 59: provisioner.Response.plan:type_name -> provisioner.PlanComplete
	49, // 60: provisioner.Response.apply:type_name -> provisioner.ApplyComplete
	54, // 61: provisioner.Response.data_upload:type_name -> provisioner.DataUpload
	55, // 62: provisioner.Response.chunk_piece:type_name -> provisioner.ChunkPiece
	46, // 63: provisioner.Response.buildPlan:type_name -> provisioner.PreApplyPlanComplete
	7,  // 64: provisioner.DataUpload.upload_type:type_name -> provisioner.DataUploadType
