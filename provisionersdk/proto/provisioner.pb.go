...
type PlanComplete struct {
	...
	ResourceReplacements  []*ResourceReplacement          `protobuf:"bytes,10,rep,name=resourceReplacements,proto3" json:"resourceReplacements,omitempty"`
}
...
var file_provisionersdk_proto_provisioner_proto_rawDesc = []byte{
	...
	0xae, 0x09, 0x0a, 0x08, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x1b, 0x0a, 0x09,
	...
	0x61, 0x63, 0x65, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x53, 0x74, 0x61, 0x67, 0x65, 0x12, 0x41, 0x0a,
	0x1d, 0x72, 0x75, 0x6e, 0x6e, 0x69, 0x6e, 0x67, 0x5f, 0x77, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61,
	0x63, 0x65, 0x5f, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x15,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x1a, 0x72, 0x75, 0x6e, 0x6e, 0x69, 0x6e, 0x67, 0x57, 0x6f, 0x72,
	0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x54, 0x6f, 0x6b, 0x65, 0x6e,
	...
	0x74, 0x68, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x73, 0x22, 0xef, 0x03, 0x0a, 0x0c,
	...
	0x0c, 0x52, 0x04, 0x70, 0x6c, 0x61, 0x6e, 0x12, 0x54, 0x0a, 0x14, 0x72, 0x65, 0x73, 0x6f, 0x75,
	0x72, 0x63, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x61, 0x63, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x18,
...
var file_provisionersdk_proto_provisioner_proto_depIdxs = []int32{
	...
	48, // 23: provisioner.ParseComplete.workspace_tags:type_name -> provisioner.ParseComplete.WorkspaceTagsEntry
	33, // 24: provisioner.PlanRequest.metadata:type_name -> provisioner.Metadata
	10, // 25: provisioner.PlanRequest.rich_parameter_values:type_name -> provisioner.RichParameterValue
	15, // 26: provisioner.PlanRequest.variable_values:type_name -> provisioner.VariableValue
	19, // 27: provisioner.PlanRequest.external_auth_providers:type_name -> provisioner.ExternalAuthProvider
	30, // 28: provisioner.PlanComplete.resources:type_name -> provisioner.Resource
	9,  // 29: provisioner.PlanComplete.parameters:type_name -> provisioner.RichParameter
	18, // 30: provisioner.PlanComplete.external_auth_providers:type_name -> provisioner.ExternalAuthProviderResource
	41, // 31: provisioner.PlanComplete.timings:type_name -> provisioner.Timing
	31, // 32: provisioner.PlanComplete.modules:type_name -> provisioner.Module
	12, // 33: provisioner.PlanComplete.presets:type_name -> provisioner.Preset
	14, // 34: provisioner.PlanComplete.resourceReplacements:type_name -> provisioner.ResourceReplacement
	33, // 35: provisioner.ApplyRequest.metadata:type_name -> provisioner.Metadata
	30, // 36: provisioner.ApplyComplete.resources:type_name -> provisioner.Resource
	9,  // 37: provisioner.ApplyComplete.parameters:type_name -> provisioner.RichParameter
	18, // 38: provisioner.ApplyComplete.external_auth_providers:type_name -> provisioner.ExternalAuthProviderResource
	41, // 39: provisioner.ApplyComplete.timings:type_name -> provisioner.Timing
	49, // 40: provisioner.Timing.start:type_name -> google.protobuf.Timestamp
	49, // 41: provisioner.Timing.end:type_name -> google.protobuf.Timestamp
	5,  // 42: provisioner.Timing.state:type_name -> provisioner.TimingState
	34, // 43: provisioner.Request.config:type_name -> provisioner.Config
	35, // 44: provisioner.Request.parse:type_name -> provisioner.ParseRequest
	37, // 45: provisioner.Request.plan:type_name -> provisioner.PlanRequest
	39, // 46: provisioner.Request.apply:type_name -> provisioner.ApplyRequest
	42, // 47: provisioner.Request.cancel:type_name -> provisioner.CancelRequest
	16, // 48: provisioner.Response.log:type_name -> provisioner.Log
	36, // 49: provisioner.Response.parse:type_name -> provisioner.ParseComplete
	38, // 50: provisioner.Response.plan:type_name -> provisioner.PlanComplete
	40, // 51: provisioner.Response.apply:type_name -> provisioner.ApplyComplete
	43, // 52: provisioner.Provisioner.Session:input_type -> provisioner.Request
	44, // 53: provisioner.Provisioner.Session:output_type -> provisioner.Response
