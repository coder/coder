...
type Agent struct {
	...
	WorkspaceApps       []string             `protobuf:"bytes,27,rep,name=workspace_apps,json=workspaceApps,proto3" json:"workspace_apps,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *Agent) GetWorkspaceApps() []string {
	if x != nil {
		return x.WorkspaceApps
	}
	return nil
}
...
const file_provisionersdk_proto_provisioner_proto_rawDesc = "" +
	...
	"\faccess_token\x18\x02 \x01(\tR\vaccessToken\"\x81\t\n" +
	"\x05Agent\x12\x0e\n" +
	...
	"\rapi_key_scope\x18\x1a \x01(\tR\vapiKeyScope\x12%\n" +
	"\x0eworkspace_apps\x18\x1b \x03(\tR\rworkspaceApps\x1a\xa3\x01\n" +
	"\bMetadata\x12\x10\n" +
