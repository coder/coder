...
var file_provisionersdk_proto_provisioner_proto_rawDesc = []byte{
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x22, 0x31, 0x0a, 0x04, 0x52,
	...
	0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6f, 0x72, 0x67, 0x49, 0x64, 0x22, 0xfc,
	...
	0x77, 0x6e, 0x65, 0x72, 0x52, 0x62, 0x61, 0x63, 0x52, 0x6f, 0x6c, 0x65, 0x73, 0x22, 0x8a, 0x01,
...
var file_provisionersdk_proto_provisioner_proto_msgTypes = make([]protoimpl.MessageInfo, 38)
var file_provisionersdk_proto_provisioner_proto_goTypes = []interface{}{
	...
	(*Role)(nil),                         // 26: provisioner.Role
	(*Metadata)(nil),                     // 27: provisioner.Metadata
	(*Config)(nil),                       // 28: provisioner.Config
	(*ParseRequest)(nil),                 // 29: provisioner.ParseRequest
	(*ParseComplete)(nil),                // 30: provisioner.ParseComplete
	(*PlanRequest)(nil),                  // 31: provisioner.PlanRequest
	(*PlanComplete)(nil),                 // 32: provisioner.PlanComplete
	(*ApplyRequest)(nil),                 // 33: provisioner.ApplyRequest
	(*ApplyComplete)(nil),                // 34: provisioner.ApplyComplete
	(*Timing)(nil),                       // 35: provisioner.Timing
	(*CancelRequest)(nil),                // 36: provisioner.CancelRequest
	(*Request)(nil),                      // 37: provisioner.Request
	(*Response)(nil),                     // 38: provisioner.Response
	(*Agent_Metadata)(nil),               // 39: provisioner.Agent.Metadata
	nil,                                  // 40: provisioner.Agent.EnvEntry
	(*Resource_Metadata)(nil),            // 41: provisioner.Resource.Metadata
	nil,                                  // 42: provisioner.ParseComplete.WorkspaceTagsEntry
...
var file_provisionersdk_proto_provisioner_proto_depIdxs = []int32{
	...
	40, // 2: provisioner.Agent.env:type_name -> provisioner.Agent.EnvEntry
	22, // 3: provisioner.Agent.apps:type_name -> provisioner.App
	39, // 4: provisioner.Agent.metadata:type_name -> provisioner.Agent.Metadata
	...
	41, // 15: provisioner.Resource.metadata:type_name -> provisioner.Resource.Metadata
	3,  // 16: provisioner.Metadata.workspace_transition:type_name -> provisioner.WorkspaceTransition
	26, // 17: provisioner.Metadata.workspace_owner_rbac_roles:type_name -> provisioner.Role
	6,  // 18: provisioner.ParseComplete.template_variables:type_name -> provisioner.TemplateVariable
	42, // 19: provisioner.ParseComplete.workspace_tags:type_name -> provisioner.ParseComplete.WorkspaceTagsEntry
	27, // 20: provisioner.PlanRequest.metadata:type_name -> provisioner.Metadata
	9,  // 21: provisioner.PlanRequest.rich_parameter_values:type_name -> provisioner.RichParameterValue
	10, // 22: provisioner.PlanRequest.variable_values:type_name -> provisioner.VariableValue
	14, // 23: provisioner.PlanRequest.external_auth_providers:type_name -> provisioner.ExternalAuthProvider
	24, // 24: provisioner.PlanComplete.resources:type_name -> provisioner.Resource
	8,  // 25: provisioner.PlanComplete.parameters:type_name -> provisioner.RichParameter
	13, // 26: provisioner.PlanComplete.external_auth_providers:type_name -> provisioner.ExternalAuthProviderResource
	35, // 27: provisioner.PlanComplete.timings:type_name -> provisioner.Timing
	25, // 28: provisioner.PlanComplete.modules:type_name -> provisioner.Module
	27, // 29: provisioner.ApplyRequest.metadata:type_name -> provisioner.Metadata
	24, // 30: provisioner.ApplyComplete.resources:type_name -> provisioner.Resource
	8,  // 31: provisioner.ApplyComplete.parameters:type_name -> provisioner.RichParameter
	13, // 32: provisioner.ApplyComplete.external_auth_providers:type_name -> provisioner.ExternalAuthProviderResource
	35, // 33: provisioner.ApplyComplete.timings:type_name -> provisioner.Timing
	43, // 34: provisioner.Timing.start:type_name -> google.protobuf.Timestamp
	43, // 35: provisioner.Timing.end:type_name -> google.protobuf.Timestamp
	4,  // 36: provisioner.Timing.state:type_name -> provisioner.TimingState
	28, // 37: provisioner.Request.config:type_name -> provisioner.Config
	29, // 38: provisioner.Request.parse:type_name -> provisioner.ParseRequest
	31, // 39: provisioner.Request.plan:type_name -> provisioner.PlanRequest
	33, // 40: provisioner.Request.apply:type_name -> provisioner.ApplyRequest
	36, // 41: provisioner.Request.cancel:type_name -> provisioner.CancelRequest
	11, // 42: provisioner.Response.log:type_name -> provisioner.Log
	30, // 43: provisioner.Response.parse:type_name -> provisioner.ParseComplete
	32, // 44: provisioner.Response.plan:type_name -> provisioner.PlanComplete
	34, // 45: provisioner.Response.apply:type_name -> provisioner.ApplyComplete
	37, // 46: provisioner.Provisioner.Session:input_type -> provisioner.Request
	38, // 47: provisioner.Provisioner.Session:output_type -> provisioner.Response
