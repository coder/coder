...
var file_provisionersdk_proto_provisioner_proto_rawDesc = []byte{
	...
	0x6c, 0x65, 0x74, 0x65, 0x42, 0x06, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0xd8, 0x05, 0x0a,
	...
	0x61, 0x6e, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x1a, 0xd9, 0x01, 0x0a, 0x05, 0x53, 0x74, 0x61,
	...
	,
	...
	0x65, 0x1a, 0x6b, 0x0a, 0x08, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x12, 0x14, 0x0a,
	...
	0x72, 0x63, 0x65, 0x52, 0x09, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x1a, 0x77,
	...
	0x05, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x04, 0x2a, 0x37, 0x0a, 0x13, 0x57, 0x6f, 0x72, 0x6b,
...
var file_provisionersdk_proto_provisioner_proto_depIdxs = []int32{
	...
	20, // 15: provisioner.Provision.Start.metadata:type_name -> provisioner.Provision.Metadata
	21, // 16: provisioner.Provision.Request.start:type_name -> provisioner.Provision.Start
	22, // 17: provisioner.Provision.Request.cancel:type_name -> provisioner.Provision.Cancel
	13, // 18: provisioner.Provision.Complete.resources:type_name -> provisioner.Resource
	10, // 19: provisioner.Provision.Response.log:type_name -> provisioner.Log
	24, // 20: provisioner.Provision.Response.complete:type_name -> provisioner.Provision.Complete
	17, // 21: provisioner.Provisioner.Parse:input_type -> provisioner.Parse.Request
	23, // 22: provisioner.Provisioner.Provision:input_type -> provisioner.Provision.Request
	19, // 23: provisioner.Provisioner.Parse:output_type -> provisioner.Parse.Response
	25, // 24: provisioner.Provisioner.Provision:output_type -> provisioner.Provision.Response
