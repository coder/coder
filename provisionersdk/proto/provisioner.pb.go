...
func (Diagnostic_Severity) EnumDescriptor() ([]byte, []int) {
	return file_provisionersdk_proto_provisioner_proto_rawDescGZIP(), []int{41, 0}
}
...
type Diagnostic struct {
	...
	Severity Diagnostic_Severity `protobuf:"varint,1,opt,name=severity,proto3,enum=provisioner.Diagnostic_Severity" json:"severity,omitempty"`
...
func (x *PlanComplete) GetDiagnostics() []*Diagnostic {
	if x != nil {
...
func (x *ApplyComplete) GetDiagnostics() []*Diagnostic {
	if x != nil {
		return x.Diagnostics
	}
	return nil
...
var file_provisionersdk_proto_provisioner_proto_rawDesc = []byte{
	...
	0x65, 0x63, 0x72, 0x65, 0x74, 0x73, 0x22, 0xad, 0x01, 0x0a, 0x0a, 0x44, 0x69, 0x61, 0x67, 0x6e,
	0x6f, 0x73, 0x74, 0x69, 0x63, 0x12, 0x3c, 0x0a, 0x08, 0x73, 0x65, 0x76, 0x65, 0x72, 0x69, 0x74,
	0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x73,
	0x69, 0x6f, 0x6e, 0x65, 0x72, 0x2e, 0x44, 0x69, 0x61, 0x67, 0x6e, 0x6f, 0x73, 0x74, 0x69, 0x63,
	...
	0x65, 0x74, 0x61, 0x69, 0x6c, 0x22, 0x2f, 0x0a, 0x08, 0x53, 0x65, 0x76, 0x65, 0x72, 0x69, 0x74,
	...
	0x4e, 0x49, 0x4e, 0x47, 0x10, 0x02, 0x22, 0xbb, 0x02, 0x0a, 0x0c, 0x50, 0x6c, 0x61, 0x6e, 0x43,
	...
	0x54, 0x61, 0x73, 0x6b, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x39, 0x0a, 0x0b, 0x64, 0x69, 0x61,
	0x67, 0x6e, 0x6f, 0x73, 0x74, 0x69, 0x63, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17,
	0x2e, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x65, 0x72, 0x2e, 0x44, 0x69, 0x61,
	0x67, 0x6e, 0x6f, 0x73, 0x74, 0x69, 0x63, 0x52, 0x0b, 0x64, 0x69, 0x61, 0x67, 0x6e, 0x6f, 0x73,
	0x74, 0x69, 0x63, 0x73, 0x22, 0x41, 0x0a, 0x0c, 0x41, 0x70, 0x70, 0x6c, 0x79, 0x52, 0x65, 0x71,
	...
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0xa5, 0x01, 0x0a, 0x0d, 0x41, 0x70, 0x70, 0x6c,
	...
	0x69, 0x6e, 0x67, 0x73, 0x12, 0x39, 0x0a, 0x0b, 0x64, 0x69, 0x61, 0x67, 0x6e, 0x6f, 0x73, 0x74,
	0x69, 0x63, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x70, 0x72, 0x6f, 0x76,
	0x69, 0x73, 0x69, 0x6f, 0x6e, 0x65, 0x72, 0x2e, 0x44, 0x69, 0x61, 0x67, 0x6e, 0x6f, 0x73, 0x74,
...
var file_provisionersdk_proto_provisioner_proto_goTypes = []interface{}{
	...
	(Diagnostic_Severity)(0),             // 9: provisioner.Diagnostic.Severity
	...
	(*Diagnostic)(nil),                   // 51: provisioner.Diagnostic
	(*PlanComplete)(nil),                 // 52: provisioner.PlanComplete
	(*ApplyRequest)(nil),                 // 53: provisioner.ApplyRequest
	(*ApplyComplete)(nil),                // 54: provisioner.ApplyComplete
	(*GraphRequest)(nil),                 // 55: provisioner.GraphRequest
	(*GraphComplete)(nil),                // 56: provisioner.GraphComplete
	(*Timing)(nil),                       // 57: provisioner.Timing
	(*CancelRequest)(nil),                // 58: provisioner.CancelRequest
	(*Request)(nil),                      // 59: provisioner.Request
	(*Response)(nil),                     // 60: provisioner.Response
	(*FileUpload)(nil),                   // 61: provisioner.FileUpload
	(*FailedFile)(nil),                   // 62: provisioner.FailedFile
	(*DataUpload)(nil),                   // 63: provisioner.DataUpload
	(*ChunkPiece)(nil),                   // 64: provisioner.ChunkPiece
	(*Agent_Metadata)(nil),               // 65: provisioner.Agent.Metadata
	nil,                                  // 66: provisioner.Agent.EnvEntry
	(*Resource_Metadata)(nil),            // 67: provisioner.Resource.Metadata
	nil,                                  // 68: provisioner.ParseComplete.WorkspaceTagsEntry
...
var file_provisionersdk_proto_provisioner_proto_depIdxs = []int32{
	...
	66, // 8: provisioner.Agent.env:type_name -> provisioner.Agent.EnvEntry
	35, // 9: provisioner.Agent.apps:type_name -> provisioner.App
	65, // 10: provisioner.Agent.metadata:type_name -> provisioner.Agent.Metadata
	...
	35, // 18: provisioner.Devcontainer.apps:type_name -> provisioner.App
	33, // 19: provisioner.Devcontainer.scripts:type_name -> provisioner.Script
	32, // 20: provisioner.Devcontainer.envs:type_name -> provisioner.Env
	36, // 21: provisioner.App.healthcheck:type_name -> provisioner.Healthcheck
	...
	27, // 24: provisioner.Resource.agents:type_name -> provisioner.Agent
	67, // 25: provisioner.Resource.metadata:type_name -> provisioner.Resource.Metadata
	41, // 26: provisioner.AITask.sidebar_app:type_name -> provisioner.AITaskSidebarApp
	4,  // 27: provisioner.Metadata.workspace_transition:type_name -> provisioner.WorkspaceTransition
	39, // 28: provisioner.Metadata.workspace_owner_rbac_roles:type_name -> provisioner.Role
	5,  // 29: provisioner.Metadata.prebuilt_workspace_build_stage:type_name -> provisioner.PrebuiltWorkspaceBuildStage
	40, // 30: provisioner.Metadata.running_agent_auth_tokens:type_name -> provisioner.RunningAgentAuthToken
	11, // 31: provisioner.ParseComplete.template_variables:type_name -> provisioner.TemplateVariable
	68, // 32: provisioner.ParseComplete.workspace_tags:type_name -> provisioner.ParseComplete.WorkspaceTagsEntry
	57, // 33: provisioner.InitComplete.timings:type_name -> provisioner.Timing
	38, // 34: provisioner.InitComplete.modules:type_name -> provisioner.Module
	43, // 35: provisioner.PlanRequest.metadata:type_name -> provisioner.Metadata
	14, // 36: provisioner.PlanRequest.rich_parameter_values:type_name -> provisioner.RichParameterValue
	22, // 37: provisioner.PlanRequest.variable_values:type_name -> provisioner.VariableValue
	26, // 38: provisioner.PlanRequest.external_auth_providers:type_name -> provisioner.ExternalAuthProvider
	14, // 39: provisioner.PlanRequest.previous_parameter_values:type_name -> provisioner.RichParameterValue
	49, // 40: provisioner.PlanRequest.user_secrets:type_name -> provisioner.UserSecretValue
	9,  // 41: provisioner.Diagnostic.severity:type_name -> provisioner.Diagnostic.Severity
	57, // 42: provisioner.PlanComplete.timings:type_name -> provisioner.Timing
	21, // 43: provisioner.PlanComplete.resource_replacements:type_name -> provisioner.ResourceReplacement
	51, // 44: provisioner.PlanComplete.diagnostics:type_name -> provisioner.Diagnostic
	43, // 45: provisioner.ApplyRequest.metadata:type_name -> provisioner.Metadata
	57, // 46: provisioner.ApplyComplete.timings:type_name -> provisioner.Timing
	51, // 47: provisioner.ApplyComplete.diagnostics:type_name -> provisioner.Diagnostic
	...
	57, // 50: provisioner.GraphComplete.timings:type_name -> provisioner.Timing
	37, // 51: provisioner.GraphComplete.resources:type_name -> provisioner.Resource
	13, // 52: provisioner.GraphComplete.parameters:type_name -> provisioner.RichParameter
	25, // 53: provisioner.GraphComplete.external_auth_providers:type_name -> provisioner.ExternalAuthProviderResource
	19, // 54: provisioner.GraphComplete.presets:type_name -> provisioner.Preset
	42, // 55: provisioner.GraphComplete.ai_tasks:type_name -> provisioner.AITask
	69, // 56: provisioner.Timing.start:type_name -> google.protobuf.Timestamp
	69, // 57: provisioner.Timing.end:type_name -> google.protobuf.Timestamp
	...
	50, // 62: provisioner.Request.plan:type_name -> provisioner.PlanRequest
	53, // 63: provisioner.Request.apply:type_name -> provisioner.ApplyRequest
	55, // 64: provisioner.Request.graph:type_name -> provisioner.GraphRequest
	58, // 65: provisioner.Request.cancel:type_name -> provisioner.CancelRequest
	61, // 66: provisioner.Request.file:type_name -> provisioner.FileUpload
	23, // 67: provisioner.Response.log:type_name -> provisioner.Log
	...
	52, // 70: provisioner.Response.plan:type_name -> provisioner.PlanComplete
	54, // 71: provisioner.Response.apply:type_name -> provisioner.ApplyComplete
	56, // 72: provisioner.Response.graph:type_name -> provisioner.GraphComplete
	63, // 73: provisioner.Response.data_upload:type_name -> provisioner.DataUpload
	64, // 74: provisioner.Response.chunk_piece:type_name -> provisioner.ChunkPiece
	63, // 75: provisioner.FileUpload.data_upload:type_name -> provisioner.DataUpload
	64, // 76: provisioner.FileUpload.chunk_piece:type_name -> provisioner.ChunkPiece
	62, // 77: provisioner.FileUpload.error:type_name -> provisioner.FailedFile
	8,  // 78: provisioner.DataUpload.upload_type:type_name -> provisioner.DataUploadType
	59, // 79: provisioner.Provisioner.Session:input_type -> provisioner.Request
	60, // 80: provisioner.Provisioner.Session:output_type -> provisioner.Response
