...
type Agent_GoogleInstanceIdentity struct {
	...
	GoogleInstanceIdentity *GoogleInstanceIdentityAuth `protobuf:"bytes,6,opt,name=google_instance_identity,json=googleInstanceIdentity,proto3,oneof"`
}
...
func (x *Provision_Complete) GetAgents() []*Agent {
	if x != nil {
		return x.Agents
	}
	return nil
...
var file_provisionersdk_proto_provisioner_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x49, 0x64, 0x22, 0x9a, 0x02, 0x0a, 0x05, 0x41, 0x67,
	0x65, 0x6e, 0x74, 0x12, 0x2d, 0x0a, 0x03, 0x65, 0x6e, 0x76, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b,
	...
	0x65, 0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65,
	0x6e, 0x12, 0x63, 0x0a, 0x18, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x5f, 0x69, 0x6e, 0x73, 0x74,
	0x61, 0x6e, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x18, 0x06, 0x20,
	...
	0x79, 0x70, 0x65, 0x22, 0x90, 0x03, 0x0a, 0x09, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f,
	...
	0x28, 0x0c, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x1a, 0x81, 0x01, 0x0a, 0x08, 0x43, 0x6f,
	...
	0x73, 0x12, 0x2a, 0x0a, 0x06, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x12, 0x2e, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x65, 0x72, 0x2e,
	0x41, 0x67, 0x65, 0x6e, 0x74, 0x52, 0x06, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x73, 0x1a, 0x77, 0x0a,
	...
	0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x04, 0x32, 0xa1, 0x01, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x76,
	...
	0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x30, 0x01, 0x12, 0x4e, 0x0a, 0x09, 0x50,
	...
	0x73, 0x69, 0x6f, 0x6e, 0x65, 0x72, 0x2e, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e,
	0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x30, 0x01, 0x42, 0x2d, 0x5a, 0x2b, 0x67,
...
var file_provisionersdk_proto_provisioner_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_provisionersdk_proto_provisioner_proto_goTypes = []interface{}{
	...
	(*GoogleInstanceIdentityAuth)(nil), // 9: provisioner.GoogleInstanceIdentityAuth
	(*Agent)(nil),                      // 10: provisioner.Agent
	(*Resource)(nil),                   // 11: provisioner.Resource
	(*Parse)(nil),                      // 12: provisioner.Parse
	(*Provision)(nil),                  // 13: provisioner.Provision
	nil,                                // 14: provisioner.Agent.EnvEntry
	(*Parse_Request)(nil),              // 15: provisioner.Parse.Request
	(*Parse_Complete)(nil),             // 16: provisioner.Parse.Complete
	(*Parse_Response)(nil),             // 17: provisioner.Parse.Response
	(*Provision_Request)(nil),          // 18: provisioner.Provision.Request
	(*Provision_Complete)(nil),         // 19: provisioner.Provision.Complete
	(*Provision_Response)(nil),         // 20: provisioner.Provision.Response
}
var file_provisionersdk_proto_provisioner_proto_depIdxs = []int32{
	...
	14, // 7: provisioner.Agent.env:type_name -> provisioner.Agent.EnvEntry
	9,  // 8: provisioner.Agent.google_instance_identity:type_name -> provisioner.GoogleInstanceIdentityAuth
	10, // 9: provisioner.Resource.agent:type_name -> provisioner.Agent
	7,  // 10: provisioner.Parse.Complete.parameter_schemas:type_name -> provisioner.ParameterSchema
	8,  // 11: provisioner.Parse.Response.log:type_name -> provisioner.Log
	16, // 12: provisioner.Parse.Response.complete:type_name -> provisioner.Parse.Complete
	6,  // 13: provisioner.Provision.Request.parameter_values:type_name -> provisioner.ParameterValue
	11, // 14: provisioner.Provision.Complete.resources:type_name -> provisioner.Resource
	10, // 15: provisioner.Provision.Complete.agents:type_name -> provisioner.Agent
	8,  // 16: provisioner.Provision.Response.log:type_name -> provisioner.Log
	19, // 17: provisioner.Provision.Response.complete:type_name -> provisioner.Provision.Complete
	15, // 18: provisioner.Provisioner.Parse:input_type -> provisioner.Parse.Request
	18, // 19: provisioner.Provisioner.Provision:input_type -> provisioner.Provision.Request
	17, // 20: provisioner.Provisioner.Parse:output_type -> provisioner.Parse.Response
	20, // 21: provisioner.Provisioner.Provision:output_type -> provisioner.Provision.Response
