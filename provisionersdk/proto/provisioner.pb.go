...
type ResourcesMonitoring struct {
	...
	Memory  *Resourcemonitor            `protobuf:"bytes,1,opt,name=memory,proto3" json:"memory,omitempty"`
	Volumes map[string]*Resourcemonitor `protobuf:"bytes,2,rep,name=volumes,proto3" json:"volumes,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *ResourcesMonitoring) GetMemory() *Resourcemonitor {
	if x != nil {
		return x.Memory
	}
	return nil
...
func (x *ResourcesMonitoring) GetVolumes() map[string]*Resourcemonitor {
	if x != nil {
		return x.Volumes
	}
	return nil
...
func (x *Resourcemonitor) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
func (x *Resourcemonitor) GetThreshold() int32 {
	if x != nil {
		return x.Threshold
	}
	return 0
...
var file_provisionersdk_proto_provisioner_proto_rawDesc = []byte{
	...
	0x64, 0x79, 0x22, 0xee, 0x01, 0x0a, 0x13, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73,
	0x4d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x69, 0x6e, 0x67, 0x12, 0x34, 0x0a, 0x06, 0x6d, 0x65,
	0x6d, 0x6f, 0x72, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x70, 0x72, 0x6f,
	0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x65, 0x72, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x6d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x52, 0x06, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79,
	0x12, 0x47, 0x0a, 0x07, 0x76, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28,
	...
	0x69, 0x6e, 0x67, 0x2e, 0x56, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79,
	0x52, 0x07, 0x76, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x73, 0x1a, 0x58, 0x0a, 0x0c, 0x56, 0x6f, 0x6c,
	...
	0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x65, 0x72, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x6d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a,
	0x02, 0x38, 0x01, 0x22, 0x49, 0x0a, 0x0f, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x6d,
	...
	0x09, 0x52, 0x07, 0x6c, 0x6f, 0x67, 0x50, 0x61, 0x74, 0x68, 0x22, 0x94, 0x03, 0x0a, 0x03, 0x41,
	...
	0x6c, 0x22, 0x4c, 0x0a, 0x06, 0x4d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x73,
	...
	0xac, 0x07, 0x0a, 0x08, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x1b, 0x0a, 0x09,
	...
	0x4f, 0x77, 0x6e, 0x65, 0x72, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x22, 0x8a,
	...
	0x52, 0x4f, 0x59, 0x10, 0x02, 0x2a, 0x35, 0x0a, 0x0b, 0x54, 0x69, 0x6d, 0x69, 0x6e, 0x67, 0x53,
...
var file_provisionersdk_proto_provisioner_proto_goTypes = []interface{}{
	...
	(*Resourcemonitor)(nil),              // 17: provisioner.Resourcemonitor
	(*DisplayApps)(nil),                  // 18: provisioner.DisplayApps
	(*Env)(nil),                          // 19: provisioner.Env
	(*Script)(nil),                       // 20: provisioner.Script
	(*App)(nil),                          // 21: provisioner.App
	(*Healthcheck)(nil),                  // 22: provisioner.Healthcheck
	(*Resource)(nil),                     // 23: provisioner.Resource
	(*Module)(nil),                       // 24: provisioner.Module
	(*Metadata)(nil),                     // 25: provisioner.Metadata
	(*Config)(nil),                       // 26: provisioner.Config
	(*ParseRequest)(nil),                 // 27: provisioner.ParseRequest
	(*ParseComplete)(nil),                // 28: provisioner.ParseComplete
	(*PlanRequest)(nil),                  // 29: provisioner.PlanRequest
	(*PlanComplete)(nil),                 // 30: provisioner.PlanComplete
	(*ApplyRequest)(nil),                 // 31: provisioner.ApplyRequest
	(*ApplyComplete)(nil),                // 32: provisioner.ApplyComplete
	(*Timing)(nil),                       // 33: provisioner.Timing
	(*CancelRequest)(nil),                // 34: provisioner.CancelRequest
	(*Request)(nil),                      // 35: provisioner.Request
	(*Response)(nil),                     // 36: provisioner.Response
	(*Agent_Metadata)(nil),               // 37: provisioner.Agent.Metadata
	nil,                                  // 38: provisioner.Agent.EnvEntry
	nil,                                  // 39: provisioner.ResourcesMonitoring.VolumesEntry
...
var file_provisionersdk_proto_provisioner_proto_depIdxs = []int32{
	...
	38, // 2: provisioner.Agent.env:type_name -> provisioner.Agent.EnvEntry
	21, // 3: provisioner.Agent.apps:type_name -> provisioner.App
	37, // 4: provisioner.Agent.metadata:type_name -> provisioner.Agent.Metadata
	18, // 5: provisioner.Agent.display_apps:type_name -> provisioner.DisplayApps
	20, // 6: provisioner.Agent.scripts:type_name -> provisioner.Script
	19, // 7: provisioner.Agent.extra_envs:type_name -> provisioner.Env
	16, // 8: provisioner.Agent.resources_monitoring:type_name -> provisioner.ResourcesMonitoring
	17, // 9: provisioner.ResourcesMonitoring.memory:type_name -> provisioner.Resourcemonitor
	39, // 10: provisioner.ResourcesMonitoring.volumes:type_name -> provisioner.ResourcesMonitoring.VolumesEntry
	22, // 11: provisioner.App.healthcheck:type_name -> provisioner.Healthcheck
	...
	25, // 19: provisioner.PlanRequest.metadata:type_name -> provisioner.Metadata
	...
	23, // 23: provisioner.PlanComplete.resources:type_name -> provisioner.Resource
	...
	33, // 26: provisioner.PlanComplete.timings:type_name -> provisioner.Timing
	24, // 27: provisioner.PlanComplete.modules:type_name -> provisioner.Module
	25, // 28: provisioner.ApplyRequest.metadata:type_name -> provisioner.Metadata
	23, // 29: provisioner.ApplyComplete.resources:type_name -> provisioner.Resource
	...
	33, // 32: provisioner.ApplyComplete.timings:type_name -> provisioner.Timing
	...
	26, // 36: provisioner.Request.config:type_name -> provisioner.Config
	27, // 37: provisioner.Request.parse:type_name -> provisioner.ParseRequest
	29, // 38: provisioner.Request.plan:type_name -> provisioner.PlanRequest
	31, // 39: provisioner.Request.apply:type_name -> provisioner.ApplyRequest
	34, // 40: provisioner.Request.cancel:type_name -> provisioner.CancelRequest
	11, // 41: provisioner.Response.log:type_name -> provisioner.Log
	28, // 42: provisioner.Response.parse:type_name -> provisioner.ParseComplete
	30, // 43: provisioner.Response.plan:type_name -> provisioner.PlanComplete
	32, // 44: provisioner.Response.apply:type_name -> provisioner.ApplyComplete
	17, // 45: provisioner.ResourcesMonitoring.VolumesEntry.value:type_name -> provisioner.Resourcemonitor
	35, // 46: provisioner.Provisioner.Session:input_type -> provisioner.Request
	36, // 47: provisioner.Provisioner.Session:output_type -> provisioner.Response
