...
const (
	...
	AppSharingLevel_ORGANIZATION  AppSharingLevel = 2
	AppSharingLevel_PUBLIC        AppSharingLevel = 3
)
...
const file_provisionersdk_proto_provisioner_proto_rawDesc = "" +
	...
	"\x03ttl\x18\x01 \x01(\x05R\x03ttl\"t\n" +
	"\bPrebuild\x12\x1c\n" +
	"\tinstances\x18\x01 \x01(\x05R\tinstances\x12J\n" +
	"\x11expiration_policy\x18\x02 \x01(\v2\x1d.provisioner.ExpirationPolicyR\x10expirationPolicy\"\x8d\x01\n" +
	"\x06Preset\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12<\n" +
	"\n" +
	"parameters\x18\x02 \x03(\v2\x1c.provisioner.PresetParameterR\n" +
	"parameters\x121\n" +
	"\bprebuild\x18\x03 \x01(\v2\x15.provisioner.PrebuildR\bprebuild\";\n" +
	...
	"configPath\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\"\xaa\x03\n" +
	"\x03App\x12\x12\n" +
	...
	"\x05group\x18\r \x01(\tR\x05group\"Y\n" +
	...
	"\x05token\x18\x02 \x01(\tR\x05token\"\xca\t\n" +
	"\bMetadata\x12\x1b\n" +
	...
	"\x19previous_parameter_values\x18\x05 \x03(\v2\x1f.provisioner.RichParameterValueR\x17previousParameterValues\"\x93\x04\n" +
	...
	"\fmodule_files\x18\v \x01(\fR\vmoduleFiles\"A\n" +
	"\fApplyRequest\x121\n" +
	"\bmetadata\x18\x01 \x01(\v2\x15.provisioner.MetadataR\bmetadata\"\xbe\x02\n" +
	...
	"\atimings\x18\x06 \x03(\v2\x13.provisioner.TimingR\atimings\"\xfa\x01\n" +
	"\x06Timing\x120\n" +
	...
	"\x05apply\x18\x04 \x01(\v2\x1a.provisioner.ApplyCompleteH\x00R\x05applyB\x06\n" +
	"\x04type*\xa8\x01\n" +
...
func file_provisionersdk_proto_provisioner_proto_init() {
	...
	file_provisionersdk_proto_provisioner_proto_msgTypes[15].OneofWrappers = []any{
		(*Agent_Token)(nil),
		(*Agent_InstanceId)(nil),
	}
	file_provisionersdk_proto_provisioner_proto_msgTypes[39].OneofWrappers = []any{
		(*Request_Config)(nil),
		(*Request_Parse)(nil),
		(*Request_Plan)(nil),
		(*Request_Apply)(nil),
	...
	file_provisionersdk_proto_provisioner_proto_msgTypes[40].OneofWrappers = []any{
		(*Response_Log)(nil),
		(*Response_Parse)(nil),
		(*Response_Plan)(nil),
		(*Response_Apply)(nil),
