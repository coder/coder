...
var file_provisionersdk_proto_provisioner_proto_depIdxs = []int32{
	...
	8,  // 15: provisioner.Provision.Response.log:type_name -> provisioner.Log
	19, // 16: provisioner.Provision.Response.complete:type_name -> provisioner.Provision.Complete
	15, // 17: provisioner.Provisioner.Parse:input_type -> provisioner.Parse.Request
	18, // 18: provisioner.Provisioner.Provision:input_type -> provisioner.Provision.Request
	17, // 19: provisioner.Provisioner.Parse:output_type -> provisioner.Parse.Response
	20, // 20: provisioner.Provisioner.Provision:output_type -> provisioner.Provision.Response
