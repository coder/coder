...
type CacheInvalidation struct {
	...
	InvalidateAfterSecs int32 `protobuf:"varint,1,opt,name=invalidate_after_secs,json=invalidateAfterSecs,proto3" json:"invalidate_after_secs,omitempty"`
}
...
func (x *CacheInvalidation) GetInvalidateAfterSecs() int32 {
	if x != nil {
		return x.InvalidateAfterSecs
	}
	return 0
}
...
type Prebuild struct {
	...
	CacheInvalidation *CacheInvalidation `protobuf:"bytes,2,opt,name=cache_invalidation,json=cacheInvalidation,proto3" json:"cache_invalidation,omitempty"`
}
...
func (x *Prebuild) GetCacheInvalidation() *CacheInvalidation {
	if x != nil {
...
var file_provisionersdk_proto_provisioner_proto_rawDesc = []byte{
	...
	,
	...
	0x61, 0x6d, 0x65, 0x22, 0x94, 0x03, 0x0a, 0x03, 0x41, 0x70, 0x70, 0x12, 0x12, 0x0a, 0x04, 0x73,
	...
	0x49, 0x6e, 0x52, 0x06, 0x6f, 0x70, 0x65, 0x6e, 0x49, 0x6e, 0x22, 0x59, 0x0a, 0x0b, 0x48, 0x65,
...
var file_provisionersdk_proto_provisioner_proto_goTypes = []interface{}{
	...
	(*CacheInvalidation)(nil),            // 11: provisioner.CacheInvalidation
...
var file_provisionersdk_proto_provisioner_proto_depIdxs = []int32{
	...
	11, // 1: provisioner.Prebuild.cache_invalidation:type_name -> provisioner.CacheInvalidation
	...
	0,  // 4: provisioner.Log.level:type_name -> provisioner.LogLevel
	...
	1,  // 16: provisioner.App.sharing_level:type_name -> provisioner.AppSharingLevel
	2,  // 17: provisioner.App.open_in:type_name -> provisioner.AppOpenIn
	...
	3,  // 20: provisioner.Metadata.workspace_transition:type_name -> provisioner.WorkspaceTransition
	33, // 21: provisioner.Metadata.workspace_owner_rbac_roles:type_name -> provisioner.Role
	4,  // 22: provisioner.Metadata.prebuilt_workspace_build_stage:type_name -> provisioner.PrebuiltWorkspaceBuildStage
	34, // 23: provisioner.Metadata.running_agent_auth_tokens:type_name -> provisioner.RunningAgentAuthToken
	7,  // 24: provisioner.ParseComplete.template_variables:type_name -> provisioner.TemplateVariable
	...
	10, // 27: provisioner.PlanRequest.rich_parameter_values:type_name -> provisioner.RichParameterValue
	...
	10, // 30: provisioner.PlanRequest.previous_parameter_values:type_name -> provisioner.RichParameterValue
	31, // 31: provisioner.PlanComplete.resources:type_name -> provisioner.Resource
	9,  // 32: provisioner.PlanComplete.parameters:type_name -> provisioner.RichParameter
	...
	9,  // 40: provisioner.ApplyComplete.parameters:type_name -> provisioner.RichParameter
	...
	5,  // 45: provisioner.Timing.state:type_name -> provisioner.TimingState
