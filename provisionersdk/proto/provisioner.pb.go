...
var file_provisionersdk_proto_provisioner_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x12, 0x2a, 0x0a, 0x11, 0x6f, 0x6d, 0x69, 0x74, 0x5f, 0x6d, 0x6f, 0x64, 0x75, 0x6c,
	0x65, 0x5f, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0f, 0x6f,
	0x6d, 0x69, 0x74, 0x4d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x22, 0xbf,
	0x04, 0x0a, 0x0c, 0x50, 0x6c, 0x61, 0x6e, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x12,
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x70, 0x6c, 0x61, 0x6e, 0x12, 0x55, 0x0a, 0x15, 0x72, 0x65,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x72, 0x65, 0x70, 0x6c, 0x61, 0x63, 0x65, 0x6d, 0x65,
	0x6e, 0x74, 0x73, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x70, 0x72, 0x6f, 0x76,
	...
	0x73, 0x12, 0x21, 0x0a, 0x0c, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x5f, 0x66, 0x69, 0x6c, 0x65,
	0x73, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0b, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x46,
	0x69, 0x6c, 0x65, 0x73, 0x12, 0x2a, 0x0a, 0x11, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x5f, 0x66,
	0x69, 0x6c, 0x65, 0x73, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0c, 0x52,
	0x0f, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x48, 0x61, 0x73, 0x68,
	...
	0x65, 0x22, 0xc9, 0x02, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x24,
	...
	0x6c, 0x65, 0x74, 0x65, 0x48, 0x00, 0x52, 0x05, 0x61, 0x70, 0x70, 0x6c, 0x79, 0x12, 0x3a, 0x0a,
	0x0b, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x75, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x18, 0x05, 0x20, 0x01,
	...
	0x6e, 0x6b, 0x5f, 0x70, 0x69, 0x65, 0x63, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17,
	...
	0x50, 0x69, 0x65, 0x63, 0x65, 0x42, 0x06, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0x9c, 0x01,
	...
	0x45, 0x10, 0x01, 0x12, 0x09, 0x0a, 0x05, 0x43, 0x4c, 0x41, 0x49, 0x4d, 0x10, 0x02, 0x2a, 0x35,
...
var file_provisionersdk_proto_provisioner_proto_msgTypes = make([]protoimpl.MessageInfo, 49)
var file_provisionersdk_proto_provisioner_proto_goTypes = []interface{}{
	...
	(*Autoscaling)(nil),                  // 15: provisioner.Autoscaling
	...
	(*Metadata)(nil),                     // 39: provisioner.Metadata
	(*Config)(nil),                       // 40: provisioner.Config
	(*ParseRequest)(nil),                 // 41: provisioner.ParseRequest
	(*ParseComplete)(nil),                // 42: provisioner.ParseComplete
	(*PlanRequest)(nil),                  // 43: provisioner.PlanRequest
	(*PlanComplete)(nil),                 // 44: provisioner.PlanComplete
	(*ApplyRequest)(nil),                 // 45: provisioner.ApplyRequest
	(*ApplyComplete)(nil),                // 46: provisioner.ApplyComplete
	(*Timing)(nil),                       // 47: provisioner.Timing
	(*CancelRequest)(nil),                // 48: provisioner.CancelRequest
	(*Request)(nil),                      // 49: provisioner.Request
	(*Response)(nil),                     // 50: provisioner.Response
	(*DataUpload)(nil),                   // 51: provisioner.DataUpload
	(*ChunkPiece)(nil),                   // 52: provisioner.ChunkPiece
	(*Agent_Metadata)(nil),               // 53: provisioner.Agent.Metadata
	nil,                                  // 54: provisioner.Agent.EnvEntry
	(*Resource_Metadata)(nil),            // 55: provisioner.Resource.Metadata
	nil,                                  // 56: provisioner.ParseComplete.WorkspaceTagsEntry
...
var file_provisionersdk_proto_provisioner_proto_depIdxs = []int32{
	...
	14, // 2: provisioner.Autoscaling.schedule:type_name -> provisioner.Schedule
	13, // 3: provisioner.Prebuild.expiration_policy:type_name -> provisioner.ExpirationPolicy
	15, // 4: provisioner.Prebuild.autoscaling:type_name -> provisioner.Autoscaling
	...
	54, // 8: provisioner.Agent.env:type_name -> provisioner.Agent.EnvEntry
	33, // 9: provisioner.Agent.apps:type_name -> provisioner.App
	53, // 10: provisioner.Agent.metadata:type_name -> provisioner.Agent.Metadata
	...
	55, // 22: provisioner.Resource.metadata:type_name -> provisioner.Resource.Metadata
	4,  // 23: provisioner.Metadata.workspace_transition:type_name -> provisioner.WorkspaceTransition
	37, // 24: provisioner.Metadata.workspace_owner_rbac_roles:type_name -> provisioner.Role
	5,  // 25: provisioner.Metadata.prebuilt_workspace_build_stage:type_name -> provisioner.PrebuiltWorkspaceBuildStage
	38, // 26: provisioner.Metadata.running_agent_auth_tokens:type_name -> provisioner.RunningAgentAuthToken
	9,  // 27: provisioner.ParseComplete.template_variables:type_name -> provisioner.TemplateVariable
	56, // 28: provisioner.ParseComplete.workspace_tags:type_name -> provisioner.ParseComplete.WorkspaceTagsEntry
	39, // 29: provisioner.PlanRequest.metadata:type_name -> provisioner.Metadata
	12, // 30: provisioner.PlanRequest.rich_parameter_values:type_name -> provisioner.RichParameterValue
	20, // 31: provisioner.PlanRequest.variable_values:type_name -> provisioner.VariableValue
	24, // 32: provisioner.PlanRequest.external_auth_providers:type_name -> provisioner.ExternalAuthProvider
	12, // 33: provisioner.PlanRequest.previous_parameter_values:type_name -> provisioner.RichParameterValue
	35, // 34: provisioner.PlanComplete.resources:type_name -> provisioner.Resource
	11, // 35: provisioner.PlanComplete.parameters:type_name -> provisioner.RichParameter
	23, // 36: provisioner.PlanComplete.external_auth_providers:type_name -> provisioner.ExternalAuthProviderResource
	47, // 37: provisioner.PlanComplete.timings:type_name -> provisioner.Timing
	36, // 38: provisioner.PlanComplete.modules:type_name -> provisioner.Module
	17, // 39: provisioner.PlanComplete.presets:type_name -> provisioner.Preset
	19, // 40: provisioner.PlanComplete.resource_replacements:type_name -> provisioner.ResourceReplacement
	39, // 41: provisioner.ApplyRequest.metadata:type_name -> provisioner.Metadata
	35, // 42: provisioner.ApplyComplete.resources:type_name -> provisioner.Resource
	11, // 43: provisioner.ApplyComplete.parameters:type_name -> provisioner.RichParameter
	23, // 44: provisioner.ApplyComplete.external_auth_providers:type_name -> provisioner.ExternalAuthProviderResource
	47, // 45: provisioner.ApplyComplete.timings:type_name -> provisioner.Timing
	57, // 46: provisioner.Timing.start:type_name -> google.protobuf.Timestamp
	57, // 47: provisioner.Timing.end:type_name -> google.protobuf.Timestamp
	6,  // 48: provisioner.Timing.state:type_name -> provisioner.TimingState
	40, // 49: provisioner.Request.config:type_name -> provisioner.Config
	41, // 50: provisioner.Request.parse:type_name -> provisioner.ParseRequest
	43, // 51: provisioner.Request.plan:type_name -> provisioner.PlanRequest
	45, // 52: provisioner.Request.apply:type_name -> provisioner.ApplyRequest
	48, // 53: provisioner.Request.cancel:type_name -> provisioner.CancelRequest
	21, // 54: provisioner.Response.log:type_name -> provisioner.Log
	42, // 55: provisioner.Response.parse:type_name -> provisioner.ParseComplete
	44, // 56: provisioner.Response.plan:type_name -> provisioner.PlanComplete
	46, // 57: provisioner.Response.apply:type_name -> provisioner.ApplyComplete
	51, // 58: provisioner.Response.data_upload:type_name -> provisioner.DataUpload
	52, // 59: provisioner.Response.chunk_piece:type_name -> provisioner.ChunkPiece
	7,  // 60: provisioner.DataUpload.upload_type:type_name -> provisioner.DataUploadType
	49, // 61: provisioner.Provisioner.Session:input_type -> provisioner.Request
	50, // 62: provisioner.Provisioner.Session:output_type -> provisioner.Response
