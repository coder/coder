...
func (x *Agent_Metadata) GetInterval() string {
	if x != nil {
		return x.Interval
	}
	return ""
...
var file_provisionersdk_proto_provisioner_proto_rawDesc = []byte{
	...
	0x22, 0xed, 0x06, 0x0a, 0x05, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	...
	0x03, 0x63, 0x6d, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c,
	...
	0x06, 0x69, 0x73, 0x4e, 0x75, 0x6c, 0x6c, 0x22, 0xcb, 0x02, 0x0a, 0x05, 0x50, 0x61, 0x72, 0x73,
	...
	0x09, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x1a, 0xa3, 0x01, 0x0a, 0x08, 0x43,
	0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x12, 0x4c, 0x0a, 0x12, 0x74, 0x65, 0x6d, 0x70, 0x6c,
	0x61, 0x74, 0x65, 0x5f, 0x76, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x18, 0x01, 0x20,
	...
	0x61, 0x62, 0x6c, 0x65, 0x73, 0x12, 0x49, 0x0a, 0x11, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74,
	...
	0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0x91, 0x0c, 0x0a, 0x09, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x73,
	0x69, 0x6f, 0x6e, 0x1a, 0xa1, 0x03, 0x0a, 0x08, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61,
	...
	0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x1a, 0x79, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69,
	...
	0x74, 0x61, 0x1a, 0xeb, 0x02, 0x0a, 0x04, 0x50, 0x6c, 0x61, 0x6e, 0x12, 0x35, 0x0a, 0x06, 0x63,
...
var file_provisionersdk_proto_provisioner_proto_depIdxs = []int32{
	...
	27, // 13: provisioner.Resource.metadata:type_name -> provisioner.Resource.Metadata
	...
	29, // 17: provisioner.Parse.Response.complete:type_name -> provisioner.Parse.Complete
	2,  // 18: provisioner.Provision.Metadata.workspace_transition:type_name -> provisioner.WorkspaceTransition
	31, // 19: provisioner.Provision.Config.metadata:type_name -> provisioner.Provision.Metadata
	32, // 20: provisioner.Provision.Plan.config:type_name -> provisioner.Provision.Config
	...
	32, // 25: provisioner.Provision.Apply.config:type_name -> provisioner.Provision.Config
	33, // 26: provisioner.Provision.Request.plan:type_name -> provisioner.Provision.Plan
	34, // 27: provisioner.Provision.Request.apply:type_name -> provisioner.Provision.Apply
	35, // 28: provisioner.Provision.Request.cancel:type_name -> provisioner.Provision.Cancel
	...
	37, // 32: provisioner.Provision.Response.complete:type_name -> provisioner.Provision.Complete
	28, // 33: provisioner.Provisioner.Parse:input_type -> provisioner.Parse.Request
	36, // 34: provisioner.Provisioner.Provision:input_type -> provisioner.Provision.Request
	30, // 35: provisioner.Provisioner.Parse:output_type -> provisioner.Parse.Response
	38, // 36: provisioner.Provisioner.Provision:output_type -> provisioner.Provision.Response
