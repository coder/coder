...
type Timing struct {
	...
	Action   string                 `protobuf:"bytes,3,opt,name=action,proto3" json:"action,omitempty"` // TODO: enum? try not be terraform-specific
	Provider string                 `protobuf:"bytes,4,opt,name=provider,proto3" json:"provider,omitempty"`
	Resource string                 `protobuf:"bytes,5,opt,name=resource,proto3" json:"resource,omitempty"`
	State    TimingState            `protobuf:"varint,6,opt,name=state,proto3,enum=provisioner.TimingState" json:"state,omitempty"`
}
...
func (x *Timing) GetProvider() string {
	if x != nil {
		return x.Provider
	}
	return ""
...
var file_provisionersdk_proto_provisioner_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0xe8, 0x01, 0x0a, 0x06, 0x54, 0x69, 0x6d, 0x69, 0x6e, 0x67, 0x12, 0x30, 0x0a, 0x05,
	...
	0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x18, 0x2e, 0x70, 0x72,
	...
	0x53, 0x54, 0x52, 0x4f, 0x59, 0x10, 0x02, 0x2a, 0x45, 0x0a, 0x0b, 0x54, 0x69, 0x6d, 0x69, 0x6e,
	0x67, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x0d, 0x0a, 0x09, 0x43, 0x4f, 0x4d, 0x50, 0x4c, 0x45,
	...
	0x02, 0x12, 0x0b, 0x0a, 0x07, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x03, 0x32, 0x49,
