...
var file_provisionersdk_proto_provisioner_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0x99, 0x03, 0x0a, 0x0c, 0x50, 0x6c, 0x61, 0x6e, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65,
	...
	0x6e, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x70, 0x6c, 0x61, 0x6e, 0x22, 0x41, 0x0a,
...
var file_provisionersdk_proto_provisioner_proto_depIdxs = []int32{
	...
	9,  // 27: provisioner.PlanRequest.previous_parameter_values:type_name -> provisioner.RichParameterValue
	28, // 28: provisioner.PlanComplete.resources:type_name -> provisioner.Resource
	8,  // 29: provisioner.PlanComplete.parameters:type_name -> provisioner.RichParameter
	16, // 30: provisioner.PlanComplete.external_auth_providers:type_name -> provisioner.ExternalAuthProviderResource
	39, // 31: provisioner.PlanComplete.timings:type_name -> provisioner.Timing
	29, // 32: provisioner.PlanComplete.modules:type_name -> provisioner.Module
	11, // 33: provisioner.PlanComplete.presets:type_name -> provisioner.Preset
	31, // 34: provisioner.ApplyRequest.metadata:type_name -> provisioner.Metadata
	28, // 35: provisioner.ApplyComplete.resources:type_name -> provisioner.Resource
	8,  // 36: provisioner.ApplyComplete.parameters:type_name -> provisioner.RichParameter
	16, // 37: provisioner.ApplyComplete.external_auth_providers:type_name -> provisioner.ExternalAuthProviderResource
	39, // 38: provisioner.ApplyComplete.timings:type_name -> provisioner.Timing
	47, // 39: provisioner.Timing.start:type_name -> google.protobuf.Timestamp
	47, // 40: provisioner.Timing.end:type_name -> google.protobuf.Timestamp
	4,  // 41: provisioner.Timing.state:type_name -> provisioner.TimingState
	32, // 42: provisioner.Request.config:type_name -> provisioner.Config
	33, // 43: provisioner.Request.parse:type_name -> provisioner.ParseRequest
	35, // 44: provisioner.Request.plan:type_name -> provisioner.PlanRequest
	37, // 45: provisioner.Request.apply:type_name -> provisioner.ApplyRequest
	40, // 46: provisioner.Request.cancel:type_name -> provisioner.CancelRequest
	14, // 47: provisioner.Response.log:type_name -> provisioner.Log
	34, // 48: provisioner.Response.parse:type_name -> provisioner.ParseComplete
	36, // 49: provisioner.Response.plan:type_name -> provisioner.PlanComplete
	38, // 50: provisioner.Response.apply:type_name -> provisioner.ApplyComplete
	41, // 51: provisioner.Provisioner.Session:input_type -> provisioner.Request
	42, // 52: provisioner.Provisioner.Session:output_type -> provisioner.Response
