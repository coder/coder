...
const file_provisionersdk_proto_provisioner_proto_rawDesc = "" +
	...
	"\x04icon\x18\x04 \x01(\tR\x04icon\"\xfe\x04\n" +
	...
	"\tephemeral\x18\x11 \x01(\bR\tephemeralB\x11\n" +
	...
	"\bPrebuild\x12\x1c\n" +
	"\tinstances\x18\x01 \x01(\x05R\tinstances\"\x8d\x01\n" +
	"\x06Preset\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12<\n" +
	"\n" +
	...
	"\faccess_token\x18\x02 \x01(\tR\vaccessToken\"\xb6\b\n" +
	"\x05Agent\x12\x0e\n" +
	...
	"\rdevcontainers\x18\x19 \x03(\v2\x19.provisioner.DevcontainerR\rdevcontainers\x1a\xa3\x01\n" +
	"\bMetadata\x12\x10\n" +
	...
	"configPath\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\"\x94\x03\n" +
	"\x03App\x12\x12\n" +
	...
	"\aopen_in\x18\f \x01(\x0e2\x16.provisioner.AppOpenInR\x06openIn\"Y\n" +
	...
	"\x06org_id\x18\x02 \x01(\tR\x05orgId\"\xae\t\n" +
	"\bMetadata\x12\x1b\n" +
	...
	"\x1eprebuilt_workspace_build_stage\x18\x14 \x01(\x0e2(.provisioner.PrebuiltWorkspaceBuildStageR\x1bprebuiltWorkspaceBuildStage\x12A\n" +
	"\x1drunning_workspace_agent_token\x18\x15 \x01(\tR\x1arunningWorkspaceAgentToken\"\x8a\x01\n" +
	"\x06Config\x126\n" +
	...
	"\x19previous_parameter_values\x18\x05 \x03(\v2\x1f.provisioner.RichParameterValueR\x17previousParameterValues\"\xbc\x03\n" +
...
func file_provisionersdk_proto_provisioner_proto_init() {
	...
	file_provisionersdk_proto_provisioner_proto_msgTypes[13].OneofWrappers = []any{
		(*Agent_Token)(nil),
		(*Agent_InstanceId)(nil),
	}
	file_provisionersdk_proto_provisioner_proto_msgTypes[36].OneofWrappers = []any{
		(*Request_Config)(nil),
		(*Request_Parse)(nil),
		(*Request_Plan)(nil),
		(*Request_Apply)(nil),
	...
	file_provisionersdk_proto_provisioner_proto_msgTypes[37].OneofWrappers = []any{
		(*Response_Log)(nil),
		(*Response_Parse)(nil),
		(*Response_Plan)(nil),
		(*Response_Apply)(nil),
