...
var file_provisionersdk_proto_provisioner_proto_depIdxs = []int32{
	...
	64, // 22: provisioner.Resource.metadata:type_name -> provisioner.Resource.Metadata
	...
	65, // 29: provisioner.ParseComplete.workspace_tags:type_name -> provisioner.ParseComplete.WorkspaceTagsEntry
	...
	66, // 49: provisioner.Timing.start:type_name -> google.protobuf.Timestamp
	66, // 50: provisioner.Timing.end:type_name -> google.protobuf.Timestamp
	...
	58, // 59: provisioner.Request.file:type_name -> provisioner.FileUpload
	22, // 60: provisioner.Response.log:type_name -> provisioner.Log
	45, // 61: provisioner.Response.parse:type_name -> provisioner.ParseComplete
	47, // 62: provisioner.Response.init:type_name -> provisioner.InitComplete
	49, // 63: provisioner.Response.plan:type_name -> provisioner.PlanComplete
	51, // 64: provisioner.Response.apply:type_name -> provisioner.ApplyComplete
	53, // 65: provisioner.Response.graph:type_name -> provisioner.GraphComplete
	60, // 66: provisioner.Response.data_upload:type_name -> provisioner.DataUpload
	61, // 67: provisioner.Response.chunk_piece:type_name -> provisioner.ChunkPiece
	60, // 68: provisioner.FileUpload.data_upload:type_name -> provisioner.DataUpload
	61, // 69: provisioner.FileUpload.chunk_piece:type_name -> provisioner.ChunkPiece
	59, // 70: provisioner.FileUpload.error:type_name -> provisioner.FailedFile
	8,  // 71: provisioner.DataUpload.upload_type:type_name -> provisioner.DataUploadType
	56, // 72: provisioner.Provisioner.Session:input_type -> provisioner.Request
	57, // 73: provisioner.Provisioner.Session:output_type -> provisioner.Response
