...
var file_provisionersdk_proto_provisioner_proto_rawDesc = []byte{
	...
	0x22, 0xfc, 0x08, 0x0a, 0x08, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x1b, 0x0a,
	...
	0x68, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x73, 0x22, 0x99, 0x03, 0x0a, 0x0c, 0x50,
	...
	0x52, 0x04, 0x70, 0x6c, 0x61, 0x6e, 0x22, 0x41, 0x0a, 0x0c, 0x41, 0x70, 0x70, 0x6c, 0x79, 0x52,
...
var file_provisionersdk_proto_provisioner_proto_goTypes = []interface{}{
	...
	(*RunningAgentAuthToken)(nil),        // 31: provisioner.RunningAgentAuthToken
...
var file_provisionersdk_proto_provisioner_proto_depIdxs = []int32{
	...
	31, // 21: provisioner.Metadata.running_agent_auth_tokens:type_name -> provisioner.RunningAgentAuthToken
	6,  // 22: provisioner.ParseComplete.template_variables:type_name -> provisioner.TemplateVariable
	...
	9,  // 25: provisioner.PlanRequest.rich_parameter_values:type_name -> provisioner.RichParameterValue
	13, // 26: provisioner.PlanRequest.variable_values:type_name -> provisioner.VariableValue
	17, // 27: provisioner.PlanRequest.external_auth_providers:type_name -> provisioner.ExternalAuthProvider
