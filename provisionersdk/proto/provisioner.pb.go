...
type Script struct {
	...
	// id identifies the script for coder_script_order dependency
	// resolution. For a coder_script resource, it is the resource's
	// generated identifier and is empty during plan because the value is
	// computed at apply. For an agent's legacy inline startup_script, it
	// is a synthetic value (the coder_agent resource's own address) set
	// only when the template declares coder_script_order, and may be
	// populated during plan since it is not resource-generated. Either
	// way it is a same-payload correlation key only; the persisted
	// database script id is always generated separately.
	Id string `protobuf:"bytes,10,opt,name=id,proto3" json:"id,omitempty"`
	// order_dependencies lists scripts on the same agent that must reach a
	// terminal state before this script starts. Resolved from
	// coder_script_order data sources. Unrelated to the Terraform depends_on
	// meta-argument.
	OrderDependencies []*ScriptOrderDependency `protobuf:"bytes,11,rep,name=order_dependencies,json=orderDependencies,proto3" json:"order_dependencies,omitempty"`
}
...
func (x *Script) GetOrderDependencies() []*ScriptOrderDependency {
	if x != nil {
		return x.OrderDependencies
	}
	return nil
}

// ScriptOrderDependency is a resolved coder_script_order rule: the script
// identified by script_id must reach a terminal state before the script
// carrying this entry starts.
type ScriptOrderDependency struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// script_id references Script.id of the script that must run first.
	ScriptId string `protobuf:"bytes,1,opt,name=script_id,json=scriptId,proto3" json:"script_id,omitempty"`
	// requires is either "success" (dependent is skipped unless the
	// dependency succeeds) or "completion" (dependent runs after the
	// dependency reaches any terminal state).
	Requires string `protobuf:"bytes,2,opt,name=requires,proto3" json:"requires,omitempty"`
}

func (x *ScriptOrderDependency) Reset() {
	*x = ScriptOrderDependency{}
	if protoimpl.UnsafeEnabled {
...
func (x *ScriptOrderDependency) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ScriptOrderDependency) ProtoMessage() {}

func (x *ScriptOrderDependency) ProtoReflect() protoreflect.Message {
	mi := &file_provisionersdk_proto_provisioner_proto_msgTypes[24]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ScriptOrderDependency.ProtoReflect.Descriptor instead.
func (*ScriptOrderDependency) Descriptor() ([]byte, []int) {
	return file_provisionersdk_proto_provisioner_proto_rawDescGZIP(), []int{24}
}

func (x *ScriptOrderDependency) GetScriptId() string {
	if x != nil {
		return x.ScriptId
	}
	return ""
...
func (x *ScriptOrderDependency) GetRequires() string {
	if x != nil {
		return x.Requires
	}
	return ""
...
var file_provisionersdk_proto_provisioner_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x67, 0x79, 0x22, 0x82, 0x03, 0x0a, 0x06, 0x53, 0x63, 0x72, 0x69, 0x70, 0x74, 0x12,
	...
	0x6f, 0x67, 0x50, 0x61, 0x74, 0x68, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x0a, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x51, 0x0a, 0x12, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f,
	...
	,
	...
	0x62, 0x61, 0x72, 0x5f, 0x61, 0x70, 0x70, 0x22, 0xf7, 0x0a, 0x0a, 0x08, 0x4d, 0x65, 0x74, 0x61,
	...
	0x22, 0x9e, 0x03, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2d, 0x0a, 0x06,
	...
	0x48, 0x00, 0x52, 0x06, 0x63, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x12, 0x2d, 0x0a, 0x04, 0x66, 0x69,
	0x6c, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x70, 0x72, 0x6f, 0x76, 0x69,
	0x73, 0x69, 0x6f, 0x6e, 0x65, 0x72, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x55, 0x70, 0x6c, 0x6f, 0x61,
	0x64, 0x48, 0x00, 0x52, 0x04, 0x66, 0x69, 0x6c, 0x65, 0x42, 0x06, 0x0a, 0x04, 0x74, 0x79, 0x70,
	0x65, 0x22, 0xae, 0x03, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x24,
	...
	0x00, 0x52, 0x05, 0x70, 0x61, 0x72, 0x73, 0x65, 0x12, 0x2f, 0x0a, 0x04, 0x69, 0x6e, 0x69, 0x74,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69,
	0x6f, 0x6e, 0x65, 0x72, 0x2e, 0x49, 0x6e, 0x69, 0x74, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74,
	0x65, 0x48, 0x00, 0x52, 0x04, 0x69, 0x6e, 0x69, 0x74, 0x12, 0x2f, 0x0a, 0x04, 0x70, 0x6c, 0x61,
	0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x73,
	...
	,
	...
	0x0a, 0x0b, 0x63, 0x68, 0x75, 0x6e, 0x6b, 0x5f, 0x70, 0x69, 0x65, 0x63, 0x65, 0x18, 0x08, 0x20,
	...
	0x70, 0x65, 0x22, 0xbd, 0x01, 0x0a, 0x0a, 0x46, 0x69, 0x6c, 0x65, 0x55, 0x70, 0x6c, 0x6f, 0x61,
	0x64, 0x12, 0x3a, 0x0a, 0x0b, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x75, 0x70, 0x6c, 0x6f, 0x61, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69,
	...
	0x0b, 0x63, 0x68, 0x75, 0x6e, 0x6b, 0x5f, 0x70, 0x69, 0x65, 0x63, 0x65, 0x18, 0x02, 0x20, 0x01,
	...
	0x68, 0x75, 0x6e, 0x6b, 0x50, 0x69, 0x65, 0x63, 0x65, 0x12, 0x2f, 0x0a, 0x05, 0x65, 0x72, 0x72,
	0x6f, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x70, 0x72, 0x6f, 0x76, 0x69,
	0x73, 0x69, 0x6f, 0x6e, 0x65, 0x72, 0x2e, 0x46, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x46, 0x69, 0x6c,
	0x65, 0x48, 0x00, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x42, 0x06, 0x0a, 0x04, 0x74, 0x79,
	0x70, 0x65, 0x22, 0x22, 0x0a, 0x0a, 0x46, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x46, 0x69, 0x6c, 0x65,
	0x12, 0x14, 0x0a, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x9c, 0x01, 0x0a, 0x0a, 0x44, 0x61, 0x74, 0x61, 0x55,
	...
	0x43, 0x4c, 0x41, 0x49, 0x4d, 0x10, 0x02, 0x2a, 0x44, 0x0a, 0x0b, 0x47, 0x72, 0x61, 0x70, 0x68,
	0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x12, 0x0a, 0x0e, 0x53, 0x4f, 0x55, 0x52, 0x43, 0x45,
	0x5f, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x00, 0x12, 0x0f, 0x0a, 0x0b, 0x53, 0x4f,
	0x55, 0x52, 0x43, 0x45, 0x5f, 0x50, 0x4c, 0x41, 0x4e, 0x10, 0x01, 0x12, 0x10, 0x0a, 0x0c, 0x53,
	0x4f, 0x55, 0x52, 0x43, 0x45, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x45, 0x10, 0x02, 0x2a, 0x35, 0x0a,
...
var file_provisionersdk_proto_provisioner_proto_goTypes = []interface{}{
	...
	(*ScriptOrderDependency)(nil),        // 33: provisioner.ScriptOrderDependency
...
var file_provisionersdk_proto_provisioner_proto_depIdxs = []int32{
	...
	33, // 18: provisioner.Script.order_dependencies:type_name -> provisioner.ScriptOrderDependency
...
func file_provisionersdk_proto_provisioner_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_provisionersdk_proto_provisioner_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ScriptOrderDependency); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
