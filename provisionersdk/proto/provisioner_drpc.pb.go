...
type DRPCProvisionerClient interface {
	...
	Metadata(ctx context.Context, in *Metadata_Request) (*Metadata_Response, error)
...
func (c *drpcProvisionerClient) Metadata(ctx context.Context, in *Metadata_Request) (*Metadata_Response, error) {
	out := new(Metadata_Response)
	err := c.cc.Invoke(ctx, "/provisioner.Provisioner/Metadata", drpcEncoding_File_provisionersdk_proto_provisioner_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DRPCProvisionerServer interface {
	Metadata(context.Context, *Metadata_Request) (*Metadata_Response, error)
...
func (s *DRPCProvisionerUnimplementedServer) Metadata(context.Context, *Metadata_Request) (*Metadata_Response, error) {
...
func (DRPCProvisionerDescription) Method(n int) (string, drpc.Encoding, drpc.Receiver, interface{}, bool) {
	switch n {
	case 0:
		return "/provisioner.Provisioner/Metadata", drpcEncoding_File_provisionersdk_proto_provisioner_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCProvisionerServer).
					Metadata(
						ctx,
						in1.(*Metadata_Request),
					)
			}, DRPCProvisionerServer.Metadata, true
	case 1:
...
type DRPCProvisioner_MetadataStream interface {
	drpc.Stream
	SendAndClose(*Metadata_Response) error
}

type drpcProvisioner_MetadataStream struct {
	drpc.Stream
}

func (x *drpcProvisioner_MetadataStream) SendAndClose(m *Metadata_Response) error {
